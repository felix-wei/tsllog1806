                ...
                <tr>
                    ...
                    <td>
                     ...
                     window.location='pay_edit.aspx?no='+txtSchNo.GetText()
                                ...
                                <td>
                                    <dxe:ASPxButton ID="ASPxButton9" Width="80" runat="server" Text="Add New" AutoPostBack="False">
                                        <ClientSideEvents Click="function(s, e) {
                     window.location='pay_edit.aspx?no=0'
                                ...
                                <td>
                                    <dxe:ASPxButton ID="btn_back" Width="80" runat="server" Text="Go Search" AutoPostBack="False">
                                        <ClientSideEvents Click="function(s, e) {
