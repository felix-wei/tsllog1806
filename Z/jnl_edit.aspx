<%@ Page Language="C#" EnableViewState="false" AutoEventWireup="true" CodeFile="jnl_edit.aspx.cs" Inherits="Z_jnl_edit" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <wilson:DataSource ID="dsArReceiptDet" runat="server" ObjectSpace="C2.Manager.ORManager"
                TypeName="C2.jnl_line" KeyMember="Id" FilterExpression="1=0" />
            ...
            <table style="float: left; position: absolute; top: 2px;">
                <tr>
                    ...
                    <td>
                     ...
                     window.location='jnl_edit.aspx?no='+txtSchNo.GetText()
                        }" />
                                    </dxe:ASPxButton>
                                </td>
                                <td>
                                    <dxe:ASPxButton ID="ASPxButton9" Width="70" runat="server" Text="Add New" AutoPostBack="False">
                                        <ClientSideEvents Click="function(s, e) {
                     window.location='jnl_edit.aspx?no=0'
                        }" />
                                    </dxe:ASPxButton>
                                </td>
                                <td>
