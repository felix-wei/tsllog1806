<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pay_list.aspx.cs" Inherits="Z_pay_list" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ShowArReceipt(invN) {
            parent.navTab.openTab(invN, "/Z/pay_edit.aspx?no=" + invN, { title: invN, fresh: false, external: true });
        }
        ...
        function OnSaveCallBack(v) {
            if (v != null && v.length > 0) {
                ...
                ASPxPopupClientControl.Hide();
                parent.navTab.openTab(v, '/Z/pay_edit.aspx?no=' + v, { title: v, fresh: false, external: true });
            }
        }
    </script>
...
<body width="800">
    ...
    ShowArReceipt('0');}" />
        ...
        <dxwgv:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" runat="server"
            DataSourceID="dsArReceipt" Width="900" KeyFieldName="Id" AutoGenerateColumns="False" OnCustomDataCallback="ASPxGridView1_CustomDataCallback">
