...
public partial class ReportFreightSea_AccountPrintView : System.Web.UI.Page
{
    ...
    private MemoryStream PrintInvoice(string billNo)
    {
        ...
        rpt.LoadLayout(Server.MapPath(@"~\ReportTpt\repx\Account\Invoice.repx"));
    ...
    {
        XtraReport rpt = new XtraReport();
        rpt.LoadLayout(Server.MapPath(@"~\ReportTpt\repx\Account\Invoice_A4.repx"));
        rpt.DataSource = AccountFreightPrint.PrintInvoice(billNo,"IV");
        System.IO.MemoryStream str = new MemoryStream();
        rpt.ExportToPdf(str);
    ...
    {
        XtraReport rpt = new XtraReport();
        rpt.LoadLayout(Server.MapPath(@"~\ReportTpt\repx\Account\Voucher.repx"));
        ...
        rpt1.LoadLayout(Server.MapPath(@"~\ReportTpt\repx\Account\Voucher_detail.repx"));
        ...
        //rpt2.LoadLayout(Server.MapPath(@"~\ReportTpt\repx\Account\Voucher_detail.repx"));
