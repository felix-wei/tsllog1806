<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AlertAPI_Passes.aspx.cs" Inherits="PagesContTrucking_Daily_AlertAPI_Passes" %>
...
<body ng-controller="Ctr_DailyTrips">
    ...
    <div class="joblist_content joblist_content_top35 {{partDetail.data.css}}">
        <div class="joblist_content_list">
            <div class="bx_table">
                <div class="header">
                    <div class="col_150">Name</div>
                    <div class="col_150">Telephone</div>
                    <div class="col_150">Expiry Date</div>
                    <div class="col_150">Pass Type</div>
                ...
                <div class="body">
                    <div class="item" ng-repeat="row in vm.list" style="{{row.id&&vm.curview.mast&&vm.curview.mast.id&&row.id==vm.curview.mast.id?'background-color:#f2f2f2': '' }}">
                        ...
                        <div ng-if="!row.isTitle">{{row.Name}}</div>
                        <div ng-if="!row.isTitle">{{row.Telephone}}</div>
                        <div ng-if="!row.isTitle">{{row.ExpiryDate|date:'yyyy-MM-dd'}}</div>
                        <div ng-if="!row.isTitle">{{row.Description}}</div>
                        <div ng-if="!row.isTitle">{{row.Remark}}</div>
                    </div>
                </div>
            </div>
        </div>
