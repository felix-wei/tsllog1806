<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateTransport2_Trips.aspx.cs" Inherits="PagesContTrucking_Daily_UpdateTransport2_Trips" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml" ng-app="app">
<head runat="server">
    <title>OP TPT Trips</title>
        ...
        app.factory('SV_Job', function ($http, SV_Common) {
            ...
            .controller('Ctr_Job', function ($scope, SV_Job, $timeout, SV_Popup) {
                ...
                $scope.action = {
                    ...
                    save2excel:function(){
                        SV_Job.save2Excel(null, $scope.action.save2excel_callback);
                    },
        ...
        <div class="joblist_content_list">
            ...
            <table class="bx_table_grid">
                ...
                <tr ng-repeat="row in vm.list.tripList">
                    ...
                    <td><div style="white-space:nowrap;">{{row.EtaDate|date:'yyyy-MM-dd'}} {{row.EtaTime}}</div>
                        <div style="white-space:nowrap;">/{{row.EtdDate|date:'yyyy-MM-dd'}} {{row.EtdTime}}</div>
                    </td>
                    <td>{{row.ServiceType}}</td>
                    <td>{{row.TowheadCode}}</td>
                    <td>{{row.DriverCode}}
                        <div style="white-space:nowrap;">/{{row.DriverCode2}}</div>
                    </td>
                    <td>
                        <div class="col_boxset col_boxset_p">
                            <div class="col_box_small col_box_small_p" ng-repeat="trip in row.trips" ng-class="{'P':'col_box_orange','S':'col_box_green','C':'col_box_blue','X':'col_box_gray','A':'col_box_calm'}[trip.t]"
                    ...
                    <td>{{row.b_inc1|number:0}}/{{row.b_inc2|number:0}}/{{row.b_inc3|number:0}}</td>
