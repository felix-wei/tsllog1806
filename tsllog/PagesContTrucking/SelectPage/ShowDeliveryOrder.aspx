<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShowDeliveryOrder.aspx.cs" Inherits="PagesContTrucking_SelectPage_ShowDeliveryOrder" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        function PrintDO(no) {
            window.open(" /PagesContTrucking/Report/RptPrintView.aspx?doc=TPT&refType=do&no=" +no);
        }
        function ShowDO(masterId) {
            parent.parent.navTab.openTab(masterId, "/PagesContTrucking/Job/JobEdit.aspx?no=" + masterId, { title: masterId, fresh: false, external: true });
            ...
            <dxwgv:ASPxGridView ID="grid_wh" ClientInstanceName="grid_wh" runat="server"
                ...
                <Columns>
                    <dxwgv:GridViewDataTextColumn Caption="#" FieldName="Id" VisibleIndex="0"
                        Width="40" >
                        <DataItemTemplate>
                            <a href='javascript:PrintDO("<%# Eval("JobNo") %>")'>Print</a>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Job No" FieldName="JobNo" VisibleIndex="0" Width="100">
                        <DataItemTemplate>
                            <div style="width:100px;">
                                <a href='javascript:ShowDO("<%# Eval("JobNo") %>")'><%# Eval("JobNo") %></a>
                            </div>
                        </DataItemTemplate>
                    </dxwgv:GridViewDataTextColumn>
                        ...
                        <DataItemTemplate>
                            <table style="width: 160px">
                                <tr>
                                    <td>Qty</td>
                                    <td>
                                        <%# BalanceQty(Eval("ClientId"),Eval("SkuCode"),Eval("BookingNo"),Eval("LineId"),Eval("Location"))  %>
                                     </td>
                                </tr>
                                <tr>
                                    <td width="160px">SKU Qty</td>
                                    <td>
                                        <%# BalanceSkuQty(Eval("ClientId"),Eval("SkuCode"),Eval("BookingNo"),Eval("LineId"),Eval("Location")) %>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Weight</td>
                                    <td>
                                        <%# BalanceWeight(Eval("ClientId"),Eval("SkuCode"),Eval("BookingNo"),Eval("LineId"),Eval("Location"))  %>
                                    </td>
                                     </tr>
                                <tr>
                                    <td>Volume</td>
                                    <td>
                                        <%# BalanceVolume(Eval("ClientId"),Eval("SkuCode"),Eval("BookingNo"),Eval("LineId"),Eval("Location"))  %>
                                    </td>
                                </tr>
                            </table>
                        </DataItemTemplate>
