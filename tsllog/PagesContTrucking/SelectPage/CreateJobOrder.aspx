<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CreateJobOrder.aspx.cs" Inherits="PagesContTrucking_SelectPage_CreateJobOrder" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <wilson:DataSource ID="dsTrip" runat="server" ObjectSpace="C2.Manager.ORManager" TypeName="C2.CtmJobDet2" KeyMember="Id" />
        <div style="display:none">
            <dxe:ASPxLabel ID="lbl_JobType" runat="server" ClientInstanceName="lbl_JobType"></dxe:ASPxLabel>
        </div>
        <div>
            <table>
                <tr>
                    ...
                    <td colspan="10">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <dxe:ASPxButton ID="ASPxButton10" Width="60" runat="server" Text="New WDO Trip"
                                        AutoPostBack="false" UseSubmitBehavior="false">
                                        <ClientSideEvents Click="function(s,e) {
                                             if(cbb_TripNo.GetText()!=''){
                                                   grid_wh.GetValuesOnCustomCallback('NewTrip',OnCallback);    
                                             }  
                                            else{
                                              alert('Pls select a Trip');
                                            }    
                                           }" />
                                    </dxe:ASPxButton>
                                </td>
                                <td>
                                    <dxe:ASPxButton ID="ASPxButton1" Width="60" runat="server" Text="New Delivery Order"
                                        AutoPostBack="false" UseSubmitBehavior="false">
                                        <ClientSideEvents Click="function(s,e) {
            ...
            <dxwgv:ASPxGridView ID="grid_wh" ClientInstanceName="grid_wh" runat="server"
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Booking Info" VisibleIndex="2" Width="150" Visible="false">
                        <DataItemTemplate>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Received Info" VisibleIndex="2" Width="400">
                        <DataItemTemplate>
                        ...
                        <DataItemTemplate>
                            <table style="width: 160px">
                                <tr>
                                    ...
                                    <td>
                                        <div style="display:none">
                                            <dxe:ASPxLabel ID="ASPxLabel1" runat="server" Text='<%# Eval("BalQty")  %>'></dxe:ASPxLabel>
                                        </div>
                                ...
                                <tr style="display:<%# SafeValue.SafeString(Eval("Action"))=="WDO"?"none":"table-row"%>;">
                                    <td width="120px">To Locaion</td>
                                    <td>
                                        <dxe:ASPxComboBox ID="txt_ToLoc" ClientInstanceName="txt_ToLoc" runat="server" Value='<%# Eval("Location") %>'
                                            Width="100px" DropDownWidth="80" DropDownStyle="DropDownList" DataSourceID="dsLocation"
