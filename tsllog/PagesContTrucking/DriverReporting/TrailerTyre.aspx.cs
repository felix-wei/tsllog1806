...
public partial class PagesContTrucking_DriverReporting_TrailerTyre : System.Web.UI.Page
{
    ...
    {
        string where = string.Format(@"ActionType='Trailer Tyre' and datediff(d,ReportDate,'{0}')<=0 and datediff(d,ReportDate,'{1}')>=0", SafeValue.SafeDate(search_from.Date, DateTime.Now), SafeValue.SafeDate(search_to.Date, DateTime.Now));
    ...
    protected void grid_Transport_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
    {
        ...
        e.NewValues["ActionType"] = "Trailer Tyre";
