...
public partial class PagesContTrucking_DriverReporting_PrimeMover_Tyre : System.Web.UI.Page
{
    ...
    {
        string where = string.Format(@"ActionType='Prime Mover Tyre' and datediff(d,ReportDate,'{0}')<=0 and datediff(d,ReportDate,'{1}')>=0", SafeValue.SafeDate(search_from.Date, DateTime.Now), SafeValue.SafeDate(search_to.Date, DateTime.Now));
