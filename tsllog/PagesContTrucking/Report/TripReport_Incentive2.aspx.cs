...
public partial class PagesContTrucking_Report_TripReport_Incentive2 : System.Web.UI.Page
{
	public int count=0;
...
(select isnull(sum(isnull(Qty*Price,0)),0) from job_cost where TripNo=det2.Id and LineType='DP' and ChgCode='OverTime' and det2.DriverCode='{0}' and(DriverCode=det2.DriverCode or isnull(DriverCode,'')='')) as Incentive2,
...
{2}
(select isnull(sum(isnull(Qty*Price,0)),0) from job_cost where TripNo=det2.Id and LineType='DP' and ChgCode='OverTime') as Incentive2x,
