<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TripReport_Month.aspx.cs" Inherits="PagesContTrucking_Report_TripReport_Month" %>
        ...
        <div>
            ...
            <dxwgv:ASPxGridView ID="grid_Transport" ClientInstanceName="detailGrid" runat="server"  KeyFieldName="Id" AutoGenerateColumns="False">
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataColumn FieldName="Addition" Caption="Addition" Width="100"></dxwgv:GridViewDataColumn>
                ...
                <TotalSummary>
                    <dx:ASPxSummaryItem FieldName="SalaryBasic" SummaryType="Sum" DisplayFormat="{0:0.00}" />
                    <dx:ASPxSummaryItem FieldName="Allowance" SummaryType="Sum" DisplayFormat="{0:0.00}" />
                    ...
                    <dx:ASPxSummaryItem FieldName="Addition" SummaryType="Sum" DisplayFormat="{0:0.00}" />
                    <dx:ASPxSummaryItem FieldName="Deduction" SummaryType="Sum" DisplayFormat="{0:0.00}" />
