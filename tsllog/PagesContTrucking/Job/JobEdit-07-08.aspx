...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function printJobSheetForTrip(id) {
                    ...
                    <EditForm>
                                ...
                                <td>
                                    <table style="padding: 0px">
                                        <tr>
                                            ...
                                            <td>
                                                <dxe:ASPxButton ID="btn_Confirm" ClientInstanceName="btn_Confirm" runat="server" Text="Confirm Quote To Job" AutoPostBack="false" Enabled='<%# SafeValue.SafeInt(Eval("Id"),0)>0 %>' Width="100">
                                                    <ClientSideEvents Click="function(s,e) {
                        ...
                        <div style="margin-top: 6px; padding: 10px; background-color: #FFFFFF; border: 1px solid #A8A8A8; white-space: nowrap">
                            <table>
                                ...
                                PopupPartyInfo();
                                    ...
                                    <td class="lbl" style="display: <%#(SafeValue.SafeString(Eval("JobType"))=="IMP"||SafeValue.SafeString(Eval("JobType"))=="EXP"||SafeValue.SafeString(Eval("JobType"))=="LOC"||SafeValue.SafeString(Eval("JobType"))=="CRA")?"show-cell":"none"%>">Ordered By</td>
                                    <td class="ctl" style="display: <%#(SafeValue.SafeString(Eval("JobType"))=="IMP"||SafeValue.SafeString(Eval("JobType"))=="EXP"||SafeValue.SafeString(Eval("JobType"))=="LOC"||SafeValue.SafeString(Eval("JobType"))=="CRA")?"show-cell":"none"%>">
                                    ...
                                    <td class="lbl2" style="display: <%#(SafeValue.SafeString(Eval("JobType"))=="WDO"||SafeValue.SafeString(Eval("JobType"))=="WGR"||SafeValue.SafeString(Eval("JobType"))=="TPT")?"show-cell":"none"%>">Bill Type</td>
                                    <td style="display: <%#(SafeValue.SafeString(Eval("JobType"))=="WDO"||SafeValue.SafeString(Eval("JobType"))=="WGR"||SafeValue.SafeString(Eval("JobType"))=="TPT")?"show-cell":"none"%>">
                        ...
                        <dxtc:ASPxPageControl runat="server" ID="pageControl" Width="1000px">
                            <TabPages>
                                            ...
                                            <table style="width: 1000px">
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        ...
                                                        <div class="<%#SafeValue.SafeString(Eval("JobType"))=="CRA"?"show":"hide"%>">
                                                            <dxe:ASPxMemo ID="txt_RemarkCRA" Rows="3" runat="server" Text='<%# Eval("Remark") %>' Width="100%">
                                                            </dxe:ASPxMemo>
                                                        </div>
                                                    </td>
                                                    <td class="lbl">
                                                    ...
                                                    <td colspan="2">
                                                        ...
                                                        <div class="<%#SafeValue.SafeString(Eval("JobType"))=="CRA"?"show":"hide"%>">
                                                            <dxe:ASPxMemo ID="txt_FromAddress" Rows="3" ClientInstanceName="txt_FromAddress" runat="server"
                                                                Width="100%" Text='<%# Eval("PickupFrom") %>'>
                                                            </dxe:ASPxMemo>
                                                        </div>
                                                    </td>
                                ...
                                <dxtc:TabPage Text="Transport" Name="Transport">
                                    <ContentCollection>
                                        <dxw:ContentControl>
                                            <div>
                                                <dxe:ASPxButton ID="ASPxButton24" runat="server" Enabled='<%# SafeValue.SafeInt(Eval("Id"),0)>0&&SafeValue.SafeString(Eval("StatusCode"),"USE")=="USE" %>' Text="Add Trailer" AutoPostBack="false">
                                                    <ClientSideEvents Click="function(s,e){
                                                            ...
                                                            <table style="width: 100%;">
                                                                ...
                                                                <tr>
                                                                    <td colspan="6" style="background-color: lightgreen; padding: 4px; padding-left: 10px;"><b>TRIP:</b>
                                                                        ...
                                                                        <dxe:ASPxButton ID="btn_tpt_newTrip" runat="server" Text="New Trip" CssClass="add_carpark" AutoPostBack="false" Enabled='<%# SafeValue.SafeInt(Eval("Id"),0)>0 %>'>
                                                                            <ClientSideEvents Click="function(s,e){gv_tpt_trip.GetValuesOnCustomCallback('AddNew',transport_trip_add_cb);}" />
                                                                        </dxe:ASPxButton>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                ...
                                grid_Trip.AddNewRow();
                                                ...
                                                <dxwgv:ASPxGridView ID="grid_Trip" ClientInstanceName="grid_Trip" runat="server" Width="1000px" DataSourceID="dsCraneTrip" KeyFieldName="Id" OnInit="grid_Trip_Init" AutoGenerateColumns="False"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dxwgv:GridViewDataColumn Caption="#" VisibleIndex="0" Width="100">
                                                            <DataItemTemplate>
                                                                <a href="#" onclick='printJobSheetForTrip("<%# Eval("Id")%>")'>Print JobSheet</a>
                                                            </DataItemTemplate>
                                                        </dxwgv:GridViewDataColumn>
                                                        <%--<dxwgv:GridViewDataColumn VisibleIndex="2" FieldName="ContainerNo" Caption="Container No"></dxwgv:GridViewDataColumn>--%>
                                        ...
                                        <dxw:ContentControl>
                                            ...
                                            <table>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <dxe:ASPxButton ID="ASPxButton12" runat="server" Text="Add Charges" AutoPostBack="false" Enabled='<%# SafeValue.SafeInt(Eval("Id"),0)>0&&SafeValue.SafeString(Eval("StatusCode"),"USE")!="CNL"&&(SafeValue.SafeString(Eval("JobStatus"),"Quoted")=="Quoted"||SafeValue.SafeString(Eval("JobStatus"),"Booked")=="Booked") %>'>
                                                            <ClientSideEvents Click="function(s,e){
                                                                PopupRate();
                                                    }" />
                                                        </dxe:ASPxButton>
                                                    ...
                                                    <td>
                                                        <dxe:ASPxButton ID="ASPxButton14" runat="server" Text="Pick from Master Rate" AutoPostBack="false" Enabled='<%# SafeValue.SafeInt(Eval("Id"),0)>0&&SafeValue.SafeString(Eval("StatusCode"),"USE")!="CNL"&&(SafeValue.SafeString(Eval("JobStatus"),"Quoted")=="Quoted"||SafeValue.SafeString(Eval("JobStatus"),"Booked")=="Booked") %>'>
                                                            <ClientSideEvents Click="function(s,e){
                                                      PopupMasterRate();
                                                    }" />
                                                        </dxe:ASPxButton>
                            ...
                            PopupCurrency(cmb_CostCurrency,spin_CostExRate);
                                ...
                                <dxtc:TabPage Text="Warehouse" Name="Warehouse">
                                    <ContentCollection>
                                        <dxw:ContentControl>
                                            <table style="width: 100%; padding: 0px">
                                                <tr>
                                                    <td>
                                                        <div class='<%# (SafeValue.SafeString(Eval("JobType"))=="IMP"||SafeValue.SafeString(Eval("JobType"))=="WGR"||SafeValue.SafeString(Eval("JobType"))=="TPT")?"show":"hide" %>' style="min-width: 70px;">
                       ...
                       grid_wh.AddNewRow();
                                                    ...
                                                    <td>
                                                        <div class='<%# SafeValue.SafeString(Eval("JobType"))=="IMP"?"show":"hide" %>' style="min-width: 70px;">
                                                            <dxe:ASPxButton ID="ASPxButton18" runat="server" Text="Add Container as Cargo" AutoPostBack="false">
                                                                <ClientSideEvents Click="function(s,e){
                                                                   grid_job.GetValuesOnCustomCallback('AutoCreateCargoer',onAutoCallBack);
                                                                  }" />
                                                            </dxe:ASPxButton>
                                                        </div>
                                                        <div class='<%# SafeValue.SafeString(Eval("JobType"))=="WDO"?"show":"hide"  %>' style="min-width: 70px;">
                                                            <dxe:ASPxButton ID="ASPxButton25" runat="server" Text="Add From Stock" AutoPostBack="false">
                                                                <ClientSideEvents Click="function(s,e){
                       PopupJobHouse();
                    }" />
                                                            </dxe:ASPxButton>
                                                        ...
                                                        <div class='<%# SafeValue.SafeString(Eval("JobType"))=="FTR"?"show":"hide" %>' style="min-width: 70px;">
                                                            <dxe:ASPxButton ID="ASPxButton26" runat="server" Text="Add From Stock" AutoPostBack="false">
                                                                <ClientSideEvents Click="function(s,e){
                       ...
                       PopupJobHouse();
                                                    ...
                                                    <td>
                                                        <div class='<%# (SafeValue.SafeString(Eval("JobType"))=="IMP"||SafeValue.SafeString(Eval("JobType"))=="WGR")?"show":"hide" %>' style="min-width: 70px;">
                                                            <dxe:ASPxButton ID="ASPxButton13" runat="server" Text="Create Transfer" AutoPostBack="false" Width="100">
                                                                <ClientSideEvents Click="function(s,e){
                                                                         GoJob_Page('Transfer');
                                                                        }" />
                                                            </dxe:ASPxButton>
                                                    ...
                                                    <td>
                                                        <div class='<%# (SafeValue.SafeString(Eval("JobType"))=="IMP"||SafeValue.SafeString(Eval("JobType"))=="WGR")?"show":"hide" %>' style="min-width: 70px;">
                                                            <dxe:ASPxButton ID="ASPxButton16" runat="server" Text="Create Delivery Order" AutoPostBack="false" Width="100">
                                                                <ClientSideEvents Click="function(s,e){
                                                                        GoJob_Page('Delivery');
                                                                    }" />
                                                            </dxe:ASPxButton>
                                                    ...
                                                    <td>
                                                        <div class='<%# (SafeValue.SafeString(Eval("JobType"))=="IMP"||SafeValue.SafeString(Eval("JobType"))=="WGR")?"show":"hide" %>' style="min-width: 70px;">
                                                            <dxe:ASPxButton ID="ASPxButton17" runat="server" Text="Show Delivery Order" AutoPostBack="false" Width="100">
                                                                <ClientSideEvents Click="function(s,e){
                                                                        GoJob_Page('ShowDO');
                                                                    }" />
                                                            </dxe:ASPxButton>
                                            ...
                                            <table style="width: 60%; border: solid 1px #A8A8A8; background: #e8e8e8">
                                                <tr>
                                                    ...
                                                    <td width="20px"></td>
                                                    <td style="width: 150px">
                                                        <a onclick="printTallySheetConfirmed();" style="text-decoration: underline; width: 150px">Print Tallysheet Confirmed</a>
                                            ...
                                            <div style="overflow-y: auto; width: 1000px">
                                                <dxwgv:ASPxGridView ID="grid_wh" ClientInstanceName="grid_wh" runat="server" DataSourceID="dsWh" OnInit="grid_wh_Init" OnInitNewRow="grid_wh_InitNewRow"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dxwgv:GridViewDataTextColumn Caption="#" Width="150" VisibleIndex="0">
                                                            <DataItemTemplate>
                                        ...
                                        <dxw:ContentControl ID="ContentControl1" runat="server" Width="1000px">
                                            <table style="width: 1000px">
                                                <tr valign="top">
                                                    <td class="lbl">Remark</td>
                                                    <td>
                                                        <dxe:ASPxMemo ID="memo_CLSRMK" ClientInstanceName="memo_CLSRMK" Rows="3" runat="server" Width="500"></dxe:ASPxMemo>
                                                    </td>
                                                    <td>
