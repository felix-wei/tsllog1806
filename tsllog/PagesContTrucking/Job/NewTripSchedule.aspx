<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewTripSchedule.aspx.cs" Inherits="PagesContTrucking_Job_NewTripSchedule" %>
...
<%--                                <dxe:ListEditItem Text="IMP" Value="IMP" />
        ...
        <dxwgv:ASPxGridView ID="grid_Transport" ClientInstanceName="detailGrid" runat="server" OnHtmlDataCellPrepared="grid_Transport_HtmlDataCellPrepared"
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataColumn Caption="OOG" FieldName="oogInd" Visible="false">
                        <DataItemTemplate>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Link Trips" FieldName="trips" Width="80">
                        <DataItemTemplate>
