...
where mast.RefNo='{0}'", txt_JobNo.Text);
	...
	private string job_save()
	{
		...
		try
		{
            ...
            ASPxButtonEdit btn_WarehouseId = pageControl.FindControl("btn_WarehouseId") as ASPxButtonEdit;
            ...
            ctmJob.WareHouseCode = btn_WarehouseId.Text;
...
WHERE (det.DocId = '{0}') and (det.DocType='IV' or det.DocType='DN')", docId)), 0);
	...
	protected void grid_job_HtmlEditFormCreated(object sender, ASPxGridViewEditFormEventArgs e)
	{
		if (this.grid_job.EditingRowVisibleIndex > -1)
		{
            ...
            TabPage wh=tab.TabPages.FindByName("Warehouse") as TabPage;
            if (jobType=="LOC"&&wh!=null)
            {
                wh.Visible = false;
            }
		}
...
BayCode,SubletFlag,StageCode,StageStatus,TripCode,Overtime,OverDistance) values");
    ...
    protected void grid_Cont_CustomDataCallback(object sender, ASPxGridViewCustomDataCallbackEventArgs e)
    {
        ...
        if (s == "save")
        {
            ...
            ASPxSpinEdit spin_fee28 = grd.FindEditFormTemplateControl("spin_fee28") as ASPxSpinEdit;
            ASPxSpinEdit spin_fee29 = grd.FindEditFormTemplateControl("spin_fee29") as ASPxSpinEdit;
            ASPxSpinEdit spin_fee30 = grd.FindEditFormTemplateControl("spin_fee30") as ASPxSpinEdit;
            ASPxSpinEdit spin_fee31 = grd.FindEditFormTemplateControl("spin_fee31") as ASPxSpinEdit;
            ASPxSpinEdit spin_fee32 = grd.FindEditFormTemplateControl("spin_fee32") as ASPxSpinEdit;
            ASPxSpinEdit spin_fee33 = grd.FindEditFormTemplateControl("spin_fee33") as ASPxSpinEdit;
            ASPxSpinEdit spin_fee34 = grd.FindEditFormTemplateControl("spin_fee34") as ASPxSpinEdit;
            ASPxSpinEdit spin_fee35 = grd.FindEditFormTemplateControl("spin_fee35") as ASPxSpinEdit;
            ASPxSpinEdit spin_fee36 = grd.FindEditFormTemplateControl("spin_fee36") as ASPxSpinEdit;
            ASPxSpinEdit spin_fee37 = grd.FindEditFormTemplateControl("spin_fee37") as ASPxSpinEdit;
            ASPxSpinEdit spin_fee38 = grd.FindEditFormTemplateControl("spin_fee38") as ASPxSpinEdit;
            ASPxSpinEdit spin_fee39 = grd.FindEditFormTemplateControl("spin_fee39") as ASPxSpinEdit;
            //ASPxSpinEdit spin_fee40 = grd.FindEditFormTemplateControl("spin_fee40") as ASPxSpinEdit;

            ASPxTextBox txt_feeNote1 = grd.FindEditFormTemplateControl("txt_feeNote1") as ASPxTextBox;
            ASPxTextBox txt_feeNote2 = grd.FindEditFormTemplateControl("txt_feeNote2") as ASPxTextBox;
            ASPxTextBox txt_feeNote3 = grd.FindEditFormTemplateControl("txt_feeNote3") as ASPxTextBox;
            ASPxTextBox txt_feeNote4 = grd.FindEditFormTemplateControl("txt_feeNote4") as ASPxTextBox;
            ASPxTextBox txt_feeNote5 = grd.FindEditFormTemplateControl("txt_feeNote5") as ASPxTextBox;
            ASPxTextBox txt_feeNote6 = grd.FindEditFormTemplateControl("txt_feeNote6") as ASPxTextBox;
            //ASPxTextBox txt_feeNote7 = grd.FindEditFormTemplateControl("txt_feeNote7") as ASPxTextBox;
            //ASPxTextBox txt_feeNote8 = grd.FindEditFormTemplateControl("txt_feeNote8") as ASPxTextBox;
            //ASPxTextBox txt_feeNote9 = grd.FindEditFormTemplateControl("txt_feeNote9") as ASPxTextBox;
            //ASPxTextBox txt_feeNote10 = grd.FindEditFormTemplateControl("txt_feeNote10") as ASPxTextBox;
            ASPxTextBox txt_feeNote11 = grd.FindEditFormTemplateControl("txt_feeNote11") as ASPxTextBox;
            ASPxTextBox txt_feeNote12 = grd.FindEditFormTemplateControl("txt_feeNote12") as ASPxTextBox;
            ASPxTextBox txt_feeNote13 = grd.FindEditFormTemplateControl("txt_feeNote13") as ASPxTextBox;
            ASPxTextBox txt_feeNote14 = grd.FindEditFormTemplateControl("txt_feeNote14") as ASPxTextBox;
            ASPxTextBox txt_feeNote15 = grd.FindEditFormTemplateControl("txt_feeNote15") as ASPxTextBox;
            ASPxTextBox txt_feeNote16 = grd.FindEditFormTemplateControl("txt_feeNote16") as ASPxTextBox;
            ASPxTextBox txt_feeNote17 = grd.FindEditFormTemplateControl("txt_feeNote17") as ASPxTextBox;
            ASPxTextBox txt_feeNote18 = grd.FindEditFormTemplateControl("txt_feeNote18") as ASPxTextBox;
            ASPxTextBox txt_feeNote19 = grd.FindEditFormTemplateControl("txt_feeNote19") as ASPxTextBox;
            //ASPxTextBox txt_feeNote20 = grd.FindEditFormTemplateControl("txt_feeNote20") as ASPxTextBox;
            ASPxTextBox txt_feeNote21 = grd.FindEditFormTemplateControl("txt_feeNote21") as ASPxTextBox;
            ASPxTextBox txt_feeNote22 = grd.FindEditFormTemplateControl("txt_feeNote22") as ASPxTextBox;
            ASPxTextBox txt_feeNote23 = grd.FindEditFormTemplateControl("txt_feeNote23") as ASPxTextBox;
            ASPxTextBox txt_feeNote24 = grd.FindEditFormTemplateControl("txt_feeNote24") as ASPxTextBox;
            ASPxTextBox txt_feeNote25 = grd.FindEditFormTemplateControl("txt_feeNote25") as ASPxTextBox;
            ASPxTextBox txt_feeNote26 = grd.FindEditFormTemplateControl("txt_feeNote26") as ASPxTextBox;
            ASPxTextBox txt_feeNote27 = grd.FindEditFormTemplateControl("txt_feeNote27") as ASPxTextBox;
            ASPxTextBox txt_feeNote28 = grd.FindEditFormTemplateControl("txt_feeNote28") as ASPxTextBox;
            ASPxTextBox txt_feeNote29 = grd.FindEditFormTemplateControl("txt_feeNote29") as ASPxTextBox;
            ASPxTextBox txt_feeNote30 = grd.FindEditFormTemplateControl("txt_feeNote30") as ASPxTextBox;
            ASPxTextBox txt_feeNote31 = grd.FindEditFormTemplateControl("txt_feeNote31") as ASPxTextBox;
            ASPxTextBox txt_feeNote32 = grd.FindEditFormTemplateControl("txt_feeNote32") as ASPxTextBox;
            ASPxTextBox txt_feeNote33 = grd.FindEditFormTemplateControl("txt_feeNote33") as ASPxTextBox;
            ASPxTextBox txt_feeNote34 = grd.FindEditFormTemplateControl("txt_feeNote34") as ASPxTextBox;
            ASPxTextBox txt_feeNote35 = grd.FindEditFormTemplateControl("txt_feeNote35") as ASPxTextBox;
            ASPxTextBox txt_feeNote36 = grd.FindEditFormTemplateControl("txt_feeNote36") as ASPxTextBox;
            ASPxTextBox txt_feeNote37 = grd.FindEditFormTemplateControl("txt_feeNote37") as ASPxTextBox;
            ASPxTextBox txt_feeNote38 = grd.FindEditFormTemplateControl("txt_feeNote38") as ASPxTextBox;
            ASPxTextBox txt_feeNote39 = grd.FindEditFormTemplateControl("txt_feeNote39") as ASPxTextBox;
            //ASPxTextBox txt_feeNote40 = grd.FindEditFormTemplateControl("txt_feeNote40") as ASPxTextBox;
...
//    }
    ...
    public decimal BalanceQty(object client, object code)
    {
        string sql = string.Format(@"select tab_bal.BalQty  from job_house mast
left join (select  sum(case when CargoType='IN' then QtyOrig else -QtyOrig end) as BalQty,ClientId,SkuCode from job_house group by ClientId,SkuCode) as tab_bal on tab_bal.ClientId=mast.ClientId and tab_bal.SkuCode=mast.SkuCode
where mast.ClientId='{0}' and mast.SkuCode='{1}'", client, code);
        return SafeValue.SafeDecimal(ConnectSql.ExecuteScalar(sql));
    }
    public decimal BalanceSkuQty(object client, object code)
    {
        string sql = string.Format(@"select tab_bal.BalQty  from job_house mast
left join (select  sum(case when CargoType='IN' then PackQty else -PackQty end) as BalQty,ClientId,SkuCode from job_house group by ClientId,SkuCode) as tab_bal on tab_bal.ClientId=mast.ClientId and tab_bal.SkuCode=mast.SkuCode
where mast.ClientId='{0}' and mast.SkuCode='{1}'", client, code);
        return SafeValue.SafeDecimal(ConnectSql.ExecuteScalar(sql));
    }
