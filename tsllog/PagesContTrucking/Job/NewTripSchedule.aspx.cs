...
job.PermitNo,job.Remark,job.SpecialInstruction,det1.ContainerNo,det1.SealNo,det1.ContainerType,job.EtaDate,job.EtaTime,job.EtdDate,job.Escort_Ind,job.Escort_Remark,
...
from(");
        ...
        if (sql_where.Equals(""))
        {
            ...
            //sql_where = " @DateFrom<=det2.BookingDate and @DateTo>det1.ScheduleDate";
            if (!cs_Uncomplete)
            {
