<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TripSchedule.aspx.cs" Inherits="PagesContTrucking_Job_NewTripSchedule" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        function PopupTripsList(jobno, tripId, contId, canGO) {
            if (canGO != "GO") {
                return;
            }
            popubCtr1.SetHeaderText('Trip Edit');
            popubCtr1.SetContentUrl('/PagesContTrucking/SelectPage/TripEditForJobList.aspx?JobNo=' + jobno + "&tripId=" + tripId + "&contId=" + contId);
            popubCtr1.Show();
        }
    ...
    <div>
        <table>
            ...
            <tr>
                ...
                <td>
                    <dxe:ASPxTextBox ID="txt_search_mastJobNo" runat="server" Width="100"></dxe:ASPxTextBox>
                </td>
                <td>
                    <dxe:ASPxLabel ID="ASPxLabel5" runat="server" Text="Trip Type" Width="60px"></dxe:ASPxLabel>
                </td>
                <td>
                ...
                <td style="display: none">NextTrip</td>
                <td style="display: none">
                ...
                <td>
                        <dxe:ASPxLabel ID="ASPxLabel6" runat="server" Text="OOG" Width="76px"></dxe:ASPxLabel>
                    </td>
                    <td>
                        <dxe:ASPxComboBox ID="cbb_oog" runat="server" Width="100" DropDownStyle="DropDownList">
                            <Items>
                                <dxe:ListEditItem Value="ALL" Text="ALL" Selected />
        ...
        <dxwgv:ASPxGridView ID="grid_Transport" ClientInstanceName="detailGrid" runat="server" OnHtmlDataCellPrepared="grid_Transport_HtmlDataCellPrepared"
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataColumn FieldName="MasterJobNo" Caption="Master" ></dxwgv:GridViewDataColumn>
                    ...
                    <dxwgv:GridViewDataTextColumn FieldName="BookingDate" Caption="Schedule Date" Width="100">
                        <DataItemTemplate>
                    ...
                    <dxwgv:GridViewDataTextColumn FieldName="Voyage" Caption="Voyage" Width="60"></dxwgv:GridViewDataTextColumn>
                    ...
                    <dxwgv:GridViewDataColumn Caption="Next" FieldName="NextTrip" Width="80" Visible="false"></dxwgv:GridViewDataColumn>
                    <dxwgv:GridViewDataTextColumn Caption="Current Trip" FieldName="trips" Width="80">
                        <DataItemTemplate>
                            ...
                            <div style='display: <%# (SafeValue.SafeString(Eval("Contractor"),"")=="YES"&&SafeValue.SafeString(Eval("ClientRefNo")).Length>0)?"block": "none" %>'>
                                <a class="a_ltrip" href='javascript: PopupTripsList("<%# Eval("JobNo") %>","<%# Eval("TripId") %>","<%# Eval("ContId") %>","<%# SafeValue.SafeString(Eval("TripId")).Length>0?"GO":"" %>")'>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Job Trips" FieldName="trips1">
                        <DataItemTemplate>
                            <div style='display: <%# (SafeValue.SafeString(Eval("Contractor"),"")=="YES"&&SafeValue.SafeString(Eval("ClientRefNo")).Length==0)?"block": "none" %>'>
                                <a class="a_ltrip">
                                    <div class="div_FixWith"><%# xmlChangeToHtml1(Eval("ContainerNo"),Eval("JobNo")) %></div>
                            ...
                            <div style='display: <%# (SafeValue.SafeString(Eval("Contractor"),"")=="YES"&&SafeValue.SafeString(Eval("ClientRefNo")).Length>0)?"block": "none" %>'>
                                <a class="a_ltrip" >
                                    <div class="div_FixWith"><%# xmlChangeToHtml(Eval("trips1"),0) %></div>
                                </a>
                            </div>
                            <div style='display: <%# (SafeValue.SafeString(Eval("Contractor"),"")=="NO"||SafeValue.SafeString(Eval("Contractor"),"").Length==0)?"block": "none" %>'>
                                <a class="a_ltrip" >
                    ...
                    <dxwgv:GridViewDataColumn Caption="REFNo" FieldName="CarrierBkgNo" Width="200px" CellStyle-Wrap="True" ></dxwgv:GridViewDataColumn>
                    ...
                    <dxwgv:GridViewDataColumn FieldName="Remark" Caption="Remark" Visible="false"></dxwgv:GridViewDataColumn>
                     <dxwgv:GridViewDataColumn Caption="Schedule Date" FieldName="ScheduleStartDate" Width="120">
                         <DataItemTemplate>
                    ...
                    <dxwgv:GridViewDataColumn Caption="#">
                        <DataItemTemplate>
                            <div style="display:none">
                                <dxe:ASPxLabel ID="lb_Id" runat="server"  Value='<%# Bind("TripId") %>' ></dxe:ASPxLabel>
                            </div>
