<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AssignDriver.aspx.cs" Inherits="PagesContTrucking_Job_AssignDriver" %>
        ...
        <div>
            ...
            <table>
                <tr>
                    ...
                    <td>View</td>
                    <td>
                        <dxe:ASPxComboBox ID="cbo_View" runat="server" Width="165">
                            <Items>
                                <dxe:ListEditItem Value="Unassigned" Text="Unassigned" Selected="true" />
                                <dxe:ListEditItem Value="Assigned" Text="Assigned" />
                    ...
                    <DataRow>
                        ...
                        <table border="1" bordercolor="#b1cfef" style="border-collapse: collapse; font-family: Tahoma; font-size: 8pt;">
                            <tr>
                                ...
                                <td width="155">
                                    <dxe:ASPxComboBox ID="cbb_CfsCode" runat="server" Value='<%# Bind("CfsCode") %>' DropDownStyle="DropDown" Width="100%">
                                    </dxe:ASPxComboBox>
                                </td>
                                <td width="150">
