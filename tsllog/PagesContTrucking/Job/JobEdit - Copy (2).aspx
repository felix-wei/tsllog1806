...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function PopupJobHouse() {
            ...
            popubCtrPic.SetContentUrl('/PagesContTrucking/SelectPage/SelectStock.aspx?no=' + txt_JobNo.GetText() + "&client=" + btn_PartyId.GetText()+"&jobType="+ cbb_JobType.GetValue());
            popubCtrPic.Show();
        }
        function AfterPopub(){
            popubCtrPic.Hide();
        ...
        function printTallySheetConfirmed() {
            window.open("/PagesContTrucking/Report/RptPrintView.aspx?doc=tallysheet_confirmed&no=" + txt_search_JobNo.GetText()+'&refType='+cbb_JobType.GetValue());
        }
        ...
        function PopupRate() {
            ...
            popubCtr.SetContentUrl('/PagesContTrucking/SelectPage/SelectChgCode.aspx?no=' +txt_QuoteNo.GetText()+'&client='+btn_ClientId.GetText()+"&type=Quoted");
            popubCtr.Show();
        }
    ...
    <script type="text/javascript">
        ...
        function PopupSubJobNo() {
            var jobNo=txt_JobNo.GetText();
            var client=btn_PartyId.GetText();
        ...
        function BatchCargoEdit(type){
            var jobNo=txt_JobNo.GetText();
            popubCtrPic.SetHeaderText('Batch Edit');
            popubCtrPic.SetContentUrl('/PagesContTrucking/SelectPage/BatchEditCargo.aspx?no=' + jobNo+'&type='+type);
            popubCtrPic.Show();
        }
                        ...
                        <div style="margin-top: 6px; padding: 5px; background-color: #FFFFFF; border: 1px solid #A8A8A8; white-space: nowrap">
                            <table>
                                ...
                                PopupPartyInfo();
                                    ...
                                    <td class="ctl">
                                        <dxe:ASPxButtonEdit ID="txt_ClientContact" ClientInstanceName="txt_ClientContact" runat="server" Text='<%# Eval("ClientContact") %>' Width="100%" AutoPostBack="False" ReadOnly="false">
                                            <Buttons>
                                                <dxe:EditButton Enabled="true" Text=".."></dxe:EditButton>
                                            </Buttons>
                                            <ClientSideEvents ButtonClick="function(s, e) {
                                    ...
                                    <ContentCollection>
                                        <dxw:ContentControl>
                                            <table style="width: 1000px">
                                                ...
                                                <tr style="display: <%#(SafeValue.SafeString(Eval("JobType"))=="IMP"||SafeValue.SafeString(Eval("JobType"))=="EXP"||SafeValue.SafeString(Eval("JobType"))=="LOC")?"show-row":"none"%>">
                                                ...
                                                <tr>
                                                    <td class="lbl">
                                                        <div class="<%#SafeValue.SafeString(Eval("JobType"))=="CRA"?"show":"hide"%>">
                                                            <a href="#" onclick="PopupAddress(null,txt_JobLocation);">Job Location</a>
                                                        </div>
                                                        <div class="<%#SafeValue.SafeString(Eval("JobType"))!="CRA"?"show":"hide"%>">
                                                ...
                                                <tr class="<%# SafeValue.SafeString(Eval("IsTrucking"))=="Yes"?"show-row":"hide"%>">
                                                        ...
                                                        <EditForm>
                                                            ...
                                                            <table style="width: 100%;">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="lbl" style="display: none">Trucking/Schedule Date</td>
                                                                    <td class="ctl" style="display: none">
                                ...
                                PopupReturnCargo('IN',txt_JobNo.GetText());
                                                ...
                                                <dxwgv:ASPxGridView ID="gv_tpt_trip" ClientInstanceName="gv_tpt_trip" OnInit="gv_tpt_trip_Init" OnInitNewRow="gv_tpt_trip_InitNewRow" runat="server" AutoGenerateColumns="false" Width="1000px" OnBeforePerformDataSelect="gv_tpt_trip_BeforePerformDataSelect" DataSourceID="dsTransportTrip" KeyFieldName="Id" OnRowUpdating="gv_tpt_trip_RowUpdating" OnRowUpdated="gv_tpt_trip_RowUpdated" OnCustomDataCallback="gv_tpt_trip_CustomDataCallback" OnHtmlEditFormCreated="gv_tpt_trip_HtmlEditFormCreated">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dxwgv:GridViewDataColumn VisibleIndex="2" FieldName="ChessisCode" Caption="Trailer No"></dxwgv:GridViewDataColumn>
                                                        <dxwgv:GridViewDataColumn VisibleIndex="2" FieldName="Statuscode" Caption="Status">
                                                            <DataItemTemplate>
                                                                <%# change_StatusShortCode_ToCode(Eval("Statuscode")) %>
                                                            </DataItemTemplate>
                                                        ...
                                                        <EditForm>
                                                            ...
                                                            <table>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <dxe:ASPxComboBox ID="cmb_JobType" runat="server" Value='<%# Bind("JobType") %>' Width="165" Enabled='<%# SafeValue.SafeInt(Eval("Id"),0)==0 %>' DropDownStyle="DropDown">
                                                                            <Items>
                                                                    ...
                                                                    <td class="lbl">Trip Type</td>
                                                                    <td class="ctl">
                                                                        <dxe:ASPxComboBox ID="cbb_Trip_TripCode" runat="server" Value='<%# Bind("TripCode") %>' Enabled='<%# SafeValue.SafeInt(Eval("Id"),0)==0 %>' Width="165" DropDownStyle="DropDown">
                                                                            <Items>
                                                                                <dxe:ListEditItem Text="WGR" Value="WGR" />
                                                                                <dxe:ListEditItem Text="WDO" Value="WDO" />
                                                                                <dxe:ListEditItem Text="TPT" Value="TPT" />
                                                                    ...
                                                                    <td class="lbl">Self Delivery/Collection</td>
                                                                    <td class="ctl">
                                                                        <dxe:ASPxComboBox ID="cbb_Self_Ind" ClientInstanceName="cbb_Self_Ind" runat="server" Value='<%# Bind("Self_Ind") %>' Width="165" DropDownStyle="DropDown" AutoPostBack="false">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="lbl">
                                                                        <div style="display: <%# SafeValue.SafeString(Eval("TripCode"))!="TPT"?"block":"none"%>">Warehouse Status</div>
                                                                    </td>
                                                                    <td>
                       ...
                       PopupStockForTransfer();
                                            ...
                                            <table style="width: 65%; margin-bottom: 10px; border: solid 1px #A8A8A8; background: #e8e8e8">
                                                <tr>
                                                    ...
                                                    <td width="20px"></td>
                                                    <td style="width: 150px">
                                                        <a onclick="printTallySheetConfirmed();" style="text-decoration: underline; width: 150px">Completed Tallysheet</a>
                                                    ...
                                                    <td style="width: 150px">
                                                        ...
                                                        <%-- <dxe:ASPxButton ID="ASPxButton20" runat="server" Text="Print Stock Tallysheet" AutoPostBack="false" Width="100">
                                                                         <ClientSideEvents Click="function(s,e){
...
<%--                                                                        <td><a href="#" onclick='<%# "grid_wh.StartEditRow("+Container.VisibleIndex+"); " %>'>Edit</a></td>--%>
                                                        ...
                                                        <dxwgv:GridViewDataTextColumn Caption="#" Width="150" VisibleIndex="0" FieldName="Id">
                                                            <DataItemTemplate>
                                                        ...
                                                        <dxwgv:GridViewDataTextColumn Caption="Status" VisibleIndex="0" Width="180" SortIndex="1">
                                                            ...
                                                            <EditItemTemplate>
                                                                <dxe:ASPxComboBox ID="cbb_CargoStatus" runat="server" Value='<%# Eval("CargoStatus") %>' Width="90">
                                                                    <Items>
                                                            ...
                                                            <EditItemTemplate>
                                                                <table style="width: 260px">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="ctl">
                                                                            <dxe:ASPxTextBox ID="txt_HblNo" runat="server" Width="120" Text='<%# Eval("HblNo") %>'></dxe:ASPxTextBox>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="lbl">Cont No</td>
                                                                        ...
                                                                        <td>
                                                                            <dxe:ASPxButtonEdit ID="btn_ContNo" ClientInstanceName="btn_ContNo" runat="server" Text='<%# Eval("ContNo") %>' AutoPostBack="False" Width="120">
                                                                                <Buttons>
                                                                                    <dxe:EditButton Enabled="true" Text=".."></dxe:EditButton>
                                                                                </Buttons>
                                                                                <ClientSideEvents ButtonClick="function(s, e) {
                                                                        PopupContNo(btn_ContNo,txt_ContId);
                                                                        }" />
                                                                            </dxe:ASPxButtonEdit>
                                                                            <div style="display: none">
                                                                                <dxe:ASPxTextBox ID="txt_ContId" ClientInstanceName="txt_ContId" runat="server" Width="120" Text='<%# Eval("ContId") %>'></dxe:ASPxTextBox>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="lbl">Trip No</td>
                                                                        <td>
                                                                            <dxe:ASPxButtonEdit ID="btn_TripIndex" ClientInstanceName="btn_TripIndex" runat="server" Text='<%# Eval("TripIndex") %>' AutoPostBack="False" Width="120">
                                                                                <Buttons>
                                                                                    <dxe:EditButton Enabled="true" Text=".."></dxe:EditButton>
                                                                                </Buttons>
                                                                                <ClientSideEvents ButtonClick="function(s, e) {
                                                                        PopupTrip(btn_TripIndex,lbl_TripId,txt_JobNo.GetText(),'WGR');
                                                                        }" />
                                                                            </dxe:ASPxButtonEdit>
                                                                            <div style="display: none">
                                                                                <dxe:ASPxTextBox ID="lbl_TripId" ClientInstanceName="lbl_TripId" runat="server" Text='<%# Eval("TripId")%>'></dxe:ASPxTextBox>
                                                                            </div>
                                                                        </td>
                                                                    ...
                                                                    <tr>
                                                                        <td class="lbl1">Po No</td>

                                                                        <td class="ctl">
                                                                            <dxe:ASPxTextBox ID="txt_PoNo" runat="server" Width="120" Text='<%# Eval("PoNo") %>'></dxe:ASPxTextBox>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="lbl">Type</td>
                                                                        ...
                                                                        <td>
                                                                            <dxe:ASPxComboBox ID="cbb_OpsType" Width="120" runat="server" ClientInstanceName="cbb_OpsType" Value='<%# Eval("OpsType") %>' DataSourceID="dsCargoStatus" EnableIncrementalFiltering="true" TextField="Code" ValueField="Code" ValueType="System.String">
                                                                            </dxe:ASPxComboBox>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                        ...
                                                        <dxwgv:GridViewDataTextColumn Caption="Marking" FieldName="Marking1" VisibleIndex="2" Width="180" Visible="true">
                                                            <EditItemTemplate>
                                                                <dxe:ASPxMemo ID="memo_Marking1" ClientInstanceName="memo_Marking1" Text='<%# Eval("Marking1") %>' Rows="6" runat="server" Width="180"></dxe:ASPxMemo>
                                                            </EditItemTemplate>
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn Caption="Inventory Id" Width="150" VisibleIndex="2" FieldName="LineId">
                                                            <DataItemTemplate>
                                                                <%# Eval("LineId") %>
                                                            </DataItemTemplate>
                                                            <EditItemTemplate>
                                                        ...
                                                        <dxwgv:GridViewDataTextColumn Caption="Description" FieldName="Marking2" VisibleIndex="2" Width="180" Visible="true">
                                                            <EditItemTemplate>
                                                                <dxe:ASPxMemo ID="memo_Marking2" ClientInstanceName="memo_Marking2" Text='<%# Eval("Marking2") %>' Rows="6" runat="server" Width="180"></dxe:ASPxMemo>
                                                            </EditItemTemplate>
                                                        </dxwgv:GridViewDataTextColumn>
                                                            ...
                                                            <EditItemTemplate>
                                                                <table style="width: 160px">
                                                                    ...
                                                                    <tr>
                                                                        <td class="lbl">Unit</td>
                                                                        <td>
                                                                            <dxe:ASPxButtonEdit runat="server" ID="txt_UomCode" Width="100%" ClientInstanceName="txt_UomCode" Text='<%# Eval("UomCode") %>'>
                                                                                <Buttons>
                                                                                    <dxe:EditButton Enabled="true" Text=".."></dxe:EditButton>
                                                                                </Buttons>
                                                                                <ClientSideEvents ButtonClick="function(s, e) {
                                                                    ...
                                                                    <tr>
                                                                        <td class="lbl">Item Code</td>
                                                                        <td>
                                                                            <dxe:ASPxButtonEdit ID="btn_BkgItemCode" ClientInstanceName="btn_BkgItemCode" runat="server" Text='<%# Eval("BookingItem") %>' AutoPostBack="False" Width="100%">
                                                                                <Buttons>
                                                                                    <dxe:EditButton Enabled="true" Text=".."></dxe:EditButton>
                                                                                </Buttons>
                                                                                <ClientSideEvents ButtonClick="function(s, e) {
                                                                        PopupSku(btn_BkgItemCode);
                                                                        }" />
                                                                            </dxe:ASPxButtonEdit>
                                                                        </td>
                                                                    </tr>
                                                        ...
                                                        <dxwgv:GridViewDataTextColumn Caption="Booking SKU Info" VisibleIndex="2" Width="260">
                                                            <DataItemTemplate>
                                                                <table style="width: 160px">
                                                                    ...
                                                                    <tr>
                                                                        <td class="lbl">
                                                                            <input type="button" style="width: 100px" class="button" value="Copy" onclick="copy_inline(<%# Container.VisibleIndex %>);" />
                                                            ...
                                                            <EditItemTemplate>
                                                                <table style="width: 160px">
                                                                    <tr>
                                                                        <td class="lbl">SKU Code</td>
                                                                        <td class="ctl">
                                                                            <dxe:ASPxButtonEdit ID="btn_BkgSKuCode" ClientInstanceName="btn_BkgSKuCode" runat="server" Text='<%# Eval("BkgSKuCode") %>' AutoPostBack="False" Width="100">
                                                                                <Buttons>
                                                                                    <dxe:EditButton Enabled="true" Text=".."></dxe:EditButton>
                                                                                </Buttons>
                                                                                <ClientSideEvents ButtonClick="function(s, e) {
                                                                    ...
                                                                    <tr>
                                                                        <td class="lbl">Qty</td>
                                                                        <td>
                                                                            <dxe:ASPxSpinEdit DisplayFormatString="0.0" runat="server" Width="100"
                                                                                ID="spin_BkgSkuQty" Height="21px" Value='<%# Eval("BkgSkuQty")%>' DecimalPlaces="3" Increment="0">
                                                                                <SpinButtons ShowIncrementButtons="false" />
                                                                            </dxe:ASPxSpinEdit>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="lbl">Unit</td>
                                                                        <td>
                                                                            <dxe:ASPxButtonEdit runat="server" ID="txt_BkgSkuUnit" Width="100" ClientInstanceName="txt_BkgSkuUnit" Text='<%# Eval("BkgSkuUnit") %>'>
                                                                                <Buttons>
                                                                                    <dxe:EditButton Enabled="true" Text=".."></dxe:EditButton>
                                                                                </Buttons>
                                                                                <ClientSideEvents ButtonClick="function(s, e) {
                                                        ...
                                                        <dxwgv:GridViewDataTextColumn Caption="Booking Dimension" VisibleIndex="2" Width="100px">
                                                            <DataItemTemplate>
                                                                <table style="width: 100px;">
                                                                    <tr>
                                                                        <td class="lbl">Length</td>
                                                                        <td class="ctl"><%# Eval("Length") %></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="lbl">Width</td>
                                                                        <td class="ctl"><%# Eval("Width") %></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="lbl">Height</td>
                                                                        <td class="ctl"><%# Eval("Height") %></td>
                                                                    </tr>
                                                            ...
                                                            <EditItemTemplate>
                                                                <table style="width: 100px">
                                                                    <tr>
                                                                        ...
                                                                        <td class="ctl">
                                                                            <dxe:ASPxSpinEdit DisplayFormatString="0.000" runat="server" Width="60"
                                                                                ID="spin_Length" Height="21px" Value='<%# Eval("Length")%>' DecimalPlaces="3" Increment="0">
                                                                                <SpinButtons ShowIncrementButtons="false" />
                                                                            </dxe:ASPxSpinEdit>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="ctl">
                                                                            <dxe:ASPxSpinEdit DisplayFormatString="0.000" runat="server" Width="100%"
                                                                                ID="spin_Width" Height="21px" Value='<%# Eval("Width")%>' DecimalPlaces="3" Increment="0">
                                                                                <SpinButtons ShowIncrementButtons="false" />
                                                                            </dxe:ASPxSpinEdit>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="ctl">
                                                                            <dxe:ASPxSpinEdit DisplayFormatString="0.000" runat="server" Width="100%"
                                                                                ID="spin_Height" Height="21px" Value='<%# Eval("Height")%>' DecimalPlaces="3" Increment="0">
                                                                                <SpinButtons ShowIncrementButtons="false" />
                                                                            </dxe:ASPxSpinEdit>
                                                                        </td>
                                                                    </tr>
                                                            ...
                                                            <EditItemTemplate>
                                                                <table style="width: 160px">
                                                                    ...
                                                                    <tr>
                                                                        <td class="lbl">Unit</td>
                                                                        <td class="ctl">
                                                                            <dxe:ASPxButtonEdit runat="server" ID="txt_PackTypeOrig" Width="100%" ClientInstanceName="txt_PackTypeOrig" Text='<%# Eval("PackTypeOrig") %>'>
                                                                                <Buttons>
                                                                                    <dxe:EditButton Enabled="true" Text=".."></dxe:EditButton>
                                                                                </Buttons>
                                                                                <ClientSideEvents ButtonClick="function(s, e) {
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="ctl">
                                                                            <dxe:ASPxSpinEdit DisplayFormatString="0.000" runat="server" Width="100%"
                                                                                ID="spin_WeightOrig" Height="21px" Value='<%# Eval("WeightOrig")%>' DecimalPlaces="3" Increment="0">
                                                                                <SpinButtons ShowIncrementButtons="false" />
                                                                            </dxe:ASPxSpinEdit>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td class="ctl">
                                                                            <dxe:ASPxSpinEdit DisplayFormatString="0.000" runat="server" Width="100%"
                                                                                ID="spin_VolumeOrig" Height="21px" Value='<%# Eval("VolumeOrig")%>' DecimalPlaces="3" Increment="0">
                                                                                <SpinButtons ShowIncrementButtons="false" />
                                                                            </dxe:ASPxSpinEdit>
                                                                        </td>
                                                            ...
                                                            <EditItemTemplate>
                                                                <table style="width: 160px">
                                                                    <tr>
                                                                        <td class="lbl">SKU Code</td>
                                                                        <td class="ctl">
                                                                            <dxe:ASPxButtonEdit ID="btn_SkuCode" ClientInstanceName="btn_SkuCode" runat="server" Text='<%# Eval("SkuCode") %>' AutoPostBack="False" Width="100">
                                                                                <Buttons>
                                                                                    <dxe:EditButton Enabled="true" Text=".."></dxe:EditButton>
                                                                                </Buttons>
                                                                                <ClientSideEvents ButtonClick="function(s, e) {
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <dxe:ASPxSpinEdit runat="server" Width="100%" DisplayFormatString="0.0" DecimalPlaces="1"
                                                                                ID="spin_PackQty" Height="100%" Value='<%# Eval("PackQty")%>' Increment="0">
                                                                                <SpinButtons ShowIncrementButtons="false" />
                                                                            </dxe:ASPxSpinEdit>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="lbl">Unit</td>
                                                                        <td>
                                                                            <dxe:ASPxButtonEdit runat="server" ID="txt_PackUom" Width="100%" ClientInstanceName="txt_PackUom" Text='<%# Eval("PackUom") %>'>
                                                                                <Buttons>
                                                                                    <dxe:EditButton Enabled="true" Text=".."></dxe:EditButton>
                                                                                </Buttons>
                                                                                <ClientSideEvents ButtonClick="function(s, e) {
                                                                    ...
                                                                    <tr>
                                                                        <td class="lbl">Location</td>
                                                                        <td>
                                                                            <dxe:ASPxButtonEdit ID="txt_Location" ClientInstanceName="txt_Location" runat="server" Text='<%# Eval("Location") %>' AutoPostBack="False" Width="100%">
                                                                                <Buttons>
                                                                                    <dxe:EditButton Enabled="true" Text=".."></dxe:EditButton>
                                                                                </Buttons>
                                                                                <ClientSideEvents ButtonClick="function(s, e) {
                                                        ...
                                                        <dxwgv:GridViewDataTextColumn Caption="Actual Dimension" VisibleIndex="2" Width="100px">
                                                            <DataItemTemplate>
                                                                <table style="width: 100px;">
                                                                    <tr>
                                                                        <td class="lbl">Length</td>
                                                        ...
                                                        <dxwgv:GridViewDataTextColumn Caption="Balance Info" VisibleIndex="2" Width="200">
                                                            <DataItemTemplate>
                                                                <table style="width: 160px">
                                                                    <tr>
                                                                        <td class="lbl" style="width: 60px">Qty</td>
                                                                        <td class="ctr" style="width: 100px"><%# SafeValue.ChinaRound(SafeValue.SafeDecimal(Eval("BalanceQty")),1) %></td>
                                                                    ...
                                                                    <tr>
                                                                        <td class="lbl">SKU Qty</td>

                                                                        <td colspan="2"><%# SafeValue.ChinaRound(SafeValue.SafeDecimal(Eval("BalanceSkuQty")),1) %></td>
                                                                    </tr>
                                                                </table>
                                                            </DataItemTemplate>
                                                            <EditItemTemplate>
                                                        ...
                                                        <dxwgv:GridViewDataDateColumn Caption="In Date" FieldName="StockDate" VisibleIndex="2" Width="100px">
                                                            ...
                                                            <EditItemTemplate>
                                                                <dxe:ASPxDateEdit ID="date_StockDate" runat="server" Value='<%# Bind("StockDate") %>' Width="100px" EditFormatString="dd/MM/yyyy" CalendarProperties-ShowClearButton="false"></dxe:ASPxDateEdit>
                                                            </EditItemTemplate>
                                                        </dxwgv:GridViewDataDateColumn>
                                                        ...
                                                        <dxwgv:GridViewDataDateColumn Caption="Bill Date" FieldName="NextBillDate" VisibleIndex="2" Width="100px">
                                                            ...
                                                            <EditItemTemplate>
                                                                <dxe:ASPxDateEdit ID="date_NextBillDate" runat="server" Value='<%# Bind("NextBillDate") %>' Width="100px" EditFormatString="dd/MM/yyyy" CalendarProperties-ShowClearButton="false"></dxe:ASPxDateEdit>
                                                            </EditItemTemplate>
                                                        </dxwgv:GridViewDataDateColumn>
                                                        <dxwgv:GridViewDataTextColumn Caption="Remark" FieldName="Remark1" VisibleIndex="3" Width="180">
                                                            <EditItemTemplate>
                                                                <dxe:ASPxMemo ID="memo_Remark1" ClientInstanceName="memo_Remark1" Text='<%# Eval("Remark1") %>' Rows="6" runat="server" Width="180"></dxe:ASPxMemo>
                                                            </EditItemTemplate>
                                                        </dxwgv:GridViewDataTextColumn>
                                                            ...
                                                            <EditItemTemplate>
                                                                <table style="width: 200px">
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <dxe:ASPxComboBox ID="cbb_LandStatus" runat="server" Value='<%# Eval("LandStatus") %>' Width="100">
                                                                                <Items>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <dxe:ASPxComboBox ID="cbb_DgClass" runat="server" Value='<%# Eval("DgClass") %>' Width="100">
                                                                                <Items>
                                                                                    <dxe:ListEditItem Text="Normal" Value="Normal" Selected="true" />
                                                                    ...
                                                                    <tr>
                                                                        <td class="lbl">Damage</td>
                                                                        <td>
                                                                            <dxe:ASPxComboBox ID="cbb_Damage" runat="server" Value='<%# Eval("DamagedStatus") %>' Width="100">
                                                                                <Items>
                                                                                    <dxe:ListEditItem Text="Normal" Value="Normal" Selected="true" />
                                                                    ...
                                                                    <tr>
                                                                        <td class="lbl">DMG Remark</td>
                                                                        <td>
                                                                            <dxe:ASPxMemo ID="memo_Remark2" Rows="2" runat="server" Text='<%# Eval("Remark2") %>' Width="100%">
                                                                            </dxe:ASPxMemo>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                        ...
                                                        <dxwgv:GridViewDataTextColumn Caption="Cargo" VisibleIndex="6" Width="100" Visible="false">
                                                            <DataItemTemplate>
                                                                <input type="button" class="button" value="Cargo List" onclick="cargo_inline(<%# Container.VisibleIndex %>);" />
                                                            </DataItemTemplate>
                                                        </dxwgv:GridViewDataTextColumn>
                                                    </Columns>
                       ...
                       grid_stockOut.Refresh();
                                            ...
                                            <table style="width: 60%; border: solid 1px #A8A8A8; background: #e8e8e8" class='<%# (SafeValue.SafeString(Eval("JobType"))=="EXP"||SafeValue.SafeString(Eval("JobType"))=="WDO")?"show":"hide" %>'>
                                                <tr>
                                                    <td style="width: 200px">
                                                        <a onclick="printTallySheetIndented();" style="text-decoration: underline; width: 150px">Print Tallysheet Indented</a>

                                                    </td>
                                                    <td width="20px"></td>
                                                    <td style="width: 200px">
                                                        <a onclick="printTallySheetConfirmed();" style="text-decoration: underline; width: 200px">Print Tallysheet Confirmed</a>

                                                    </td>
                                                    <td width="20px"></td>
                                                    <td style="width: 200px">
                                                        <a onclick="printStockTallySheet();" style="text-decoration: underline; width: 150px">Print Stock Tallysheet</a>
                                            ...
                                            <div style="overflow-y: auto; width: 1000px">
                                                ...
                                                <dxwgv:ASPxGridView ID="grid_stockOut" ClientInstanceName="grid_stockOut" runat="server" DataSourceID="dsStockOut" OnInit="grid_stockOut_Init" OnInitNewRow="grid_stockOut_InitNewRow"
                                                    ...
                                                    <Columns>
                                                            ...
                                                            <EditItemTemplate>
                                                                <table style="width: 260px">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <dxe:ASPxComboBox ID="cbb_OpsType" runat="server" Value='<%# Eval("OpsType") %>' Width="120">
                                                                                <Items>
                                                        ...
                                                        <dxwgv:GridViewDataTextColumn Caption="Booking SKU Info" VisibleIndex="2" Width="260">
                                                            <DataItemTemplate>
                                                                <table style="width: 160px">
                                                                    ...
                                                                    <tr>
                                                                        <td class="lbl">
                                                                            <input type="button" style="width: 100px" class="button" value="Copy" onclick="copy_inline1(<%# Container.VisibleIndex %>);" />
                                                            ...
                                                            <DataItemTemplate>
                                                                <table style="width: 100px;">
                                                                    ...
                                                                    <tr style="display: none">
                                                                        ...
                                                                        <td>
                                                                            <input type="button" class="button" value="Dimension" onclick="dimension_inline1(<%# Container.VisibleIndex %>);" /></td>
                                                                    </tr>
                                                                    <tr>

                                                                        <td>
                                                                            <input type="button" class="button" value="Process" onclick="process_inline1(<%# Container.VisibleIndex %>);" /></td>
                                                                    </tr>
                                                                </table>
                                                            </DataItemTemplate>
                                                            <EditItemTemplate>
                                                        ...
                                                        <dxwgv:GridViewDataTextColumn Caption="Balance Info" VisibleIndex="2" Width="200">
                                                            <DataItemTemplate>
                                                                <table style="width: 160px">
                                                                    <tr>
                                                                        <td class="lbl">Qty</td>
                                                                        <td><%# SafeValue.ChinaRound(SafeValue.SafeDecimal(Eval("BalanceQty")),1) %></td>
                                                        ...
                                                        <dxwgv:GridViewDataDateColumn Caption="Out Date" FieldName="StockDate" VisibleIndex="2" Width="100px">
                                                            <DataItemTemplate>
                                                                <%# SafeValue.SafeDateStr(Eval("StockDate")) %>
                                                            </DataItemTemplate>
                                                            <EditItemTemplate>
                                                                <dxe:ASPxDateEdit ID="date_StockDate" runat="server" Value='<%# Bind("StockDate") %>' Width="100" EditFormatString="dd/MM/yyyy" CalendarProperties-ShowClearButton="false"></dxe:ASPxDateEdit>
                                                            </EditItemTemplate>
                                                        </dxwgv:GridViewDataDateColumn>
                                                        <dxwgv:GridViewDataTextColumn Caption="Remark" FieldName="Remark1" VisibleIndex="3" Width="180">
                                                            <EditItemTemplate>
                                                        ...
                                                        <dxwgv:GridViewDataTextColumn Caption="Attachment" VisibleIndex="6" Width="100">
                                                            <DataItemTemplate>
                                                                ...
                                                                <input type="button" class="button" value="Upload" onclick="upload_inline1(<%# Container.VisibleIndex %>);" />
                                                                <br />
                                                                <br />
                                                                <div class='<%# FilePath(SafeValue.SafeInt(Eval("Id"),0))!=""?"show":"hide" %>' style="min-width: 70px;">
                                                                    <a href='<%# FilePath(SafeValue.SafeInt(Eval("Id"),0)) %>' target="_blank">View</a>
                                                        ...
                                                        <dxwgv:GridViewDataTextColumn Caption="Cargo" VisibleIndex="6" Width="100"  Visible="false">
                                                            <DataItemTemplate>
                                                                <input type="button" class="button" value="Cargo List" onclick="cargo_inline1(<%# Container.VisibleIndex %>);" />
                                                                 <div style="display: none">
                                                                        <dxe:ASPxTextBox ID="txt_LineId" runat="server" Text='<%# Eval("LineId") %>'></dxe:ASPxTextBox>
                                                                    </div>
                                                            </DataItemTemplate>
                                                        </dxwgv:GridViewDataTextColumn>
                                                    </Columns>
                                                    ...
                                                    <dxwgv:ASPxGridView ID="grid_OtherOut" ClientInstanceName="grid_OtherOut" runat="server" DataSourceID="dsStockOtherOut"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <dxwgv:GridViewDataTextColumn Caption="Status" VisibleIndex="0" Width="180" SortIndex="1">
                                                                ...
                                                                <EditItemTemplate>
                                                                    <dxe:ASPxComboBox ID="cbb_JobType" runat="server" Value='<%# Eval("CargoStatus") %>' Width="90">
                                                                        <Items>
                                                                            <dxe:ListEditItem Text="Pending" Value="P" />
                                                                            <dxe:ListEditItem Text="Completed" Value="C" />
                                                                        </Items>
                                                                ...
                                                                <DataItemTemplate>
                                                                    <table style="width: 100px;">
                                                                        ...
                                                                        <tr style="display: none">
                                                                            ...
                                                                            <td>
                                                                                <input type="button" class="button" value="Dimension" onclick="dimension_inline2(<%# Container.VisibleIndex %>);" /></td>
                                                                        </tr>
                                                                        <tr>
                                                                ...
                                                                <EditItemTemplate>
                                                                    <table style="width: 200px">
                                                                        ...
                                                                        <tr>
                                                                            <td class="lbl">DMG Remark</td>
                                                                            <td>
                                                                                <dxe:ASPxMemo ID="meno_Remark2" Rows="2" runat="server" Text='<%# Eval("Remark2") %>' Width="100%">
                                                                                </dxe:ASPxMemo>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                            ...
                                                            <dxwgv:GridViewDataTextColumn Caption="Cargo" VisibleIndex="6" Width="100"  Visible="false">
                                                                <DataItemTemplate>
                                                                    <input type="button" class="button" value="Cargo List" onclick="cargo_inline2(<%# Container.VisibleIndex %>);" />
                                                                    <div style="display: none">
                                                                        <dxe:ASPxTextBox ID="txt_LineId" runat="server" Text='<%# Eval("LineId") %>'></dxe:ASPxTextBox>
                                                                    </div>
                                                                </DataItemTemplate>
