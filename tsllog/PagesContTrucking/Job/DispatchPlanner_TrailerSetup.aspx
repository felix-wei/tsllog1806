<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DispatchPlanner_TrailerSetup.aspx.cs" Inherits="PagesContTrucking_Job_DispatchPlanner_TrailerSetup" %>
    ...
    <form id="form1" runat="server">
        ...
        <dxwgv:ASPxGridView ID="grid_Transport" ClientInstanceName="detailGrid" runat="server" Width="100%" DataSourceID="dsTransport" KeyFieldName="Id" OnRowInserting="grid_Transport_RowInserting" OnRowDeleting="grid_Transport_RowDeleting" OnRowUpdating="grid_Transport_RowUpdating" OnInitNewRow="grid_Transport_InitNewRow" OnInit="grid_Transport_Init" OnHtmlDataCellPrepared="grid_Transport_HtmlDataCellPrepared" OnCustomDataCallback="grid_Transport_CustomDataCallback">
            ...
            <Columns>
                ...
                <dxwgv:GridViewDataColumn Caption="Size" FieldName="Remark" Width="70"></dxwgv:GridViewDataColumn>
                <dxwgv:GridViewDataColumn Caption="Remark" FieldName="Note1" Width="150"></dxwgv:GridViewDataColumn>
                <dxwgv:GridViewDataDateColumn FieldName="Date1" Caption="Next Maint." Width="80">
                    <PropertiesDateEdit DisplayFormatString="dd/MM/yyyy" EditFormatString="dd/MM/yyyy"></PropertiesDateEdit>
                </dxwgv:GridViewDataDateColumn>
                <dxwgv:GridViewDataDateColumn FieldName="Date2" Caption="Next Inspect" Width="80">
                    <PropertiesDateEdit DisplayFormatString="dd/MM/yyyy" EditFormatString="dd/MM/yyyy"></PropertiesDateEdit>
                </dxwgv:GridViewDataDateColumn>
                <dxwgv:GridViewDataDateColumn FieldName="Date3" Caption="Insur. Expiry" Width="80">
                    <PropertiesDateEdit DisplayFormatString="dd/MM/yyyy" EditFormatString="dd/MM/yyyy"></PropertiesDateEdit>
                </dxwgv:GridViewDataDateColumn>
                <dxwgv:GridViewDataDateColumn FieldName="Date4" Caption="Road Tax Expiry" Width="80">
                    <PropertiesDateEdit DisplayFormatString="dd/MM/yyyy" EditFormatString="dd/MM/yyyy"></PropertiesDateEdit>
                </dxwgv:GridViewDataDateColumn>
                <dxwgv:GridViewDataDateColumn FieldName="Date5" Caption="Vpc Expiry" Width="80">
                    <PropertiesDateEdit DisplayFormatString="dd/MM/yyyy" EditFormatString="dd/MM/yyyy"></PropertiesDateEdit>
                </dxwgv:GridViewDataDateColumn>
                <dxwgv:GridViewCommandColumn VisibleIndex="99"  >
