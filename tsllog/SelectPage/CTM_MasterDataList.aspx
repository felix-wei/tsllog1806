<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CTM_MasterDataList.aspx.cs" Inherits="SelectPage_CTM_MasterDataList" %>
...
<body>
    <form id="form1" runat="server">
        <div style="display:none">
            <dxe:ASPxLabel ID="lb_type" runat="server" Text=""></dxe:ASPxLabel>
        </div>
        <div>
            <table>
                <tr>
                    ...
                    <td>
                        <dxe:ASPxLabel ID="ASPxLabel1" runat="server" Text="Info" />
                    </td>
                    <td>
                        <dxe:ASPxTextBox ID="txt_Info" Width="170" runat="server">
                        </dxe:ASPxTextBox>
                    </td>
                    <td>
            ...
            <dxwgv:ASPxGridView ID="ASPxGridView1" runat="server" Width="100%"
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Info" FieldName="Remark" VisibleIndex="2">
                    </dxwgv:GridViewDataTextColumn>
                </Columns>
            </dxwgv:ASPxGridView>
        </div>
