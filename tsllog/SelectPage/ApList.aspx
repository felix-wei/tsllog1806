<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ApList.aspx.cs" Inherits="SelectPage_ApList" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <wilson:DataSource ID="dsApDet" runat="server" ObjectSpace="C2.Manager.ORManager"
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <dxe:ASPxTextBox ID="txt_SupplierBillNo" runat="server" Text='' Width="150">
                        </dxe:ASPxTextBox>
                    </td>
                    <td>
            ...
            <dxwgv:ASPxGridView ID="ASPxGridView1" ClientInstanceName="grid_Sch" runat="server" DataSourceID="dsApDet"
