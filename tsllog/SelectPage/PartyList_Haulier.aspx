<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PartyList_Haulier.aspx.cs" Inherits="PagesFreight_SelectPage_PartyList_Haulier" %>
        ...
        <dxwgv:ASPxGridView ID="ASPxGridView1" runat="server" Width="100%"
            ...
            <Columns>
                <dxwgv:GridViewDataTextColumn Caption="#" VisibleIndex="0" Width="5%">
                    <DataItemTemplate>
                        <a onclick='parent.PutHaulier("<%# Eval("PartyName") %>","<%# Eval("CrNo") %>","<%# Eval("Fax1") %>","<%# Eval("Contact1") %>");'>Select</a>
                    </DataItemTemplate>
                    <EditItemTemplate>
                    </EditItemTemplate>
