    ...
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <dxwgv:ASPxGridView ID="grid" ClientInstanceName="grid" runat="server" Width="100%"
                KeyFieldName="Id" OnInit="grid_Init" OnInitNewRow="grid_InitNewRow"  DataSourceID="dsProduct"
                    ...
                    <EditForm>
                        ...
                        <table border="0" width="900">
                            ...
                            <tr>
                                <td>AR Code</td>
                                <td>
                                    <dxe:ASPxTextBox runat="server" Width="155" ID="txt_ArCode" Text='<%# Eval("ArCode")%>'></dxe:ASPxTextBox>
                                </td>

                                <td>AP Code</td>
                                <td>
                                    <dxe:ASPxTextBox runat="server" Width="155" ID="txt_ApCode" Text='<%# Eval("ApCode")%>'></dxe:ASPxTextBox>
                                </td>
