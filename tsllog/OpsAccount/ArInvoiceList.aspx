<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ArInvoiceList.aspx.cs" Inherits="PagesFreight_Account_ArInvoiceList" %>
...
<body>
    ...
    <div>
        <wilson:DataSource ID="dsArInvDet" runat="server" ObjectSpace="C2.Manager.ORManager"
        ...
        <dxwgv:ASPxGridView ID="ASPxGridView1" ClientInstanceName="grid_Sch" runat="server" DataSourceID="dsArInvDet"
