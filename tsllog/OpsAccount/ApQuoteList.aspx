<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ApQuoteList.aspx.cs" Inherits="PagesFreight_Account_ApQuoteList" %>
...
<body>
    ...
    <div>
        <wilson:DataSource ID="dsQuoteDet" runat="server" ObjectSpace="C2.Manager.ORManager"
        ...
        <dxwgv:ASPxGridView ID="ASPxGridView1" ClientInstanceName="grid_Sch" runat="server" DataSourceID="dsQuoteDet"
