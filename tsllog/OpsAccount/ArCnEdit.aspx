<%@ Page Language="C#" EnableViewState="false" AutoEventWireup="true" CodeFile="ArCnEdit.aspx.cs" Inherits="Account_ArCnEdit" %>
            ...
            <table>
                <tr>
                    ...
                    <td>
                     ...
                     window.location='ArCnEdit.aspx?no='+txtSchNo.GetText()
                        }" />
                        </dxe:ASPxButton>
                    </td>
                    <td>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <dxe:ASPxComboBox ID="cmb_PartyTo" ClientInstanceName="cmb_PartyTo" runat="server"
                                        Value='<%# Eval("PartyTo") %>' Width="413" DropDownWidth="380" DropDownStyle="DropDownList"
                            ...
                            <tr>
                                ...
                                <td>
                                    <table>
                                        <tr>
                                            <td>
                                                <dxe:ASPxTextBox runat="server" Width="47" ReadOnly="true" BackColor="Control" ID="txt_AcYear"
                                                    Text='<%# Eval("AcYear")%>'>
                                                </dxe:ASPxTextBox>
                                            </td>
                                            <td>
                                                <dxe:ASPxTextBox runat="server" Width="47" ReadOnly="true" BackColor="Control" ID="txt_AcPeriod"
                                                    Text='<%# Eval("AcPeriod")%>'>
                                                </dxe:ASPxTextBox>
                                            </td>
                                        </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <dxe:ASPxButton ID="ASPxButton1" runat="server" Text="Print" Enabled='<%# SafeValue.SafeString(Eval("SequenceId"),"0")!="0" %>'
                                        AutoPostBack="false" UseSubmitBehavior="false">
                                        <ClientSideEvents Click="function(s,e){
                                PrintInvoice(txt_DocNo.GetText(),'CN', cbo_DocCate.GetText());
                            }" />
                                    </dxe:ASPxButton>
                                </td>
                                <td>
                                    <dxe:ASPxButton ID="ASPxButton2" runat="server" Text="Print Simple" Enabled='<%# SafeValue.SafeString(Eval("SequenceId"),"0")!="0" %>'
                                        AutoPostBack="false" UseSubmitBehavior="false">
                                        <ClientSideEvents Click="function(s,e){
                                PrintInvoiceA4(txt_DocNo.GetText(),'CN', cbo_DocCate.GetText());
                            }" />
                                    </dxe:ASPxButton>
                                </td>
                                <td>
                                                    ...
                                                    <tr>
                                                        <td colspan="10">
                                                            <table border="0" cellspacing="0">
                                                                ...
                                                                <td colspan="2">
                                                                    <dxe:ASPxButtonEdit ID="btn_MastRefNo" ReadOnly="true" BackColor="Control" ClientInstanceName="btn_MastRefNo" runat="server" Text='<%# Bind("MastRefNo") %>' Width="170">
                                                                        <Buttons>
