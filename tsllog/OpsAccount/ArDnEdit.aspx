<%@ Page Language="C#" EnableViewState="false" AutoEventWireup="true" CodeFile="ArDnEdit.aspx.cs" Inherits="Account_ArDnEdit" %>
            ...
            <table>
                <tr>
                    ...
                    <td>
                     ...
                     window.location='ArDnEdit.aspx?no='+txtSchNo.GetText()
                        }" />
                        </dxe:ASPxButton>
                    </td>
                    <td>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <dxe:ASPxComboBox ID="cmb_PartyTo" ClientInstanceName="cmb_PartyTo" runat="server"
                                        Value='<%# Eval("PartyTo") %>' Width="423" DropDownWidth="380" DropDownStyle="DropDownList"
                            ...
                            <tr>
                                ...
                                <td>
                                    <dxe:ASPxButton ID="ASPxButton1" runat="server" Text="Print" Enabled='<%# SafeValue.SafeString(Eval("SequenceId"),"0")!="0" %>'
                                        AutoPostBack="false" UseSubmitBehavior="false">
                                        <ClientSideEvents Click="function(s,e){
                                PrintInvoice(txt_DocNo.GetText(),'DN', cbo_DocCate.GetText());
                            }" />
                                    </dxe:ASPxButton>
                                </td>
                                <td style="display:none">
                                    <dxe:ASPxButton ID="ASPxButton2" runat="server" Text="Print Simple" Enabled='<%# SafeValue.SafeString(Eval("SequenceId"),"0")!="0" %>'
                                        AutoPostBack="false" UseSubmitBehavior="false">
                                        <ClientSideEvents Click="function(s,e){
                                PrintInvoiceA4(txt_DocNo.GetText(),'DN', cbo_DocCate.GetText());
                            }" />
                                    </dxe:ASPxButton>
                                </td>
                                <td>
