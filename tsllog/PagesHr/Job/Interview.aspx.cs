...
public partial class PagesHr_Job_Interview : BasePage
{
    ...
    {
        gridExport.WriteXlsToResponse("Interview", true);
    }
    ...
    protected void SaveAndUpdate()
    {
        try
        {
            ...
            ASPxComboBox interviewPic = ASPxGridView1.FindEditFormTemplateControl("txt_InterviewPic") as ASPxComboBox;
            itv.Pic = SafeValue.SafeInt(interviewPic.Value,0);
