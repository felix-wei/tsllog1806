<%@ Page Language="C#" AutoEventWireup="true" EnableViewState="false" CodeFile="LeaveRecord.aspx.cs" Inherits="PagesHr_Job_LeaveRecord" %>
                    ...
                    <EditForm>
                        <table>
                            ...
                            <tr>
                                ...
                                <td>Days</td>
                                <td>
                                    <dxe:ASPxSpinEdit runat="server" Width="170" ID="spin_Days" ClientInstanceName="spin_Days" Value='<%# Bind("Days")%>'>
                            ...
                            <tr>
                                ...
                                <td>
                                    <dxe:ASPxComboBox runat="server" EnableIncrementalFiltering="true" ID="cmb_ApproveBy" TextFormatString="{1}"
                                        EnableCallbackMode="true" IncrementalFilteringMode="StartsWith" DropDownStyle="DropDownList"
                                        DataSourceID="dsPerson" ValueField="Id" TextField="Name" Width="170" ValueType="System.Int32" Value='<%# Bind("ApproveBy")%>'>
                                        <Buttons>
                                            <dxe:EditButton Text="Clear"></dxe:EditButton>
                                        </Buttons>
                                        <ClientSideEvents ButtonClick="function(s, e) {
