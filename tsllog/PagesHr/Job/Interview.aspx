<%@ Page Language="C#" AutoEventWireup="true" EnableViewState="false" CodeFile="Interview.aspx.cs" Inherits="PagesHr_Job_Interview" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <dxwgv:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" runat="server" OnRowInserting="ASPxGridView1_RowInserting"
                DataSourceID="dsInterview" Width="900px" KeyFieldName="Id" OnInit="ASPxGridView1_Init" OnRowUpdating="ASPxGridView1_RowUpdating"
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Department" FieldName="Department" VisibleIndex="3" Width="80">
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataComboBoxColumn Caption="PIC" FieldName="Pic" VisibleIndex="0" Width="150">
                    ...
                    <EditForm>
                        ...
                        <table border="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <dxe:ASPxComboBox runat="server" EnableIncrementalFiltering="true" ID="txt_InterviewPic" TextFormatString="{1}"
                                        EnableCallbackMode="true" IncrementalFilteringMode="StartsWith" DropDownStyle="DropDownList"
                                        DataSourceID="dsPIC" ValueField="Id" TextField="Name" Width="240" ValueType="System.Int32" Value='<%# Eval("Pic")%>'>
                                        <Buttons>
                                            <dxe:EditButton Text="Clear"></dxe:EditButton>
                                        </Buttons>
                                        <ClientSideEvents ButtonClick="function(s, e) {
                        ...
                        <table>
                            <tr>
                                <td>
                                    <dxe:ASPxButton ID="btn_Interview_update" runat="server" Text="Update" Width="40" AutoPostBack="false" Enabled='<%#SafeValue.SafeString(Eval("StatusCode"))=="USE" %>'
                                ...
                                <td>
                                    <dxe:ASPxButton ID="ASPxButton2" Width="80" runat="server" Text="Add Line"
                                        Enabled='<%# SafeValue.SafeInt(Eval("Id"),0)>0&&SafeValue.SafeString(Eval("StatusCode"))=="USE" %>' AutoPostBack="false" UseSubmitBehavior="false">
                                        <ClientSideEvents Click="function(s,e) {
                                ...
                                <td>
                                    <dxe:ASPxButton ID="btn_DetAdd_quote" runat="server" Text="Pick From Candidate" Enabled='<%# SafeValue.SafeString(Eval("Id"),"0")!="0"&&SafeValue.SafeString(Eval("StatusCode"))=="USE" %>'
