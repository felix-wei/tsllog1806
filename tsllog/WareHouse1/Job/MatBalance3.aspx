<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MatBalance3.aspx.cs" Inherits="WareHouse_Job_MatBalance3" %>
...
<body>
    ...
    <div>
            ...
            <Columns>
                ...
                <dxwgv:GridViewDataTextColumn Caption="Stock Qty" FieldName="OnHand" VisibleIndex="3" Width="100px">
                </dxwgv:GridViewDataTextColumn>
            </Columns>
