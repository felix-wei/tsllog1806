<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mm_SPJ_WHS.aspx.cs" Inherits="WareHouse_Job_Mm_SPJ_WHS" %>
             ...
             <dxwgv:ASPxGridView ID="grid" ClientInstanceName="grid" runat="server" 
                ...
                <Columns>
                 ...
                 <dxwgv:GridViewDataComboBoxColumn Caption="Item Code" Width="240" FieldName="Code" VisibleIndex="2" >
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Out Qty" FieldName="QtyOut" VisibleIndex="2" Width="80">
					</dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Visible="false" Caption="Price" FieldName="Price" VisibleIndex="2" Width="80">
					</dxwgv:GridViewDataTextColumn>
					<dxwgv:GridViewDataComboBoxColumn Visible="false" Caption="GST" FieldName="GstType" VisibleIndex="2" Width="100">
                    ...
                    <dxwgv:GridViewDataTextColumn Visible="false" Caption="GstAmt" FieldName="GstAmt" Readonly="true" VisibleIndex="2" Width="80">
					</dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Visible="false" Caption="Total" FieldName="DocAmt" Readonly="true" VisibleIndex="2" Width="80">
					</dxwgv:GridViewDataTextColumn>
                ...
                <Settings ShowFooter="True" />
                 <TotalSummary>
                     ...
                     <dxwgv:ASPxSummaryItem  FieldName="QtyOut" DisplayFormat="{0}" SummaryType="Sum"/>
