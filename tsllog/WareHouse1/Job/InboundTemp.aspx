<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InboundTemp.aspx.cs" Inherits="WareHouse_Job_InboundTemp" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Templete For Inbound</title>
					...
					<td align=right width=240>
                        ...
                        <div style="padding: 2px 2px 2px 2px">
                            ...
                            <dxtc:ASPxPageControl runat="server" ID="pageControl_Hbl" Width="100%" Height="440px"  ActiveTabIndex="0">
                                <TabPages>
                                    <dxtc:TabPage Name="BookingDetails" Text="Survery" Visible="false">
                                        <ContentCollection>
