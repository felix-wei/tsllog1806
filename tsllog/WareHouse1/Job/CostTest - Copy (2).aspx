...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
	...
	<style>
		table {font-size:10px; width:800px; }		
	</style>
</head>
<body>
...
$(".cssunit").each(function () {
			...
			<td width=180>
		<input type="text" style="width:120px" class="csscuft" name='cuft' id='cuft' onchange="change_vol(this);" value='0.00' />
			</td>
			<td>
			</td>
			<td>
			...
			<td width=180>
		<input type="text" style="width:120px" class="csscuft" name='gross' id='gross'  value='0.00' />
			</td>
			<td>
			Total Chargeable
			</td>
			<td>
	<input type="text" style="width:120px" class="csscuft" name='total' id='total'  value='0.00' />
			</td>
			</tr>
			<tr>
			<td width=120>
			...
			<td width=180>
<input type="text" style="width:120px" class="csscuft" name='lbs' id='lbs'  value='0.00' />
			</td>
			<td>
			Cross Wt. (kgs)
			</td>
			<td>
<input type="text" style="width:120px" class="csscuft" name='kgs' id='kgs'  value='0.00' />
			</td>
			</tr>
			<tr>
			<td width=120>
			...
			<td width=180>
<input type="text" style="width:120px" class="csscuft" name='cbm' id='cbm'  value='0.00' />
			</td>
			<td width=120>
			Rounding Vol. (M3)
			</td>
			<td width=180>
<input type="text" style="width:120px" class="csscuft" name='cbmr' id='cbmr'  value='0.00' />
			</td>
			</tr>
			</table>
			<%
