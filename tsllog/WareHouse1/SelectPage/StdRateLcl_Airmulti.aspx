<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="StdRateLcl_Airmulti.aspx.cs"
    Inherits="PagesFreight_SelectPage_AirStdRateLcl_multi" %>
...
<body>
    ...
    <div>
        <wilson:DataSource ID="dsAirQuoteDet" runat="server" ObjectSpace="C2.Manager.ORManager"
            TypeName="C2.AirQuoteDet1" KeyMember="SequenceId" FilterExpression="1=0" />
        <table>
            <tr>
                <td>
        ...
        <dxwgv:ASPxGridView ID="ASPxGridView1" runat="server" DataSourceID="dsAirQuoteDet"
            ClientInstanceName="grid" KeyFieldName="SequenceId" OnCustomDataCallback="ASPxGridView1_CustomDataCallback"
            >
            ...
            <Columns>
                            ...
                            <dxwgv:GridViewDataTextColumn Caption="Qy" VisibleIndex="5"
                                Width="80">
                            </dxwgv:GridViewDataTextColumn>
                            ...
                            <dxwgv:GridViewDataTextColumn Caption="Amt" VisibleIndex="5"
                                Width="80">
                            </dxwgv:GridViewDataTextColumn>
                            <dxwgv:GridViewDataTextColumn Caption="Min Amt" VisibleIndex="5"
                                Width="80">
                            </dxwgv:GridViewDataTextColumn>
