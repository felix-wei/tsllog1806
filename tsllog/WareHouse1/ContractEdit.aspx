                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="3">
                                                            <table>
                                                               ...
                                                               PopupParty(txt_PartyId,txt_PartyName,'V');
                                                                    }" />
                                                                        </dxe:ASPxButtonEdit>
                                                                    </td>
                                                                    <td>
                                                        ...
                                                        <td>
                                                            <div style="WIDTH: 1000px; overflow-y: scroll;">
                                                                <dxwgv:ASPxGridView ID="grid_det" ClientInstanceName="grid_det" Styles-Cell-HorizontalAlign="Left"
                                                                    ...
                                                                    OnBeforePerformDataSelect="grid_det_BeforePerformDataSelect" OnRowUpdating="grid_det_RowUpdating" OnCellEditorInitialize
                                                                    ="grid_det_CellEditorInitialize"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <dxwgv:GridViewDataTextColumn
                                                                            Caption="Handling Fee" FieldName="HandlingFee" VisibleIndex="5" Width="80">
                                                                            <EditItemTemplate>
                                                                        ...
                                                                        <dxwgv:GridViewDataTextColumn
                                                                            Caption="Storage Fee" FieldName="StorageFee" VisibleIndex="5" Width="80">
                                                                            <EditItemTemplate>
                                                                         ...
                                                                         <dxwgv:GridViewDataTextColumn
                                                                            Caption="Pack Fee" FieldName="Price1" VisibleIndex="5" Width="80" Visible="false">
                                                                            <EditItemTemplate>
                                                                        ...
                                                                        <dxwgv:GridViewDataCheckColumn Caption="Fixed" FieldName="IsFixed" VisibleIndex="13" Width="50">
                                                                        </dxwgv:GridViewDataCheckColumn>
                                                                       
                                                                        <dxwgv:GridViewDataTextColumn Caption="Fee Schedule" VisibleIndex="14" >
                                                                            <DataItemTemplate>
                                                                                <%# Eval("SchStr") %>
                                                                            </DataItemTemplate>
                                                                            <EditItemTemplate>
