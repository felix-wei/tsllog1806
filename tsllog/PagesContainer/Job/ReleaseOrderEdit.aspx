<%@ Page Language="C#" EnableViewState="false" AutoEventWireup="true" CodeFile="ReleaseOrderEdit.aspx.cs" Inherits="PagesContainer_Job_ReleaseOrderEdit" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Container Asset</title>
    ...
    <script>
        ...
        function SetLookupKeyValue(rowIndex) {
            ...
            cmb_ContainerType.SetText(GridView.cpContType[rowIndex]);
        }
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <wilson:DataSource ID="dsReleaseType" runat="server" ObjectSpace="C2.Manager.ORManager"
                TypeName="C2.XXUom" KeyMember="Code" FilterExpression="CodeType='ReleaseType'" />
            ...
            <%--<wilson:DataSource ID="dsRefCont" runat="server" ObjectSpace="C2.Manager.ORManager"
                TypeName="C2.ContAssetEvent" KeyMember="Code" FilterExpression="1=0" />--%>
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <dxe:ASPxButton ID="ASPxButton1" Width="100" runat="server" Text="Retrieve" AutoPostBack="false">
                            <ClientSideEvents Click="function(s,e){
                           window.location='ReleaseOrderEdit.aspx?no='+txt_ReNo.GetText();
                    }" />
                        </dxe:ASPxButton>
                    </td>
                    <td>
                        <dxe:ASPxButton ID="ASPxButton7" Width="100" runat="server" Text="Add New" AutoPostBack="false"
                            ...
                            <ClientSideEvents Click="function(s,e) {
                                           window.location='ReleaseOrderEdit.aspx?no=0';
                        }" />
                        </dxe:ASPxButton>
                    </td>
                    <td>
                        <dxe:ASPxButton ID="ASPxButton3" Width="100" runat="server" Text="New Search" AutoPostBack="false"
                            UseSubmitBehavior="false">
                            <ClientSideEvents Click="function(s,e) {
                                           window.location='ReleaseOrderList.aspx';
                        }" />
                        </dxe:ASPxButton>
                    </td>
                </tr>
            ...
            <dxwgv:ASPxGridView ID="grid_Transport" ClientInstanceName="detailGrid" runat="server"
                KeyFieldName="Id" Width="1000" AutoGenerateColumns="False" DataSourceID="dsTransport"
                        ...
                        <div style="padding: 2px 2px 2px 2px">
                            <table style="width: 100%;">
                                <tr>
                                    <td width="80%"></td>
                                    <td>
                                        <dxe:ASPxButton ID="btn_Save" Width="100" runat="server" Text="Save" AutoPostBack="false" UseSubmitBehavior="false" Enabled='<%# Eval("saveEnable") %>'>
                                            <ClientSideEvents Click="function(s,e) {
                                    ...
                                    <td>
                                        <dxe:ASPxButton ID="btn_Close" ClientInstanceName="btn_Close" Width="100" runat="server" Text="Close" AutoPostBack="false" UseSubmitBehavior="false" Enabled='<%# Eval("closeEnable") %>'>
                                            <ClientSideEvents Click="function(s,e) {
                                    if(confirm('Confirm '+btn_Close.GetText()+' it?')) {
                                                    detailGrid.GetValuesOnCustomCallback('Close',OnPostCallback);
                                                    }
                                            }" />
                                        </dxe:ASPxButton>
                                    </td>
                                    <td>
                                        <dxe:ASPxButton ID="btn_Void" ClientInstanceName="btn_Void"  Width="100" runat="server" Text="Void" AutoPostBack="false" UseSubmitBehavior="false" Enabled='<%# Eval("voidEnable") %>'>
                                            <ClientSideEvents Click="function(s,e) {
                                    if(confirm('Confirm '+btn_Void.GetText()+' it?')) {
                                                    detailGrid.GetValuesOnCustomCallback('Void',OnPostCallback);
                                                    }
                                            }" />
                                        </dxe:ASPxButton>
                                    </td>
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <dxe:ASPxComboBox runat="server" EnableIncrementalFiltering="true" ID="cmb_ReleaseType"
                                            DataSourceID="dsReleaseType" TextField="Code" ValueField="Code" Width="150" Value='<%# Eval("ReleaseType")%>'>
                                        </dxe:ASPxComboBox>
                                    </td>
                                    <td>Job Ref
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td >
                                            <dxe:ASPxButtonEdit ID="btn_HaulierCode" ClientInstanceName="btn_HaulierCode" runat="server" Width="150" HorizontalAlign="Left" AutoPostBack="False" Text='<%# Eval("HaulierCode")%>' ReadOnly="true">
                                                <Buttons>
                                                    <dxe:EditButton Enabled="true" Text=".."></dxe:EditButton>
                                                </Buttons>
                                                <ClientSideEvents ButtonClick="function(s, e) {
                                                                PopupParty(btn_HaulierCode,txt_HaulierName,'CVA');
                                                                    }" />
                                            </dxe:ASPxButtonEdit>
                                        </td>
                                        <td>HaulierName</td>
                                        <td colspan="3">
                                            <dxe:ASPxTextBox ID="txt_HaulierName" ClientInstanceName="txt_HaulierName" runat="server" Width="370" Enable="false" ReadOnly="true" Value='<%# Eval("HaulierRef") %>'></dxe:ASPxTextBox>
                                        </td>
                                        <td>Compl.Date
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <dxe:ASPxButtonEdit runat="server" ID="btn_ShipCarrierCode" ClientInstanceName="btn_ShipCarrierCode" Width="150" HorizontalAlign="Left" AutoPostBack="false" Text='<%# Eval("ShipCarrierCode")%>' ReadOnly="true">
                                                <Buttons>
                                                    <dxe:EditButton Enabled="true" Text=".."></dxe:EditButton>
                                                </Buttons>
                                                <ClientSideEvents ButtonClick="function(s, e) {
                                        ...
                                        <td colspan="3">
                                            <dxe:ASPxTextBox runat="server" Width="370" ID="txt_ShipCarrierRef" ClientInstanceName="txt_ShipCarrierRef" Text='<%# Eval("ShipCarrierRef")%>' ReadOnly="true">
                                            </dxe:ASPxTextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <dxe:ASPxButtonEdit ID="btn_ShipperCode" ClientInstanceName="btn_ShipperCode" runat="server" Width="150" HorizontalAlign="Left" AutoPostBack="False" Text='<%# Eval("ShipperCode")%>' ReadOnly="true">
                                                <Buttons>
                                                    <dxe:EditButton Enabled="true" Text=".."></dxe:EditButton>
                                                </Buttons>
                                                <ClientSideEvents ButtonClick="function(s, e) {
                                        ...
                                        <td colspan="3">
                                            <dxe:ASPxTextBox runat="server" Width="370" ID="txt_ShipperName" ClientInstanceName="txt_ShipperName" Text='<%# Eval("ShipperName")%>' ReadOnly="true">
                                            </dxe:ASPxTextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <dxe:ASPxButtonEdit ID="btn_ConsigneeCode" ClientInstanceName="btn_ConsigneeCode" runat="server" Width="150" HorizontalAlign="Left" AutoPostBack="False" Text='<%# Eval("ConsigneeCode")%>' ReadOnly="true">
                                                <Buttons>
                                                    <dxe:EditButton Enabled="true" Text=".."></dxe:EditButton>
                                                </Buttons>
                                                <ClientSideEvents ButtonClick="function(s, e) {
                                        ...
                                        <td colspan="3">
                                            <dxe:ASPxTextBox runat="server" Width="370" ID="txt_ConsigneeName" ClientInstanceName="txt_ConsigneeName" Text='<%# Eval("ConsigneeName")%>' ReadOnly="true">
                                            </dxe:ASPxTextBox>
                                        </td>
                                    </tr>
                                </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <dxe:ASPxDropDownEdit ID="DropDownEdit" runat="server" ClientInstanceName="DropDownEdit"
                                                        Text='<%# Bind("ContainerNo") %>' Width="150">
                                                ...
                                                <td>
                                                    <%--<dxe:ASPxTextBox runat="server" Width="150" ID="txt_ContainerType" ClientInstanceName="txt_ContainerType" Text='<%# Bind("ContainerType")%>'>
                                                    </dxe:ASPxTextBox>--%>
                                                    <dxe:ASPxComboBox runat="server" EnableIncrementalFiltering="true" ID="cmb_ContainerType" ClientInstanceName="cmb_ContainerType" DataSourceID="dsContainerType" TextField="ContainerType" ValueField="ContainerType" Width="165" Value='<%# Bind("ContainerType")%>'>
                                                    </dxe:ASPxComboBox>
                                                </td>
                                                <td>VehicleNo
                                                </td>
