<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DepotInList.aspx.cs" Inherits="PagesContainer_Job_DepotInList" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        function PopupDepotIn() {
            popubCtr.SetContentUrl('DeportInEdit.aspx');
            popubCtr.Show();
        }
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <dxwgv:ASPxGridView ID="grid_Transport" ClientInstanceName="detailGrid" runat="server"
                ...
                <Columns>
                    <dxwgv:GridViewDataTextColumn Caption="SO No" FieldName="DocNo" VisibleIndex="1"
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Receive Date" FieldName="ReceiveDate" VisibleIndex="8" Width="40">
            ...
            <dxpc:ASPxPopupControl ID="popubCtr" runat="server" CloseAction="CloseButton" Modal="True"
                ...
                HeaderText="Confirm SO" AllowDragging="True" EnableAnimation="False" Height="550"
