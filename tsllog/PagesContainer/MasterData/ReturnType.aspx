<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReturnType.aspx.cs" Inherits="PagesMaster_Category" %>
            ...
            <tr>
                <td colspan="3">
                    <wilson:DataSource ID="dsXXUom" runat="server" ObjectSpace="C2.Manager.ORManager"
                        TypeName="C2.XXUom" KeyMember="Id"  FilterExpression="CodeType='ReturnType'"/>
