...
public partial class PagesMaster_Category : System.Web.UI.Page
{
    ...
    protected void grid_RowUpdating(object sender, DevExpress.Web.Data.ASPxDataUpdatingEventArgs e)
    {
        ...
        e.NewValues["UpdateDateTime"] = DateTime.Now;
        ASPxTextBox txt_code = this.grid.FindEditRowCellTemplateControl(null, "txt") as ASPxTextBox;
        ASPxLabel lb_id = this.grid.FindEditRowCellTemplateControl(null, "lb_id") as ASPxLabel;
        if (checkExist(lb_id.Text, txt_code.Text))
        {
            throw new Exception("This Code is exited");
        }
    }
   //
    ...
    {
        string sql = "select COUNT(*) from XXUom where CodeType='TankCate' and Code='"+code+"' and Id<>"+id;
