<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Import_XML.aspx.cs" Inherits="PSA_Import_XML" %>
    ...
    <script type="text/javascript">
        ...
        function CheckFile(s, e) {
            ...
            if (fileType == "xml")
                ...
                alert("This file extension isn't allowed,pls select Excel(.xml)");
            }
        }
    </script>
</head>
    ...
    <form id="form1" runat="server">
        <div>
            <table>
                <tr>
                    <td>
                        <dxe:ASPxDateEdit ID="search_from" runat="server"></dxe:ASPxDateEdit>
                    </td>
                    <td>
                        <dxe:ASPxDateEdit ID="search_to" runat="server"></dxe:ASPxDateEdit>
                    </td>
                    <td><dxe:ASPxButton ID="btn_search" runat="server" Text="Retrieve" OnClick="btn_search_Click"></dxe:ASPxButton></td>
                    <td>
                        <dxuc:ASPxUploadControl ID="file_upload1" ClientInstanceName="file_upload1" runat="server" Width="100%" ClientSideEvents-TextChanged="CheckFile">
