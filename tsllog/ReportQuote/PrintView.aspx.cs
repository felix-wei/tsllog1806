...
public partial class ReportFreightSea_PrintView : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            try
            {
                ...
                else if (reportName == "300")
                {
                    ms = PrintQuote_Fcl(refN, userName);
                    fileName = "Quotation" + DateTime.Now.ToString("yyyyMMdd");
                }
                else if (reportName == "301")
                {
    ...
    private MemoryStream PrintQuote(string no, string userName)
    {
        ...
        //rpt.DataSource = SeaFreightDocPrint.dsAccountQuote(no,userName);
    ...
    {
        XtraReport rpt = new XtraReport();
        rpt.LoadLayout(Server.MapPath(@"~\ReportQuote\repx\Sea\Quote_Fcl.repx"));
    ...
    {
        XtraReport rpt = new XtraReport();
        rpt.LoadLayout(Server.MapPath(@"~\ReportQuote\repx\Sea\Quote_Lcl.repx"));
