<%@ Page Language="C#" EnableViewState="false" AutoEventWireup="true" CodeFile="LCEdit.aspx.cs" Inherits="PagesMaster_LCEdit" %>
    ...
    <script type="text/javascript">
        function OnSaveCallBack(v) {
            if (v == "Success") {
                ...
                window.location = 'LCEdit.aspx?no=' + v;
         ...
         <table>
                <tr>
                    ...
                    <td>
                        ...
                        window.location='LCEdit.aspx?no='+txt_SchRefNo.GetText();
                    }" />
                        </dxe:ASPxButton>
                    </td>
                    <td>
                        <dxe:ASPxButton ID="btn_Add" Width="100" runat="server" Text="Add New" AutoPostBack="false">
                            <ClientSideEvents Click="function(s,e){
                        window.location='LCEdit.aspx?no=0';
                                                        }" />
                        </dxe:ASPxButton>
                    </td>
                    <td>
                                    ...
                                    <td width="94">
                                        <dxe:ASPxButtonEdit ID="txt_EntityCode" ClientInstanceName="txt_EntityCode" runat="server"
                                            ...
                                            <ClientSideEvents ButtonClick="function(s, e) {
                                                                            PopupParty(txt_EntityCode,txt_EntityName,null,null,null,null,null,memo_EntityAddress,'CV');
                                                                    }" />
                                        </dxe:ASPxButtonEdit>
                                    </td>
                                    <td>
