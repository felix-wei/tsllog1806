...
public partial class PagesMaster_DepotRate : System.Web.UI.Page
{
    ...
    protected void btn_search_Click(object sender, EventArgs e)
    {
        ...
        string where = "JobNo='-1' and LineType='DEPOT'";
        if (_client.Length > 1)
        {
            if (_client != "ALL")
    ...
    protected void Grid1_InitNewRow(object sender, DevExpress.Web.Data.ASPxDataInitNewRowEventArgs e)
    {
        ...
        e.NewValues["ChgCode"] = "DHC";
        e.NewValues["ChgCodeDe"] = "DHC";
        e.NewValues["Unit"] = "";
        e.NewValues["Remark"] = " ";
