<%@ Page Language="C#" EnableViewState="false" AutoEventWireup="true" CodeFile="BuyingLCEdit.aspx.cs" Inherits="PagesMaster_BuyingLCEdit" %>
    ...
    <script type="text/javascript">
        function OnSaveCallBack(v) {
            ...
            if (v != null && v.indexOf("Fail") > -1) {
                ...
                window.location = 'BuyingLCEdit.aspx?no=' + v;
            }
        }
    </script>
</head>
         ...
         <table>
                <tr>
                    ...
                    <td>
                        ...
                        window.location='BuyingLCEdit.aspx?no='+txt_SchRefNo.GetText();
                    }" />
                        </dxe:ASPxButton>
                    </td>
                    <td>
                        <dxe:ASPxButton ID="btn_Add" Width="100" runat="server" Text="Add New LC" AutoPostBack="false">
                            <ClientSideEvents Click="function(s,e){
                        window.location='BuyingLCEdit.aspx?no=0';
                                                        }" />
                        </dxe:ASPxButton>
                    </td>
                    <td>
                        <dxe:ASPxButton ID="ASPxButton3" Width="100" runat="server" Text="Go Search" AutoPostBack="false"
                            ...
                            <ClientSideEvents Click="function(s,e) {
                                           window.location='BuyingLCList.aspx';
                        }" />
                        </dxe:ASPxButton>
                    </td>
                    <td>
                        <dxe:ASPxButton ID="ASPxButton1" Width="200" runat="server" Text="Go Bank LC Summary" AutoPostBack="false"
                            UseSubmitBehavior="false">
                            <ClientSideEvents Click="function(s,e) {
                                           window.location='BankList.aspx';
                        }" />
                        </dxe:ASPxButton>
                    </td>
                </tr>
                                    ...
                                    <td width="94">
                                        <dxe:ASPxButtonEdit ID="txt_EntityCode" ClientInstanceName="txt_EntityCode" runat="server"
                                            ...
                                            <ClientSideEvents ButtonClick="function(s, e) {
                                                                            PopupParty(txt_EntityCode,txt_EntityName,null,null,null,null,null,memo_EntityAddress,'C','');
                                                                    }" />
                                        </dxe:ASPxButtonEdit>
                                    </td>
                                    <td>
                                ...
                                <table cellpadding="0" cellspacing="0">
                                    <td width="94">
                                        <dxe:ASPxButtonEdit ID="btn_BeneCode" ClientInstanceName="btn_BeneCode" runat="server"
                                            ...
                                            <ClientSideEvents ButtonClick="function(s, e) {
                                                                            PopupParty(btn_BeneCode,txt_LcBeneName,null,null,null,null,null,memo_BeneAddress,'C','');
                                                                    }" />
                                        </dxe:ASPxButtonEdit>
                                    </td>
                                    <td>
                        ...
                        <dxtc:ASPxPageControl runat="server" ID="pageControl" Width="1000px" Height="500px">
                            <TabPages>
                                ...
                                <dxtc:TabPage Text="Sub PO">
                                    <ContentCollection>
                                        <dxw:ContentControl>
                                            <dxwgv:ASPxGridView ID="grid_Po" ClientInstanceName="grid_Po" runat="server"
                                                KeyFieldName="Id" Width="100%" AutoGenerateColumns="False" OnBeforePerformDataSelect="grid_Po_BeforePerformDataSelect">
                                                <SettingsPager Mode="ShowAllRecords"></SettingsPager>
                                                <Columns>
