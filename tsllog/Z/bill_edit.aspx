<%@ Page Language="C#" AutoEventWireup="true" EnableViewState="false" CodeFile="bill_edit.aspx.cs" Inherits="Z_bill_edit" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function PrintBill(s, n, m, h, t) {   // src, name, mast, house, type
            window.open('/_doc/print.aspx?src=' + s + '&name=' + n + '&master=' + m + '&house=' + h + '&type=' + t);
        }
        $(function () {
...
<body style="padding: 0px; border-spacing: 0; margin: 0px; border: 0px; overflow: hidden; background-color: #F0F0F0">
    <form id="form1" runat="server">
        ...
        <wilson:DataSource ID="dsArInvoice" runat="server" ObjectSpace="C2.Manager.ORManager"
            TypeName="C2.bill_doc" KeyMember="Id" FilterExpression="1=0" />
        <wilson:DataSource ID="dsArInvoiceDet" runat="server" ObjectSpace="C2.Manager.ORManager"
            TypeName="C2.bill_line" KeyMember="Id" FilterExpression="1=0" />
            ...
            <tr>
                ...
                <td>
                    <table>
                     ...
                     window.location='bill_edit.aspx?no='+txtSchNo.GetText()
                        }" />
                                </dxe:ASPxButton>
                            </td>
                            <td>
                                <dxe:ASPxButton ID="ASPxButton3" Width="90" runat="server" Text="Go Search" AutoPostBack="false"
                                    ...
                                    <ClientSideEvents Click="function(s,e) {
                                           window.location='bill_list.aspx';
                        }" />
                                </dxe:ASPxButton>
                            </td>
                        </tr>
        ...
        <dxwgv:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" runat="server" Styles-EditForm-Border-BorderWidth="0" Styles-EditForm-Paddings-PaddingTop="0" Styles-EditForm-Paddings-PaddingBottom="0"
            ...
            OnHtmlEditFormCreated="ASPxGridView1_HtmlEditFormCreated" OnCustomDataCallback="ASPxGridView1_CustomDataCallback1" OnAfterPerformCallback="ASPxGridView1_AfterPerformCallback"
                    ...
                    <table style="border: 0px">
                                    ...
                                    if(confirm('Confirm post it?')) {
                                        ...
                                        <td>
                                            <dxe:ASPxButton ID="ASPxButton1" runat="server" Text="Print" Width="70" Enabled='<%# SafeValue.SafeString(Eval("Id"),"0")!="0" %>'
                                                ...
                                                <ClientSideEvents Click="function(s,e){
                                                        PrintBill('bill', 'Invoice', txt_DocNo.GetText(), 0, 0);
                        ...
                        <tr>
                            ...
                            <td style="font-size: 20px; font-weight: bolder">
                                <dxe:ASPxComboBox runat="server" ID="total_LocAmt" ClientInstanceName="total_LocAmt" DropDownHeight="0" DropDownWidth="0" DropDownRows="20" ItemImage-Height="0" Spacing="0" ListBoxStyle-Border-BorderWidth="0" ListBoxStyle-BackColor="#F0F0F0" ItemStyle-BackColor="#F0F0F0" ShowShadow="false" DropDownButton-Enabled="false" Width="120" Border-BorderWidth="0" BackColor="#F0F0F0" Font-Bold="true" Font-Size="20px" Height="20px" Paddings-Padding="0"
                                    OnCallback="total_LocAmt_Callback" DropDownButton-Visible="false" DropDownStyle="DropDownList">
                                </dxe:ASPxComboBox>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>Last Updated</td>
                            <td>
                                <dxe:ASPxLabel Text='<%#Eval("UserId") %>' runat="server"></dxe:ASPxLabel>
                            </td>
                        </tr>
                        <tr>
                            <td>GL Period
                                ...
                                AddInvoiceDet();
                                    ...
                                    <td>
                                        <dxe:ASPxButton ID="btn_ShortcutCode1" ClientInstanceName="btn_ShortcutCode1" runat="server" Enabled='<%# SafeValue.SafeString(Eval("Id"),"0")!="0"&&SafeValue.SafeString(Eval("ExportIndStr"),"N")!="Y" %>'
                                            AutoPostBack="false" UseSubmitBehavior="false">
                                            <ClientSideEvents Click="function(s,e) {
                                                        grid_det.GetValuesOnCustomCallback('ShortcutCode'+btn_ShortcutCode1.GetText(),onDetCallback);
                                                        }" />
                                        </dxe:ASPxButton>
                                    </td>
                                    <td>
                                        <dxe:ASPxButton ID="btn_ShortcutCode2" ClientInstanceName="btn_ShortcutCode2" runat="server" Enabled='<%# SafeValue.SafeString(Eval("Id"),"0")!="0"&&SafeValue.SafeString(Eval("ExportIndStr"),"N")!="Y" %>'
                                            AutoPostBack="false" UseSubmitBehavior="false">
                                            <ClientSideEvents Click="function(s,e) {
                                                        grid_det.GetValuesOnCustomCallback('ShortcutCode'+btn_ShortcutCode2.GetText(),onDetCallback);
                                                        }" />
                                        </dxe:ASPxButton>
                                    </td>
                                    <td>
                                        <dxe:ASPxButton ID="btn_ShortcutCode3" ClientInstanceName="btn_ShortcutCode3" runat="server" Text="PSA" Enabled='<%# SafeValue.SafeString(Eval("Id"),"0")!="0"&&SafeValue.SafeString(Eval("ExportIndStr"),"N")!="Y" %>'
                                            AutoPostBack="false" UseSubmitBehavior="false">
                                            <ClientSideEvents Click="function(s,e) {
                                                        grid_det.GetValuesOnCustomCallback('ShortcutCode'+btn_ShortcutCode3.GetText(),onDetCallback);
                                                        }" />
                                        </dxe:ASPxButton>
                                    </td>
                                    <td>
                                        <dxe:ASPxButton ID="btn_ShortcutCode4" ClientInstanceName="btn_ShortcutCode4" runat="server" Text="FRTOC20" Enabled='<%# SafeValue.SafeString(Eval("Id"),"0")!="0"&&SafeValue.SafeString(Eval("ExportIndStr"),"N")!="Y" %>'
                                            AutoPostBack="false" UseSubmitBehavior="false">
                                            <ClientSideEvents Click="function(s,e) {
                                                        grid_det.GetValuesOnCustomCallback('ShortcutCode'+btn_ShortcutCode4.GetText(),onDetCallback);
                                                        }" />
                                        </dxe:ASPxButton>
                                    </td>
                                    <td>
                                        <dxe:ASPxButton ID="btn_ShortcutCode5" ClientInstanceName="btn_ShortcutCode5" runat="server" Text="FRTOC40" Enabled='<%# SafeValue.SafeString(Eval("Id"),"0")!="0"&&SafeValue.SafeString(Eval("ExportIndStr"),"N")!="Y" %>'
                                            AutoPostBack="false" UseSubmitBehavior="false">
                                            <ClientSideEvents Click="function(s,e) {
                                                        grid_det.GetValuesOnCustomCallback('ShortcutCode'+btn_ShortcutCode5.GetText(),onDetCallback);
                                                        }" />
                                        </dxe:ASPxButton>
                                    </td>
                                    <td>
                                        <dxe:ASPxButton ID="btn_ShortcutCode6" ClientInstanceName="btn_ShortcutCode6" runat="server" Text="THC" Enabled='<%# SafeValue.SafeString(Eval("Id"),"0")!="0"&&SafeValue.SafeString(Eval("ExportIndStr"),"N")!="Y" %>'
                                            AutoPostBack="false" UseSubmitBehavior="false">
                                            <ClientSideEvents Click="function(s,e) {
                                                        grid_det.GetValuesOnCustomCallback('ShortcutCode'+btn_ShortcutCode6.GetText(),onDetCallback);
                                                        }" />
                                        </dxe:ASPxButton>
                                    </td>
                                    <td>
                                        <dxe:ASPxButton ID="btn_ShortcutCode7" ClientInstanceName="btn_ShortcutCode7" runat="server" Text="FRTOC" Enabled='<%# SafeValue.SafeString(Eval("Id"),"0")!="0"&&SafeValue.SafeString(Eval("ExportIndStr"),"N")!="Y" %>'
                                            AutoPostBack="false" UseSubmitBehavior="false">
                                            <ClientSideEvents Click="function(s,e) {
                                                        grid_det.GetValuesOnCustomCallback('ShortcutCode'+btn_ShortcutCode7.GetText(),onDetCallback);
                                                        }" />
                                        </dxe:ASPxButton>
                                    </td>
                                    <td>
                                        <dxe:ASPxButton ID="btn_ShortcutCode8" ClientInstanceName="btn_ShortcutCode8" runat="server" Text="LCL" Enabled='<%# SafeValue.SafeString(Eval("Id"),"0")!="0"&&SafeValue.SafeString(Eval("ExportIndStr"),"N")!="Y" %>'
                                            AutoPostBack="false" UseSubmitBehavior="false">
                                            <ClientSideEvents Click="function(s,e) {
                                                        grid_det.GetValuesOnCustomCallback('ShortcutCode'+btn_ShortcutCode8.GetText(),onDetCallback);
                                                        }" />
                                        </dxe:ASPxButton>
                                    </td>
                                    <td>
                                        <dxe:ASPxButton ID="btn_ShortcutCode9" ClientInstanceName="btn_ShortcutCode9" runat="server" Text="DEPOT" Enabled='<%# SafeValue.SafeString(Eval("Id"),"0")!="0"&&SafeValue.SafeString(Eval("ExportIndStr"),"N")!="Y" %>'
                                            AutoPostBack="false" UseSubmitBehavior="false">
                                            <ClientSideEvents Click="function(s,e) {
                                                        grid_det.GetValuesOnCustomCallback('ShortcutCode'+btn_ShortcutCode9.GetText(),onDetCallback);
                                                        }" />
                                        </dxe:ASPxButton>
                                    </td>
                                    <td>
                                        <dxe:ASPxButton ID="btn_ShortcutCode10" ClientInstanceName="btn_ShortcutCode10" runat="server" Text="DEPOT" Enabled='<%# SafeValue.SafeString(Eval("Id"),"0")!="0"&&SafeValue.SafeString(Eval("ExportIndStr"),"N")!="Y" %>'
                                            AutoPostBack="false" UseSubmitBehavior="false">
                                            <ClientSideEvents Click="function(s,e) {
                                                        grid_det.GetValuesOnCustomCallback('ShortcutCode'+btn_ShortcutCode10.GetText(),onDetCallback);
                                                        }" />
                                        </dxe:ASPxButton>
                                    </td>
                                </table>
                            ...
                            <dxwgv:GridViewDataColumn Caption="#" Width="50" CellStyle-Paddings-Padding="0" CellStyle-HorizontalAlign="Center" VisibleIndex="0" FixedStyle="Left">
                                <DataItemTemplate>
                                    <div style='display: <%# Eval("Display")%>'>
                                        ...
                                        <a href="#" onclick='if(confirm("Confirm Delete"))  {<%# "grid_det.DeleteRow("+Container.VisibleIndex+");total_LocAmt.PerformCallback();"  %>}'>D</a>
                                    </div>
                                </DataItemTemplate>
                                <EditItemTemplate>
                                    <div style='display: <%# Eval("Display")%>'>
                                        <a href="#" onclick='<%# "grid_det.UpdateEdit("+Container.VisibleIndex+");total_LocAmt.PerformCallback();" %>'>U</a>
