<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rate_list.aspx.cs" Inherits="Z_rate_list" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function ShowArInvoice(invN) {
            parent.navTab.openTab(invN, "/Z/rate_edit.aspx?no=" + invN, { title: invN, fresh: false, external: true });
        }
        ...
        function OnSaveCallBack(v) {
            if (v != null && v.length > 0) {
                ...
                txt_TermId.SetText();
                ASPxPopupClientControl.Hide();
                parent.navTab.openTab(v, '/Z/rate_edit.aspx?no=' + v, { title: v, fresh: false, external: true });
            }
        }
    </script>
</head>
    ...
    <form id="form1" runat="server">
        <div>
            <wilson:DataSource ID="dsArInvoice" runat="server" ObjectSpace="C2.Manager.ORManager"
                TypeName="C2.rate_doc" KeyMember="SequenceId" FilterExpression="1=0" />
