...
public partial class Z_pay_edit : BasePage
{
    ...
    protected void ASPxGridView1_Init(object sender, EventArgs e)
    {
        ...
        if (grd != null)
            grd.ForceDataRowType(typeof(C2.pay_doc));
    }
    ...
    protected void grid_InvDet_Init(object sender, EventArgs e)
    {
        ASPxGridView grd = sender as ASPxGridView;
        if (grd != null)
            grd.ForceDataRowType(typeof(C2.pay_line));
    }
    ...
    protected void grid_InvDet_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
    {
        ...
        ASPxGridView grd = (sender as ASPxGridView) as ASPxGridView;
        string sql_detCnt = "select count(DocNo) from pay_line where RepId='" + SafeValue.SafeInt(grd.GetMasterRowKeyValue(), 0) + "'";
    ...
    protected void grid_InvDet_RowDeleting(object sender, DevExpress.Web.Data.ASPxDataDeletingEventArgs e)
    {
        ...
        ASPxGridView grd = (sender as ASPxGridView) as ASPxGridView;
        string sql_detCnt = "select ExportInd from pay_doc where Id='" + SafeValue.SafeInt(grd.GetMasterRowKeyValue(), 0) + "'";
    ...
    private void UpdateMaster(string docId, string docType)
    {
        ...
        {
            string sql = "select SUM(docAmt) from pay_line where DocId='" + docId + "' and DocType='" + docType + "'";
    ...
    {
        string sql_invoice = "update pay_doc set ExportInd='Y' where Id='" + docId + "'";
