<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DriverViewLog.aspx.cs" Inherits="PagesTpt_Local_Viewer_DriverViewLog" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <table>
                <tr>
                    <td>JobNo</td>
                    <td>
                        <asp:Label ID="txt_JobNo" runat="server"></asp:Label>
                        <dxe:ASPxLabel ID="txt_Driver" ClientInstanceName="txt_Driver" runat="server"></dxe:ASPxLabel>
                    </td>
                </tr>
            </table>
            ...
            <table>
                <tr>
                    <td>
                        <dxe:ASPxButton ID="ASPxButton1" Width="110" runat="server" Text="Add" AutoPostBack="false" UseSubmitBehavior="false">
        ...
        document.getElementById('div').style.display='block';
                    ...
                    <td>
                        <dxe:ASPxButton ID="btn_GoBack" Width="110" runat="server" Text="Go Back" AutoPostBack="false">
            ...
            <div id="div" style="display: none">
                <table style="width: 600px">
                    <tr>
                        ...
                        <td>Date</td>
                        <td>
                            <dxe:ASPxDateEdit ID="date_TptDate" runat="server" Width="100" Value='<%# Bind("TptDate") %>'
                                EditFormat="Custom" EditFormatString="dd/MM/yyyy">
                            </dxe:ASPxDateEdit>
                        </td>
                        <td>Time</td>
                        <td>
                            <dxe:ASPxTextBox ID="txt_TptTime" Width="100" runat="server">
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <dxe:ASPxButton ID="ASPxButton21" Width="110" runat="server" Text="Save" OnClick="btn_Click">
                            </dxe:ASPxButton>
                        </td>
                        <td>
