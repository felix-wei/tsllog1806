<%@ Page Language="C#" EnableViewState="false" AutoEventWireup="true" CodeFile="ExpLclQuoteEdit.aspx.cs" Inherits="PagesFreight_ExpLclQuoteEdit" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function ImportStdRate() {
            ...
            popubCtr.SetContentUrl('/SelectPage/StdRateLcl_multi.aspx?no=' + txt_Oid.GetText());
            popubCtr.Show();
        }
        function ImportDet() {
            popubCtr.SetHeaderText('Export Standard List');
            popubCtr.SetContentUrl('/SelectPage/ExpLclQuoteList_Sea.aspx?id=' + txt_Oid.GetText());
            popubCtr.Show();
        }
        function ImportArDet() {
            popubCtr.SetHeaderText('AR Invoice Item List');
            popubCtr.SetContentUrl('/SelectPage/ArList.aspx?id=' + txt_Oid.GetText());
            popubCtr.Show();
        }
            ...
            <table>
                <tr>
                    ...
                    <td>
                     ...
                     window.location='ExpLclQuoteEdit.aspx?no='+txtSchNo.GetText()
                        }" />
                                    </dxe:ASPxButton>
                                </td>
                                <td>
                                    <dxe:ASPxButton ID="ASPxButton1" Width="110" runat="server" Text="Add New" AutoPostBack="false">
                                        <ClientSideEvents Click="function(s, e) {
                     window.location='ExpLclQuoteEdit.aspx?no=0'
                        }" />
                                    </dxe:ASPxButton>
                                </td>
                            </tr>
