<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SeaQuoteList.aspx.cs" Inherits="PagesFreight_Quote1_SeaQuoteList" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        function ShowQuo(invN) {
            //alert('asdf');
            window.location = 'SeaQuoteEdit.aspx?no=' + invN;
        }
    </script>
</head>
<body  width="800">
    ...
    <div>
        ...
        <dxwgv:ASPxGridView ID="ASPxGridView1" runat="server" DataSourceID="dsSeaQuotation"
            ...
            <Columns>
                ...
                <dxwgv:GridViewDataTextColumn Caption="Quote Date" FieldName="QuoteDate" VisibleIndex="4"
                    Width="8%">
                ...
                <dxwgv:GridViewDataTextColumn Caption="Tel" FieldName="Tel" VisibleIndex="5">
                </dxwgv:GridViewDataTextColumn>
                <dxwgv:GridViewDataTextColumn Caption="Fax" FieldName="Fax" VisibleIndex="5">
                </dxwgv:GridViewDataTextColumn>
