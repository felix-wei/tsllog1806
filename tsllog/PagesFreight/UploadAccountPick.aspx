<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UploadAccountPick.aspx.cs" Inherits="PagesFreight_UploadAccountPick" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <table>
                <tr>
                    <td width="200">Content
                    </td>
                    <td width="200">FileName
                    </td>
                    <td width="200">Note
                    </td>
                            ...
                            <table width="600" style="border-bottom: solid 1px black;">
                                <tr style="font-weight: bold; font-size: 11px">
                                    <td style="width: 200px">
                                       <a href='/Photos/<%# Eval("FilePath")%>' target="_blank">
                                                                            <dxe:ASPxImage ID="ASPxImage1" Width="80" Height="80" runat="server" ImageUrl='<%# GetPath(Eval("FilePath","{0}")) %>'>
                                                                            </dxe:ASPxImage>
                                                                        </a>
                                    </td>
                                    <td style="width: 200px">
