                            ...
                            <tr>
                                ...
                                <td>
                                    <dxe:ASPxButton ID="ASPxButton2" runat="server" Text="Print Simple" Enabled='<%# SafeValue.SafeString(Eval("SequenceId"),"0")!="0" %>'
                                        AutoPostBack="false" UseSubmitBehavior="false">
                                        <ClientSideEvents Click="function(s,e){
                                PrintInvoiceA4(txt_DocNo.GetText(),'IV','S');
                            }" />
                                    </dxe:ASPxButton>
                                </td>
                                <td>
                                    <table>
                                        <td>
                                            <dxe:ASPxButton ID="ASPxButton1" runat="server" Text="Print" Enabled='<%# SafeValue.SafeString(Eval("SequenceId"),"0")!="0" %>'
                                                AutoPostBack="false" UseSubmitBehavior="false">
                                                <ClientSideEvents Click="function(s,e){
                                PrintInvoice(txt_DocNo.GetText(),'IV','S');
                            }" />
                                            </dxe:ASPxButton>
                                        </td>
                                         <td>
                                        ...
                                        <Templates>
                                            <EditForm>
                                                <table style="border-bottom: solid 1px black;">
                                                    ...
                                                    <tr>
                                                        <td colspan="7" align="right">Other amount</td>
                                                        <td><dxe:ASPxSpinEdit ID="txt_OtherAmt" Increment="0" Width="100%" runat="server" Text='<%# Bind("OtherAmt")%>' 
                                                            DisplayFormatString="0.00">
                                                            <SpinButtons ShowIncrementButtons="false" />
                                                            </dxe:ASPxSpinEdit></td>
                                                    </tr>
