...
public partial class ReportWarehouse_PrintView : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            try
            {
                ...
                else if (reportName == "wh_po" || reportName == "wh_putaway" || reportName == "wh_so" || reportName == "wh_inv" || reportName == "wh_doout" || reportName == "wh_picking" || reportName == "wh_shipdo" || reportName == "wh_Invoie")
                {
