            ...
            <div>
                <dxwgv:ASPxGridView ID="grid" runat="server" ClientInstanceName="grid"
                    ...
                    <Columns>
                        ...
                        <dxwgv:GridViewDataTextColumn Caption="ML" FieldName="Att4" VisibleIndex="9" Width="50">
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="ACL%" FieldName="Att5" VisibleIndex="9" Width="50">
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="CO" FieldName="Att6" VisibleIndex="9" Width="50">
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="NRF/REF" FieldName="Att7" VisibleIndex="9" Width="50">
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="GBX" FieldName="Att8" VisibleIndex="9" Width="50">
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="DECODE" FieldName="Att9" VisibleIndex="9" Width="50">
                        </dxwgv:GridViewDataTextColumn>
                    </Columns>
