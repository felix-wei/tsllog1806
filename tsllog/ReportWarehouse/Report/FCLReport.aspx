...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <link href="/Style/StyleSheet.css" rel="stylesheet" type="text/css" />
        <script type="text/javascript">
            function Print() {
                parent.PrintReport('/ReportWarehouse/RptPrintView.aspx?doc=2&docType=0&type=' + cmb_DocType.GetValue() + '&d1=' + frmDate.GetText() + '&d2=' + toDate.GetText());
            }
            function ExportToExcel() {
                parent.PrintReport('/ReportWarehouse/Rptprintview.aspx?doc=1&docType=1&d1=' + frmDate.GetText() + '&d2=' + toDate.GetText() + '&type=' + cmb_DocType.GetValue())
            }
    </script>
</head>
<body>
