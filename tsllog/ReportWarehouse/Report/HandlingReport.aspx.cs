...
0 as Surcharge,0 as SurchageAmt,JobType as DoType,(case when  mast.DoType='OUT' then '/WareHouse/Job/DoOutEdit.aspx?no='+mast.DoNo else '/WareHouse/Job/DoInEdit.aspx?no='+mast.DoNo end) as Pagelink,
