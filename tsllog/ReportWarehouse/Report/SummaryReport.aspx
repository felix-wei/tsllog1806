...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        function Print() {
            parent.PrintReport('/ReportWarehouse/RptPrintView.aspx?doc=0&docType=0&type=' + cmb_DocType.GetValue() + '&d1=' + frmDate.GetText() + '&d2=' + toDate.GetText());
        }
        function ExportToExcel() {
            parent.PrintReport('/ReportWarehouse/Rptprintview.aspx?doc=0&docType=1&d1=' + frmDate.GetText() + '&d2=' + toDate.GetText() + '&type=' + cmb_DocType.GetValue())
        }
    </script>
</head>
<body>
