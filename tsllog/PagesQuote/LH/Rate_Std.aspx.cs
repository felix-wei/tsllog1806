...
public partial class PagesQuote_Air_Rate_Std : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            Session["TptRate_" + typ] = "ImpExpInd='" + typ + "' and QuoteId = '-1'";
        }
        if (Session["TptRate_" + this.txt_type.Text] != null)
            this.dsQuotationDet.FilterExpression = Session["TptRate_" + this.txt_type.Text].ToString();
    }
