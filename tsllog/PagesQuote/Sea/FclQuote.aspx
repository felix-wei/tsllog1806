<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="FclQuote.aspx.cs"
    Inherits="PagesQuote_FclQuote" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function ShowQuo(invN) {
            window.location = 'FclQuoteEdit.aspx?no=' + invN + '&typ=' + txt_type.GetText();
        }
    </script>
