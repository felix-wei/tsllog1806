<%@ Page Language="C#" AutoEventWireup="true" EnableViewState="false" CodeFile="FclQuoteEdit.aspx.cs" Inherits="PagesQuote_FclQuoteEdit" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
         function ImportStdRate() {
            popubCtr.SetHeaderText('Standard Rate List');
            popubCtr.SetContentUrl('../SelectPage/StdRateFcl_multi.aspx?no=' + txt_Oid.GetText() + '&pol=' + txt_Pol.GetText() + '&pod=' + txt_Pod.GetText() + '&partyTo=' + txt_CustId.GetText());
            popubCtr.Show();
        }
       function ImportDet() {
            popubCtr.SetHeaderText('Pick From Quote');
            popubCtr.SetContentUrl('../SelectPage/FclQuoteList.aspx?no=' + txt_Oid.GetText());
            popubCtr.Show();
        }
        ...
        function PrintQuote(invN) {
            window.open('/ReportFreightSea/printview.aspx?document=Quote_FCL&house=0&master=' + invN);
        }  
            ...
            <tr>
                ...
                <td>
                    <table>
                     ...
                     window.location='FclQuoteEdit.aspx?no='+txtSchNo.GetText()+'&typ='+txt_type.GetText();
                        }" />
                                </dxe:ASPxButton>
                            </td>
                            <td>
                                <dxe:ASPxButton ID="btn_AddNew" Width="110" runat="server" Text="Add New" AutoPostBack="false">
                                    <ClientSideEvents Click="function(s, e) {
                     window.location='FclQuoteEdit.aspx?no=0&typ='+txt_type.GetText()
                        }" />
                                </dxe:ASPxButton>
                            </td>
                            <td>
                                <dxe:ASPxButton ID="ASPxButton3" Width="110" runat="server" Text="Go Search" AutoPostBack="false">
                                    <ClientSideEvents Click="function(s, e) {
                     window.location='/PagesQuote/Sea/FclQuote.aspx?typ='+txt_type.GetText()
                        }" />
                                </dxe:ASPxButton>
                            </td>
                        </tr>
                ...
                <EditForm>
                    <table border="0">
                        ...
                        <tr>
                            ...
                            <td>
                                <dxe:ASPxButtonEdit ID="txt_Pol" ClientInstanceName="txt_Pol" runat="server" Width="120" MaxLength="5"
                            ...
                            <td>Cont Type
                                ...
                                <td>
                                    <dxe:ASPxComboBox EnableIncrementalFiltering="True" runat="server" Width="120" ID="cbx_ContType"
                            ...
                            <EditForm>
                                <table style="border: solid 0px black;">
                                    ...
                                    <tr>
                                        ...
                                        <td>                                           
                                                <dxe:ASPxComboBox Width="80" ID="txt_det_Unit" ClientInstanceName="txt_det_Unit" DataSourceID="dsXXUom" ValueField="Code" ValueType="System.String"
                                                    TextField="Code" DropDownStyle="DropDown" runat="server" Value='<%# Bind("Unit") %>'>
                                                </dxe:ASPxComboBox>
                                        </td>
                                        <td>
                                            GstType
