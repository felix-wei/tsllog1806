<%@ Page Language="C#" AutoEventWireup="true" EnableViewState="false" CodeFile="Rate_Std.aspx.cs" Inherits="PagesQuote_Rate_Std" %>
    ...
    <form id="form1" runat="server">
        <div>
            <wilson:DataSource ID="dsQuotationDet" runat="server" ObjectSpace="C2.Manager.ORManager"
                TypeName="C2.SeaQuoteDet1" KeyMember="SequenceId" FilterExpression="QuoteId = '-1'" />
                    ...
                    <td colspan="6">
                        <dxwgv:ASPxGridView ID="grid_InvDet" ClientInstanceName="grid_det" runat="server"
                            ...
                            <Columns>
                                ...
                                <dxwgv:GridViewDataTextColumn Caption="ShipType" FieldName="ShipType" VisibleIndex="5"
                                    Width="30">
                                </dxwgv:GridViewDataTextColumn>
                            ...
                            <Templates>
                                <EditForm>
                                    <table style="border: solid 1px black;width:800px">
                                        <tr>
                                            <td width="100">Party To
                                            </td>
                                            <td width="100">
                                                <dxe:ASPxButtonEdit ID="txt_det_PartyToId" ClientInstanceName="txt_det_PartyToId" runat="server" Width="100%" HorizontalAlign="Left" AutoPostBack="False" Value='<%# Bind("PartyTo") %>'>
                                                    <Buttons>
                                            ...
                                            <td width="100">Ship Type
                                            </td>
                                            <td width="100">
                                                <dxe:ASPxComboBox Width="100%" ID="cmb_ShipType" ClientInstanceName="cmb_ShipType" IncrementalFilteringMode="StartsWith"
                                                    runat="server" Text='<%# Bind("ShipType") %>'>
                                                    <Items>
                                                        <dxe:ListEditItem Text="DIRECT" Value="DIRECT" />
                                                        <dxe:ListEditItem Text="COLOAD" Value="COLOAD" />
                                                        <dxe:ListEditItem Text="EXCHANGE CARGO" Value="EXCHANGE CARGO" />
                                                        <dxe:ListEditItem Text="NOMINATION" Value="NOMINATION" />
                                                    </Items>
                                                </dxe:ASPxComboBox>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <dxe:ASPxButtonEdit ID="txt_det_AgtId" ClientInstanceName="txt_det_AgtId" runat="server" Width="100%" HorizontalAlign="Left" AutoPostBack="False" Value='<%# Bind("AgentId") %>'>
                                                    <Buttons>
                                                        <dxe:EditButton Enabled="true" Text=".."></dxe:EditButton>
                                                    </Buttons>
                                                    <ClientSideEvents ButtonClick="function(s, e) {
                                                    PopupParty(txt_det_AgtId,txt_det_AgtName,'ACV');
                                                    }" />
                                                </dxe:ASPxButtonEdit>
                                            </td>
                                            <td colspan="4">
                                                <dxe:ASPxTextBox ID="txt_det_AgtName" ClientInstanceName="txt_det_AgtName" ReadOnly="true" BackColor="Control" Width="100%" runat="server">
                                                </dxe:ASPxTextBox>
                                            </td>
                                            <td>Pol
                                            </td>
                                            <td>
                                                <dxe:ASPxButtonEdit ID="txt_det_Pol" ClientInstanceName="txt_det_Pol" runat="server" MaxLength="5" Width="100%" HorizontalAlign="Left" AutoPostBack="False" Value='<%# Bind("Pol") %>'>
                                                    <Buttons>
                                                        <dxe:EditButton Enabled="true" Text=".."></dxe:EditButton>
                                                    </Buttons>
                                                    <ClientSideEvents ButtonClick="function(s, e) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <dxe:ASPxButtonEdit ID="txt_det_CarrierId" ClientInstanceName="txt_det_CarrierId" runat="server" Width="100%" HorizontalAlign="Left" AutoPostBack="False" Value='<%# Bind("CarrierId") %>'>
                                                    <Buttons>
                                                        <dxe:EditButton Enabled="true" Text=".."></dxe:EditButton>
                                                    </Buttons>
                                                    <ClientSideEvents ButtonClick="function(s, e) {
                                                    PopupParty(txt_det_CarrierId,txt_det_CarrierName,'ACV');
                                                    }" />
                                                </dxe:ASPxButtonEdit>
                                            </td>
                                            <td colspan="4">
                                                <dxe:ASPxTextBox ID="txt_det_CarrierName" ClientInstanceName="txt_det_CarrierName" ReadOnly="true" BackColor="Control" Width="100%" runat="server">
                                                </dxe:ASPxTextBox>
                                            </td>
                                            <td>Pod
                                            </td>
                                            <td>
                                                <dxe:ASPxButtonEdit ID="txt_det_Pod" ClientInstanceName="txt_det_Pod" runat="server" MaxLength="5" Width="100%" HorizontalAlign="Left" AutoPostBack="False" Value='<%# Bind("Pod") %>'>
                                                    <Buttons>
                                                        <dxe:EditButton Enabled="true" Text=".."></dxe:EditButton>
                                                    </Buttons>
                                                    <ClientSideEvents ButtonClick="function(s, e) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <dxe:ASPxButtonEdit ID="txt_det_CngId" ClientInstanceName="txt_det_CngId" runat="server" Width="100%" HorizontalAlign="Left" AutoPostBack="False" Value='<%# Bind("CngId") %>'>
                                                    <Buttons>
                                                        <dxe:EditButton Enabled="true" Text=".."></dxe:EditButton>
                                                    </Buttons>
                                                    <ClientSideEvents ButtonClick="function(s, e) {
                                                    PopupParty(txt_det_CngId,txt_det_CngName,'ACV');
                                                    }" />
                                                </dxe:ASPxButtonEdit>
                                            </td>
                                            <td colspan="4">
                                                <dxe:ASPxTextBox ID="txt_det_CngName" ClientInstanceName="txt_det_CngName" ReadOnly="true" BackColor="Control" Width="100%" runat="server">
                                                </dxe:ASPxTextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <dxe:ASPxComboBox Width="100%" ID="txt_det_Currency" ClientInstanceName="txt_det_Currency"
                                            ...
                                            <td>
                                                <dxe:ASPxComboBox Width="100%" ID="txt_det_Unit" ClientInstanceName="txt_det_Unit" 
                                            ...
                                            <td>
                                                <dxe:ASPxComboBox Width="100%" ID="txt_det_GstType" ClientInstanceName="txt_det_GstType"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <dxe:ASPxSpinEdit Increment="0" Width="100%" ID="spin_det_Amt" ClientInstanceName="spin_det_Amt"
                                                    DisplayFormatString="0.00" runat="server" Value='<%# Bind("Amt") %>'>
                                                    <SpinButtons ShowIncrementButtons="false" />
                                                </dxe:ASPxSpinEdit>
                                            </td>
                                        </tr>
