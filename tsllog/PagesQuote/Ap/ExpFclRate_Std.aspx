<%@ Page Language="C#" AutoEventWireup="true" EnableViewState="false" CodeFile="ExpFclRate_Std.aspx.cs" Inherits="PagesFreight_ApQuote_ExpFclRate_Std" %>
...
<body>
    ...
    <div>
        <wilson:DataSource ID="dsApQuotationDet" runat="server" ObjectSpace="C2.Manager.ORManager"
            TypeName="C2.SeaApQuoteDet1" KeyMember="SequenceId" FilterExpression="FclLclInd='Fcl' and QuoteId = '-1'" />
        <table>
            <tr>
                <td>
