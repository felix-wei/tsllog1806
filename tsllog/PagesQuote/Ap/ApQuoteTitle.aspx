<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ApQuoteTitle.aspx.cs" Inherits="PagesFreight_SeaApQuoteTitle" %>
...
<body>
    ...
    <div>
        <wilson:DataSource ID="dsApQuotationTitle" runat="server" ObjectSpace="C2.Manager.ORManager"
            TypeName="C2.SeaApQuoteTitle" KeyMember="SequenceId" />
        <table>
            <tr>
                <td>
            ...
            <tr>
                <td colspan="6">
                    <dxwgv:ASPxGridView ID="grid_InvDet" ClientInstanceName="grid_det" runat="server"
                        DataSourceID="dsApQuotationTitle" KeyFieldName="SequenceId" OnRowUpdating="grid_InvDet_RowUpdating"
