...
public partial class PagesFreight_ApQuote_ExpFclRate_Std : BasePage
{
    ...
    protected void btn_search_Click(object sender, EventArgs e)
    {
        ...
        this.dsApQuotationDet.FilterExpression = where;
    }
    ...
    protected void grid_InvDet_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
    {
        ...
        string sql_detCnt = "select max(QuoteLineNo) from SeaApQuoteDet1 where " + where;
