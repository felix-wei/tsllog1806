<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="ExpFclApQuote.aspx.cs"
    Inherits="PagesFreight_ExpFclApQuote" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function ShowQuo(invN) {
            window.location = 'ExpFclApQuoteEdit.aspx?no=' + invN;
        }
    </script>
...
<body width="800">
    ...
    <div>
        <wilson:DataSource ID="dsApQuotation" runat="server" ObjectSpace="C2.Manager.ORManager"
            TypeName="C2.SeaApQuote1" KeyMember="SequenceId" />
        <table border="0">
            <tr>
                <td>
                    Quotation No
                ...
                <td>
                    <asp:TextBox ID="txt_refNo" Width="200" runat="server"></asp:TextBox>
                </td>
                <td>
                    Party To
                </td>
        ...
        <dxwgv:ASPxGridView ID="ASPxGridView1" runat="server" DataSourceID="dsApQuotation"
            ...
            <Columns>
                ...
                <dxwgv:GridViewDataTextColumn Caption="20'" FieldName="Gp20" VisibleIndex="5">
                </dxwgv:GridViewDataTextColumn>
                <dxwgv:GridViewDataTextColumn Caption="40'" FieldName="Gp40" VisibleIndex="5">
                </dxwgv:GridViewDataTextColumn>
                <dxwgv:GridViewDataTextColumn Caption="40HC" FieldName="Hc40" VisibleIndex="5">
                </dxwgv:GridViewDataTextColumn>
            </Columns>
        </dxwgv:ASPxGridView>
