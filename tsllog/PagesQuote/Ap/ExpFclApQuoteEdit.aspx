<%@ Page Language="C#" AutoEventWireup="true" EnableViewState="false" CodeFile="ExpFclApQuoteEdit.aspx.cs" Inherits="PagesFreight_ExpFclApQuoteEdit" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
         function ImportStdRate() {
            ...
            popubCtr.SetContentUrl('/SelectPage/StdRateFclAp_multi.aspx?no=' + txt_Oid.GetText());
            popubCtr.Show();
        }
       function ImportDet() {
            popubCtr.SetHeaderText('Export Standard List');
            popubCtr.SetContentUrl('/SelectPage/ExpFclApQuoteList_Sea.aspx?id=' + txt_Oid.GetText());
            popubCtr.Show();
        }
            ...
            <tr>
                ...
                <td>
                    <table>
                     ...
                     window.location='ExpFclApQuoteEdit.aspx?no='+txtSchNo.GetText()
                        }" />
                                </dxe:ASPxButton>
                            </td>
                            <td>
                                <dxe:ASPxButton ID="ASPxButton1" Width="110" runat="server" Text="Add New" AutoPostBack="false">
                                    <ClientSideEvents Click="function(s, e) {
                     window.location='ExpFclApQuoteEdit.aspx?no=0'
                        }" />
                                </dxe:ASPxButton>
                            </td>
                                <td>
                                    <dxe:ASPxButton ID="ASPxButton3" Width="110" runat="server" Text="Go Search" AutoPostBack="false">
                                        <ClientSideEvents Click="function(s, e) {
                     window.location='ExpFclApQuote.aspx'
                        }" />
                                    </dxe:ASPxButton>
                                </td>
                        </tr>
                ...
                <EditForm>
                    <table border="0">
                        ...
                        <td colspan="6"><table><tr>
                            ...
                            <td>
                                <dxe:ASPxButton ID="ASPxButton2" runat="server" Visible="false" Text="Print"
                                    AutoPostBack="false" UseSubmitBehavior="false">
                                    <ClientSideEvents Click="function(s,e){
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2">
                                            <dxe:ASPxButtonEdit ID="txt_det_ChgCode" ClientInstanceName="txt_det_ChgCode" runat="server" Width="100%"
                                                ...
                                                <ClientSideEvents ButtonClick="function(s, e) {
                                                        PopupChgCode_Ap(txt_det_ChgCode,txt_det_ChgCodeDes,txt_det_Unit,txt_det_GstType,null,null,null);
                                                            }" />
                                            </dxe:ASPxButtonEdit>
                                        </td>
                                        <td>
