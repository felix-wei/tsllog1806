<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BankReceiptRptView.aspx.cs" Inherits="ReportAccount_Other_BankReceiptRptView" %>
...
<frameset runat="server" id="rptFrameset" cols="200,*" border="0" framespacing="2" bordercolor="#9B98B6">
	<frame name="schFrame" runat="server" id="schFrame" src="BankReceiptRpt.aspx" />
