<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BankPaymentRpt.aspx.cs" Inherits="ReportAccount_Other_BankPaymentRpt" %>
    ...
    <script type="text/javascript">
        function Print() {
            if (null == cmb_acCode.GetValue())
                ...
                parent.PrintReport('/ReportAccount/Rptprintview.aspx?doc=62&d1=' + frm.GetText() + '&d2=' + to.GetText() + '&p=' + cmb_acCode.GetValue());
        }
        function PrintExcel() {
            if (null == cmb_acCode.GetValue())
                alert("Please select the chart of account");
            else
                parent.PrintReport('/ReportAccount/Rptprintview.aspx?docType=1&doc=62&d1=' + frm.GetText() + '&d2=' + to.GetText() + '&p=' + cmb_acCode.GetValue());
        }
    </script>
