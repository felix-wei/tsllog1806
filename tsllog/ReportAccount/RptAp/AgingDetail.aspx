<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AgingDetail.aspx.cs" Inherits="ReportAccount_RptAp_AgingDetail" %>
    ...
    <script type="text/javascript">
        function Print() {
            if (cury.GetSelectedIndex() == 1 && rbt1.GetSelectedIndex() == 0) {
                parent.PrintReport('/ReportAccount/Rptprintview.aspx?doc=28&d1=' + frm.GetText() + '&d2=' + to.GetText() + '&cury=' + cury.GetSelectedIndex())
            } else if (cury.GetSelectedIndex() == 1 && rbt1.GetSelectedIndex() == 1) {
                parent.PrintReport('/ReportAccount/Rptprintview.aspx?doc=30&d1=' + frm.GetText() + '&d2=' + to.GetText() + '&cury=' + cury.GetSelectedIndex())
            } else {
            parent.PrintReport('/ReportAccount/Rptprintview.aspx?doc=24&d1=' + frm.GetText() + '&d2=' + to.GetText() + '&cury=' + cury.GetSelectedIndex())
        }
        }
        function ExportToExcel() {
            if (cury.GetSelectedIndex() == 1 && rbt1.GetSelectedIndex() == 0){
                parent.PrintReport('/ReportAccount/Rptprintview.aspx?docType=1&doc=28&d1=' + frm.GetText() + '&d2=' + to.GetText() + '&cury=' + cury.GetSelectedIndex())
            } else if (cury.GetSelectedIndex() == 1 && rbt1.GetSelectedIndex() == 1) {
                parent.PrintReport('/ReportAccount/Rptprintview.aspx?docType=1&doc=30&d1=' + frm.GetText() + '&d2=' + to.GetText() + '&cury=' + cury.GetSelectedIndex())
            } else 
                parent.PrintReport('/ReportAccount/Rptprintview.aspx?docType=1&doc=24&d1=' + frm.GetText() + '&d2=' + to.GetText() + '&cury=' + cury.GetSelectedIndex())
        }
    </script>
    </head>
<body>
