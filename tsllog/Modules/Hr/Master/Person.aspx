<%@ Page Language="C#" EnableViewState="false" AutoEventWireup="true" CodeFile="Person.aspx.cs" Inherits="Modules_Hr_Master_Person" %>
...
<head runat="server">
    ...
    <script>
        ...
        function PrintEmploymentProfile(id) {
            window.open('/Modules/Hr/Report/printview.aspx?document=Hr_EmploymentProfile&master=' + id);
        }
    </script>
</head>
<body>
        ...
        <div>
            ...
            <dxwgv:ASPxGridView ID="grid" runat="server" ClientInstanceName="grid" DataSourceID="dsPerson"
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Name" FieldName="Name" SortIndex="1" SortOrder="Ascending" VisibleIndex="1">
                    </dxwgv:GridViewDataTextColumn>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Status" FieldName="Status" VisibleIndex="2">
                        <DataItemTemplate>
							<%#  Eval("Status","{0}") == "EMPLOYEE" ? "" : "<span style='padding:2px;border:solid 1px black;background:orange;'>"+Eval("Status","{0}")+"</span>" %>
                        </DataItemTemplate>
                    </dxwgv:GridViewDataTextColumn>
                    ...
                    <dxwgv:GridViewDataTextColumn FieldName="ProbationToDate" Caption="Probation" VisibleIndex="5" Width="100">
                        <PropertiesTextEdit DisplayFormatString="dd/MM/yyyy"></PropertiesTextEdit>
                        <DataItemTemplate>
							<%# Eval("Status","{0}") != "EMPLOYEE" ? "" : ShowDateAlert(Eval("ProbationToDate"),14) %>
                        </DataItemTemplate>
                    </dxwgv:GridViewDataTextColumn>
                </Columns>
                ...
                <Templates>
                    <EditForm>
                        ...
                        <dxtc:ASPxPageControl ID="pageControl" runat="server" Width="1024" EnableCallBacks="true" BackColor="#F0F0F0" ActiveTabIndex="0">
                            <TabPages>
                                            ...
                                            <div style="padding: 4px 4px 3px 4px;">
                                                <table border="0">
                                                        ...
                                                        <td>
                                                            <table style="width: 100%">
                                                                <tr>
                                                                    ...
                                                                    <td>Is CPF</td>
                                                                    <td>
                                                                        <dxe:ASPxComboBox ID="cbb_IsCPF" runat="server" Value='<%# Eval("IsCPF")%>' Width="65">
                                                                            <Items>
                                                                                <dxe:ListEditItem Text="No " Value="No" />
                                                                                <dxe:ListEditItem Text="SC" Value="SC" />
                                                                                <dxe:ListEditItem Text="PR3" Value="PR3" />
                                                                                <dxe:ListEditItem Text="PR2" Value="PR2" />
                                                                                <dxe:ListEditItem Text="PR1" Value="PR1" />
                                                                            </Items>
                                                                        </dxe:ASPxComboBox>
                                                                    </td>
                                                                </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <dxe:ASPxComboBox runat="server" ID="txt_Race" Width="150" Value='<%# Eval("Race") %>'>
                                                                <Items>
                                                                    <dxe:ListEditItem Value="CHINESE" Text="CHINESE" />
                                                                    <dxe:ListEditItem Value="MALAY" Text="MALAY" />
                                                                    <dxe:ListEditItem Value="INDIAN" Text="INDIAN" />
                                                                </Items>
                                                            </dxe:ASPxComboBox>
                                                        </td>
                                                        <td>Religion：
                                                        ...
                                                        <td>
                                                            ...
                                                            <dxe:ASPxComboBox runat="server" ID="txt_Religion" Width="150" Value='<%# Eval("Religion") %>'>
                                                                <Items>
                                                                    <dxe:ListEditItem Value="BUDDHIST" Text="BUDDHIST" />
                                                                    <dxe:ListEditItem Value="CHRISTIAN" Text="CHRISTIAN" />
                                                                    <dxe:ListEditItem Value="ROMAN CATHOLIC" Text="ROMAN CATHOLIC" />
                                                                    <dxe:ListEditItem Value="MUSLIM" Text="MUSLIM" />
                                                                    <dxe:ListEditItem Value="HINDU" Text="HINDU" />
                                                                    <dxe:ListEditItem Value="FREE THINKER" Text="FREE THINKER" />
                                                                </Items>
                                                            </dxe:ASPxComboBox>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <asp:Panel runat="server" ID="divStatus2">
                                                            ...
                                                            <td>
                                                                <dxe:ASPxComboBox runat="server" EnableIncrementalFiltering="true" ID="cmb_Department" DropDownStyle="DropDown" DataSourceID="dsDepartment" TextField="Code" ValueField="Code" Width="150" Value='<%# Eval("Department")%>'>
                                                                </dxe:ASPxComboBox>
                                                            </td>
                                                            <td>Role
                                                            </td>
                                                            <td>
                                                                <dxe:ASPxComboBox runat="server" EnableIncrementalFiltering="true" ID="cmb_Role" DropDownStyle="DropDown" DataSourceID="dsRole" TextField="Code" ValueField="Code" Width="140" Value='<%# Eval("HrRole")%>'>
                                                                </dxe:ASPxComboBox>
                                                            </td>
                                                        </asp:Panel>
                                                    </tr>
													<tr>
                                                            ...
                                                            <td>
													<dxe:ASPxDateEdit ID="date_Date3" Width="150" runat="server" Value='<%# Eval("Date3")%>'
                                                               DisplayFormatString="dd" EditFormat="Custom" EditFormatString="dd/MM/yyyy">
                                                            </dxe:ASPxDateEdit>                                                            </td>
                                                    </tr>
                                                ...
                                                <dxwgv:ASPxGridView ID="gridPersonDet" ClientInstanceName="gridPersonDet" runat="server"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dxwgv:GridViewDataTextColumn Caption="Remark" FieldName="Remark" VisibleIndex="4" Visible="false">
                                                            <EditItemTemplate>
                                                    ...
                                                    <dxe:ASPxButton ID="ASPxButton17" Width="150" runat="server" Text="Add Contact"
                                                        Enabled='<%# SafeValue.SafeInt(Eval("Id"),0)>0 %>' AutoPostBack="false" UseSubmitBehavior="false">
                                                        <ClientSideEvents Click="function(s,e) {
                                                        gridPersonDet2.AddNewRow();
                                                        }" />
                                                    </dxe:ASPxButton>
                                                    <dxwgv:ASPxGridView ID="ASPxGridView1" runat="server" ClientInstanceName="gridPersonDet2" DataSourceID="dsPersonDet2"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <dxwgv:GridViewDataTextColumn Caption="Phone" FieldName="Phone" VisibleIndex="2" Width="80">
                                                            </dxwgv:GridViewDataTextColumn>
                                                            <dxwgv:GridViewDataTextColumn Caption="Mobile" FieldName="Mobile" VisibleIndex="2" Width="80">
                                                            </dxwgv:GridViewDataTextColumn>
                                                            <dxwgv:GridViewDataDateColumn  Caption="Dob" FieldName="Dob" VisibleIndex="3" Width="80" Visible="false">
                                                                <DataItemTemplate>
                                                                    <%# SafeValue.SafeDate(Eval("Dob"),DateTime.Today).ToString("dd/MM/yyyy") %>
                                                                </DataItemTemplate>
                                                            ...
                                                            <EditForm>
                                                                ...
                                                                <table>
                                                                    <tr>
                                                                        ...
                                                                        <td>Gender:</td>
                                                                        <td width="157">
                                                                            <dxe:ASPxComboBox ID="cbo_ContactGender" runat="server" Value='<%# Bind("Gender")%>' Width="150" DropDownStyle="DropDownList" >
                                                                                <Items>
                                                                                    <dxe:ListEditItem Text="MALE" Value="MALE" />
                                                                                    <dxe:ListEditItem Text="FEMALE " Value="FEMALE" />
                                                                                </Items>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <dxe:ASPxComboBox ID="txt_Relationship" runat="server" Value='<%# Bind("Relationship")%>' DropDownStyle="DropDown" Width="150" >
                                                                                <Items>
                                                                                    <dxe:ListEditItem Text="FATHER" Value="FATHER" />
                                                                                    <dxe:ListEditItem Text="MOTHER " Value="MOTHER" />
                                                                                    <dxe:ListEditItem Text="SON " Value="SON" />
                                                                                    <dxe:ListEditItem Text="DAUGHTER" Value="DAUGHTER" />
                                                                                    <dxe:ListEditItem Text="WIFE " Value="WIFE" />
                                                                                    <dxe:ListEditItem Text="HUSBAND " Value="HUSBAND" />
                                                                                    <dxe:ListEditItem Text="BROTHER " Value="BROTHER" />
                                                                                    <dxe:ListEditItem Text="SISTER " Value="SISTER" />
                                                                                </Items>
                                                                            </dxe:ASPxComboBox>
                                                                        </td>
                                                                    </tr>
                                                ...
                                                <dxe:ASPxButton ID="ASPxButton18" Width="150" runat="server" Text="Add Bank Account"
                                                    Enabled='<%# SafeValue.SafeInt(Eval("Id"),0)>0 %>' AutoPostBack="false" UseSubmitBehavior="false">
                                                    <ClientSideEvents Click="function(s,e) {
                                                        gridPersonDet3.AddNewRow();
                                                        }" />
                                                </dxe:ASPxButton>
                                                <dxwgv:ASPxGridView ID="ASPxGridView2" runat="server" ClientInstanceName="gridPersonDet3" DataSourceID="dsPersonDet3"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dxwgv:GridViewDataTextColumn Caption="IsPayroll" FieldName="IsPayroll" VisibleIndex="5" Width="80" Visible="false">
                                                        </dxwgv:GridViewDataTextColumn>
                                                    </Columns>
                                                    <Templates>
                                                        <EditForm>
                                                            ...
                                                            <table>
                                                                <tr>
                                                                    ...
                                                                    <td style="display:none">IsPayroll
                                                                    </td>
...
<%--                                                            <td>Department
                                                        ...
                                                        <td>
                                                            <dxe:ASPxComboBox ID="cmb_PassType" runat="server" Text='<%#Eval("PassType") %>' Width="150">
                                                                <Items>
                                                                    ...
                                                                    <dxe:ListEditItem Text="NRIC" Value="NRIC" />
                                                                </Items>
                                                            </dxe:ASPxComboBox>
                                                        </td>
                                                        <td style="display:none">PassNo</td>
                                                        <td  style="display:none">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <dxe:ASPxComboBox ID="cmb_DrivingType" runat="server" Text='<%#Eval("DrivingType") %>' Width="150">
                                                                <Items>
                                                                    <dxe:ListEditItem Text="No" Value="No" />
                                                                    <dxe:ListEditItem Text="Class2" Value="Class2" />
                                ...
                                <dxtc:TabPage Text="Family & Contact" Visible="false">
                                    <ContentCollection>
                                        <dxw:ContentControl>
                                            <div style="padding: 4px 4px 3px 4px;">
                                ...
                                <dxtc:TabPage Text="Pass/Certificate" Name="PassCertificate">
                                    <ContentCollection>
                                        <dxw:ContentControl>
                                            <dxe:ASPxButton ID="ASPxButton20" Width="100" runat="server" Text="Add New" AutoPostBack="false">
                                                <ClientSideEvents Click="function(s,e){
                                grid_pass.AddNewRow();
                                }" />
                                            </dxe:ASPxButton>
                                            <dxwgv:ASPxGridView ID="grid_pass" ClientInstanceName="grid_pass" runat="server" DataSourceID="dsPassCertificate" OnBeforePerformDataSelect="grid_pass_BeforePerformDataSelect"
                                                Width="100%" KeyFieldName="Id" AutoGenerateColumns="False" OnInit="grid_pass_Init" OnCellEditorInitialize="grid_pass_CellEditorInitialize"
                                                OnInitNewRow="grid_pass_InitNewRow" OnRowInserting="grid_pass_RowInserting" OnRowDeleting="grid_pass_RowDeleting" OnRowUpdating="grid_pass_RowUpdating"
                                                OnCustomCallback="grid_pass_CustomCallback"
                                                OnRowInserted="grid_pass_RowInserted">
                                                ...
                                                <Columns>
                                                    ...
                                                    <dxwgv:GridViewDataComboBoxColumn Caption="Employee" FieldName="Employee" VisibleIndex="0" Width="100" ReadOnly="true">
                                        ...
                                        <dxw:ContentControl ID="ContentControl8" runat="server">
                                            ...
                                            <dxwgv:ASPxGridView ID="grd_Photo" ClientInstanceName="grd_Photo" runat="server" DataSourceID="dsJobPhoto"
                                                ...
                                                <Columns>
                                                    ...
                                                    <dxwgv:GridViewDataTextColumn Caption="Category" FieldName="Category" Width="100"></dxwgv:GridViewDataTextColumn>
                                        ...
                                        <dxw:ContentControl>
                                            ...
                                            <div>
                                                <dxwgv:ASPxGridView ID="grid_Leave" runat="server" ClientInstanceName="grid_Leave" DataSourceID="dsLeave" OnRowInserting="grid_Leave_RowInserting"
                                                    ...
                                                    Width="1000px" OnInit="grid_Leave_Init" OnBeforePerformDataSelect="grid_Leave_BeforePerformDataSelect" OnRowInserted="grid_Leave_RowInserted" OnRowUpdated="grid_Leave_RowUpdated">
                                                    <SettingsPager Mode="ShowAllRecords">
                                                    </SettingsPager>
                                                    <SettingsEditing Mode="EditForm" />
                                                    <SettingsCustomizationWindow Enabled="True" />
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dxwgv:GridViewDataComboBoxColumn Caption="Leave Type" FieldName="LeaveType" VisibleIndex="4" Width="60">
                                                            <PropertiesComboBox DataSourceID="dsLeaveType" TextField="Description" ValueField="Code" ValueType="System.String"></PropertiesComboBox>
                                                        </dxwgv:GridViewDataComboBoxColumn>
                                                        <dxwgv:GridViewDataTextColumn Caption="Days" FieldName="Days" VisibleIndex="4" Width="60">
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn Caption="ApproveStatus" FieldName="ApproveStatus" UnboundType="String" VisibleIndex="5" Width="75">
                                                        </dxwgv:GridViewDataTextColumn>
                                                    </Columns>
                                                    <Styles Header-HorizontalAlign="Center">
                                                        <Header HorizontalAlign="Center"></Header>
                                                        ...
                                                        <EditForm>
                                                            <table>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <dxe:ASPxComboBox runat="server" EnableIncrementalFiltering="true" ID="cmb_LeaveType"
                                                                            DataSourceID="dsLeaveType" TextField="Description" ValueField="Code" Width="90" Value='<%# Bind("LeaveType")%>'>
                                                                        </dxe:ASPxComboBox>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                ...
                                                <div>
                                                    <dxe:ASPxButton ID="ASPxButton10" Width="150" runat="server" Text="Add Template"
                                                     ...
                                                     <dxe:ASPxButton ID="ASPxButton19" Width="150" runat="server" Text="Refresh"
                                                        Enabled='<%# SafeValue.SafeInt(Eval("Id"),0)>0&&SafeValue.SafeString(Eval("Status")).ToUpper()!="RESIGNATION" %>' AutoPostBack="false" UseSubmitBehavior="false">
                                                        <ClientSideEvents Click="function(s,e) {
                                                                grid_LeaveTmp.Refresh();
                                                                }" />
                                                    </dxe:ASPxButton>
                                                </div>
                                                <dxwgv:ASPxGridView ID="grid_LeaveTmp" ClientInstanceName="grid_LeaveTmp" runat="server" OnRowInserting="grid_LeaveTmp_RowInserting"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dxwgv:GridViewDataTextColumn Caption="Bal Days"  UnboundType="String" VisibleIndex="3" Width="75">
                                                           <DataItemTemplate>
                                                               <%# Eval("BalanceDays") %>
                                                           </DataItemTemplate>
                                                            <EditItemTemplate>
                                                        ...
                                                        <dxwgv:GridViewDataTextColumn Caption="Type" FieldName="LeaveType" VisibleIndex="4" Width="120">
                                                            <EditItemTemplate>
                                                                <dxe:ASPxComboBox runat="server" EnableIncrementalFiltering="true" ID="cmb_LeaveType"
                                                                    DataSourceID="dsLeaveType" TextField="Description" ValueField="Code" Width="140" Value='<%# Bind("LeaveType")%>'>
                                                                </dxe:ASPxComboBox>
                                                            </EditItemTemplate>
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn Caption="Remark" FieldName="Remark" VisibleIndex="5">
                                            ...
                                            <div>
                                                <dxwgv:ASPxGridView ID="grid_Quote" runat="server" ClientInstanceName="grid_Quote" DataSourceID="dsQuote"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dxwgv:GridViewDataComboBoxColumn Caption="PayItem" FieldName="PayItem" VisibleIndex="1" Width="150">
                                                        ...
                                                        <dxwgv:GridViewDataSpinEditColumn Caption="Amount" FieldName="Amt" UnboundType="String" VisibleIndex="2" Width="120">
                                                            <EditItemTemplate>
