<%@ Page Language="C#" EnableViewState="false" AutoEventWireup="true" CodeFile="AllPerson.aspx.cs" Inherits="Modules_Hr_Master_AllPerson" %>
...
<head runat="server">
    ...
    <script>
        ...
        function ConfirmStatusAndSave() {
            if (txt_Id.GetText() != '' && cmb_Type.GetText() != txt_OldStatus.GetText()) {
                var result = confirm('Confirm change this ' + txt_OldStatus.GetText() + ' to ' + cmb_Type.GetText() + ' ?');
                if (result) {
                    txt_OldStatus.SetText(cmb_Type.GetText());
                    grid.PerformCallback('Save');
                }
                else {
                    cmb_Type.SetText(txt_OldStatus.GetText());
                }
            }
        ...
        <div>
            ...
            <table width="450">
                <tr>
                    <td>Type</td>
                    <td>
                        <dxe:ASPxComboBox ID="txtSchStatus" ClientInstanceName="txtSchStatus" runat="server" Width="120">
                            <Items>
                    ...
                    <td>
                        <dxe:ASPxComboBox runat="server" EnableIncrementalFiltering="true" ID="txtSchName" ClientInstanceName="txtSchName" TextFormatString="{1}"
                            ...
                            DataSourceID="dsSchPerson" ValueField="Id" TextField="Name" Width="200" ValueType="System.Int32">
                            <Buttons>
                    ...
                    <td>
                        ...
                        window.location='AllPerson.aspx?name='+txtSchName.GetText();
                    }" />
                        </dxe:ASPxButton>
                    </td>
                    <td>
            ...
            <dxwgv:ASPxGridView ID="grid" runat="server" ClientInstanceName="grid" DataSourceID="dsPerson"
                KeyFieldName="Id" AutoGenerateColumns="False" OnLoad="grid_Load" OnCustomCallback="grid_CustomCallback" OnHtmlEditFormCreated="grid_HtmlEditFormCreated"
                Width="1000px" OnInit="grid_Init" OnInitNewRow="grid_InitNewRow" OnRowDeleting="grid_RowDeleting" OnCustomDataCallback="grid_CustomDataCallback">
                ...
                <Templates>
                    <EditForm>
                        ...
                        <div style="display: none">
                            ...
                            <dxe:ASPxTextBox ID="txt_OldStatus" ClientInstanceName="txt_OldStatus" runat="server" ReadOnly="true"
                                BackColor="Control" Text='<%# Eval("Status") %>' Width="150">
                            </dxe:ASPxTextBox>
                        </div>
                        ...
                        <table>
                            <tr>
                                ...
                                <td>Type</td>
                                <td>
                                    <dxe:ASPxComboBox ID="cmb_Type" ClientInstanceName="cmb_Type" runat="server" SelectedIndex="1" Value='<%# Eval("Status")%>' Width="120">
                                        <Items>
                                            <dxe:ListEditItem Text="EMPLOYEE" Value="EMPLOYEE" />
                                            <dxe:ListEditItem Text="CANDIDATE" Value="CANDIDATE" />
                                            <dxe:ListEditItem Text="RESIGNATION" Value="RESIGNATION" />
