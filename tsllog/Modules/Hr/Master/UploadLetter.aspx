<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UploadLetter.aspx.cs" Inherits="Page_Upload" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <dxe:ASPxLabel ID="lab" runat="server" Font-Bold="true" Font-Size="X-Large" ForeColor="Red">
            </dxe:ASPxLabel>
            <div style="display: none">
