<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Crews.aspx.cs" Inherits="Modules_Hr_Job_Crews" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        function PopupCrew(name,code, date1, date2) {
            clientId = name;
            clientName = code;
            popubCtr.SetContentUrl('/PagesHr/SelectPage/SelectDayCrew.aspx?DateFrom=' + date1.GetText() + "&DateTo=" + date2.GetText());
            popubCtr.SetHeaderText('Job No');
            popubCtr.Show();
        }
        ...
        function PrintPayment() {
            window.open("/ReportJob/PrintDailyPayment.aspx?DateFrom=" + txt_from.GetText() + "&DateTo=" + txt_from.GetText() + "&PayDate=" + txt_PayDate.GetText());
        }
...
<body>
    ...
    <table style="width:100%">
        <tr>
            ...
            <td width="50"><dxe:ASPxLabel ID="ASPxLabel2" runat="server" Text="PayDate">
                </dxe:ASPxLabel></td>
            <td width="100">
                            ...
                            <tr>
                                <td>
                                    <dxe:ASPxButton ID="btn_edit" runat="server" Text="Edit" Width="40" AutoPostBack="false"
                                        ClientSideEvents-Click='<%# "function(s) { grid.StartEditRow("+Container.VisibleIndex+") }"  %>'>
                                    </dxe:ASPxButton>
                                </td>
                                <td>
                ...
                <dxwgv:GridViewDataTextColumn Caption="Name" FieldName="Name" VisibleIndex="2" Width="120">
                    <EditItemTemplate>
                       <dxe:ASPxButtonEdit ID="btn_Name" ClientInstanceName="btn_Name" runat="server"
                            ...
                            <ClientSideEvents ButtonClick="function(s, e) {
                                                                            PopupCrew(btn_Name,txt_Code,date_JobDate,date_JobDate);
                                                                    }" />
                        </dxe:ASPxButtonEdit>
