<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StockSummary.aspx.cs" Inherits="Modules_Tpt_Report_StockInspection" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        function Print() {
            ...
            parent.PrintReport('/Modules/Tpt/Report/RptPrintView.aspx?docType=0&doc=stock_summary&no=' + no + '&d1=' + from + '&d2=0')
        }
        function ExportToExcel() {
            var no = cmb_PartyTo.GetValue();
            var from = frmDate.GetText();
            parent.PrintReport('/Modules/Tpt/Report/RptPrintView.aspx?docType=1&doc=stock_summary&no=' + no + '&d1=' + from + '&d2=0')
        }
    </script>
</head>
<body>
