<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LCLSchedule.aspx.cs" Inherits="Modules_Tpt_LCLSchedule" %>
        ...
        <div>
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <dxe:ASPxLabel ID="ASPxLabel4" runat="server" Text="WareHouse Status"></dxe:ASPxLabel>
                    </td>
                    <td>
                    ...
                    <td>
                        <dxe:ASPxLabel ID="ASPxLabel6" runat="server" Text="Trips Status"></dxe:ASPxLabel>
                    </td>
                    <td>
                        <dxe:ASPxComboBox ID="cbb_tripsStatus" runat="server" Width="100" DropDownStyle="DropDownList">
                            <Items>
                                <dxe:ListEditItem Text="ALL" Value="ALL" Selected="true" />
                                <dxe:ListEditItem Text="Start" Value="Start" />
                                <dxe:ListEditItem Text="Arrival" Value="Arrival" />
                                <dxe:ListEditItem Text="LCL-LD" Value="LCL-LD" />
                                <dxe:ListEditItem Text="LCL-MT" Value="LCL-MT" />
                                <dxe:ListEditItem Text="Depart" Value="Depart" />
                                <dxe:ListEditItem Text="Delivered" Value="Delivered" />
                                <dxe:ListEditItem Text="Returned" Value="Returned" />
                            </Items>
                        </dxe:ASPxComboBox>
                    </td>
                    <td>
                        <dxe:ASPxLabel ID="ASPxLabel5" runat="server" Text="Trip Type"></dxe:ASPxLabel>
                    </td>
                    <td>
                    ...
                    <dxe:ASPxButton ID="ASPxButton10" Width="60" runat="server" Text="Save"
            ...
            <dxwgv:ASPxGridView ID="grid_Transport" ClientInstanceName="detailGrid" runat="server" KeyFieldName="Id" Width="100%" AutoGenerateColumns="False" OnCustomDataCallback="grid_Transport_CustomDataCallback">
                ...
                <Columns>
                   <dxwgv:GridViewDataTextColumn Caption="Job No" FieldName="JobNo" FixedStyle="Left">
                    ...
                    <dxwgv:GridViewDataColumn FieldName="JobType" Caption="Job Type" FixedStyle="Left"></dxwgv:GridViewDataColumn>
                    <dxwgv:GridViewDataColumn FieldName="TripCode" Caption="Trip Type" FixedStyle="Left"></dxwgv:GridViewDataColumn>
                    ...
                    <dxwgv:GridViewDataColumn FieldName="Self_Ind" Caption="Self Delivery">
                        <DataItemTemplate>
                            <%# Eval("Self_Ind","{0}")=="Yes"?"X":""%>
                        </DataItemTemplate>
                    </dxwgv:GridViewDataColumn>
					<dxwgv:GridViewDataColumn Caption="Schedule" FieldName="BookingDate">
                        <DataItemTemplate>
                            <%# string.Format("{0:dd/MM/yyyy}",Eval("BookingDate")) %>
                        </DataItemTemplate>
					</dxwgv:GridViewDataColumn>
                    <dxwgv:GridViewDataColumn Caption="Time" FieldName="BookingTime"></dxwgv:GridViewDataColumn>
                    <dxwgv:GridViewDataColumn FieldName="StatusCode" Caption="T/P Status">
                        <DataItemTemplate>
                            <div style="background-color: <%# ShowColor(SafeValue.SafeString(Eval("StatusCode"))) %>" class="div_contStatus">
                                <%# Eval("StatusCode") %>
                            </div>
                            <div style="display:none">
                                 <dxe:ASPxLabel ID="lb_StatusCode" runat="server"  Value='<%# Bind("StatusCode") %>' ></dxe:ASPxLabel>
                            </div>
                        </DataItemTemplate>
                    </dxwgv:GridViewDataColumn>
                    <dxwgv:GridViewDataColumn FieldName="CfsStatus" Caption="W/H Status"></dxwgv:GridViewDataColumn>
                    <dxwgv:GridViewDataColumn FieldName="client" Caption="Client"></dxwgv:GridViewDataColumn>
                    <dxwgv:GridViewDataColumn FieldName="RequestTrailerType" Caption="Request Trailer"></dxwgv:GridViewDataColumn>
                    <dxwgv:GridViewDataColumn FieldName="TowheadCode" Caption="Vehicle No"></dxwgv:GridViewDataColumn>
                    <dxwgv:GridViewDataColumn FieldName="ChessisCode" Caption="Trailer No"></dxwgv:GridViewDataColumn>
                    <dxwgv:GridViewDataColumn FieldName="DriverCode" Caption="Driver No"></dxwgv:GridViewDataColumn>
                    <dxwgv:GridViewDataDateColumn FieldName="WarehouseScheduleDate" Caption="W/H ScheduleDate" PropertiesDateEdit-DisplayFormatString="dd/MM/yyyy">
                        <DataItemTemplate>
                            <%# SafeValue.SafeDateStr(Eval("WarehouseScheduleDate")) %>
                        </DataItemTemplate>
                    </dxwgv:GridViewDataDateColumn>
                    <dxwgv:GridViewDataDateColumn FieldName="DateIn" Caption="Start Date" PropertiesDateEdit-DisplayFormatString="dd/MM/yyyy">
                        <DataItemTemplate>
                            <%# SafeValue.SafeDateStr(Eval("DateIn")) %>
                        </DataItemTemplate>
                    </dxwgv:GridViewDataDateColumn>
                    <dxwgv:GridViewDataDateColumn FieldName="DateOut" Caption="Completion Date" PropertiesDateEdit-DisplayFormatString="dd/MM/yyyy">
                        <DataItemTemplate>
                            <%# SafeValue.SafeDateStr(Eval("DateOut")) %>
                        </DataItemTemplate>
                    </dxwgv:GridViewDataDateColumn>
                    <dxwgv:GridViewDataTextColumn FieldName="FromCode" Caption="From">
                        <DataItemTemplate>
                            <div style="min-width: 100px"><%# Eval("FromCode") %></div>
                        </DataItemTemplate>
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn FieldName="ToCode" Caption="To">
                        <DataItemTemplate>
                            <div style="min-width: 100px"><%# Eval("FromCode") %></div>
                        </DataItemTemplate>
                    </dxwgv:GridViewDataTextColumn>
                    ...
                    </dxwgv:GridViewDataDateColumn>WH Schedule/Start Date--%>
                   
                   <%-- <dxwgv:GridViewDataColumn Caption="Completion Date" FieldName="WarehouseEndDate">
					    <DataItemTemplate>
                            <%# string.Format("{0:dd/MMM}",Eval("WarehouseEndDate")) == "01/Jan" ? "" : string.Format("{0:dd/MMM HH:mm}",Eval("WarehouseEndDate")) %>
                        </DataItemTemplate>
					</dxwgv:GridViewDataColumn>--%>
                    ...
                    <dxwgv:GridViewDataColumn Caption="#">
                        <DataItemTemplate>
                            ...
                            <dxe:ASPxButton ID="btn_contStart" Width="60" Text="Start" runat="server" Visible='<%# (Eval("CfsStatus").Equals("Scheduled")||(Eval("StatusCode").Equals("Arrival")||Eval("StatusCode").Equals("Delivered"))) %>' AutoPostBack="false" >
                                <ClientSideEvents Click="function(s,e){rowStatusChange(s,e,'Started');}" />
                            </dxe:ASPxButton>
                            <dxe:ASPxButton ID="ASPxButton1" Width="60" Text="End" runat="server" Visible='<%# (Eval("CfsStatus").Equals("Started")) %>' AutoPostBack="false" >
                    ...
                    <dxwgv:GridViewDataColumn Caption="Schedule Date" FieldName="ScheduleStartDate">
                        <DataItemTemplate>
                            <table>
                                <tr>
                                    <td>
                                        <dxe:ASPxDateEdit ID="txt_search_dateFrom" OnInit="txt_search_dateFrom_Init" Value='<%# Bind("NewScheduleDate") %>' runat="server" Width="100" EditFormatString="dd/MM/yyyy" DisplayFormatString="dd/MM/yyyy"></dxe:ASPxDateEdit>
                                    </td>
                                    <td>
                                        <dxe:ASPxTextBox ID="date_ScheduleStartTime" runat="server" Text='<%# Bind("ScheduleStartTime") %>' Width="60">
                    ...
                    <dxwgv:GridViewDataColumn Caption="#">
                        <DataItemTemplate>
                            ...
                            <dxe:ASPxButton ID="btn_contStart" Width="60" Text="ReSchedule"  runat="server" Visible='<%# (!Eval("CfsStatus").Equals("Completed")) %>' AutoPostBack="false" >
                                <ClientSideEvents Click="function(s,e){ if(confirm('Confirm Re Schedule?')){rowStatusChange(s,e,'Scheduled');}}" />
                            </dxe:ASPxButton>
                        </DataItemTemplate>
                    </dxwgv:GridViewDataColumn>
                    <dxwgv:GridViewDataColumn Caption="#" FieldName="Id">
                        <DataItemTemplate>
                            <div style="display: none">
                                <dxe:ASPxLabel ID="lb_Id" runat="server" Value='<%# Bind("Id") %>'></dxe:ASPxLabel>
                            </div>
