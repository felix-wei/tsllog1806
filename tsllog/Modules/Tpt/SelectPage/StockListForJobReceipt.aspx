<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StockListForJobReceipt.aspx.cs" Inherits="Modules_Tpt_SelectPage_StockListForJobReceipt" %>
        ...
        <div>
            ...
            <dxwgv:ASPxGridView ID="grid_wh" ClientInstanceName="grid_wh" runat="server"
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Lot No/BL/Trailer" VisibleIndex="0" Width="180" SortIndex="1" SortOrder="Descending">
                        <DataItemTemplate>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Booking Info" VisibleIndex="2" Width="100">
                        <DataItemTemplate>
                        ...
                        <DataItemTemplate>
                            <table style="width: 160px">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <dxe:ASPxSpinEdit DisplayFormatString="0.000" runat="server" Width="80"
                                            ID="spin_WholeQty" Height="21px" Value='<%# Eval("BalPack") %>' DecimalPlaces="3" Increment="0">
                                            <SpinButtons ShowIncrementButtons="false" />
                                        </dxe:ASPxSpinEdit>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <dxe:ASPxSpinEdit DisplayFormatString="0.000" runat="server" Width="80"
                                            ID="spin_Weight" Height="21px" Value='<%# Eval("BalWeight") %>' DecimalPlaces="3" Increment="0">
                                            <SpinButtons ShowIncrementButtons="false" />
                                        </dxe:ASPxSpinEdit>
                                    </td>
                                     </tr>
                                <tr>
                                    ...
                                    <td>
                                        <dxe:ASPxSpinEdit DisplayFormatString="0.000" runat="server" Width="80"
                                            ID="spin_Volume" Height="21px" Value='<%# Eval("BalVolume")  %>' DecimalPlaces="3" Increment="0">
                                            <SpinButtons ShowIncrementButtons="false" />
                                        </dxe:ASPxSpinEdit>
                                    </td>
                                </tr>
