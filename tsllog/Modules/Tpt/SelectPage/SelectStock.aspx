<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SelectStock.aspx.cs" Inherits="Modules_Tpt_SelectPage_SelectStock" %>
...
<body>
    <form id="form1" runat="server">
        <div style="display:none">
            <dxe:ASPxLabel ID="lbl_warehouse"  runat="server" ClientInstanceName="lbl_warehouse"></dxe:ASPxLabel>
        </div>
        ...
        <div>
            ...
            <dxwgv:ASPxGridView ID="grid_wh" ClientInstanceName="grid_wh" runat="server"
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Job No" FieldName="JobNo" VisibleIndex="0" Width="150">
                        <DataItemTemplate>
                            <dxe:ASPxLabel ID="lbl_JobNo" runat="server" Text='<%# Eval("JobNo") %>' Width="80"></dxe:ASPxLabel>
                            <div style="display:none">
                                <dxe:ASPxLabel ID="lbl_RefNo" runat="server" Text='<%# Eval("RefNo") %>' Width="80"></dxe:ASPxLabel>
                            </div>
                        </DataItemTemplate>
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="Lot No/BL/Container" VisibleIndex="0" Width="150" SortIndex="1" SortOrder="Descending">
                        <DataItemTemplate>
