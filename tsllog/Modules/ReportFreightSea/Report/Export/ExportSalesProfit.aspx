    ...
    <script type="text/javascript">
        ...
        function Print() {
            ...
            if (tabInd == "0") {
                ...
                parent.PrintReport('/ReportFreightSea/Rptprintview.aspx?doc=6&type=E&docType=0&d1=' + frm + '&d2=' + to + '&p=' + party)
            } else if (tabInd == "1") {
                var party = cmb_Sales.GetValue();
                parent.PrintReport('/ReportFreightSea/Rptprintview.aspx?doc=7&type=E&docType=0&d1=' + frm + '&d2=' + to + '&p=' + party)
            }
        }
        function ExportToExcel() {
            ...
            if (tabInd == "0") {
                var party = cmb_Cust.GetValue();
                parent.PrintReport('/ReportFreightSea/Rptprintview.aspx?doc=6&type=E&docType=1&d1=' + frm + '&d2=' + to + '&p=' + party)
            } else if (tabInd == "1") {
                var party = cmb_Sales.GetValue();
                parent.PrintReport('/ReportFreightSea/Rptprintview.aspx?doc=7&type=E&docType=1&d1=' + frm + '&d2=' + to + '&p=' + party)
            }
        }
    </script>
