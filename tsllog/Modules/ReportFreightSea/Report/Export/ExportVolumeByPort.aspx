...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function Print() {
            ...
            parent.PrintReport('/ReportFreightSea/Rptprintview.aspx?doc=35&docType=0&d1=' + frm + '&d2=' + to + '&type=' + docType + '&p=' + party)
        }
        function ExportToExcel() {
            ...
            var frm = frmDate.GetText();
            var to = toDate.GetText();
            parent.PrintReport('/ReportFreightSea/Rptprintview.aspx?doc=35&docType=1&d1=' + frm + '&d2=' + to + '&type=' + docType + '&p=' + party)
        }
    </script>
