<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CraneTripReport_Claims.aspx.cs" Inherits="PagesContTrucking_Report_TripReport_Claims" %>
            ...
            <dxwgv:ASPxGridView ID="grid_Transport" ClientInstanceName="detailGrid" runat="server" Width="950px" KeyFieldName="Id" AutoGenerateColumns="False"
               OnCustomDataCallback="grid_Transport_CustomDataCallback"  >
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataColumn FieldName="DocNo" Caption="Doc No">
                        <DataItemTemplate>
                            <table>
                                <tr>
                                    <td>
