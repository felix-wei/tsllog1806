...
public partial class Job_CraneJobEdit : System.Web.UI.Page
{
...
BayCode,SubletFlag,StageCode,StageStatus,TripCode,Overtime,OverDistance,FromParkingLot,DoubleMounting) values ('{0}','{1}','','','{6}','{2}','{7}','{8}','{3}',getdate(),left(convert(nvarchar,getdate(),108),5),'{4}','P','','N','{5}','','{10}','Normal','N','{9}','No')", txt_JobNo.Text, btn_ContNo.Text, FromCode, "", txt_Id.Text, "", btn_ContNo.Text, FromDate, FromTime, FromPL, TripCode, btn_ContNo.Text);
    ...
    protected void grid_Trip_InitNewRow(object sender, DevExpress.Web.Data.ASPxDataInitNewRowEventArgs e)
    {
        ...
        e.NewValues["BookingDate"] = DateTime.Now;
        e.NewValues["FromDate"] = new DateTime(1900, 1, 1);
        e.NewValues["ToDate"] = new DateTime(1900, 1, 1);
        e.NewValues["BookingTime"] = DateTime.Now.ToString("HH:mm");
        e.NewValues["BookingTime2"] = DateTime.Now.ToString("HH:mm");
        e.NewValues["FromTime"] = "00:00";
        e.NewValues["ToTime"] = "00:00";
        ...
        e.NewValues["ByUser"] = HttpContext.Current.User.Identity.Name;
    ...
    private void Trip_Update(object sender, ASPxGridViewCustomDataCallbackEventArgs e,string jobType)
    {
        ...
        ASPxTextBox txt_RequestVehicleType = grd.FindEditFormTemplateControl("txt_RequestVehicleType") as ASPxTextBox;
        ...
        trip.RequestVehicleType = SafeValue.SafeString(txt_RequestVehicleType.Text);
        ...
        ASPxButtonEdit btn_ClientId = this.grid_job.FindEditFormTemplateControl("btn_ClientId") as ASPxButtonEdit;
        decimal otHour = SafeValue.SafeDecimal(txt_OtHour.Value, 0);
    ...
    private void OverTime(object sender, ASPxGridViewCustomDataCallbackEventArgs e)
    {
