<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AssignImportContainerList.aspx.cs" Inherits="Modules_Freight_Job_AssignImportContainerList" %>
    ...
    <script type="text/javascript">
        ...
        function save_list_inline_callback(res) {
            if (res.indexOf('Save Error') >= 0) {
                console.log('===========', res);
                //alert('Save Error');
                parent.notice('Save Error', '', 'success');
            } else {
        ...
        <div>
            ...
            <dxwgv:ASPxGridView ID="grid" ClientInstanceName="grid" runat="server" 
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="JobNo" FieldName="JobNo" Width="140px" VisibleIndex="0">
                        <DataItemTemplate>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Carrier" FieldName="CarrierId" Width="140px" VisibleIndex="3">
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="Eta" FieldName="EtaDate" Width="140px" VisibleIndex="3">
                        <DataItemTemplate>
                            <%# SafeValue.SafeDateStr(Eval("EtaDate")) %>
                            <div style="display:none">
                                <dxe:ASPxDateEdit ID="date_EtaDate" runat="server" Width="120px" Value='<%# Eval("EtaDate") %>'
                                EditFormat="Custom" EditFormatString="dd/MM/yyyy">
                            </dxe:ASPxDateEdit>
                            </div>
                        </DataItemTemplate>
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="Vali Date" FieldName="ValiDate" VisibleIndex="3" Width="120">
                        <DataItemTemplate>
                            <%--<%# SafeValue.SafeDateStr(Eval("TptDate")) %>--%>
                            <dxe:ASPxDateEdit ID="date_ValiDate" runat="server" Width="120px" Value='<%# Eval("ValiDate") %>'
                                EditFormat="Custom" EditFormatString="dd/MM/yyyy">
                            </dxe:ASPxDateEdit>
                        </DataItemTemplate>
                    </dxwgv:GridViewDataTextColumn>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Billing Date" FieldName="BillingDate" VisibleIndex="3" Width="120">
                        <DataItemTemplate>
                            <%--<%# SafeValue.SafeDateStr(Eval("TptDate")) %>--%>
                            <dxe:ASPxDateEdit ID="date_BillingDate" runat="server" Width="120px" Value='<%# Eval("BillingDate") %>'
                                EditFormat="Custom" EditFormatString="dd/MM/yyyy">
                            </dxe:ASPxDateEdit>
                        </DataItemTemplate>
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="WHS Date" FieldName="ScheduleStartDate" VisibleIndex="3" Width="120">
                        <DataItemTemplate>
                            <%--<%# SafeValue.SafeDateStr(Eval("TptDate")) %>--%>
                            <dxe:ASPxDateEdit ID="date_ScheduleStartDate" runat="server" Width="120px" Value='<%# Eval("ScheduleStartDate") %>'
                                EditFormat="Custom" EditFormatString="dd/MM/yyyy">
                            </dxe:ASPxDateEdit>
                        </DataItemTemplate>
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="Dispatch Date" FieldName="DispatchDate" VisibleIndex="3" Width="120">
                        <DataItemTemplate>
                            <%--<%# SafeValue.SafeDateStr(Eval("TptDate")) %>--%>
                            <dxe:ASPxDateEdit ID="date_DispatchDate" runat="server" Width="120px" Value='<%# Eval("DispatchDate") %>'
                                EditFormat="Custom" EditFormatString="dd/MM/yyyy">
                            </dxe:ASPxDateEdit>
                        </DataItemTemplate>
                    </dxwgv:GridViewDataTextColumn>
