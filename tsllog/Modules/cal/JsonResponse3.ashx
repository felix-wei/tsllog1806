<%@ WebHandler Language="C#" Class="JsonResponse3" %>
...
public class JsonResponse3 : IHttpHandler, IRequiresSessionState 
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        foreach (CalendarEvent cevent in EventDAO3.getEvents(start, end))
        {
