<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JobList.aspx.cs" Inherits="Modules_Client_JobList" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        function go_Job(jobno) {
            parent.navTab.openTab(jobno, "/Modules/Client/JobEdit.aspx?no=" + jobno, { title: jobno, fresh: false, external: true });
        }
                    ...
                    <td>
                        <table>
                            <tr>
                               ...
                               <td>
                                    <dxe:ASPxButton ID="btn_Add" runat="server" Text="New&nbsp;Booking" AutoPostBack="False">
