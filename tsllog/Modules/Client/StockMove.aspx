<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StockMove.aspx.cs" Inherits="Modules_Client_StockMove" %>
...
<form runat="server" id="form1">
        ...
        <table width="100%" cellspacing="0" cellpadding="0" style="border-bottom:solid #000000 1px;">
            <tr style="background-color: #999999; font-size: 18px; font-weight: bold; text-align: center">
                <td colspan="22">Stock Movement Report</td>
            </tr>
            <tr style="background-color: #CCCCCC; text-align: center">
                ...
                <td colspan="4" class="td_border_1">Incoming</td>
                <td colspan="4" class="td_border_1">Outgoing</td>
            ...
            <tr style="background-color: #CCCCCC; text-align: center">
                ...
                <td class="td_border_1" width="100">Pending</td>
                <td class="td_border_1" width="100">Date</td>
                <td class="td_border_1" width="100">Pallet</td>
            ...
            <tr>
                ...
                <td class="td_border_1"><%=SafeValue.SafeDecimal(tab.Rows[i]["InPending"]) %></td>
                ...
                <td class="td_border_1"><%=SafeValue.SafeDecimal(tab.Rows[i]["OutPending"]) %></td>
            ...
            <tr>
                ...
                <td class="td_border"><%=SafeValue.SafeDecimal(tab.Rows[i]["OutPending"]) %></td>
                <td class="td_border"></td>
