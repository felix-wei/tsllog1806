...
<link href="/Style/StyleSheet.css" rel="stylesheet" type="text/css" />
    <script type="text/javascript">
        ...
        function PrintMix() {
            var tabInd = rbt.GetValue();
            if (tabInd == "0") {//by chart of account
                parent.PrintReport('/ReportAccount/Rptprintview.aspx?doc=45b&d1=' + year.GetText() + '&d2=' + period.GetText() + '&d3=' + period1.GetValue() + '&p=' + cmb_acCode.GetValue())
        ...
        function PrintFull() {
            var tabInd = rbt.GetValue();
            if (tabInd == "0") {//by chart of account
                parent.PrintReport('/ReportAccount/Rptprintview.aspx?doc=45a&d1=' + year.GetText() + '&d2=' + period.GetText() + '&d3=' + period1.GetValue() + '&p=' + cmb_acCode.GetValue())
...
<body>
  ...
  <div>
        <table>
		<tr>
		<td colspan=3>Year / Period</td></tr>
            <tr>
                <td>
            ...
            <tr>
                <td>
                    <dxe:ASPxButton ID="ASPxButton1" runat="server" Text="Print By Page" Width="110" AutoPostBack="false">
            ...
            <tr>
                <td>
                    <dxe:ASPxButton ID="ASPxButton1b" runat="server" Text="Print Together" Width="110" AutoPostBack="false">
                        <ClientSideEvents Click="function(s,e){
                        PrintMix();
                        }" />
                    </dxe:ASPxButton>
            ...
            <tr>
                <td>
                    <dxe:ASPxButton ID="ASPxButton1a" runat="server" Text="Print Full" Width="110" AutoPostBack="false">
                        <ClientSideEvents Click="function(s,e){
                        PrintFull();
                        }" />
                    </dxe:ASPxButton>
