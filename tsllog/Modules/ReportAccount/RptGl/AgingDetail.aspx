    ...
    <script type="text/javascript">
        function Print() {
            if (cury.GetSelectedIndex() == 1 && rbt1.GetSelectedIndex() == 0) {
                parent.PrintReport('/ReportAccount/Rptprintview.aspx?doc=52&d1=' + frm.GetText() + '&d2=' + to.GetText() + '&cury=' + cury.GetSelectedIndex() + '&p=' + cmb_Salesman.GetValue())
            } else if (cury.GetSelectedIndex() == 1 && rbt1.GetSelectedIndex() == 1) {
                parent.PrintReport('/ReportAccount/Rptprintview.aspx?doc=53&d1=' + frm.GetText() + '&d2=' + to.GetText() + '&cury=' + cury.GetSelectedIndex() + '&p=' + cmb_Salesman.GetValue())
            } else {
            parent.PrintReport('/ReportAccount/Rptprintview.aspx?doc=51&d1=' + frm.GetText() + '&d2=' + to.GetText() + '&cury=' + cury.GetSelectedIndex() + '&p=' + cmb_Salesman.GetValue())
        }
        }
        function ExportToExcel() {
            if (cury.GetSelectedIndex() == 1 && rbt1.GetSelectedIndex() == 0)
                parent.PrintReport('/ReportAccount/Rptprintview.aspx?docType=1&doc=52&d1=' + frm.GetText() + '&d2=' + to.GetText() + '&cury=' + cury.GetSelectedIndex() + '&p=' + cmb_Salesman.GetValue())
            else if (cury.GetSelectedIndex() == 1 && rbt1.GetSelectedIndex() == 1)
                parent.PrintReport('/ReportAccount/Rptprintview.aspx?docType=1&doc=53&d1=' + frm.GetText() + '&d2=' + to.GetText() + '&cury=' + cury.GetSelectedIndex() + '&p=' + cmb_Salesman.GetValue())
            else
                parent.PrintReport('/ReportAccount/Rptprintview.aspx?docType=1&doc=51&d1=' + frm.GetText() + '&d2=' + to.GetText() + '&cury=' + cury.GetSelectedIndex() + '&p=' + cmb_Salesman.GetValue())
        }
    </script>
