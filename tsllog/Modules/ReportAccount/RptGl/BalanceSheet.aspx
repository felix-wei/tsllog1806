<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BalanceSheet.aspx.cs" Inherits="ReportAccount_RptGl_BalanceSheet" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>GL Balance Sheet</title>
...
<tr>
                <td>
                        ...
                        <ClientSideEvents Click="function(s, e) {
                                    parent.PrintReport('/ReportAccount/Rptprintview.aspx?doc=42&d1='+year.GetText()+'&d2='+period.GetText())
                                    }" />
                                </dxe:ASPxButton></td>
            </tr>
<tr>
                <td>
                        ...
                        <ClientSideEvents Click="function(s, e) {
                                    parent.PrintReport('/ReportAccount/Rptprintview.aspx?doc=42a&d1='+year.GetText()+'&d2='+period.GetText())
                                    }" />
                                </dxe:ASPxButton></td>
            </tr>
<tr>
                <td>
                                <dxe:ASPxButton ID="ASPxButton4" runat="server" Text="Export To Excel" Width="110" AutoPostBack="False" UseSubmitBehavior="False">
                        <ClientSideEvents Click="function(s, e) {
                                    parent.PrintReport('/ReportAccount/Rptprintview.aspx?docType=1&doc=42&d1='+year.GetText()+'&d2='+period.GetText())
                                    }" />
                                </dxe:ASPxButton></td>
            </tr>
        </table>
