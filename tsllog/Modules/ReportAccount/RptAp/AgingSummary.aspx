<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AgingSummary.aspx.cs" Inherits="ReportAccount_RptAp_AgingSummary" %>
    ...
    <script type="text/javascript">
        function Print() {
            if (cury.GetSelectedIndex() == 1 && rbt1.GetSelectedIndex() == 0) {
                parent.PrintReport('/ReportAccount/Rptprintview.aspx?doc=27&d1=' + frm.GetText() + '&d2=' + to.GetText() + '&cury=' + cury.GetSelectedIndex())
            } else if (cury.GetSelectedIndex() == 1 && rbt1.GetSelectedIndex() == 1) {
                parent.PrintReport('/ReportAccount/Rptprintview.aspx?doc=29&d1=' + frm.GetText() + '&d2=' + to.GetText() + '&cury=' + cury.GetSelectedIndex())
            } else {
                parent.PrintReport('/ReportAccount/Rptprintview.aspx?doc=23&d1=' + frm.GetText() + '&d2=' + to.GetText() + '&cury=' + cury.GetSelectedIndex())
            }
        }
        function ExportToExcel() {
            if (cury.GetSelectedIndex() == 1 && rbt1.GetSelectedIndex() == 0){
                parent.PrintReport('/ReportAccount/Rptprintview.aspx?docType=1&doc=27&d1=' + frm.GetText() + '&d2=' + to.GetText() + '&cury=' + cury.GetSelectedIndex())
            } else if (cury.GetSelectedIndex() == 1 && rbt1.GetSelectedIndex() == 1) {
                parent.PrintReport('/ReportAccount/Rptprintview.aspx?docType=1&doc=29&d1=' + frm.GetText() + '&d2=' + to.GetText() + '&cury=' + cury.GetSelectedIndex())
            }else
                parent.PrintReport('/ReportAccount/Rptprintview.aspx?docType=1&doc=23&d1=' + frm.GetText() + '&d2=' + to.GetText() + '&cury=' + cury.GetSelectedIndex())
        }
    </script>
