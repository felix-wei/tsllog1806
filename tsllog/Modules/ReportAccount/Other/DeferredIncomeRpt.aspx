<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DeferredIncomeRpt.aspx.cs" Inherits="ReportAccount_Other_DeferredIncomeRpt" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function Print() {
                parent.PrintReport('/ReportAccount/Rptprintview.aspx?doc=69&d1=' + frm.GetText() + '&d2=' + to.GetText());
        }
        function PrintExcel() {
                parent.PrintReport('/ReportAccount/Rptprintview.aspx?docType=1&doc=69&d1=' + frm.GetText() + '&d2=' + to.GetText());
        }
    </script>
