...
<body>
    ...
    <div>
        <table>
            ...
            <Items>
            <dxe:ListEditItem Text="Invoice" Value="SIN" />
            <dxe:ListEditItem Text="Credit Note" Value="SCN" />
            <dxe:ListEditItem Text="Debit Note" Value="SDN" />
            <dxe:ListEditItem Text="Receipt-RVC" Value="RVC" />
            <dxe:ListEditItem Text="Receipt-RVG" Value="RVG" />
            </Items>
            </dxe:ASPxComboBox>
            </td>
            </tr>
