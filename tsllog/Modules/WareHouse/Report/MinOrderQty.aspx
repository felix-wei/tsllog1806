                ...
                <dxwgv:ASPxGridView ID="grid" runat="server" ClientInstanceName="grid"
                    ...
                    <Columns>
                        ...
                        <dxwgv:GridViewDataTextColumn Caption="PKG" FieldName="pkg" VisibleIndex="6" Width="50" Visible="false">
                          ...
                          <dxwgv:GridViewDataTextColumn Caption="Grade" FieldName="Att4" VisibleIndex="6" Width="50" >
                              <DataItemTemplate>
                                <dxe:ASPxLabel ID="lbl_Att4" runat="server" Text='<%# Eval("Att4") %>'></dxe:ASPxLabel>
                            </DataItemTemplate>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="Color" FieldName="Att5" VisibleIndex="6" Width="50">
                            <DataItemTemplate>
                                <dxe:ASPxLabel ID="lbl_Att5" runat="server" Text='<%# Eval("Att5") %>'></dxe:ASPxLabel>
                            </DataItemTemplate>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="Size" FieldName="Att6" VisibleIndex="6" Width="50" >
                            <DataItemTemplate>
                                <dxe:ASPxLabel ID="lbl_Att6" runat="server" Text='<%# Eval("Att6") %>'></dxe:ASPxLabel>
                            </DataItemTemplate>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="Type" FieldName="Att7" VisibleIndex="6" Width="50" >
                            <DataItemTemplate>
                                <dxe:ASPxLabel ID="lbl_Att7" runat="server" Text='<%# Eval("Att7") %>'></dxe:ASPxLabel>
                            </DataItemTemplate>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="Clot1" FieldName="Att8" VisibleIndex="6" Width="50" >
                            <DataItemTemplate>
                                <dxe:ASPxLabel ID="lbl_Att8" runat="server" Text='<%# Eval("Att8") %>'></dxe:ASPxLabel>
                            </DataItemTemplate>
                        </dxwgv:GridViewDataTextColumn>
                        <dxwgv:GridViewDataTextColumn Caption="Att" FieldName="Att9" VisibleIndex="6" Width="50">
                            <DataItemTemplate>
