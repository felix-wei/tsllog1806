    ...
    <form id="form1" runat="server">
        ...
        <div>
                ...
                <tr>
                    ...
                    <td>
                        <dxe:ASPxButton ID="ASPxButton1" Width="100" runat="server" Text="Add New One" AutoPostBack="false">
                            <ClientSideEvents Click="function(s,e){
                                grid.AddNewRow();
                                }" />
                        </dxe:ASPxButton>
                    ...
                    <td>
                        <dxe:ASPxButton ID="ASPxButton2" Width="100" runat="server" Text="Auto 10 Pieces" AutoPostBack="false">
                            <ClientSideEvents Click="function(s,e){
                                   grid.GetValuesOnCustomCallback('Auto',OnCallBack);
                                }" />
                        </dxe:ASPxButton>
                    </td>
                    <td>&nbsp;</td>
            ...
            <div>
                <dxwgv:ASPxGridView ID="grid" runat="server" ClientInstanceName="grid" DataSourceID="dsLotNo"  
                    KeyFieldName="Id" AutoGenerateColumns="False" OnCellEditorInitialize="grid_CellEditorInitialize" OnCustomDataCallback="grid_CustomDataCallback"
