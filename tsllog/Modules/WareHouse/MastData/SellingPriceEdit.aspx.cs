...
public partial class WareHouse_MastData_SellingPriceEdit : System.Web.UI.Page
{
    ...
    protected void grid_SKULine_BeforePerformDataSelect(object sender, EventArgs e)
    {
        ...
        this.dsPriceDet.FilterExpression = "DoType= 'SQ' and DoNo='" + SafeValue.SafeString(txt_Id.Text, "") + "'";
    }
