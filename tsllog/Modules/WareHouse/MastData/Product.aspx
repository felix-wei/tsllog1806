        ...
        <div>
            ...
            <div>
                <dxwgv:ASPxGridView ID="grid" runat="server" ClientInstanceName="detailGrid" DataSourceID="dsProduct"
                    ...
                    Width="100%" OnInit="grid_Init" OnRowDeleting="grid_RowDeleting" OnPageIndexChanged="grid_PageIndexChanged">
...
<%--                        <dxwgv:GridViewDataTextColumn Caption="#" VisibleIndex="0" Width="80">
                        ...
                        <dxwgv:GridViewDataTextColumn Caption="Name" FieldName="Name" VisibleIndex="3" Width="150">
                         ...
                         <dxwgv:GridViewDataTextColumn Caption="Customer" VisibleIndex="3" Width="150">
                            <DataItemTemplate>
                                <%# GetPartyName(SafeValue.SafeString(Eval("PartyId"))) %>
                            </DataItemTemplate>
                        </dxwgv:GridViewDataTextColumn>
