<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchasePriceEdit.aspx.cs" Inherits="WareHouse_MastData_PurchasePriceEdit" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        function MultiplePickProduct() {
            ...
            popubCtr.SetContentUrl('../SelectPage/SelectPurchasePrice.aspx?Type=PQ&Sn=' + txt_DoNo.GetText());
            popubCtr.Show();
        }
        ...
        function OnSaveCallBack(v) {
            if (v != null && v.indexOf("Fail") > -1) {
                ...
                window.location = 'PurchasePrice.aspx?no=' + v;
        ...
        function PrintDo(doNo, doType) {
            if (doType == "PQ")
                window.open('/Modules/WareHouse/PrintView.aspx?document=wh_PQ&master=' + doNo + "&house=0");
        }
    </script>
</head>
<body>
  <form id="form1" runat="server">
       <wilson:DataSource ID="dsPrice" runat="server" ObjectSpace="C2.Manager.ORManager" TypeName="C2.WhTrans"
           KeyMember="Id" FilterExpression="DoType='PQ'" />
        ...
        <div>
            <table width="620">
                <tr>
                    ...
                    <td>
                        <dxe:ASPxTextBox ID="txt_SQNo" ClientInstanceName="txt_SQNo" ReadOnly="true" BackColor="Control" Width="200" runat="server" Style="margin-bottom: 0px">
                        </dxe:ASPxTextBox>
                    </td>
                    <td>
                        <dxe:ASPxButton ID="btn_Sch" Width="100" runat="server" Text="Retrieve">
                            <ClientSideEvents Click="function(s,e){
                        window.location='PurchasePriceEdit.aspx?no='+txt_SQNo.GetText();
                    }" />
                        </dxe:ASPxButton>
                    </td>
                    <td>
                        <dxe:ASPxButton ID="btn_Add" Width="100" runat="server" Text="Add New" AutoPostBack="false">
                            <ClientSideEvents Click="function(s,e){
                         window.location='PurchasePriceEdit.aspx?no=0';
                                                        }" />
                        </dxe:ASPxButton>
                    </td>
                    <td>
                        <dxe:ASPxButton ID="ASPxButton3" Width="100" runat="server" Text="Go Search" AutoPostBack="false"
                            ...
                            <ClientSideEvents Click="function(s,e) {
                                           window.location='PurchasePrice.aspx';
                        }" />
                        </dxe:ASPxButton>
                    </td>
                </tr>
                                    ...
                                    <tr>
                                        <td width="80%">
                                            <table style="border: solid 1px black; padding: 2px 2px 2px 2px; width: 80%">
                                                <tr>
                                                    <td>Print Document:
                                        <a href="#" onclick='PrintDo("<%# Eval("DoNo") %>","PQ")'>Purchase Price</a>
                                                    &nbsp;&nbsp;
                                                </tr>
                                            </table>
                                        </td>
