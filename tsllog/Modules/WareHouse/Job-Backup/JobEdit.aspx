                        ...
                        <div style="padding: 2px 2px 2px 2px">
                            ...
                            <dxtc:ASPxPageControl runat="server" ID="pageControl_Hbl" Width="960px" ActiveTabIndex="0">
                                <TabPages>
                                    ...
                                    <dxtc:TabPage Text="Survey Schedule" Visible="false" Name="SurveySchedule">
                                        <ContentCollection>
                                            <dxw:ContentControl ID="ContentControl_SurSch" runat="server">
                                            </dxw:ContentControl>
                                        </ContentCollection>
                                    </dxtc:TabPage>
...
<%--                                                        <dxwgv:GridViewDataTextColumn Caption="Supervisor/Crews" VisibleIndex="2" Width="40" CellStyle-VerticalAlign="Top" Visible="false">
                                                        ...
                                                        <dxwgv:GridViewDataTextColumn Caption="#" VisibleIndex="2" Width="40">
                                                            <DataItemTemplate>
                                                                <a onclick='javascript:PopubCrews("<%# Eval("JobNo") %>","<%# SafeValue.SafeDateStr(Eval("JobDate")) %>","Supervisor");' href="#">Supervisor</a><br /><a onclick='javascript:PopubCrews("<%# Eval("JobNo") %>","<%# SafeValue.SafeDateStr(Eval("JobDate")) %>","Casual");' href="#">Crews</a>
                                                            </DataItemTemplate>
                                                            <EditItemTemplate>
                                                                 <a onclick='javascript:PopubCrews("<%# Eval("JobNo") %>","<%# SafeValue.SafeDateStr(Eval("JobDate")) %>","Supervisor");' href="#">Supervisor</a><br /><a onclick='javascript:PopubCrews("<%# Eval("JobNo") %>","<%# SafeValue.SafeDateStr(Eval("JobDate")) %>","Casual");' href="#">Crews</a>
                                                            </EditItemTemplate>
                                               ...
                                               <table>
                                                    <tr>
                                                        <td>
                                                            <dxe:ASPxButton ID="ASPxButton5w" runat="server"  Visible="false" Text="Add New Warehouse Schedule" AutoPostBack="false"
                                                                UseSubmitBehavior="false" Enabled='<%# SafeValue.SafeString(Eval("JobStatus"),"")!="Closed" %>'>
                                                                <ClientSideEvents Click="function(s,e) {
                                                                   grid_warehouse.AddNewRow();
                                                                 }" />
                                                            </dxe:ASPxButton>
                                                        </td>
                                                         <td>
                                                            <dxe:ASPxButton ID="ASPxButton10w" runat="server" Text="Refresh" AutoPostBack="false"
                                                                UseSubmitBehavior="false" Enabled='<%# SafeValue.SafeString(Eval("JobStatus"),"")!="Closed" %>'>
                                                                <ClientSideEvents Click="function(s,e) {
                                                                   grid_warehouse.Refresh();
                                                                 }" />
                                                            </dxe:ASPxButton>
                                                        </td>
                                                    </tr>
                                                ...
                                                <dxwgv:ASPxGridView ID="grid_warehouse" ClientInstanceName="grid_warehouse" runat="server"
                                                    KeyFieldName="Id" Width="1800px" AutoGenerateColumns="False" DataSourceID="dsInventory"
                                                    OnBeforePerformDataSelect="grid_warehouse_BeforePerformDataSelect" OnInit="grid_warehouse_Init" OnInitNewRow="grid_warehouse_InitNewRow"
                                                    OnRowInserting="grid_warehouse_RowInserting" OnRowDeleting="grid_warehouse_RowDeleting" OnRowUpdating="grid_warehouse_RowUpdating">
                                                    <SettingsPager Mode="ShowAllRecords"></SettingsPager>
                                                    <SettingsEditing Mode="Inline" />
                                                    <SettingsText Title="Warehouse Schedule" />
                                                    <Columns>
                                                        <dxwgv:GridViewDataColumn Caption="#" VisibleIndex="0" Width="40">
                                                            <DataItemTemplate>
                                                                <table>
                                                                    <tr>
                                                                        <td>
                                                                            <dxe:ASPxButton ID="btn_edit" runat="server" Text="Edit" Width="40" AutoPostBack="false"
                                                                                ClientSideEvents-Click='<%# "function(s) { grid_warehouse.StartEditRow("+Container.VisibleIndex+") }"  %>'>
                                                                            </dxe:ASPxButton>
                                                                        </td>
                                                            ...
                                                            <EditItemTemplate>
                                                                <table>
                                                                    <tr>
                                                                        <td>
                                                                            <dxe:ASPxButton ID="btn_update" runat="server" Text="Update" Width="40" AutoPostBack="false" Enabled='<%# SafeValue.SafeString(Eval("JobStatus"),"")!="Closed" %>'
                                                                                ClientSideEvents-Click='<%# "function(s) { grid_warehouse.UpdateEdit() }"  %>'>
                                                                            </dxe:ASPxButton>
                                                                        </td>
                                                                        <td>
                                                                            <dxe:ASPxButton ID="btn_cancel" runat="server" Text="Cancel" Width="40" AutoPostBack="false"
                                                                                ClientSideEvents-Click='<%# "function(s) { grid_warehouse.CancelEdit() }"  %>'>
                                                                            </dxe:ASPxButton>
                                                                        </td>
                                                                    </tr>
                                                                </table>
 ...
 <dxwgv:GridViewDataComboBoxColumn  Caption="In/Out" FieldName="DoType" VisibleIndex="1" Width="150">
                                                            <PropertiesComboBox Width="100">
                                                                <Items>
                                                                    <dxe:ListEditItem Text="To Warehouse" Value="WI" />
                                                                    <dxe:ListEditItem Text="From Warehouse" Value="WO" />
                                                        ...
                                                        <dxwgv:GridViewDataDateColumn Caption="Schedule Date" FieldName="Date1" VisibleIndex="2" Width="140" SortIndex="0" SortOrder="Descending">
                                                        ...
                                                        <dxwgv:GridViewDataTextColumn Caption="Vessel" FieldName="Note1" VisibleIndex="1" Width="100">
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn Caption="Cont No" FieldName="Note2" VisibleIndex="1" Width="100">
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn Caption="Seal No" FieldName="Note3" VisibleIndex="1" Width="100">
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn Caption="ContType" FieldName="Note4" VisibleIndex="1" Width="100">
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn Caption="Carrier" FieldName="Note5" VisibleIndex="1" Width="100">
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn Caption="Port" FieldName="Note6" VisibleIndex="1" Width="100">
                                                        </dxwgv:GridViewDataTextColumn>
                                                   ...
                                                   <SettingsDetail  ShowDetailRow="true" ShowDetailButtons="true"/>
                                                    <Templates>
                                                        <DetailRow>
                                                            <dxwgv:ASPxGridView ID="grid_img_W" ClientInstanceName="grid_img_W" runat="server" DataSourceID="dsItemRImg" 
                                                                KeyFieldName="Id" Width="900px" EnableRowsCache="False" OnBeforePerformDataSelect="grid_img_W_BeforePerformDataSelect"
                                                                AutoGenerateColumns="false" OnRowDeleting="grid_img_W_RowDeleting" OnInit="grid_img_W_Init" OnInitNewRow="grid_img_W_InitNewRow" OnRowUpdating="grid_img_W_RowUpdating">
                                                                <SettingsPager Mode="ShowAllRecords"></SettingsPager>
                                                                <Columns>
                                                                    <dxwgv:GridViewDataColumn Caption="#" Width="40px">
                                                                        <DataItemTemplate>
                                                                            <dxe:ASPxButton ID="btn_mkg_del" runat="server"
                                                                                Text="Delete" Width="40" AutoPostBack="false" ClientSideEvents-Click='<%# "function(s) { if(confirm(\"Confirm Delete\")){grid_img_W.DeleteRow("+Container.VisibleIndex+") }}"  %>'>
                                                                            </dxe:ASPxButton>
                                                                        </DataItemTemplate>
                                                                    </dxwgv:GridViewDataColumn>
                                    ...
                                    <dxtc:TabPage Text="Warehouse Schedule" Visible="false" Name="WarehouseSchedule">
                                        <ContentCollection>
                                            <dxw:ContentControl ID="ContentControl_WhsSch" runat="server">
...
<dxe:ASPxComboBox EnableIncrementalFiltering="True" Width="60" ID="cmb_Unit" Text='<%# Bind("Unit") %>'
    ...
    border-right: solid 1px #9B9A96;">New</td>
                                    ...
                                    <dxtc:TabPage Text="Warehouse" Visible="false" Name="Warehouse">
                                        <ContentCollection>
                                            <dxw:ContentControl>
                                                <table>
                                                    <tr>
                                            ...
                                            detailGrid.GetValuesOnCustomCallback('AddDoIn',OnDoInCallBack);           
                                                ...
                                                <dxwgv:ASPxGridView ID="grid_DoIn" ClientInstanceName="grid_DoIn"
                                                    ...
                                                    <Columns>
														...
														<dxwgv:GridViewDataTextColumn Caption="Type" FieldName="DoType" VisibleIndex="6" Width="50">
                                                        </dxwgv:GridViewDataTextColumn>
                                                        ...
                                                        <dxwgv:GridViewDataTextColumn Caption="RefDate" FieldName="CustomerDate" VisibleIndex="6" Width="80" Visible="false">
