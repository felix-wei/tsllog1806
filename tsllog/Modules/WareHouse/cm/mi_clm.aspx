<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mi_clm.aspx.cs" Inherits="WareHouse_Job_Mi_CLM" %>
...
<body>
    <form id="form1" runat="server">
                ...
                KeyMember="SequenceId" FilterExpression="PartyId='8006' OR PartyId='8014'"  />
             ...
             <dxwgv:ASPxGridView ID="grid" ClientInstanceName="grid" runat="server" DataSourceID="dsStock" 
                ...
                <Columns>
                 ...
                 <dxwgv:GridViewDataComboBoxColumn Caption="Item Code" Width="80" FieldName="Code" VisibleIndex="2" >
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Qty" FieldName="TotalNew" VisibleIndex="2" Width="80">
					<DataItemTemplate>
						<%# Eval("Qty","{0:0}") %>
					</DataItemTemplate>
					</dxwgv:GridViewDataTextColumn>
					...
					<dxwgv:GridViewDataComboBoxColumn Visible="false" Caption="Supplier" Width="80" FieldName="PartyTo" VisibleIndex="2" >
                ...
                <Settings ShowFooter="True" />
                 <TotalSummary>
                     ...
                     <dxwgv:ASPxSummaryItem  FieldName="TotalNew" DisplayFormat="{0}" SummaryType="Sum"/>
