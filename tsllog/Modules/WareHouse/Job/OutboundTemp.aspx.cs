...
public partial class WareHouse_Job_OutboundTemp : System.Web.UI.Page
{
    protected void Page_Init()
    {
        if (!IsPostBack)
        {
            ...
            {
                string sql = string.Format(@"select count(*) from JobInfo where JobType='OBTemp'");
                ...
                {
                    Session["SoWhere"] = "JobType='OBTemp'";
