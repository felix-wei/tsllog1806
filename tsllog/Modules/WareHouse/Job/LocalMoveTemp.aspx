<%@ Page Language="C#" EnableViewState="false" AutoEventWireup="true" CodeFile="LocalMoveTemp.aspx.cs" Inherits="WareHouse_Job_LocalMoveTemp" %>
    ...
    <script type="text/javascript">
        function OnSaveCallBack(v) {
            if (v != null && v.indexOf("Fail") > -1) {
                ...
                window.location = 'LocalMoveTemp.aspx?no=' + v;
            }
        }
