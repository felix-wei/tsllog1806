...
public partial class WareHouse_Job_Mr_SPJ : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
           ...
           // where += "CONVERT(varchar(100), DocDate, 23) between '" + txt_date.Date.ToString("yyyy-MM-dd")
            ...
            this.dsStock.FilterExpression = " DocOwner='SPJ' and DoType='RT3'";
        }
    }
    protected void btn_search_Click(object sender, EventArgs e)
    {
       ...
       // if (where.Length > 0)
        //{
            where += " DocOwner='SPJ' and DoType='RT3' ";
       // }
