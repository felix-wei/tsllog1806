<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DoOutList.aspx.cs" Inherits="WareHouse_Job_DoOutList" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        function ShowHouse(masterId) {
            parent.navTab.openTab(masterId, "/Modules/WareHouse/Job/DoOutEdit.aspx?no=" + masterId + '&t=' + lbl_t.GetText(), { title: masterId, fresh: false, external: true });
        ...
        <div>
            ...
            <dxwgv:ASPxGridView ID="grid" ClientInstanceName="detailGrid" runat="server"
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="SO No" FieldName="PoNo" VisibleIndex="6"  Width="100">
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="SO Date" FieldName="PoDate" VisibleIndex="2" Width="60">
