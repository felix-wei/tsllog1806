...
public partial class WareHouse_Job_InboundTemp : System.Web.UI.Page
{
    protected void Page_Init()
    {
        if (!IsPostBack)
        {
            ...
            {
                string sql = string.Format(@"select count(*) from JobInfo where JobType='IBTemp'");
                ...
                {
                    Session["SoWhere"] = "JobType='IBTemp'";
