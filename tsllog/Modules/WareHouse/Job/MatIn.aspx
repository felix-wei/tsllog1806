<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MatIn.aspx.cs" Inherits="WareHouse_Job_MatIn" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        function PopubMaterials(jobNo, company) {
            ...
            popubCtr.SetContentUrl('/Modules/WareHouse/SelectPage/AddCMMaterials.aspx?no=' + jobNo + '&type=OUT3&company=' + company);
            popubCtr.Show();
        }
   ...
   <form id="form1" runat="server">
        ...
        <div>
             ...
             <dxwgv:ASPxGridView ID="grid" ClientInstanceName="grid" runat="server" DataSourceID="dsJobSchedule" OnRowUpdating="grid_RowUpdating" OnRowInserting="grid_RowInserting" OnInitNewRow="grid_InitNewRow"
                ...
                <Columns>
                     <dxwgv:GridViewCommandColumn Caption="#" VisibleIndex="0" Width="40" Visible="false">
                        <EditButton Visible="false" Text="Edit"></EditButton>
                    ...
                    <dxwgv:GridViewDataComboBoxColumn Caption="Company Name" FieldName="OriginAdd" VisibleIndex="2" Width="100">
                        <PropertiesComboBox Width="100">
                            <Items>
                                <dxe:ListEditItem Text="CM" Value="CM" />
                            </Items>
                        </PropertiesComboBox>
                    </dxwgv:GridViewDataComboBoxColumn>
                    <dxwgv:GridViewDataTextColumn Caption="Suppiler" FieldName="CustomerName" VisibleIndex="2" Width="120">
                          <DataItemTemplate>
                            <%# Eval("CustomerName") %>
                        </DataItemTemplate>
                        <EditItemTemplate>
                            <dxe:ASPxMemo ID="memo_Origin" runat="server" Text='<%# Bind("CustomerName") %>' Rows="2" Width="120"></dxe:ASPxMemo>
                        </EditItemTemplate>
                    </dxwgv:GridViewDataTextColumn>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Pay Ref" FieldName="Value3" Width="80" VisibleIndex="2">
                        <DataItemTemplate>
                            <%# Eval("Value3") %>
                        </DataItemTemplate>
                        <EditItemTemplate>
                    ...
                    <dxwgv:GridViewDataDateColumn Caption="Pay Date" FieldName="DateTime3" VisibleIndex="2" Width="80">
                        <PropertiesDateEdit Width="100" DisplayFormatString="dd/MM/yyyy" EditFormat="DateTime" EditFormatString="dd/MM/yyyy"></PropertiesDateEdit>
                    </dxwgv:GridViewDataDateColumn>
                    ...
                    <dxwgv:GridViewDataDateColumn Caption="Whs Remark" FieldName="Value5" VisibleIndex="4">
                        ...
                        <EditItemTemplate>
                            <dxe:ASPxMemo ID="memo_Value5" runat="server" Text='<%# Bind("Value5") %>' Rows="2" Width="120"></dxe:ASPxMemo>
                        </EditItemTemplate>
                    </dxwgv:GridViewDataDateColumn>
                </Columns>
            ...
            <dxpc:ASPxPopupControl ID="popubCtr" runat="server" CloseAction="CloseButton" Modal="True"
                ...
                AllowResize="True" Width="600px" EnableViewState="False">
            </dxpc:ASPxPopupControl>
            <dxpc:ASPxPopupControl ID="popubCtr1" runat="server" CloseAction="CloseButton" Modal="True"
                PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" ClientInstanceName="popubCtr1"
                HeaderText="Customer" AllowDragging="True" EnableAnimation="False" Height="500px"
                AllowResize="True" Width="500px" EnableViewState="False">
            </dxpc:ASPxPopupControl>
        </div>
    </form>
</body>
