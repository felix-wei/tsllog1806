<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StockIn.aspx.cs" Inherits="WareHouse_Job_StockIn" %>
...
<body>
    <form id="form1" runat="server">
        <wilson:DataSource ID="dsInventory" runat="server" ObjectSpace="C2.Manager.ORManager"
            TypeName="C2.JobInventory" KeyMember="Id" FilterExpression="DoType='WI'" />
