...
<head runat="server">
    ...
    <script type="text/javascript">
        function OnCallBack(v) {
            ...
            else if(v=="Return")
            {
            ...
            else if (v == "No Costing") {
                alert("No Costing,Not Close");
            }
           else if (v != null && v.indexOf("Fail") > -1) {
                alert(v+"Had Costing");
            }
           else if (v == "Costing") {
               alert("Action Success!");
               grid_Cost.Refresh();
                ...
                window.location = 'DoOutEdit.aspx?no=' + v;
            }
        }
        function Refresh() {
            grid_PickDetail.Refresh();
        ...
        function MultipleAdd() {
            ...
            popubCtr.SetContentUrl('../selectpage/SelectPoductFromStock.aspx?Type=OUT&Sn=' + txt_DoNo.GetText() + '&WhId=' + txt_WareHouseId.GetText() + "&partyId=" + txt_ConsigneeCode.GetText());
            popubCtr.Show();
        }
        ...
        function Multiple_AddPick() {
            ...
            popubCtr.SetContentUrl('../SelectPage/ProductList_do.aspx?typ=out&Sn=' + txt_DoNo.GetText());
            popubCtr.Show();
        }
                ...
                <tr>
                    ...
                    <td>
                        <dxe:ASPxButton ID="ASPxButton3" Width="100" runat="server" Text="Go Search" AutoPostBack="false"
                            ...
                            <ClientSideEvents Click="function(s,e) {
                                           window.location='DoOutList.aspx';
                        }" />
                        </dxe:ASPxButton>
                    </td>
                     <td>
                        <dxe:ASPxButton ID="btn_Add" Width="100" runat="server" Text="Add New" AutoPostBack="false">
                            <ClientSideEvents Click="function(s,e){
                        window.location='DoOutEdit.aspx?no=0';
                                                        }" />
                        </dxe:ASPxButton>
                    </td>
                </tr>
                        ...
                        <div style="padding: 2px 2px 2px 2px">
                            <table style="text-align: left; padding: 2px 2px 2px 2px; width: 900px">
                                <tr>
                                    ...
                                    <td>
                                        <dxe:ASPxButton ID="btn_CreateCosting" Width="150" runat="server" Text="Create Costing" Enabled='<%# SafeValue.SafeInt(Eval("Id"),0)>0 &&SafeValue.SafeString(Eval("StatusCode"),"USE")=="USE"%>'
                                            AutoPostBack="false" UseSubmitBehavior="false">
                                            <ClientSideEvents Click="function(s,e) {
                                                        detailGrid.GetValuesOnCustomCallback('Costing',OnCallBack);
                                                        }" />
                                        </dxe:ASPxButton>
                                    </td>
                                    <td>
                            ...
                            <table>
                                    ...
                                    <td>
                                        <dxe:ASPxComboBox EnableIncrementalFiltering="True" Width="150" ID="cmb_Priority"
                                            ...
                                            <Items>
                                                ...
                                                <dxe:ListEditItem Text="REMOVAL-EXP" Value="REMOVAL-EXP" />
                                                <dxe:ListEditItem Text="DUTY" Value="DUTY" />
                                        </Items>
                                        </dxe:ASPxComboBox>
                                    </td>
                                    <td>Date</td>
                                    <td>
                                        <dxe:ASPxDateEdit ID="date_IssueDate" Width="150" runat="server" Value='<%# Eval("DoDate") %>'
                                        ...
                                        <table cellpadding="0" cellspacing="0">
                                            <td width="94">
                                                <dxe:ASPxButtonEdit ID="txt_ConsigneeCode" ClientInstanceName="txt_ConsigneeCode" runat="server"
                                                    ...
                                                    <ClientSideEvents ButtonClick="function(s, e) {
                                                                            PopupParty(txt_ConsigneeCode,txt_ConsigneeName,null,null,null,null,txt_PostalCode,memo_Address,txt_Country,txt_City,'C');
                                                                    }" />
                                                </dxe:ASPxButtonEdit>
                                            </td>
                                            <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                     ...
                                     <td>Status</td>
                                    <td>
                                        <dxe:ASPxComboBox EnableIncrementalFiltering="True" DataSourceID="dsOutStatus" Width="150" ID="cmb_Status"
                                            runat="server" Text='<%# Eval("DoStatus") %>' TextField="Code" ValueField="Code" DropDownStyle="DropDown">
                                        </dxe:ASPxComboBox>
                                    </td>
                                     <td>EQ. No</td>
                                    <td>
                                        <dxe:ASPxComboBox EnableIncrementalFiltering="True" Width="100%" DataSourceID="dsEquipmentNo" ID="cmb_EquipmentNo"
                                            runat="server" TextField="Code" ValueField="Code" ValueType="System.String" Text='<%# Eval("EquipNo") %>' DropDownStyle="DropDown">
                                        </dxe:ASPxComboBox>
                                    </td>
                                    <td>Personnel</td>
                                    <td>
                                        <dxe:ASPxComboBox EnableIncrementalFiltering="True" DataSourceID="dsPersonnel" Width="100%" ID="cmb_Personnel"
                                            runat="server" ValueField="Code" ValueType="System.String" TextField="Code" Text='<%# Eval("Personnel") %>' DropDownStyle="DropDown">
                                        </dxe:ASPxComboBox>
                                    </td>              
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <dxe:ASPxButtonEdit ID="txt_TransportName" ClientInstanceName="txt_TransportName" runat="server"
                                            ...
                                            <ClientSideEvents ButtonClick="function(s, e) {
                                                                             PopupCarrier(null,txt_TransportName)
                                                                    }" />
                                        </dxe:ASPxButtonEdit>
                                    </td>
                                    <td>TptFee</td>
                                    <td>
                                        <dxe:ASPxSpinEdit ID="spin_TransportFee" ClientInstanceName="spin_TransportFee" runat="server" Value='<%# Bind("TransportFee") %>' Width="150" Increment="0" NumberType="Integer" SpinButtons-ShowIncrementButtons="false"></dxe:ASPxSpinEdit>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="8">
                            ...
                            <dxtc:ASPxPageControl runat="server" ID="pageControl_Hbl" Width="1000px" Height="440px" ActiveTabIndex="0">
                                <TabPages>
                                            ...
                                            <dxw:ContentControl ID="ContentControl_pod" runat="server">
                                                ...
                                                <div><%-- style="WIDTH: 950px; overflow-y: scroll;"--%>
                                                    <dxwgv:ASPxGridView ID="grid_SKULine" ClientInstanceName="grid_SKULine" runat="server" OnRowInserting="grid_SKULine_RowInserting"
                                                        ...
                                                        KeyFieldName="Id" Width="1500" AutoGenerateColumns="False" DataSourceID="dsIssueDet" OnInit="grid_SKULine_Init" OnInitNewRow="grid_SKULine_InitNewRow" OnRowInserted="grid_DoDet_RowInserted" OnRowUpdated="grid_DoDet_RowUpdated" OnRowDeleted="grid_DoDet_RowDeleted">
                                                        <SettingsCustomizationWindow Enabled="True" />
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <dxwgv:GridViewDataTextColumn Caption="SKU" FieldName="ProductCode" VisibleIndex="2" Width="80">
                                                                <EditItemTemplate>
                                                                    <dxe:ASPxButtonEdit ID="txt_SKULine_Product" ReadOnly="true" BackColor="Control" ClientInstanceName="txt_SKULine_Product" runat="server" Value='<%# Bind("ProductCode") %>' Width="80">
                                                                        ...
                                                                        <ClientSideEvents ButtonClick="function(s, e) {
                                                                              PopupProductFromDoIn(txt_SKULine_Product,txt_Det1_LotNo,txt_Description,spin_Qty4,spin_Qty5,txt_Uom1,txt_Uom2,txt_Uom3,cb_Att1,cb_Att2,cb_Att3,cb_Att4,cb_Att5,cb_Att6,txt_WareHouseId.GetText());
                                                                           }" />
                                                                    </dxe:ASPxButtonEdit>
                                                                </EditItemTemplate>
                                                            </dxwgv:GridViewDataTextColumn>
                                                            ...
                                                            <dxwgv:GridViewDataSpinEditColumn Caption="Expected" FieldName="Qty4" CellStyle-HorizontalAlign="Left" VisibleIndex="3" Width="60">
                                                                 <EditItemTemplate>
                                                                    <dxe:ASPxSpinEdit id="spin_Qty4" ClientInstanceName="spin_Qty4" runat="server" Value='<%# Bind("Qty4") %>' Width="60" Increment="0" NumberType="Integer" SpinButtons-ShowIncrementButtons="false"></dxe:ASPxSpinEdit>
                                                                </EditItemTemplate>
                                                            </dxwgv:GridViewDataSpinEditColumn>
                                                            <dxwgv:GridViewDataSpinEditColumn Caption="To Pick" FieldName="Qty5" CellStyle-HorizontalAlign="Left" VisibleIndex="3" Width="60">
                                                                 <EditItemTemplate>
                                                                    <dxe:ASPxSpinEdit id="spin_Qty5" ClientInstanceName="spin_Qty5" runat="server" Value='<%# Bind("Qty5") %>' Width="60" Increment="0" NumberType="Integer" SpinButtons-ShowIncrementButtons="false"></dxe:ASPxSpinEdit>
                                                                </EditItemTemplate>
                                                            </dxwgv:GridViewDataSpinEditColumn>
                                                            <dxwgv:GridViewDataSpinEditColumn Caption="P.Qty" FieldName="Qty1" VisibleIndex="4" Width="60">
                                                            ...
                                                            <dxwgv:GridViewDataTextColumn Caption="UOM" FieldName="Uom1" VisibleIndex="4" Width="50">
                                                              ...
                                                              <dxwgv:GridViewDataSpinEditColumn Caption="PKG" FieldName="QtyPackWhole" VisibleIndex="11" Width="60">
                                                                <EditItemTemplate>
                                                            ...
                                                            <dxwgv:GridViewDataSpinEditColumn Caption="UNIT" FieldName="QtyWholeLoose" VisibleIndex="12" Width="60">
                                                                <EditItemTemplate>
                                                            ...
                                                            <dxwgv:GridViewDataComboBoxColumn Caption="Att1" FieldName="Att1" VisibleIndex="13" Width="60">
                                                                <EditItemTemplate>
                                                                    <dxe:ASPxTextBox ID="cb_Att1" ClientInstanceName="cb_Att1" Width="60" runat="server"  ReadOnly="true" Value='<%# Bind("Att1") %>' DropDownStyle="DropDown">
                                                                    </dxe:ASPxTextBox>
                                                                </EditItemTemplate>
                                                            </dxwgv:GridViewDataComboBoxColumn>
                                                            <dxwgv:GridViewDataComboBoxColumn Caption="Att2" FieldName="Att2" VisibleIndex="13" Width="60">
                                                                 <EditItemTemplate>
                                                                    <dxe:ASPxTextBox ID="cb_Att2" ClientInstanceName="cb_Att2" Width="60"  ReadOnly="true" runat="server" Value='<%# Bind("Att2") %>' DropDownStyle="DropDown">
                                                                    </dxe:ASPxTextBox>
                                                                </EditItemTemplate>
                                                            </dxwgv:GridViewDataComboBoxColumn>
                                                            <dxwgv:GridViewDataComboBoxColumn Caption="Att3" FieldName="Att3" VisibleIndex="13" Width="60">
                                                               <EditItemTemplate>
                                                                    <dxe:ASPxTextBox ID="cb_Att3" ClientInstanceName="cb_Att3" Width="60"  ReadOnly="true" runat="server" Value='<%# Bind("Att3") %>' DropDownStyle="DropDown">
                                                                    </dxe:ASPxTextBox>
                                                                </EditItemTemplate>
                                                            </dxwgv:GridViewDataComboBoxColumn>
                                                            <dxwgv:GridViewDataComboBoxColumn Caption="Att4" FieldName="Att4" VisibleIndex="13" Width="60">
                                                                 <EditItemTemplate>
                                                                    <dxe:ASPxTextBox ID="cb_Att4" ClientInstanceName="cb_Att4" Width="60"  ReadOnly="true" runat="server" Value='<%# Bind("Att4") %>' DropDownStyle="DropDown">
                                                                    </dxe:ASPxTextBox>
                                                                </EditItemTemplate>
                                                            </dxwgv:GridViewDataComboBoxColumn>
                                                            <dxwgv:GridViewDataComboBoxColumn Caption="Att5" FieldName="Att5" VisibleIndex="13" Width="60">
                                                                 <EditItemTemplate>
                                                                    <dxe:ASPxTextBox ID="cb_Att5" ClientInstanceName="cb_Att5" Width="60"  ReadOnly="true" runat="server" Value='<%# Bind("Att5") %>' DropDownStyle="DropDown">
                                                                    </dxe:ASPxTextBox>
                                                                </EditItemTemplate>
                                                            </dxwgv:GridViewDataComboBoxColumn>
                                                            <dxwgv:GridViewDataComboBoxColumn Caption="Att6" FieldName="Att6" VisibleIndex="13" Width="60">
                                                                 <EditItemTemplate>
                                                                    <dxe:ASPxTextBox ID="cb_Att6" ClientInstanceName="cb_Att6" Width="60"  ReadOnly="true" runat="server"  Value='<%# Bind("Att6") %>' DropDownStyle="DropDown">
                                                                    </dxe:ASPxTextBox>
                                                                </EditItemTemplate>
                                                            </dxwgv:GridViewDataComboBoxColumn>
                                                            <dxwgv:GridViewDataDateColumn Caption="ExpiryDate" FieldName="ExpiredDate" VisibleIndex="13" Width="80">
                                                                <EditItemTemplate>
                                                             ...
                                                             <dxwgv:GridViewDataSpinEditColumn Caption="STK" FieldName="QtyLooseBase" VisibleIndex="26" Width="60">
                                                                <EditItemTemplate>
                                                            ...
                                                            <dxwgv:GridViewDataTextColumn Caption="PKG UOM" FieldName="Uom2" VisibleIndex="31" Width="50">
                                                                <EditItemTemplate>
                                                            ...
                                                            <dxwgv:GridViewDataTextColumn Caption="UNIT UOM" FieldName="Uom3" VisibleIndex="32" Width="50">
                                                                <EditItemTemplate>
                                                           ...
                                                           <%-- <dxwgv:GridViewDataTextColumn Caption="B.UOM" FieldName="Uom4" VisibleIndex="19" Width="50">
                                                                <EditItemTemplate>
                                                                    <dxe:ASPxButtonEdit runat="server" ID="txt_Uom4" ReadOnly="true" BackColor="Control" Width="70" ClientInstanceName="txt_Uom4" Text='<%# Bind("Uom4") %>'>
                                        ...
                                        <ContentCollection>
                                            <dxw:ContentControl ID="ContentControl2" runat="server">
                                                <table>
                                                    <tr>
                                                        <td>
                                                            <dxe:ASPxButton ID="ASPxButton1" Width="150" Visible="false" runat="server" Text="Add Pick Detail" AutoPostBack="false" UseSubmitBehavior="false"
                                                                Enabled='<%# SafeValue.SafeString(Eval("Id"),"0")!="0"&&SafeValue.SafeString(Eval("StatusCode"),"USE")=="USE" %>'>
                                                                <ClientSideEvents Click="function(s,e) {
                                                       Multiple_AddPick();
                                                        }" />
                                                    ...
                                                    <dxwgv:ASPxGridView ID="grid_PickDetail" ClientInstanceName="grid_PickDetail" runat="server" Styles-Cell-Paddings-Padding="2" Styles-EditForm-Paddings-Padding="2"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <dxwgv:GridViewDataTextColumn Caption="SKU" FieldName="Product" VisibleIndex="2" Width="60">
                                                             ...
                                                             <dxwgv:GridViewDataDateColumn Caption="Do Date" FieldName="DoDate" VisibleIndex="3" Width="80">
                                                                <EditItemTemplate>
                                                                    <dxe:ASPxDateEdit ID="txt_DoDate" runat="server" Value='<%# Bind("DoDate") %>' Width="100" EditFormat="Custom" EditFormatString="dd/MM/yyyy">
                                                                    </dxe:ASPxDateEdit>
                                                                </EditItemTemplate>
                                                            </dxwgv:GridViewDataDateColumn>
                                                            <dxwgv:GridViewDataTextColumn Caption="Description" FieldName="Des1" VisibleIndex="3" Width="100">
                                                            ...
                                                            <dxwgv:GridViewDataSpinEditColumn Caption="L.Qty" FieldName="Qty3" VisibleIndex="4" Width="60">
                                                             ...
                                                             <dxwgv:GridViewDataSpinEditColumn Caption="PKG" FieldName="QtyPackWhole" VisibleIndex="4" Width="60">
                                                                <EditItemTemplate>
                                                                    <dxe:ASPxSpinEdit ID="spin_QtyPack" runat="server" Width="40" ClientInstanceName="spin_QtyPack" Value='<%# Bind("QtyPackWhole") %>' Increment="0" SpinButtons-ShowIncrementButtons="false" NumberType="Integer">
                                                                    </dxe:ASPxSpinEdit>
                                                                </EditItemTemplate>
                                                            </dxwgv:GridViewDataSpinEditColumn>
                                                            <dxwgv:GridViewDataSpinEditColumn Caption="UNIT" FieldName="QtyWholeLoose" VisibleIndex="5" Width="60">
                                                                <EditItemTemplate>
                                                                    <dxe:ASPxSpinEdit ID="spin_QtyWhole" runat="server" Width="40" ClientInstanceName="spin_QtyWhole" Value='<%# Bind("QtyWholeLoose") %>' Increment="0" SpinButtons-ShowIncrementButtons="false" NumberType="Integer">
                                                                    </dxe:ASPxSpinEdit>
                                                                </EditItemTemplate>
                                                            ...
                                                            <dxwgv:GridViewDataComboBoxColumn Caption="Att1" FieldName="Att1" ReadOnly="true" VisibleIndex="6" Width="60">
                                                                <PropertiesComboBox DataSourceID="dsWhMastData" TextField="Code" ValueField="Code"  DropDownStyle="DropDown" Width="60"/>
                                                            </dxwgv:GridViewDataComboBoxColumn>
                                            ...
                                            <dxw:ContentControl ID="ContentControl5" runat="server">
                                                ...
                                                <div><%-- style="WIDTH: 950px; overflow-y: scroll;"--%>
                                                    <dxwgv:ASPxGridView ID="Grid_Cont" ClientInstanceName="grid_Cont" runat="server"
                                                        KeyFieldName="Id" DataSourceID="dsIssueDet3" Width="100%" OnBeforePerformDataSelect="Grid_Cont_BeforePerformDataSelect"
                                    ...
                                    <dxtc:TabPage Text="Shipment" Visible="true">
                                        <ContentCollection>
                                                ...
                                                <table border="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="3">
                                                            <dxe:ASPxButtonEdit ID="txt_Carrier" ClientInstanceName="txt_Carrier" runat="server"
                                                                Width="100%" HorizontalAlign="Left" AutoPostBack="False" Text='<%# Eval("Carrier") %>'>
                                                                <Buttons>
                                                                    <dxe:EditButton Enabled="true" Text=".."></dxe:EditButton>
                                                                </Buttons>
                                                                <ClientSideEvents ButtonClick="function(s, e) {
                                                        ...
                                                        <td>Transport
                                                         ...
                                                         <td >
                                                            <dxe:ASPxButtonEdit ID="txt_Transport" ClientInstanceName="txt_Transport" runat="server"
                                                                Width="100%" HorizontalAlign="Left" AutoPostBack="False" Text='<%# Eval("Transport") %>'>
                                                                <Buttons>
                                                                    <dxe:EditButton Enabled="true" Text=".."></dxe:EditButton>
                                                                </Buttons>
                                                                <ClientSideEvents ButtonClick="function(s, e) {
                                                                             PopupCarrier(null,txt_Transport)
                                                                    }" />
                                                            </dxe:ASPxButtonEdit>
                                                        </td>
                                                        </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                          ...
                                                          <td>ContainerYard</td>
                                                        <td><dxe:ASPxTextBox ID="txt_ContainerYard" Width="150" ClientInstanceName="txt_ContainerYard"
                                        ...
                                        <ContentCollection>
                                            <dxw:ContentControl ID="ContentControl_Bill" runat="server">
                                                ...
                                                <dxe:ASPxButton ID="btn_Costing" Width="150" runat="server" Text="Import Costing" Enabled='<%# SafeValue.SafeInt(Eval("Id"),0)>0 &&SafeValue.SafeString(Eval("StatusCode"),"USE")=="USE"%>'
                                                    AutoPostBack="false" UseSubmitBehavior="false">
                                                    <ClientSideEvents Click="function(s,e) {
                                                        grid_Cost.GetValuesOnCustomCallback('Import',OnCostingCallBack);
                                                        }" />
                                                </dxe:ASPxButton>
                                                    </td>
                                                    <td>
                                                ...
                                                <dxwgv:ASPxGridView ID="grid_Cost" ClientInstanceName="grid_Cost" runat="server" Styles-Cell-HorizontalAlign="Left" Styles-Footer-HorizontalAlign="Left"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dxwgv:GridViewDataSpinEditColumn Caption="Qty" FieldName="CostQty" VisibleIndex="3" Width="50">
                                                            <PropertiesSpinEdit DisplayFormatString="{0:#,##0}"></PropertiesSpinEdit>
                                                        </dxwgv:GridViewDataSpinEditColumn>
                                                        ...
                                                        <dxwgv:GridViewDataSpinEditColumn Caption="GST Type" FieldName="CostGstType" VisibleIndex="5" Width="50">
                                                        </dxwgv:GridViewDataSpinEditColumn>
                            ...
                            PopupCurrency(cmb_CostCostCurrency,spin_CostCostExRate);
                                                           ...
                                                           Calc1(spin_CostCostQty.GetText(),spin_CostCostPrice.GetText(),spin_CostCostExRate.GetText(),2,spin_CostCostAmt,spin_CostCostGst.GetText());
                                                                ...
                                                                <tr>
                                                                    <td colspan="8">
                                                                        <div style="text-align: right; padding: 2px 2px 2px 2px">
                                                                            <dxe:ASPxHyperLink ID="btn_UpdateCost" runat="server" NavigateUrl="#" Text="Update" Visible='<%# SafeValue.SafeString(Eval("StatusCode"),"USE")=="USE"&&SafeValue.SafeString(Eval("IsInv"),"none")=="none"%>'>
                                                    ...
                                                    <TotalSummary>
                                                        <dxwgv:ASPxSummaryItem FieldName="ChgCode" SummaryType="Count" DisplayFormat="{0}" />
                                                        <dxwgv:ASPxSummaryItem FieldName="CostLocAmt" SummaryType="Sum" DisplayFormat="{0:00.00}" />
                                                    </TotalSummary>
                                                </dxwgv:ASPxGridView>
                                            </dxw:ContentControl>
                                        </ContentCollection>
