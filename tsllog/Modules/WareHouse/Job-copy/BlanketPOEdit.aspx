<%@ Page Language="C#" EnableViewState="false" AutoEventWireup="true" CodeFile="BlanketPOEdit.aspx.cs" Inherits="WareHouse_Job_BlanketPOEdit" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        function PopupLC(txtId, txtName) {
            clientId = txtId;
            clientName = txtName;
            popubCtr.SetContentUrl('/SelectPage/SelectLcNo.aspx');
            popubCtr.SetHeaderText('Letter Of Credit');
            popubCtr.Show();
        }
        ...
        function CreatePurchaseOrder() {
            ...
            popubCtr.SetContentUrl('../selectpage/CreatePurchaseOrder.aspx?Type=PO&Sn=' + txt_DoNo.GetText() + '&WhId=' + txt_WareHouseId.GetText() + "&partyId=" + txt_PartyId.GetText());
            popubCtr.Show();
        }
        function OnSaveCallBack(v) {
            if (v == "Success") {
                ...
                window.location = 'BlanketPOEdit.aspx?no=' + v;
                //txt_SchRefNo.SetText(v);
                //txt_DoNo.SetText(v);
            }
        }
        function OnCreateCallBack(v) {
        ...
        function MultipleAdd() {
            ...
            popubCtr.SetContentUrl('../SelectPage/SelectPurchaseOrderRequest.aspx?Type=BP&Sn=' + txt_DoNo.GetText());
            popubCtr.Show();
        }
        function MultiplePickProduct() {
            popubCtr.SetHeaderText('Multiple Product');
            popubCtr.SetContentUrl('../SelectPage/MultipleProduct.aspx?Type=BP&Sn=' + txt_DoNo.GetText() + "&WhId=" + txt_WareHouseId.GetText());
            popubCtr.Show();
        }
            ...
            <table>
                <tr>
                    ...
                    <td>
                        ...
                        window.location='BlanketPoEdit.aspx?no='+txt_RefDoNo.GetText();
                    }" />
                        </dxe:ASPxButton>
                    </td>
                    <td>
                        <dxe:ASPxButton ID="ASPxButton3" Width="100" runat="server" Text="Go Search" AutoPostBack="false"
                            ...
                            <ClientSideEvents Click="function(s,e) {
                                           window.location='BlanketPoList.aspx';
                        }" />
                        </dxe:ASPxButton>
                    </td>
                    <td>
                        <dxe:ASPxButton ID="ASPxButton7" Width="100" runat="server" Text="Add New" AutoPostBack="false"
                            UseSubmitBehavior="false">
                            <ClientSideEvents Click="function(s,e) {
                                           window.location='BlanketPoEdit.aspx?no=0';
                                            }" />
                        </dxe:ASPxButton>
                    </td>
                </tr>
                    ...
                    <EditForm>
                        <table style="text-align: left; padding: 2px 2px 2px 2px; width: 900px">
                            <tr>
                                ...
                                <td>
                                 ...
                                 <td>
                                    <dxe:ASPxButton ID="btn_AddDoIn" ClientInstanceName="btn_AddDoIn" runat="server" Width="120" Text="Create PO" AutoPostBack="False"
                                        ...
                                        <ClientSideEvents Click="function(s, e) {
                                                detailGrid.GetValuesOnCustomCallback('CreatePO',OnCreateCallBack);
                                        }" />
                                    </dxe:ASPxButton>
                                </td>
                                <td>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>L/C</td>
                                <td><dxe:ASPxButtonEdit ID="btn_Lc" ClientInstanceName="btn_Lc" runat="server" Text='<%# Eval("LcNo")%>' Width="100%" HorizontalAlign="Left" AutoPostBack="False">
                                        <Buttons>
                                            <dxe:EditButton Enabled="true" Text=".."></dxe:EditButton>
                                        </Buttons>
                                        <ClientSideEvents ButtonClick="function(s, e) {
                        ...
                        <div style="padding: 2px 2px 2px 2px">
                            <dxtc:ASPxPageControl runat="server" ID="pageControl" Width="1000px" Height="500px">
                                <TabPages>
                                        ...
                                        <ContentCollection>
                                            <dxw:ContentControl ID="ContentControl8" runat="server">
                                                ...
                                                <table>
                                                    <tr>
                                                        <td>
                                                            <dxe:ASPxButton ID="ASPxButton6" runat="server" Text="Multiple Pick Product" AutoPostBack="false"
                                                        ...
                                                        <td>
                                                            <dxe:ASPxButton ID="btn_Add" runat="server" Text="Add Product" AutoPostBack="false"
                                                                UseSubmitBehavior="false" Enabled='<%# SafeValue.SafeString(Eval("Id"),"0")!="0"&&(SafeValue.SafeString(Eval("DoStatus"),"USE")=="Draft"||SafeValue.SafeString(Eval("DoStatus"),"USE")=="Confirmed")%>'>
                                                                <ClientSideEvents Click="function(s,e) {
                                                ...
                                                <div><%-- style="WIDTH: 950px; overflow-y: scroll;"--%>
                                                    <dxwgv:ASPxGridView ID="grid_DoDet" ClientInstanceName="grid_DoDet"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <dxwgv:GridViewDataTextColumn Caption="Product" FieldName="ProductCode" VisibleIndex="2" Width="60">
                                                                <EditItemTemplate>
                                                                    <dxe:ASPxButtonEdit ID="txt_SKULine_Product" ClientInstanceName="txt_SKULine_Product" runat="server" Value='<%# Bind("ProductCode") %>' Width="60">
                                                                        ...
                                                                        <ClientSideEvents ButtonClick="function(s, e) {
                                                                              PopupProduct(txt_SKULine_Product,txt_Des,txt_Uom1,txt_Uom2,txt_Uom3,null,spin_QtyPack,spin_QtyWhole,spin_QtyBase,cb_Att1,cb_Att2,cb_Att3,null,null,null,null,null,null,spin_Price);
                                                                           }" />
                                                                    </dxe:ASPxButtonEdit>
                                                                </EditItemTemplate>
                                                            </dxwgv:GridViewDataTextColumn>
                                                            ...
                                                            <dxwgv:GridViewDataSpinEditColumn Caption="Whole Qty" FieldName="QtyPackWhole" VisibleIndex="7" Width="40">
                                                                <EditItemTemplate>
                                                            ...
                                                            <dxwgv:GridViewDataSpinEditColumn Caption="Whole Qty" FieldName="QtyWholeLoose" VisibleIndex="7" Width="40">
                                                                <EditItemTemplate>
                                                            ...
                                                            <dxwgv:GridViewDataTextColumn Caption="UNIT UOM" FieldName="Uom3" VisibleIndex="17" Width="40">
                                                             ...
                                                             <dxwgv:GridViewDataSpinEditColumn Caption="Qty" FieldName="Qty1" VisibleIndex="18" Width="80">
                                                                <PropertiesSpinEdit SpinButtons-ShowIncrementButtons="false" Increment="4" NumberType="Float" Width="80" />
                                                            </dxwgv:GridViewDataSpinEditColumn>
                                    ...
                                    <dxtc:TabPage Text="Shipment" Visible="false">
                                        <ContentCollection>
                                            <dxw:ContentControl>
                                                <table>
                                                    <tr>
                                    ...
                                    <dxtc:TabPage Text="PO Invoice" Visible="false">
                                        <ContentCollection>
