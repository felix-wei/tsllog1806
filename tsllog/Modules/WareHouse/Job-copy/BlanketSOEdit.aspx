<%@ Page Language="C#" EnableViewState="false" AutoEventWireup="true" CodeFile="BlanketSOEdit.aspx.cs" Inherits="WareHouse_Job_BlanketEdit" %>
    ...
    <script type="text/javascript">
        ...
        function OnSaveCallBack(v) {
            if (v != null && v.indexOf("Fail") > -1) {
                ...
                //alert(v);
                window.location = 'BlanketSOEdit.aspx?no=' + v;
            }
        }
        ...
        function MultipleAdd() {
            popubCtr.SetHeaderText('Poduct List');
            popubCtr.SetContentUrl('../selectpage/SelectPoductFromStock.aspx?Type=BS&Sn=' + txt_DoNo.GetText() + '&WhId=' + txt_WareHouseId.GetText() + "&partyId=" + txt_ConsigneeCode.GetText());
            popubCtr.Show();
        }
        function MultiplePickProduct() {
            popubCtr.SetHeaderText('Multiple Product');
            popubCtr.SetContentUrl('../SelectPage/MultipleProduct.aspx?Type=BS&Sn=' + txt_DoNo.GetText() + '&WhId=' + txt_WareHouseId.GetText());
            popubCtr.Show();
        }
        function CreateSalesOrder() {
            popubCtr.SetHeaderText('Blanket Poduct List');
            popubCtr.SetContentUrl('../selectpage/CreateSalesOrder.aspx?Type=SO&Sn=' + txt_DoNo.GetText() + '&WhId=' + txt_WareHouseId.GetText() + "&partyId=" + txt_ConsigneeCode.GetText());
            popubCtr.Show();
        }
            ...
            function AfterPopubMultiInv2() {
                popubCtr2.Hide();
                popubCtr2.SetContentUrl('about:blank');
                grid_Contract.Refresh();
            }
...
<body>
   <form id="form1" runat="server">
        <div>
            ...
            <wilson:DataSource ID="dsSoInvoice" runat="server" ObjectSpace="C2.Manager.ORManager" TypeName="C2.XAArInvoice"
                KeyMember="SequenceId" FilterExpression="1=0" />
            ...
            <wilson:DataSource ID="dsSubSo" runat="server" ObjectSpace="C2.Manager.ORManager"
            ...
            <wilson:DataSource ID="dsRefContract" runat="server" ObjectSpace="C2.Manager.ORManager"
                TypeName="C2.RefContract" KeyMember="Id" FilterExpression="1=0" />
            <table>
                <tr>
                    <td> No
                    </td>
                    ...
                    <td>
                        ...
                        window.location='BlanketSOEdit.aspx?no='+txt_SchRefNo.GetText();
                    }" />
                        </dxe:ASPxButton>
                    </td>
                    <td>
                        <dxe:ASPxButton ID="btn_Add" Width="100" runat="server" Text="Add New" AutoPostBack="false">
                            <ClientSideEvents Click="function(s,e){
                        window.location='BlanketSOEdit.aspx?no=0';
                                                        }" />
                        </dxe:ASPxButton>
                    </td>
                    <td>
                        <dxe:ASPxButton ID="ASPxButton3" Width="100" runat="server" Text="Go Search" AutoPostBack="false"
                            ...
                            <ClientSideEvents Click="function(s,e) {
                                           window.location='BlanketSOList.aspx';
                        }" />
                        </dxe:ASPxButton>
                    </td>
                </tr>
                        ...
                        <div style="padding: 2px 2px 2px 2px">
                                ...
                                <tr>
                                    <td width="100%">
                                        <table style="border: solid 1px black; padding: 2px 2px 2px 2px; width: 100%">
                                            <tr>
                                                <td>Print Document:&nbsp;&nbsp;
                                        <a href="#" onclick='PrintDo("<%# Eval("DoNo") %>","SO")'>Blanket Sales Order</a>
                                                    &nbsp;&nbsp;
                                    ...
                                    <td >
                                        <dxe:ASPxButton ID="btn_CreatePO" Width="90" runat="server" Text="Create SO" AutoPostBack="False"
                                            UseSubmitBehavior="false" Enabled='<%# SafeValue.SafeInt(Eval("Id"),0)>0&&SafeValue.SafeString(Eval("DoStatus"),"Draft")=="Confirmed" %>'>
                                            <ClientSideEvents Click="function(s, e) {
                                                             detailGrid.GetValuesOnCustomCallback('CreateSO',OnSaveCallBack); 
                                                                    }" />
                                        </dxe:ASPxButton>
                                    </td>
                            ...
                            <table>
                                ...
                                <tr>
                                            ...
                                            <td width="94">
                                                <dxe:ASPxButtonEdit ID="txt_ConsigneeCode" ClientInstanceName="txt_ConsigneeCode" runat="server"
                                                    ...
                                                    <ClientSideEvents ButtonClick="function(s, e) {
                                                                            PopupParty(txt_ConsigneeCode,txt_ConsigneeName,null,null,txt_Country,txt_City,txt_PostalCode,memo_Address,'C',' ');
                                                                    }" />
                                                </dxe:ASPxButtonEdit>
                                            </td>
                                            <td>
                                    ...
                                    <td>OrderType</td>
                                    <td>
                                        <dxe:ASPxComboBox EnableIncrementalFiltering="True" Width="100%" ID="cmb_OrderType"
                                            runat="server" Text='<%# Eval("OrderType") %>'>
                                            <Items>
                                                <dxe:ListEditItem Text="BLANKET" Value="BLANKET" />
                                                <dxe:ListEditItem Text="ORDER" Value="ORDER" />
                                                 <dxe:ListEditItem Text="DROPSHIP" Value="DROPSHIP" />
                                            </Items>
                                        </dxe:ASPxComboBox>
                                    </td>
                                </tr>
                                    ...
                                    <td>
                                     ...
                                     <td colspan="3">
                                        <table cellpadding="0" cellspacing="0">
                                            ...
                                            <ClientSideEvents ButtonClick="function(s, e) {
                                                             PopupParty(txt_SupplierId,txt_SupplierName,null,null,null,null,null,null,'V',' ');
                                                                    }" />
                                        </dxe:ASPxButtonEdit>
                                            </td>
                                            <td>
                            ...
                            <dxtc:ASPxPageControl runat="server" ID="pageControl_Hbl" Width="900px" Height="440px" ActiveTabIndex="0">
                                <TabPages>
                                    <dxtc:TabPage Text="Product List" Visible="true">
                                        <ContentCollection>
                                            <dxw:ContentControl ID="ContentControl1" runat="server">
                                                <table>
                                                    <tr>
                                                        <td>
                                                            <dxe:ASPxButton ID="ASPxButton10" runat="server" Text="Multiple Pick Product" AutoPostBack="false"
                                                ...
                                                <div>
                                                    ...
                                                    <dxwgv:ASPxGridView ID="grid_SKULine" ClientInstanceName="grid_SKULine" runat="server" OnRowInserting="grid_SKULine_RowInserting"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <dxwgv:GridViewDataTextColumn Caption="Product" FieldName="ProductCode" VisibleIndex="2" Width="60">
                                                                <EditItemTemplate>
                                                                    <dxe:ASPxButtonEdit ID="txt_SKULine_Product" ClientInstanceName="txt_SKULine_Product" runat="server" Value='<%# Bind("ProductCode") %>' Width="60">
                                                                        ...
                                                                        <ClientSideEvents ButtonClick="function(s, e) {
                                                                              PopupProduct_so(txt_SKULine_Product,txt_Des,txt_Uom1,txt_Uom2,txt_Uom3,null,spin_QtyPack,spin_QtyWhole,spin_QtyBase,cb_Att1,cb_Att2,cb_Att3,null,null,null,null,null,null,spin_Price);
                                                                           }" />
                                                                    </dxe:ASPxButtonEdit>
                                                                </EditItemTemplate>
                                                            </dxwgv:GridViewDataTextColumn>
                                                           ...
                                                           <%-- <dxwgv:GridViewDataSpinEditColumn Caption="Whole Qty" FieldName="Qty2" VisibleIndex="11" Width="60">
                                                            ...
                                                            <dxwgv:GridViewDataSpinEditColumn Caption="Whole Qty" FieldName="QtyPackWhole" VisibleIndex="5" Width="40">
                                                                <EditItemTemplate>
                                                            ...
                                                            <dxwgv:GridViewDataSpinEditColumn Caption="Loose Qty" FieldName="QtyWholeLoose" VisibleIndex="6" Width="40">
                                                                <EditItemTemplate>
                                                            ...
                                                            <dxwgv:GridViewDataComboBoxColumn Caption="NRF/REF" FieldName="Att4" VisibleIndex="7" Width="50" Visible="false">
                                                                 <EditItemTemplate>
                                                            ...
                                                            <dxwgv:GridViewDataComboBoxColumn Caption="GBX" FieldName="Att5" VisibleIndex="7" Width="50" Visible="false">
                                                                 <EditItemTemplate>
                                                            ...
                                                            <dxwgv:GridViewDataComboBoxColumn Caption="DECODED" FieldName="Att6" VisibleIndex="7" Width="50" Visible="false">
                                                                 <EditItemTemplate>
                                                            ...
                                                            <dxwgv:GridViewDataSpinEditColumn Caption="Base Qty" FieldName="QtyLooseBase"  VisibleIndex="8" Width="40">
                                                               <EditItemTemplate>
...
<%--                                                            <dxwgv:GridViewDataComboBoxColumn Caption="Att7" FieldName="Att7" VisibleIndex="51" Width="60">
                                                            ...
                                                            <%--<dxwgv:GridViewDataTextColumn Caption="" FieldName="Id" VisibleIndex="200" Width="10">
                                                             ...
                                                             <dxwgv:GridViewDataSpinEditColumn Caption="Qty" FieldName="Qty1" VisibleIndex="18" Width="40">
                                                                <PropertiesSpinEdit SpinButtons-ShowIncrementButtons="false" Increment="4" NumberType="Float" Width="40" />
                                                            </dxwgv:GridViewDataSpinEditColumn>
                                                ...
                                                <div>
                                                    ...
                                                    <dxwgv:ASPxGridView ID="grid_PoRequest" ClientInstanceName="grid_PoRequest" runat="server" OnRowInserting="grid_PoRequest_RowInserting"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <dxwgv:GridViewDataTextColumn Caption="Product" FieldName="Product" VisibleIndex="1" Width="60px">
                                                                <EditItemTemplate>
                                                            ...
                                                            <dxwgv:GridViewDataSpinEditColumn Caption="QTY" FieldName="Qty1" VisibleIndex="3" Width="40">
                                                                <PropertiesSpinEdit NumberType="Float" Increment="4" SpinButtons-ShowIncrementButtons="false" Width="40">
                                                                </PropertiesSpinEdit>
                                                            </dxwgv:GridViewDataSpinEditColumn>
                                        ...
                                        <ContentCollection>
                                            <dxw:ContentControl>
                                                <table>
                                                    <tr>
                                                        <td>
                                                              <dxe:ASPxButton ID="ASPxButton7" runat="server" Text="Add New" AutoPostBack="false"
                                                                UseSubmitBehavior="false" Enabled='<%# SafeValue.SafeString(Eval("Id"),"0")!="0"&&(SafeValue.SafeString(Eval("DoStatus"),"Draft")=="Draft"||SafeValue.SafeString(Eval("DoStatus"),"Draft")=="Confirmed")%>'>
                                                                <ClientSideEvents Click="function(s,e) {
                                                        grid_Contract.AddNewRow();
                                                         ...
                                                         <td>
                                                              <dxe:ASPxButton ID="ASPxButton9" runat="server" Text="Copy" AutoPostBack="false"
                                                                UseSubmitBehavior="false" Enabled='<%# SafeValue.SafeString(Eval("Id"),"0")!="0"&&(SafeValue.SafeString(Eval("DoStatus"),"Draft")=="Draft"||SafeValue.SafeString(Eval("DoStatus"),"Draft")=="Confirmed")%>'>
                                                                <ClientSideEvents Click="function(s,e) {
                                                        MultipleTemplete(txt_DoNo.GetText());
                                                        }" />
                                                            </dxe:ASPxButton>
                                                        </td>
                                                         <td>
                                                              <dxe:ASPxButton ID="ASPxButton11" runat="server" Text="Print" AutoPostBack="false"
                                                                UseSubmitBehavior="false" Enabled='<%# SafeValue.SafeString(Eval("Id"),"0")!="0"&&(SafeValue.SafeString(Eval("DoStatus"),"Draft")=="Draft"||SafeValue.SafeString(Eval("DoStatus"),"Draft")=="Confirmed")%>'>
                                                                <ClientSideEvents Click="function(s,e) {
                                                        PrintContract();
                                                        }" />
                                                ...
                                                <dxwgv:ASPxGridView ID="grid_Contract" ClientInstanceName="grid_Contract" OnInit="grid_Contract_Init" DataSourceID="dsRefContract" Styles-Cell-Paddings-Padding="0" Styles-EditForm-Paddings-Padding="0" Styles-EditFormCell-Paddings-Padding="0"
                                                    runat="server" KeyFieldName="Id" Width="1100px" Styles-Cell-HorizontalAlign="Left" Styles-Footer-HorizontalAlign="Left" OnInitNewRow="grid_Contract_InitNewRow"
                                                    OnBeforePerformDataSelect="grid_Contract_BeforePerformDataSelect" OnRowInserting="grid_Contract_RowInserting"  OnRowUpdating="grid_Contract_RowUpdating" OnRowDeleting="grid_Contract_RowDeleting">
                                                    <SettingsCustomizationWindow Enabled="True" />
                                                    <SettingsEditing Mode="Inline" />
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dxwgv:GridViewDataTextColumn Caption="Index" FieldName="IndexNo" VisibleIndex="1" Width="30">
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn Caption="Section" FieldName="Section" VisibleIndex="2" Width="50">
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn Caption="Ttile" FieldName="Title" VisibleIndex="3" Width="150">
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn Caption="Content" FieldName="CenterContent" VisibleIndex="4" Width="450">
                                                            <EditItemTemplate>
                                                                <dxe:ASPxMemo ID="memo_Content" ClientInstanceName="memo_Content" runat="server" Rows="4" Width="450" Text='<%# Bind("CenterContent") %>'></dxe:ASPxMemo>
                                                                <dxe:ASPxButton ID="btn_Pick" ClientInstanceName="" Text="Pick" AutoPostBack="false" runat="server">
                                                                    <ClientSideEvents Click="function(s,e) {
                                                        PopupContract(memo_Content);
                                                        }" />
                                                                </dxe:ASPxButton>
                                                            </EditItemTemplate>
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn Caption="CreateBy" FieldName="CreateBy" VisibleIndex="5" Width="50">
                                                            <EditItemTemplate>
                                                            </EditItemTemplate>
                                                        </dxwgv:GridViewDataTextColumn> 
                                                        <dxwgv:GridViewDataDateColumn Caption="CreateDateTime" FieldName="CreateDateTime" VisibleIndex="6" Width="50">
                                                            <EditItemTemplate>
                                                            </EditItemTemplate>
                                    ...
                                    <dxtc:TabPage Text="Sub SO" Visible="true">
                                        <ContentCollection>
                                            <dxw:ContentControl>
                                                <dxwgv:ASPxGridView ID="grid_SubSo" ClientInstanceName="grid_SubSo"
                                                    runat="server" KeyFieldName="Id" Width="100%" Styles-Cell-HorizontalAlign="Left" Styles-Footer-HorizontalAlign="Left"
                                                    OnBeforePerformDataSelect="grid_SubSo_BeforePerformDataSelect">
                                                    <SettingsCustomizationWindow Enabled="True" />
                                                    <SettingsEditing Mode="EditForm" />
                                                    <SettingsPager Mode="ShowAllRecords"></SettingsPager>
                                                    <Columns>
                                                        ...
                                                        <dxwgv:GridViewDataTextColumn Caption="Customer" FieldName="PartyName" VisibleIndex="6" Width="100">
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn Caption="Qty" FieldName="TotalQty" VisibleIndex="6" Width="100">
                                                        </dxwgv:GridViewDataTextColumn>
                                                    ...
                                                    <Settings  ShowFooter="true"/>
                                                    <TotalSummary>
                                                        <dxwgv:ASPxSummaryItem FieldName="TotalQty" SummaryType="Sum" DisplayFormat="{0:00.00}" />
                                                    </TotalSummary>
                                                </dxwgv:ASPxGridView>
                                            </dxw:ContentControl>
                                        </ContentCollection>
                                    </dxtc:TabPage>                                   
                                    <dxtc:TabPage Text="Sub DO" Visible="true">
                                        <ContentCollection>
                                            <dxw:ContentControl>
                                        ...
                                        <ContentCollection>
                                            <dxw:ContentControl ID="ContentControl_Bill" runat="server">
                                                ...
                                                <table>
                                                    <tr>
                                                        <td>
                                                            <dxe:ASPxButton ID="ASPxButton14" Width="150" runat="server" Text="Add Costing" Enabled='<%# SafeValue.SafeInt(Eval("Id"),0)>0&&SafeValue.SafeString(Eval("DoStatus"),"Draft")!="Closed"&&SafeValue.SafeString(Eval("DoStatus"),"Draft")!="Canceled" %>'
                                                                AutoPostBack="false" UseSubmitBehavior="false">
                                                                <ClientSideEvents Click="function(s,e) {
                                                        grid_Cost.AddNewRow();
                                                        }" />
                            ...
                            PopupCurrency(cmb_CostCostCurrency,spin_CostCostExRate);
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <dxe:ASPxButton ID="ASPxButton15" Width="150" runat="server" Text="Add Payment " Enabled='<%# SafeValue.SafeInt(Eval("Id"),0)>0&&SafeValue.SafeString(Eval("DoStatus"),"USE")!="Closed"&&SafeValue.SafeString(Eval("DoStatus"),"USE")!="Canceled"%>'
                                                                AutoPostBack="false" UseSubmitBehavior="false">
                                                                <ClientSideEvents Click='function(s,e) {
                                                       AddReceive(grid_Payment, txt_DoNo.GetText(), txt_ConsigneeName.GetText());
                                                        }' />
                                                            </dxe:ASPxButton>
                                                        </td>
                                                    </tr>
                                                 ...
                                                 <dxwgv:ASPxGridView ID="grid_Payment" ClientInstanceName="grid_Payment" runat="server"
                                                    ...
                                                    <Columns>
                                                        <dxwgv:GridViewDataTextColumn Caption="DocNo" FieldName="DocNo" VisibleIndex="1"
                                                            Width="8%">
                                                             <DataItemTemplate>
                                                                 <a onclick='ShowPayment(grid_Payment,"<%# Eval("DocNo") %>","Receive");'><%# Eval("DocNo") %></a>
                                                            </DataItemTemplate>
                                                        </dxwgv:GridViewDataTextColumn>
                                   ...
                                   <dxtc:TabPage Text="Attachments" Visible="true">
                                        <ContentCollection>
                                    ...
                                    <dxtc:TabPage Text="Packing" Visible="false">
                                        <ContentCollection>
                                    ...
                                    <dxtc:TabPage Text="SO Invoice" Visible="false">
                                        <ContentCollection>
                                            <dxw:ContentControl ID="ContentControl7" runat="server">
                                                <dxwgv:ASPxGridView ID="grid_SoInv" ClientInstanceName="grid_SoInv"
                                                    runat="server" KeyFieldName="SequenceId"  Width="900px" Styles-Cell-HorizontalAlign="Left" Styles-Footer-HorizontalAlign="Left"
                                                    OnBeforePerformDataSelect="grid_SoInv_BeforePerformDataSelect">
                                                    <SettingsPager Mode="ShowAllRecords"></SettingsPager>
                                                    <Columns>
                                                        <dxwgv:GridViewDataTextColumn Caption="#" VisibleIndex="0" Width="10%">
                                                            <DataItemTemplate>
                                                        ...
                                                        <dxwgv:GridViewDataTextColumn Caption="So No" FieldName="MastRefNo" VisibleIndex="1" Width="100">
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn Caption="Doc Date" FieldName="DocDate" VisibleIndex="2" Width="70">
                                                            <PropertiesTextEdit DisplayFormatString="dd/MM/yyyy">
                                                            </PropertiesTextEdit>
