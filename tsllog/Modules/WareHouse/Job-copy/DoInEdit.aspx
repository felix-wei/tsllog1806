    ...
    <script type="text/javascript">
        ...
        function OnSaveCallBack(v) {
            if (v != null && v.indexOf("Fail") > -1) {
                ...
                window.location = 'DoInEdit.aspx?no=' + v;
            }
        }
        ...
        function MultipleAdd() {
            ...
            popubCtr.SetContentUrl('../SelectPage/ProductList_so.aspx?typ=po&Sn=' + txt_DoNo.GetText() + '&so=' + txt_PONo.GetText());
            popubCtr.Show();
        }
        function AfterPopubMultiInv() {
            popubCtr.Hide();
                ...
                <tr>
                    ...
                    <td>
                        <dxe:ASPxButton ID="ASPxButton7" Width="100" runat="server" Text="Add New" AutoPostBack="false"
                            UseSubmitBehavior="false">
                            <ClientSideEvents Click="function(s,e) {
                                           window.location='DoInEdit.aspx?no=0';
                                            }" />
                        </dxe:ASPxButton>
                    </td>
                </tr>
                    ...
                    <EditForm>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>Type</td>
                                <td>
                                    <dxe:ASPxComboBox EnableIncrementalFiltering="True" Width="100%" ID="cmb_Priority" runat="server" Text='<%# Eval("Priority") %>' DropDownStyle="DropDown">
                                        <Items>
                                            <dxe:ListEditItem Text="IMPORT" Value="IMPORT" />
                                            <dxe:ListEditItem Text="REMOVAL-IMP" Value="REMOVAL-IMP" />
                                        </Items>
                                    </dxe:ASPxComboBox>
                                </td>
                                <td>Date</td>
                                <td>
                                    <dxe:ASPxDateEdit ID="txt_Date" runat="server" Value='<%# Eval("DoDate") %>' Width="100px" EditFormat="Custom" EditFormatString="dd/MM/yyyy">
                                    </dxe:ASPxDateEdit>
                                </td>
                                <td>ExpectedDate
                                </td>
                                        ...
                                        <tr>
                                            <td>
                                                <dxe:ASPxButtonEdit ID="txt_PartyId" ClientInstanceName="txt_PartyId" runat="server" Text='<%# Eval("PartyId")%>' Width="80" HorizontalAlign="Left" AutoPostBack="False">
                                                    ...
                                                    <ClientSideEvents ButtonClick="function(s, e) {
                                                               PopupParty(txt_PartyId,txt_PartyName,null,null,null,null,txt_PostalCode,txt_PartyAdd,txt_PartyCountry,txt_PartyCity,'V');
                                                                    }" />
                                                </dxe:ASPxButtonEdit>
                                            </td>
                                            <td>
                                            ...
                                            <dxw:ContentControl>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                                <dxe:ASPxButton ID="btn_AddSKULine1" Width="150" runat="server" Text="Pick From PO" AutoPostBack="false" UseSubmitBehavior="false"
                                                ...
                                                <div><%-- style="WIDTH: 950px; overflow-y: scroll;"--%>
                                                    <dxwgv:ASPxGridView ID="grid_DoDet" ClientInstanceName="grid_DoDet"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <dxwgv:GridViewDataTextColumn Caption="SKU" FieldName="ProductCode" VisibleIndex="2" Width="60">
                                                                <EditItemTemplate>
                                                                    <dxe:ASPxButtonEdit ID="txt_SKULine_Product" ClientInstanceName="txt_SKULine_Product" runat="server" Value='<%# Bind("ProductCode") %>' Width="60">
                                                                        ...
                                                                        <ClientSideEvents ButtonClick="function(s, e) {
                                                                              PopupProduct(txt_SKULine_Product,txt_Des,txt_Uom1,txt_Uom2,txt_Uom3,null,spin_QtyPack,spin_QtyWhole,spin_QtyBase,cb_Att1,cb_Att2,cb_Att3,cb_Att4,cb_Att5,cb_Att6,null,null,null,null);
                                                                           }" />
                                                                    </dxe:ASPxButtonEdit>
                                                                    <div style="display: none">
                                                            ...
                                                            <dxwgv:GridViewDataSpinEditColumn Caption="P.Qty" FieldName="Qty1" VisibleIndex="4" Width="40">
                                                                <PropertiesSpinEdit NumberType="Integer" Increment="0" SpinButtons-ShowIncrementButtons="false" Width="40">
                                                                </PropertiesSpinEdit>
                                                            </dxwgv:GridViewDataSpinEditColumn>
                                                            <dxwgv:GridViewDataSpinEditColumn Caption="W.Qty" FieldName="Qty2" VisibleIndex="4" Width="40">
                                                                <PropertiesSpinEdit NumberType="Integer" Width="40" Increment="0" SpinButtons-ShowIncrementButtons="false">
                                                                </PropertiesSpinEdit>
                                                            </dxwgv:GridViewDataSpinEditColumn>
                                                            <dxwgv:GridViewDataSpinEditColumn Caption="L.Qty" FieldName="Qty3" VisibleIndex="4" Width="40">
                                                                <PropertiesSpinEdit NumberType="Integer" Width="40" Increment="0" SpinButtons-ShowIncrementButtons="false">
                                                                </PropertiesSpinEdit>
                                                            </dxwgv:GridViewDataSpinEditColumn>
                                                            ...
                                                            <dxwgv:GridViewDataTextColumn Caption="UOM" FieldName="Uom1" VisibleIndex="4" Width="50">
                                                                <EditItemTemplate>
                                                                    <dxe:ASPxButtonEdit runat="server" ID="txt_Uom1" Width="50" ClientInstanceName="txt_Uom1" Text='<%# Bind("Uom1") %>'>
                                                                        <Buttons>
                                                                            <dxe:EditButton Enabled="true" Text=".."></dxe:EditButton>
                                                                        </Buttons>
                                                                        <ClientSideEvents ButtonClick="function(s, e) {
                                                            ...
                                                            <dxwgv:GridViewDataDateColumn Caption="ExpiryDate" FieldName="ExpiredDate" VisibleIndex="7" Width="80">
                                                             ...
                                                             <dxwgv:GridViewDataSpinEditColumn Caption="STK" FieldName="QtyLooseBase" VisibleIndex="6" Width="40">
                                                                <EditItemTemplate>
                                                ...
                                                <div><%-- style="WIDTH: 950px; overflow-y: scroll;"--%>
                                                    <dxwgv:ASPxGridView ID="grid_DoDet2" ClientInstanceName="grid_DoDet2" Styles-Cell-Paddings-Padding="2" Styles-EditForm-Paddings-Padding="2"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <dxwgv:GridViewDataComboBoxColumn Caption="Att1" FieldName="Att1" VisibleIndex="6" Width="60">
                                                                <PropertiesComboBox DataSourceID="dsWhMastData" TextField="Code" ValueField="Code"  DropDownStyle="DropDown" Width="60"/>
                                                            </dxwgv:GridViewDataComboBoxColumn>
                                                            <dxwgv:GridViewDataComboBoxColumn Caption="Att2" FieldName="Att2" VisibleIndex="6" Width="60">
                                                                <PropertiesComboBox DataSourceID="dsWhMastData" TextField="Code" ValueField="Code"  DropDownStyle="DropDown" Width="60"/>
                                                            </dxwgv:GridViewDataComboBoxColumn>
                                                            <dxwgv:GridViewDataComboBoxColumn Caption="Att3" FieldName="Att3" VisibleIndex="6" Width="60">
                                                                <PropertiesComboBox DataSourceID="dsWhMastData" TextField="Code" ValueField="Code"  DropDownStyle="DropDown" Width="60"/>
                                                            </dxwgv:GridViewDataComboBoxColumn>
                                                            <dxwgv:GridViewDataComboBoxColumn Caption="Att4" FieldName="Att4" VisibleIndex="6" Width="60">
                                                                <PropertiesComboBox DataSourceID="dsWhMastData" TextField="Code" ValueField="Code"  DropDownStyle="DropDown" Width="60"/>
                                                            </dxwgv:GridViewDataComboBoxColumn>
                                                            <dxwgv:GridViewDataComboBoxColumn Caption="Att5" FieldName="Att5" VisibleIndex="6" Width="60">
                                                                <PropertiesComboBox DataSourceID="dsWhMastData" TextField="Code" ValueField="Code"  DropDownStyle="DropDown" Width="60"/>
                                                            </dxwgv:GridViewDataComboBoxColumn>
                                                            <dxwgv:GridViewDataComboBoxColumn Caption="Att6" FieldName="Att6" VisibleIndex="6" Width="60">
                                                                <PropertiesComboBox DataSourceID="dsWhMastData" TextField="Code" ValueField="Code"  DropDownStyle="DropDown" Width="60"/>
                                                            </dxwgv:GridViewDataComboBoxColumn>
                                                            <dxwgv:GridViewDataSpinEditColumn Caption="STK" FieldName="QtyLooseBase" VisibleIndex="5" Width="40">
                                                                <EditItemTemplate>
                                                                    <dxe:ASPxSpinEdit ID="spin_QtyBase" runat="server" Width="40" ClientInstanceName="spin_QtyBase" Value='<%# Bind("QtyLooseBase") %>' Increment="0" SpinButtons-ShowIncrementButtons="false" NumberType="Integer">
                                                                    </dxe:ASPxSpinEdit>
                                                                </EditItemTemplate>
                                        ...
                                        <ContentCollection>
                                            <dxw:ContentControl>
                                                ...
                                                <dxwgv:ASPxGridView ID="grid_DoDet3" ClientInstanceName="grid_DoDet3"
                                                    ...
                                                    Width="980" AutoGenerateColumns="False">
                                                    <SettingsEditing Mode="Inline" />
                                                    <SettingsPager Mode="ShowAllRecords" />
                                                    <SettingsBehavior ConfirmDelete="true" />
                                                    <Columns>
                                                        ...
                                                        <dxwgv:GridViewDataTextColumn
                                                            Caption="Container" FieldName="ContainerNo" VisibleIndex="3" Width="120">
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn
                                            ...
                                            <dxw:ContentControl>
                                                <table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>ContainerYard</td>
                                                        <td><dxe:ASPxTextBox ID="txt_ContainerYard" Width="140" ClientInstanceName="txt_ContainerYard"
