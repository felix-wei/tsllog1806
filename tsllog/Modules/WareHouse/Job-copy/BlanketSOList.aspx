<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BlanketSOList.aspx.cs" Inherits="WareHouse_Job_BlanketSOList" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Blanket List</title>
        <script type="text/javascript" src="/Script/pages.js"></script>
    <script type="text/javascript">
        function ShowHouse(masterId) {
            window.location = "BlanketSOEdit.aspx?no=" + masterId;
        }
    </script>
</head>
<body>
