<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChgCodeList_Ar.aspx.cs" Inherits="SelectPage_ChgCodeList_Ar" %>
...
<body>
    ...
    <div>
        <wilson:DataSource ID="dsChgcodeMast" runat="server" ObjectSpace="C2.Manager.ORManager"
            TypeName="C2.XXChgCode" KeyMember="SequenceId"  FilterExpression="1=0"/>
        ...
        <dxwgv:ASPxGridView ID="ASPxGridView1" ClientInstanceName="grid" runat="server" Width="100%" DataSourceID="dsChgcodeMast"
         KeyFieldName="SequenceId" >
            ...
            <Columns>
                ...
                <DataItemTemplate>
               <a onclick='parent.PutChgCode("<%# Eval("ChgcodeId") %>","<%# Eval("ChgcodeDe") %>","<%# Eval("ChgUnit") %>","<%# Eval("GstTypeId") %>","<%# Eval("GstP") %>","<%# Eval("ArCode") %>","DB")'>
                                Select</a>
                </DataItemTemplate>
                <EditItemTemplate>
                </EditItemTemplate>
