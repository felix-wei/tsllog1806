<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CreatePurchaseOrder.aspx.cs" Inherits="WareHouse_SelectPage_CreatePurchaseOrder" %>
...
<body>
    ...
    <div>
       <table>
                ...
                <td>
                    <dxe:ASPxButton ID="ASPxButton1" runat="server" Text="Create Purchase" AutoPostBack="false" UseSubmitBehavior="false">
                        <ClientSideEvents Click="function(s,e) {
            ...
            <dxwgv:ASPxGridView ID="ASPxGridView1" ClientInstanceName="grid" runat="server"
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Lot No" FieldName="LotNo" VisibleIndex="2" Visible="false">
                        <DataItemTemplate>
                            <%# Eval("LotNo") %>
                            <div style="display: none">
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Description" FieldName="Des1" VisibleIndex="2" Width="200" SortIndex="0" SortOrder="Ascending">
                     ...
                     <dxwgv:GridViewDataTextColumn Caption="Location" FieldName="LocationCode" VisibleIndex="2" Width="40" Visible="false">
                        <DataItemTemplate>
                            <dxe:ASPxLabel id="lbl_Location" ClientInstanceName="lbl_Location" runat="server" Width="40" Text='<%# Eval("LocationCode") %>'></dxe:ASPxLabel>
                        </DataItemTemplate>
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="OnHand" Visible="false" FieldName="AvaibleQty" VisibleIndex="2" Width="40">
                        <DataItemTemplate>
                     ...
                     <dxwgv:GridViewDataTextColumn Caption="TotalQty" FieldName="Qty1" VisibleIndex="2" Width="40">
                          <DataItemTemplate>
                            <dxe:ASPxLabel id="spin_Picked" ClientInstanceName="spin_Picked" runat="server" Width="40" Text='<%# Eval("Qty1") %>'></dxe:ASPxLabel>
                        </DataItemTemplate>
                    </dxwgv:GridViewDataTextColumn>
                     <dxwgv:GridViewDataTextColumn Caption="PendingPickQty" Visible="false" FieldName="PendingPickQty" VisibleIndex="2" Width="40">
                          <DataItemTemplate>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Qty" FieldName="Qty" VisibleIndex="2" Width="40">
                        <DataItemTemplate>
                            <dxe:ASPxSpinEdit id="spin_Qty" runat="server" Width="120"  Increment="2" NumberType="Integer" SpinButtons-ShowIncrementButtons="false"></dxe:ASPxSpinEdit>
                        </DataItemTemplate>
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="Packing" FieldName="Packing" Visible="false" VisibleIndex="2" Width="100" >
                    </dxwgv:GridViewDataTextColumn>                   
                    ...
                    <dxwgv:GridViewDataComboBoxColumn Caption="NRF/REF" FieldName="Att4" Visible="false" ReadOnly="true" VisibleIndex="6" Width="60">
                    </dxwgv:GridViewDataComboBoxColumn>
                    <dxwgv:GridViewDataComboBoxColumn Caption="GBX" FieldName="Att5" Visible="false" ReadOnly="true" VisibleIndex="6" Width="60">
                    </dxwgv:GridViewDataComboBoxColumn>
                    <dxwgv:GridViewDataComboBoxColumn Caption="DECODED" FieldName="Att6" Visible="false" ReadOnly="true" VisibleIndex="6" Width="60">
                    </dxwgv:GridViewDataComboBoxColumn>
