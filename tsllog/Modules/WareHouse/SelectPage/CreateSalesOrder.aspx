<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CreateSalesOrder.aspx.cs" Inherits="WareHouse_SelectPage_CreateSalesOrder" %>
...
<body>
    ...
    <div>
       <table>
                ...
                <td>
                    <dxe:ASPxButton ID="ASPxButton1" runat="server" Text="Create Sales" AutoPostBack="false" UseSubmitBehavior="false">
                        <ClientSideEvents Click="function(s,e) {
