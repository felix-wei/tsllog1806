<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SelectSalesOrderParty.aspx.cs" Inherits="WareHouse_SelectPage_SelectSalesOrderParty" %>
        ...
        <dxwgv:ASPxGridView ID="ASPxGridView1" runat="server" Width="100%"
            ...
            <Columns>
                <dxwgv:GridViewDataTextColumn Caption="#" VisibleIndex="0" Width="5%">
                    <DataItemTemplate>
                        <a onclick='parent.PutParty("<%# Eval("PartyId") %>","<%# Eval("PartyName") %>","<%# Eval("Contact1") %>","<%# Eval("Tel1") %>","<%# Eval("Country") %>","<%# Eval("City") %>","<%# Eval("ZipCode") %>","<%# Eval("Address1") %>","<%# Eval("Address2") %>","<%# Eval("SalesmanId") %>");'>Select</a>
                    </DataItemTemplate>
                    <EditItemTemplate>
                    </EditItemTemplate>
