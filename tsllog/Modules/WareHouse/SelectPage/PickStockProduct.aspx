            ...
            <dxwgv:ASPxGridView ID="ASPxGridView1" ClientInstanceName="grid" runat="server"
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Picking" FieldName="Qty" VisibleIndex="2" Width="40">
                        <DataItemTemplate>
                            <dxe:ASPxSpinEdit id="spin_Qty" runat="server" Width="40"  Increment="3" NumberType="Float" Text='<%# Eval("Qty") %>' SpinButtons-ShowIncrementButtons="false"></dxe:ASPxSpinEdit>
                        </DataItemTemplate>
                    </dxwgv:GridViewDataTextColumn>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Remark" FieldName="Remark" VisibleIndex="4" Width="120">
                        <DataItemTemplate>
                            <dxe:ASPxLabel ID="txt_Remark" ClientInstanceName="txt_Remark" Width="120" runat="server" Text='<%# Bind("Remark") %>'>
                            </dxe:ASPxLabel>
                        </DataItemTemplate>
                    </dxwgv:GridViewDataTextColumn>
                     <dxwgv:GridViewDataTextColumn Caption="Pallet" FieldName="PalletNo" VisibleIndex="4" Width="120">
                        <DataItemTemplate>
                            <dxe:ASPxLabel ID="txt_PalletNo" ClientInstanceName="txt_PalletNo" Width="120" runat="server" Text='<%# Bind("PalletNo") %>'>
                            </dxe:ASPxLabel>
                        </DataItemTemplate>
                    </dxwgv:GridViewDataTextColumn>
