<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PartyList_Haulier1.aspx.cs" Inherits="PagesFreight_SelectPage_PartyList_Haulier1" %>
        ...
        <dxwgv:ASPxGridView ID="ASPxGridView1" runat="server" Width="100%"
            ...
            <Columns>
                <dxwgv:GridViewDataTextColumn Caption="#" VisibleIndex="0" Width="5%">
                    <DataItemTemplate>
                        <a onclick='parent.PutHaulier1("<%# Eval("Adr") %>");'>Select</a>
                    </DataItemTemplate>
