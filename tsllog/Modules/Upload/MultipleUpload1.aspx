<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MultipleUpload1.aspx.cs" Inherits="Modules_Upload_MultipleUpload" %>
        ...
        .controller('Ctrl_UploadAttach', function ($scope, SV_UploadAttach, $timeout, SV_Popup, Upload, $http) {
            ...
            $scope.action = {
                ...
                trip_select: function (row) {
                    SV_UploadAttach.init($scope.vm.job.JobNo);
        ...
        <div>
            <table class="table table-bordered table-responsive width-40-pen">
                <tr>
                    <td>JobNo</td>
                    <td colspan="2">
                        <input id="JobNo" runat="server" type="text" class="width-150 control onlyread" ng-model="vm.job.JobNo" /></td>
                </tr>
                <tr>
                    <td>Container</td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <table class="table">
                            <tr>
                                <td>
                                    <input type="text" id="txt_TripId" class="width-60 control" name="txt_TripId" width="60" ng-model="attac.TripId" /></td>
                                <td>
                                    <input type="text" width="120" ng-model="attac.TripIndex" class="width-150 control" /></td>
                            </tr>
                        </table>
                    </td>
                    <td>
                ...
                <tr>
                    <td>Category</td>
                    <td>
                        <select ng-model="attac.FileType">
        ...
        <script type="text/javascript">
            ...
            function files_add() {
                ...
                $.each(oFile.files, function (index, file) {
                    ...
                    str += '<td width="10%">' + file.name + '</td>';
                    str += '<td width="10%">' + formatFileSize(file.size) + '</td>';
