<%@ Page Language="C#" EnableViewState="false" AutoEventWireup="true" CodeFile="Air_ExportEdit.aspx.cs" Inherits="PagesAir_Export_Air_ExportEdit" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="/Script/Air/Export.js"></script>
    <title>Export Edit</title>
            ...
            <table>
                <tr>
                    ...
                    <td>
                        ...
                        window.location='Air_ExportEdit.aspx?no='+txt_RefNo.GetText();
                    }" />
                        </dxe:ASPxButton>
                    </td>
                    <td>
                        <dxe:ASPxButton ID="ASPxButton3" Width="100" runat="server" Text="Go Search" AutoPostBack="false"
                            ...
                            <ClientSideEvents Click="function(s,e) {
                                           window.location='Air_ExportRefList.aspx';
                        }" />
                        </dxe:ASPxButton>
                    </td>
                </tr>
                    ...
                    <EditForm>
                        <div style="padding: 2px 2px 2px 2px">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <dxe:ASPxButton ID="ASPxButton3" Width="100" runat="server" Text="View Master" AutoPostBack="false"
                                            UseSubmitBehavior="false">
                                            <ClientSideEvents Click="function(s,e) {
                                           window.location='Air_ExportRefEdit.aspx?no='+txtRefNo.GetText();
                        }" />
                                        </dxe:ASPxButton>
                                    </td>
                                    <td>
                            ...
                            <table style="border: solid 1px black; padding: 2px 2px 2px 2px; width: 100%">
                                ...
                                <tr>
                                    <td>
                                <a href='/ReportFreightSea/printview.aspx?document=AEH_OrgHAWB&master=<%# Eval("RefNo")%>&house=<%# Eval("JobNo")%>'
                                ...
                                <a href='/ReportFreightSea/printview.aspx?document=AIH_DraftHAWB&master=<%# Eval("RefNo")%>&house=<%# Eval("JobNo")%>'
                                 ...
                                 <a href='/ReportFreightSea/printview.aspx?document=AEH_ShippingOrder&master=<%# Eval("RefNo")%>&house=<%# Eval("JobNo")%>'
                                     target="_blank">Shipping Order</a>
                                 <a href='/ReportFreightSea/printview.aspx?document=AEH_BookingConfirm&master=<%# Eval("RefNo")%>&house=<%# Eval("JobNo")%>'
                                     target="_blank">BookingConfirm</a>
                            ...
                            <table style="padding: 2px 2px 2px 2px; width: 100%; background-color: white;">
                                <tr>
                                    <td style="text-align: left">Export No
                                    </td>
                                    <td>
                            ...
                            <dxtc:ASPxPageControl runat="server" ID="pageControl_Hbl" Width="100%" Height="1020px"  ActiveTabIndex="0">
                                <TabPages>
                                    <dxtc:TabPage Text="Air Export Info" Visible="true">
                                        <ContentCollection>
                                                                                ...
                                                                                <td>
                                                                                    <table cellpadding="0" cellspacing="0" border="0">
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                <dxe:ASPxSpinEdit DisplayFormatString="0.00" Increment="0" DecimalPlaces="2" ID="tbxOtherCharge1Amount" Width="50px" runat="server" Text='<%# Eval("OtherCharge1Amount") %>'>
                                                                                                    <SpinButtons ShowIncrementButtons="false"></SpinButtons>
                                                                                                </dxe:ASPxSpinEdit>
                                                                                            </td>
                                                                                        </tr>
                                                                                ...
                                                                                <td>
                                                                                    <table cellpadding="0" cellspacing="0" border="0">
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                <dxe:ASPxSpinEdit DisplayFormatString="0.00" DecimalPlaces="2" Increment="0" ID="tbxOtherCharge2Amount" Width="50px" runat="server" Text='<%# Eval("OtherCharge2Amount") %>'>
                                                                                                    <SpinButtons ShowIncrementButtons="false"></SpinButtons>
                                                                                                </dxe:ASPxSpinEdit>
                                                                                            </td>
                                                                                        </tr>
                                                                                ...
                                                                                <td>
                                                                                    <table cellpadding="0" cellspacing="0" border="0">
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                <dxe:ASPxSpinEdit DisplayFormatString="0.00" DecimalPlaces="2" Increment="0" ID="tbxOtherCharge5Amount" Width="50px" runat="server" Text='<%# Eval("OtherCharge5Amount") %>'>
                                                                                                    <SpinButtons ShowIncrementButtons="false"></SpinButtons>
                                                                                                </dxe:ASPxSpinEdit>
                                                                                            </td>
                                                                                        </tr>
                                        ...
                                        <ContentCollection>
                                            <dxw:ContentControl ID="ContentControl_tpt" runat="server">
                                                <table>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <dxe:ASPxButton ID="ASPxButton9" runat="server" HorizontalAlign="Left" Width="95" Text="TruckTo" AutoPostBack="False">
                                                                <ClientSideEvents Click="function(s, e) {
                                    ...
                                    <dxtc:TabPage Text="Billing">
                                        <ContentCollection>
                                            <dxw:ContentControl ID="ContentControl_Inv" runat="server">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <dxe:ASPxButton ID="ASPxButton1" Width="150" runat="server" Text="Add Invoice" Enabled='<%# SafeValue.SafeString(Eval("Id"),"0")!="0"&&SafeValue.SafeString(Eval("StatusCode"),"USE")=="USE" %>'
                                                                ...
                                                                <ClientSideEvents Click='function(s,e) {
                                                       AddInvoice(Grid_Invoice_Import, "AE", txtRefNo.GetText(), txtHouseNo.GetText());
                                                        }' />
                                                            </dxe:ASPxButton>
                                                        </td>
                                                        <td>
                                                            <dxe:ASPxButton ID="ASPxButton5" Width="150" runat="server" Text="Add CN" Enabled='<%# SafeValue.SafeString(Eval("Id"),"0")!="0"&&SafeValue.SafeString(Eval("StatusCode"),"USE")=="USE" %>'
                                                                AutoPostBack="false" UseSubmitBehavior="false">
                                                                <ClientSideEvents Click='function(s,e) {
                                                       AddCn(Grid_Invoice_Import, "AE", txtRefNo.GetText(), txtHouseNo.GetText());
                                                        }' />
                                                            </dxe:ASPxButton>
                                                        </td>
                                                        <td>
                                                            <dxe:ASPxButton ID="ASPxButton2" Width="150" runat="server" Text="Add DN" Enabled='<%# SafeValue.SafeString(Eval("Id"),"0")!="0"&&SafeValue.SafeString(Eval("StatusCode"),"USE")=="USE" %>'
                                                                AutoPostBack="false" UseSubmitBehavior="false">
                                                                <ClientSideEvents Click='function(s,e) {
                                                       AddDn(Grid_Invoice_Import, "AE", txtRefNo.GetText(), txtHouseNo.GetText());
                                                        }' />
                                                            </dxe:ASPxButton>
                                                        </td>
                                                    </tr>
                                                ...
                                                <tr>
                                                    <td>
                                                        <dxe:ASPxButton ID="ASPxButton10" Width="150" runat="server" Text="Add Voucher" Enabled='<%# SafeValue.SafeString(Eval("Id"),"0")!="0"&&SafeValue.SafeString(Eval("StatusCode"),"USE")=="USE"%>'
                                                            AutoPostBack="false" UseSubmitBehavior="false">
                                                            <ClientSideEvents Click='function(s,e) {
                                                       AddVoucher(Grid_Payable_Import, "AE", txtRefNo.GetText(), txtHouseNo.GetText());
                                                        }' />
                                                        </dxe:ASPxButton>
                                                    </td>
                                                    <td>
                                                        <dxe:ASPxButton ID="ASPxButton12" Width="150" runat="server" Text="Add Payable" Enabled='<%# SafeValue.SafeString(Eval("Id"),"0")!="0"&&SafeValue.SafeString(Eval("StatusCode"),"USE")=="USE" %>'
                                                            AutoPostBack="false" UseSubmitBehavior="false">
                                                            <ClientSideEvents Click='function(s,e) {
                                                       AddPayable(Grid_Payable_Import, "AE", txtRefNo.GetText(), txtHouseNo.GetText());
                                                        }' />
                                                        </dxe:ASPxButton>
                                                    </td>
                                                </tr>
                                    ...
                                    <dxtc:TabPage Text="Commercial">
                                        <ContentCollection>
                                            <dxw:ContentControl>
                                                 <dxe:ASPxButton ID="ASPxButton4" Width="150" runat="server" Text="Add Commercial" Enabled='<%#SafeValue.SafeString(Eval("Id"),"0")!="0"&&SafeValue.SafeString(Eval("StatusCode"),"USE")=="USE" %>'
                                                    AutoPostBack="false" UseSubmitBehavior="false">
                                                    <ClientSideEvents Click="function(s,e) {
                                                ...
                                                <dxwgv:ASPxGridView ID="grid_Commercial" runat="server" ClientInstanceName="grid_Commercial" 
                                                    ...
                                                    OnRowUpdating="grid_Commercial_RowUpdating" Width="100%" OnRowDeleting="grid_Commercial_RowDeleting" KeyFieldName="Id" DataSourceID="dsCommercial" OnBeforePerformDataSelect="grid_Commercial_DataSelect">
                                                    ...
                                                    <Columns>
                                                            ...
                                                            <DataItemTemplate>
                                                                <table>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <dxe:ASPxButton ID="btn_det_del" runat="server" Enabled='<%# SafeValue.SafeString(Eval("JobStatusCode"),"USE")=="USE" %>'
                                                        ...
                                                        <dxwgv:GridViewDataTextColumn Caption="PackageType" FieldName="PackageType" VisibleIndex="1">
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn Caption="Qty" FieldName="Qty" VisibleIndex="3">
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn Caption="Price" FieldName="Price" VisibleIndex="4">
                                                            <PropertiesTextEdit DisplayFormatString="{0:#,##0.00}">
                                                            </PropertiesTextEdit>
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn Caption="Amount" FieldName="Amount" VisibleIndex="5">
                                                            <PropertiesTextEdit DisplayFormatString="{0:#,##0.00}">
                                                            </PropertiesTextEdit>
                                                        </dxwgv:GridViewDataTextColumn>
                                                        ...
                                                        <EditForm>
                                                            <table>
                                                                <tr>
                                                                    <td>Code</td>
                                                                    <td>
                                                                        <dxe:ASPxTextBox ID="txt_Code" runat="server" Text='<%#Bind("Code") %>' Width="120">
                                                                        </dxe:ASPxTextBox>
                                                                    </td>
                                                                     <td>PackageType</td>
                                                                    <td>
                                                                ...
                                                                PopupUom(txt_pkgType,2);
                                                                    ...
                                                                    <td>
                                                                        <dxe:ASPxSpinEdit SpinButtons-ShowIncrementButtons="false" runat="server" Width="100"
                                                                            ID="spin_Qty" ClientInstanceName="spin_Qty" Text='<%# Bind("Qty")%>' Increment="0" DisplayFormatString="0">
                                                                              <ClientSideEvents ValueChanged="function(s, e) {
                                                           spin_Amount.SetText(Calculate(spin_Qty.GetText(),spin_Price.GetText(),'1.00',2));
	                                                   }" />
                                                                        </dxe:ASPxSpinEdit>
                                                                    </td>
                                                                    <td>Price</td>
                                                                    <td>
                                                                        <dxe:ASPxSpinEdit SpinButtons-ShowIncrementButtons="false" Width="100" ID="spin_Price"
                                                                            ClientInstanceName="spin_Price" runat="server" DisplayFormatString="0.00" DecimalPlaces="0"
                                                           ...
                                                           spin_Amount.SetText(Calculate(spin_Qty.GetText(),spin_Price.GetText(),'1.00',2));
                                                                    ...
                                                                    <td>Amount</td>
                                                                    <td><dxe:ASPxSpinEdit SpinButtons-ShowIncrementButtons="false" Width="100" ID="spin_Amount" ReadOnly="true" BackColor="Control"
                                                                            ClientInstanceName="spin_Amount" runat="server" DisplayFormatString="0.00" DecimalPlaces="2"
                                    ...
                                    <dxtc:TabPage Text="Packing">
                                        <ContentCollection>
                                            <dxw:ContentControl>
                                                <dxe:ASPxButton ID="ASPxButton7" Width="150" runat="server" Text="Add Packing" Enabled='<%# SafeValue.SafeString(Eval("Id"),"0")!="0"&&SafeValue.SafeString(Eval("StatusCode"),"USE")=="USE" %>'
                                                    AutoPostBack="false" UseSubmitBehavior="false">
                                                    <ClientSideEvents Click="function(s,e) {
                                                ...
                                                <dxwgv:ASPxGridView ID="gird_Packing" runat="server" ClientInstanceName="gird_Packing" 
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dxwgv:GridViewDataTextColumn Caption="Weight" FieldName="Weight" VisibleIndex="2">
                                                            <PropertiesTextEdit DisplayFormatString="{0:#,##0.000}">
                                                            </PropertiesTextEdit>
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn Caption="Volume" FieldName="Volume" VisibleIndex="3">
                                                            <PropertiesTextEdit DisplayFormatString="{0:#,##0.000}">
                                                            </PropertiesTextEdit>
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn Caption="Qty" FieldName="Qty" VisibleIndex="4">
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn Caption="Dimension" FieldName="Dimension" VisibleIndex="5">
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn Caption="Marking" FieldName="Marking" VisibleIndex="5">
                                                        </dxwgv:GridViewDataTextColumn>
                                                        <dxwgv:GridViewDataTextColumn Caption="Description" FieldName="Description" VisibleIndex="5">
                                                        </dxwgv:GridViewDataTextColumn>
                                                    </Columns>
                                                        ...
                                                        <EditForm>
                                                            <table>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                       <dxe:ASPxSpinEdit SpinButtons-ShowIncrementButtons="false" runat="server" Width="100"
                                                                            ID="spin_Qty" Text='<%# Bind("Qty")%>' InCrement="0" DisplayFormatString="0">
                                                                        </dxe:ASPxSpinEdit>
                                                                    </td>
                                                                    <td>PackageType</td>
                                                                    <td><dxe:ASPxButtonEdit ID="txt_pkgType" ClientInstanceName="txt_pkgType" runat="server"
                                                                ...
                                                                PopupUom(txt_pkgType,0);
                                                                    ...
                                                                    <td>Dimension</td>
                                                                    <td><dxe:ASPxTextBox ID="txt_Dimension" runat="server" Text='<%#Bind("Dimension") %>' Width="60">
                                                                        </dxe:ASPxTextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Marking</td>
                                                                    <td colspan="5">
                                                                        <dxe:ASPxMemo ID="memo_Marking" runat="server" Text='<%# Bind("Marking")%>' Width="100%" Rows="3"></dxe:ASPxMemo>
                                                                    </td>
                                                                    <td>Description</td>
                                                                    <td colspan="5">
                                    ...
                                    <dxtc:TabPage Text="Shipping Request">
                                        <ContentCollection>
                                            <dxw:ContentControl>
                                                <dxe:ASPxButton ID="ASPxButton8" Width="150" runat="server" Text="Add Shipping" Enabled='<%# SafeValue.SafeString(Eval("Id"),"0")!="0"&&SafeValue.SafeString(Eval("StatusCode"),"USE")=="USE" %>'
                                                    AutoPostBack="false" UseSubmitBehavior="false">
                                                    <ClientSideEvents Click="function(s,e) {
                                                ...
                                                <dxwgv:ASPxGridView ID="grid_shipping" runat="server" ClientInstanceName="grid_shipping" 
                                                    ...
                                                    OnRowUpdating="grid_shipping_RowUpdating" Width="100%" OnRowDeleting="grid_shipping_RowDeleting" KeyFieldName="Id" DataSourceID="dsPacking" OnBeforePerformDataSelect="grid_shipping_DataSelect">
                                                    <SettingsBehavior ConfirmDelete="True" />
                                                    <SettingsEditing Mode="EditFormAndDisplayRow" />
                                                    <Columns>
                                                         <dxwgv:GridViewDataColumn Caption="#" Width="80" VisibleIndex="0">
