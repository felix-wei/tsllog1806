<%@ Page Language="C#" EnableViewState="false" AutoEventWireup="true" CodeFile="Air_ExportRefEdit.aspx.cs" Inherits="PagesAir_Export_Air_ExportRefEdit" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="/Script/Air/ExportRef.js"></script>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table>
                <tr>
                    ...
                    <td>
                        ...
                        window.location='Air_ExportRefEdit.aspx?no='+txt_SchRefNo.GetText();
                    }" />
                        </dxe:ASPxButton>
                        <td>
                            <dxe:ASPxButton ID="ASPxButton9" Width="100" runat="server" Text="Add New" AutoPostBack="false">
                                <ClientSideEvents Click="function(s,e){
                        window.location='Air_ExportRefEdit.aspx?no=0';
                    }" />
                            </dxe:ASPxButton>
                        </td>
                        <td>
            ...
            <dxwgv:ASPxGridView ID="grid_ref" ClientInstanceName="grid_ref" runat="server" KeyFieldName="Id"
                ...
                OnInit="grid_ref_Init" OnCustomCallback="grid_ref_CustomCallback" OnCustomDataCallback="grid_ref_CustomDataCallback" OnHtmlEditFormCreated="grid_ref_HtmlEditFormCreated">
                ...
                <Templates>
                    <EditForm>
                        ...
                        <table style="border: solid 1px black; padding: 2px 2px 2px 2px; width: 100%">
                            ...
                            <tr>
                                <td width="80"> <a href='/ReportFreightSea/printview.aspx?document=AEM_Manifest&master=<%# Eval("RefNo")%>&house=0'
                                        target="_blank">Manifest</a>
                                </td >
                                <td width="80"><a href='/ReportFreightSea/printview.aspx?document=AEM_OrgMAWB&master=<%# Eval("RefNo")%>&house=0'
                                    target="_blank">ORG MAWB</a>
                                </td>
                                <td width="80"><a href='/ReportFreightSea/printview.aspx?document=AEM_DraftMAWB&master=<%# Eval("RefNo")%>&house=0'
                        ...
                        <dxtc:ASPxPageControl runat="server" ID="pageControl" Width="100%" Height="1020px"  ActiveTabIndex="0">
                            <TabPages>
                                <dxtc:TabPage Text="Air Export Master" Visible="true">
                                    <ContentCollection>
                                    ...
                                    <ContentCollection>
                                        <dxw:ContentControl>
                                                ...
                                                <tr>
                                                    <td>
                                                        <dxe:ASPxButton ID="ASPxButton4" Width="150" runat="server" Text="Add Invoice" Enabled='<%# SafeValue.SafeString(Eval("Id"),"0")!="0"&&SafeValue.SafeString(Eval("StatusCode"),"USE")=="USE"%>'
                                                            AutoPostBack="false" UseSubmitBehavior="false">
                                                            <ClientSideEvents Click='function(s,e) {
                                                       AddInvoice(Grid_Invoice_Import, "AE", txt_RefN.GetText(), "0");
                                                        }' />
                                                        </dxe:ASPxButton>
                                                    </td>
                                                    <td>
                                                        <dxe:ASPxButton ID="ASPxButton7" Width="150" runat="server" Text="Add CN" Enabled='<%# SafeValue.SafeString(Eval("Id"),"0")!="0"&&SafeValue.SafeString(Eval("StatusCode"),"USE")=="USE" %>'
                                                            AutoPostBack="false" UseSubmitBehavior="false">
                                                            <ClientSideEvents Click='function(s,e) {
                                                       AddCn(Grid_Invoice_Import, "AE", txt_RefN.GetText(), "0");
                                                        }' />
                                                        </dxe:ASPxButton>
                                                    </td>
                                                    <td>
                                                        <dxe:ASPxButton ID="ASPxButton8" Width="150" runat="server" Text="Add DN" Enabled='<%# SafeValue.SafeString(Eval("Id"),"0")!="0"&&SafeValue.SafeString(Eval("StatusCode"),"USE")=="USE" %>'
                                                            AutoPostBack="false" UseSubmitBehavior="false">
                                                            <ClientSideEvents Click='function(s,e) {
                                                       AddDn(Grid_Invoice_Import, "AE", txt_RefN.GetText(), "0");
                                                        }' />
                                                        </dxe:ASPxButton>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td>
                                                        <dxe:ASPxButton ID="ASPxButton1" Width="150" runat="server" Text="Add Voucher" Enabled='<%# SafeValue.SafeString(Eval("Id"),"0")!="0"&&SafeValue.SafeString(Eval("StatusCode"),"USE")=="USE" %>'
                                                            AutoPostBack="false" UseSubmitBehavior="false">
                                                            <ClientSideEvents Click='function(s,e) {
                                                       AddVoucher(Grid_Payable_Import, "AE", txt_RefN.GetText(), "0");
                                                        }' />
                                                        </dxe:ASPxButton>
                                                    </td>
                                                    <td>
                                                        <dxe:ASPxButton ID="ASPxButton5" Width="150" runat="server" Text="Add Payable" Enabled='<%# SafeValue.SafeString(Eval("Id"),"0")!="0"&&SafeValue.SafeString(Eval("StatusCode"),"USE")=="USE" %>'
                                                            AutoPostBack="false" UseSubmitBehavior="false">
                                                            <ClientSideEvents Click='function(s,e) {
                                                       AddPayable(Grid_Payable_Import, "AE", txt_RefN.GetText(), "0");
                                                        }' />
                                                        </dxe:ASPxButton>
                                                    </td>
                                                </tr>
                                            ...
                                            <dxwgv:ASPxGridView ID="grid_Cost" ClientInstanceName="grid_Cost" runat="server"
                                                ...
                                                OnInit="grid_Cost_Init" OnInitNewRow="grid_Cost_InitNewRow" OnRowInserted="grid_Cost_RowInserted" OnRowInserting="grid_Cost_RowInserting" OnRowDeleting="grid_Cost_RowDeleting"
                                                OnRowUpdating="grid_Cost_RowUpdating" OnHtmlEditFormCreated="grid_Cost_HtmlEditFormCreated" OnRowUpdated="grid_Cost_RowUpdated" OnRowDeleted="grid_Cost_RowDeleted">
