<%@ Page Language="C#" EnableViewState="false" AutoEventWireup="true" CodeFile="Air_ImportRefEdit.aspx.cs" Inherits="PagesAir_Import_Air_ImportRefEdit" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="/Script/Air/ImportRef.js"></script>
            ...
            <table>
                <tr>
                    ...
                    <td>
                        ...
                        window.location='Air_ImportRefEdit.aspx?no='+txt_SchRefNo.GetText();
                    }" />
                        </dxe:ASPxButton>
                        <td>
                            <dxe:ASPxButton ID="ASPxButton9" Width="100" runat="server" Text="Add New" AutoPostBack="false">
                                <ClientSideEvents Click="function(s,e){
                        window.location='Air_ImportRefEdit.aspx?no=0';
                    }" />
                            </dxe:ASPxButton>
                        </td>
                        <td>
                ...
                <Templates>
                    <EditForm>
                        ...
                        <table style="border: solid 1px black; padding: 2px 2px 2px 2px; width: 100%">
                            ...
                            <tr>
                                <td width="80"> <a href='/ReportFreightSea/printview.aspx?document=AIM_Manifest&master=<%# Eval("RefNo")%>&house=0'
                                        target="_blank">Manifest</a>
                                </td >
                                <td width="80"><a href='/ReportFreightSea/printview.aspx?document=AIM_OrgMAWB&master=<%# Eval("RefNo")%>&house=0'
                                    target="_blank">ORG MAWB</a>
                                </td>
                                <td width="80"><a href='/ReportFreightSea/printview.aspx?document=AIM_DraftMAWB&master=<%# Eval("RefNo")%>&house=0'
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <table>
                                        <tr>
                                            <td>
                                                <dxe:ASPxButtonEdit ID="txt_AgentId" ClientInstanceName="txt_AgentId" runat="server" Width="105" Text='<%# Eval("AgentId")%>' HorizontalAlign="Left" AutoPostBack="False">
                                                    <Buttons>
                                            ...
                                            <td>
                                                <dxe:ASPxTextBox runat="server" Width="395" BackColor="Control" ID="txt_AgentName"
                                ...
                                <td colspan="3">
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                <dxe:ASPxTextBox runat="server" BackColor="Control" Width="395"
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <table>
                                        <tr>
                                            <td>
                                                <dxe:ASPxButtonEdit ID="txt_CrAgentId" ClientInstanceName="txt_CrAgentId" runat="server" Text='<%# Eval("CarrierAgentId") %>' Width="105px" HorizontalAlign="Left" AutoPostBack="False">
                                                    <Buttons>
                                                        <dxe:EditButton Enabled="true" Text=".."></dxe:EditButton>
                                                    </Buttons>
                                                    <ClientSideEvents ButtonClick="function(s, e) {
                                            ...
                                            <td>
                                                <dxe:ASPxTextBox ID="txt_CrAgentName" runat="server" BackColor="Control" ClientInstanceName="txt_CrAgentName" ReadOnly="True" Width="395">
                                                </dxe:ASPxTextBox>
                                            </td>
                                        </tr>
                                    </table>
                        ...
                        <dxtc:ASPxPageControl runat="server" ID="pageControl" Width="100%" Height="1020px" ActiveTabIndex="0">
                            <TabPages>
                                <dxtc:TabPage Text="Air Import Master" Visible="true" >
                                    <ContentCollection >
                                        <dxw:ContentControl ID="ContentControl1" runat="server" Height="700px">
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="3">
                                                        ...
                                                        <table>
                                                            <td>Qty</td>
                                                            <td>
                                                                <dxe:ASPxSpinEdit runat="server" Width="60" BackColor="Control" ReadOnly="true"
                                                                    ID="spin_Pkgs" Value='<%# Eval("Qty")%>'>
                                                                    <SpinButtons ShowIncrementButtons="false" />
                                                                </dxe:ASPxSpinEdit>
                                                            </td>
                                                            <td>
                                                                <dxe:ASPxTextBox runat="server" BackColor="Control" ReadOnly="true" Width="100" ID="txt_PkgsType"
                            ...
                            Enabled='<%# SafeValue.SafeString(Eval("Id"),"0")!="0"&&SafeValue.SafeString(Eval("StatusCode"),"USE")!="CLS"&&(SafeValue.SafeString(Eval("StatusCode"),"UES")!="CNL") %>'
                                    ...
                                    <ContentCollection>
                                        <dxw:ContentControl>
                                                ...
                                                <tr>
                                                    <td>
                                                        <dxe:ASPxButton ID="ASPxButton4" Width="150" runat="server" Text="Add Invoice" Enabled='<%# SafeValue.SafeString(Eval("Id"),"0")!="0"&&SafeValue.SafeString(Eval("StatusCode"),"USE")=="USE"%>'
                                                            AutoPostBack="false" UseSubmitBehavior="false">
                                                            <ClientSideEvents Click='function(s,e) {
                                                       AddInvoice(Grid_Invoice_Import, "AI", txt_RefN.GetText(), "0");
                                                        }' />
                                                        </dxe:ASPxButton>
                                                    </td>
                                                    <td>
                                                        <dxe:ASPxButton ID="ASPxButton7" Width="150" runat="server" Text="Add CN" Enabled='<%# SafeValue.SafeString(Eval("Id"),"0")!="0"&&SafeValue.SafeString(Eval("StatusCode"),"USE")=="USE"%>'
                                                            AutoPostBack="false" UseSubmitBehavior="false">
                                                            <ClientSideEvents Click='function(s,e) {
                                                       AddCn(Grid_Invoice_Import, "AI", txt_RefN.GetText(), "0");
                                                        }' />
                                                        </dxe:ASPxButton>
                                                    </td>
                                                    <td>
                                                        <dxe:ASPxButton ID="ASPxButton8" Width="150" runat="server" Text="Add DN" Enabled='<%# SafeValue.SafeString(Eval("Id"),"0")!="0"&&SafeValue.SafeString(Eval("StatusCode"),"USE")=="USE"%>'
                                                            AutoPostBack="false" UseSubmitBehavior="false">
                                                            <ClientSideEvents Click='function(s,e) {
                                                       AddDn(Grid_Invoice_Import, "AI", txt_RefN.GetText(), "0");
                                                        }' />
                                                        </dxe:ASPxButton>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td>
                                                        <dxe:ASPxButton ID="ASPxButton1" Width="150" runat="server" Text="Add Voucher" Enabled='<%# SafeValue.SafeString(Eval("Id"),"0")!="0"&&SafeValue.SafeString(Eval("StatusCode"),"USE")=="USE"%>'
                                                            AutoPostBack="false" UseSubmitBehavior="false">
                                                            <ClientSideEvents Click='function(s,e) {
                                                       AddVoucher(Grid_Payable_Import, "AI", txt_RefN.GetText(), "0");
                                                        }' />
                                                        </dxe:ASPxButton>
                                                    </td>
                                                    <td>
                                                        <dxe:ASPxButton ID="ASPxButton5" Width="150" runat="server" Text="Add Payable" Enabled='<%# SafeValue.SafeString(Eval("Id"),"0")!="0"&&SafeValue.SafeString(Eval("StatusCode"),"USE")=="USE"%>'
                                                            AutoPostBack="false" UseSubmitBehavior="false">
                                                            <ClientSideEvents Click='function(s,e) {
                                                       AddPayable(Grid_Payable_Import, "AI", txt_RefN.GetText(), "0");
                                                        }' />
                                                        </dxe:ASPxButton>
                                                    </td>
                                                </tr>
                                            ...
                                            <dxwgv:ASPxGridView ID="grid_Cost" ClientInstanceName="grid_Cost" runat="server"
                                                DataSourceID="dsCosting" KeyFieldName="Id" Width="100%" OnBeforePerformDataSelect="grid_Cost_DataSelect" OnRowUpdated="grid_Cost_RowUpdated" OnRowDeleted="grid_Cost_RowDeleted"
                                                ...
                                                OnRowUpdating="grid_Cost_RowUpdating" OnHtmlEditFormCreated="grid_Cost_HtmlEditFormCreated">
