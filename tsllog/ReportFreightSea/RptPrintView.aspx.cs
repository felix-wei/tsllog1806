    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            try
            {
                ...
                {
                    ms = PrintProfitByCustomer(refType, type, d1, d2, party, userName);
                    fileName = "ImportProfit" + DateTime.Now.ToString("yyyyMMdd");
                }
                else if (reportName == "7")//profit by salesman
                {
                    ms = PrintProfitBySales(refType, type, d1, d2, party, userName);
                    fileName = "ImportProfit" + DateTime.Now.ToString("yyyyMMdd");
                }
                ...
                {
                    ms = PrintExportVolumeByDate(refType, type, d1, d2, userName);
                    fileName = "ExportVolumeByDate" + DateTime.Now.ToString("yyyyMMdd");
                }
                else if (reportName == "34")
                {
                    ms = PrintExportVolumeByAgent(refType, type, d1, d2, party, userName);
                    fileName = "ExportVolumeByAgent" + DateTime.Now.ToString("yyyyMMdd");
                }
                else if (reportName == "35")
                {
                    ms = PrintExportVolumeByPort(refType, type, d1, d2, party, userName);
...
Response.End();
    ...
    private MemoryStream PrintProfitByCustomer(string refType, string type, string date1, string date2, string cust, string userName)
    {
        XtraReport rpt = new XtraReport();
        ...
        DateTime d1 = new DateTime(SafeValue.SafeInt(s1[2], 0), SafeValue.SafeInt(s1[1], 0), SafeValue.SafeInt(s1[0], 0));
        DateTime d2 = new DateTime(SafeValue.SafeInt(s2[2], 0), SafeValue.SafeInt(s2[1], 0), SafeValue.SafeInt(s2[0], 0));
        rpt.DataSource = SeaFreightRptPrint.dsProfitByCust(refType, type, d1, d2, cust, userName);
        System.IO.MemoryStream str = new MemoryStream();
        if (docType == "1")
            rpt.ExportToXls(str);
        else
    ...
    private MemoryStream PrintProfitBySales(string refType, string type, string date1, string date2, string sales, string userName)
    {
        XtraReport rpt = new XtraReport();
        ...
        DateTime d1 = new DateTime(SafeValue.SafeInt(s1[2], 0), SafeValue.SafeInt(s1[1], 0), SafeValue.SafeInt(s1[0], 0));
        DateTime d2 = new DateTime(SafeValue.SafeInt(s2[2], 0), SafeValue.SafeInt(s2[1], 0), SafeValue.SafeInt(s2[0], 0));
        rpt.DataSource = SeaFreightRptPrint.dsProfitBySales(refType, type, d1, d2, sales, userName);
        System.IO.MemoryStream str = new MemoryStream();
        if (docType == "1")
            rpt.ExportToXls(str);
        else
    ...
    #region export
    private MemoryStream PrintExportVolumeByDate(string refType, string jobType, string date1, string date2, string userName)
    {
        XtraReport rpt = new XtraReport();
        rpt.LoadLayout(Server.MapPath(@"~\ReportFreightSea\ReportRepx\Volume.repx"));
        ...
        DateTime d1 = new DateTime(SafeValue.SafeInt(s1[2], 0), SafeValue.SafeInt(s1[1], 0), SafeValue.SafeInt(s1[0], 0));
        DateTime d2 = new DateTime(SafeValue.SafeInt(s2[2], 0), SafeValue.SafeInt(s2[1], 0), SafeValue.SafeInt(s2[0], 0));
        rpt.DataSource = SeaFreightRptPrint.dsExportVolumeByDate(refType, jobType, d1, d2, userName);
        System.IO.MemoryStream str = new MemoryStream();
        if (docType == "1")
            rpt.ExportToXls(str);
        else
    ...
    private MemoryStream PrintExportVolumeByAgent(string refType, string jobType, string date1, string date2, string agentId, string userName)
    {
        XtraReport rpt = new XtraReport();
        rpt.LoadLayout(Server.MapPath(@"~\ReportFreightSea\ReportRepx\VolumeByAgent.repx"));
        ...
        DateTime d1 = new DateTime(SafeValue.SafeInt(s1[2], 0), SafeValue.SafeInt(s1[1], 0), SafeValue.SafeInt(s1[0], 0));
        DateTime d2 = new DateTime(SafeValue.SafeInt(s2[2], 0), SafeValue.SafeInt(s2[1], 0), SafeValue.SafeInt(s2[0], 0));
        rpt.DataSource = SeaFreightRptPrint.dsExportVolumeByAgent(refType, jobType, d1, d2, agentId, userName);
        System.IO.MemoryStream str = new MemoryStream();
        if (docType == "1")
            rpt.ExportToXls(str);
        else
    ...
    private MemoryStream PrintExportVolumeByPort(string refType, string jobType, string date1, string date2, string port, string userName)
    {
        XtraReport rpt = new XtraReport();
        rpt.LoadLayout(Server.MapPath(@"~\ReportFreightSea\ReportRepx\VolumeByPort.repx"));
        ...
        DateTime d1 = new DateTime(SafeValue.SafeInt(s1[2], 0), SafeValue.SafeInt(s1[1], 0), SafeValue.SafeInt(s1[0], 0));
        DateTime d2 = new DateTime(SafeValue.SafeInt(s2[2], 0), SafeValue.SafeInt(s2[1], 0), SafeValue.SafeInt(s2[0], 0));
        rpt.DataSource = SeaFreightRptPrint.dsExportVolumeByPort(refType, jobType, d1, d2, port, userName);
        System.IO.MemoryStream str = new MemoryStream();
        if (docType == "1")
            rpt.ExportToXls(str);
        else
