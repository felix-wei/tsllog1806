        ...
        <div>
            <table>
                <tr>
                    ...
                    <td>
                        <dxe:ASPxButtonEdit ID="btn_SchPod" ClientInstanceName="txt_SchPod" runat="server" Text="" Width="90">
                            <Buttons>
                ...
                <tr>
                    ...
                    <td>
                        <dxe:ASPxButtonEdit ID="btn_AgtId" ClientInstanceName="txt_AgtId" runat="server" Text="" Width="90">
                            <Buttons>
                                <dxe:EditButton Enabled="true" Text=".."></dxe:EditButton>
                            </Buttons>
                            <ClientSideEvents ButtonClick="function(s, e) {
