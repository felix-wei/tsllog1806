<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ApBatchPosting.aspx.cs"
    Inherits="PagesAccount_ApBatchPosting" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>AP Batch Posting</title>
            ...
            <tr>
                <td valign="top">
                    <table>
                        <tr>
                            <td>
                                <dxe:ASPxCheckBox ID="cb_ApSi" runat="server" Text="AP Invoice">
                                </dxe:ASPxCheckBox>
                            </td>
                            <td>
                                <dxe:ASPxCheckBox ID="cb_ApVoucher" runat="server" Text="AP Voucher">
                                </dxe:ASPxCheckBox>
                            </td>
                            <td>
                                <dxe:ASPxCheckBox ID="cb_ApPaySi" runat="server" Text="AP Payment">
                                </dxe:ASPxCheckBox>
                            </td>
                            <td>
                                <dxe:ASPxCheckBox ID="cb_ApSr" runat="server" Text="AP Refund">
                                </dxe:ASPxCheckBox>
                            </td>
                        </tr>
                    </table>
