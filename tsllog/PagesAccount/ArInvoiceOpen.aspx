<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="ArInvoiceOpen.aspx.cs"
    Inherits="Account_ArInvoiceOpen" %>
    ...
    <div>
       ...
       <table border="0">
            ...
            <tr>
                ...
                <td>
                    <dxe:ASPxDateEdit  ReadOnly="true" ID="txt_end" Width="100" runat="server" EditFormat="Custom" EditFormatString="dd/MM/yyyy" DisplayFormatString="dd/MM/yyyy">
                    </dxe:ASPxDateEdit>
                </td>
				                <td>
                    Type
        ...
        <dxwgv:ASPxGridView ID="ASPxGridView1" runat="server" DataSourceID="dsArInvoice"
            ...
            <Columns>
                ...
                <dxwgv:GridViewDataTextColumn Caption="Loc Amt" FieldName="AbsAmt" VisibleIndex="8"
                    Width="8%">
                </dxwgv:GridViewDataTextColumn>
                <dxwgv:GridViewDataTextColumn Caption="Bal Amt" FieldName="BalanceAmt" VisibleIndex="8"
                    Width="8%">
                </dxwgv:GridViewDataTextColumn>
                <dxwgv:GridViewDataTextColumn Caption="Remark" FieldName="Description" VisibleIndex="8"
                    Width="8%">
                </dxwgv:GridViewDataTextColumn>
            </Columns>
                                    <Settings ShowFooter="true" />
                                    <TotalSummary>
                                        <dxwgv:ASPxSummaryItem FieldName="AbsAmt" ShowInColumn="AbsAmt" SummaryType="Sum" DisplayFormat="{0:#,##0.00}" />
                                        <dxwgv:ASPxSummaryItem FieldName="BalanceAmt" ShowInColumn="BalanceAmt" SummaryType="Sum" DisplayFormat="{0:#,##0.00}" />
                                    </TotalSummary>
