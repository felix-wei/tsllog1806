<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="ArInvoiceList_Cn_multi.aspx.cs"
    Inherits="PagesAccount_SelectPage_ArInvoiceList_Cn_multi" %>
            ...
            <Templates>
                <DataRow>
                    <table border="0" style="border-bottom: solid 1px BLACK; width: 100%">
                        ...
                        <td width="50">
                            <dxe:ASPxSpinEdit Width="100%" ID="spin_Amt" DisplayFormatString="0.00" ReadOnly="false"
                                Value='<%# Eval("BalanceAmt")%>' runat="server">
                                <SpinButtons ShowIncrementButtons="false" />
                            </dxe:ASPxSpinEdit>
                        </td>
                        <td width="50">
