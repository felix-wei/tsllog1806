<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="ArCashInvoice.aspx.cs"
    Inherits="Account_ArCashInvoice" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ShowArInvoice(invN, docType) {
            window.location = 'EditPage/ArCashInvoiceEdit.aspx?no=' + invN+'&type='+docType;
        }
    </script>
