<%@ Page Language="C#" AutoEventWireup="true" EnableViewState="false"  CodeFile="ArCnEdit.aspx.cs" Inherits="Account_ArCnEdit" %>
    ...
    <script type="text/javascript">
        ...
        function ShowReceipt(repNo, repType) {
            if (repType == "RE")
                ...
                window.location = 'ArReceiptEdit_Cn.aspx?no=' + repNo;
        }
            ...
            <tr>
                ...
                <td>
                    <table>
                     ...
                     window.location='ArCnEdit.aspx?no='+txtSchNo.GetText()+'&type=CN'
                        }" />
                                </dxe:ASPxButton>
                            </td>
                            <td>
                                <dxe:ASPxButton ID="ASPxButton9" Width="110" runat="server" Text="Add New" AutoPostBack="False">
                                    <ClientSideEvents Click="function(s, e) {
                     window.location='ArCnEdit.aspx?no=0'
                        }" />
                                </dxe:ASPxButton>
                            </td>
                            <td>
                ...
                <EditForm>
                    ...
                    <table border="0" >
                        <tr><td colspan="6" style="display:none">
                                <dxe:ASPxTextBox runat="server" ID="txt_Oid" ClientInstanceName="txt_Oid" ReadOnly="true" BackColor="Control" width="100" Text='<%# Eval("SequenceId")%>'>
                                </dxe:ASPxTextBox></td>
                        </tr>
                        <tr>
                            <td width="100">
                            ...
                            <td width="160">
                                <dxe:ASPxTextBox runat="server" ID="txt_DocNo" ClientInstanceName="txt_DocNo" ReadOnly="true" BackColor="Control" width="100" Text='<%# Eval("DocNo")%>'>
                                </dxe:ASPxTextBox>
                            </td>
                            <td  width="100">
                                Doc Type
                            ...
                            <td width="160">
                                <dxe:ASPxComboBox runat="server" ID="cbo_DocType" ReadOnly='<%# SafeValue.SafeString(Eval("SequenceId"),"0")!="0" %>' BackColor="Control" width="100" Text='<%# Eval("DocType")%>'>
                                    <Items>
                                        <dxe:ListEditItem Value="IV" Text="Invoice"/>
                                        <dxe:ListEditItem Value="DN" Text="DebitNote" />
                                    </Items>
                                </dxe:ASPxComboBox>
                            </td>
                            <td  width="100">
                            ...
                            <td width="160">
                                <dxe:ASPxDateEdit ID="txt_DocDt" runat="server" Width="100" Value='<%# Eval("DocDate")%>' EditFormat="Custom" EditFormatString="dd/MM/yyyy" DisplayFormatString="dd/MM/yyyy">
                                </dxe:ASPxDateEdit>
                            </td>
                        </tr>
                        <tr>
                     ...
                     <dxe:ASPxComboBox ID="cmb_PartyTo" ClientInstanceName="cmb_PartyTo" runat="server" Value='<%# Eval("PartyTo") %>'
                        Width="370" DropDownWidth="380" DropDownStyle="DropDownList" DataSourceID="dsCustomerMast"
                        ...
                        <Columns>
                            ...
                            <td width="100px">
                                Term</td>
                            <td width="150px">
                                <dxe:ASPxComboBox runat="server" EnableIncrementalFiltering="true" 
                                    ID="txt_TermId" DataSourceID="dsTerm" TextField="Code" ValueField="Code" 
                                    width="100" value='<%# Eval("Term")%>'>
                                </dxe:ASPxComboBox>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                Due Date</td>
                            <td>
                                <dxe:ASPxDateEdit ID="txt_DueDt" runat="server" ReadOnly="true" BackColor="Control" Width="100" Value='<%# Eval("DocDueDate")%>'
                        ...
                        <tr>
                            ...
                            <td>
                                <dxe:ASPxTextBox runat="server" ID="txt_AcCode" ClientInstanceName="txt_AcCode" BackColor="Control" ReadOnly="true" Width="100" Text='<%# Eval("AcCode")%>'>
                                </dxe:ASPxTextBox>
                            </td>
                            <td >
                                A/C Source
                            ...
                            <td>
                                <dxe:ASPxComboBox runat="server" ID="txt_AcSource" Width="100" ReadOnly="true" BackColor="Control" Text='<%# Eval("AcSource")%>'>
                                    <Items>
                        ...
                        <tr>
                            ...
                            <td style="text-align: right; padding: 2px 2px 2px 2px">
                                <dxe:ASPxButton ID="btn_DetAdd" runat="server" Text="Add Line" Enabled='<%# SafeValue.SafeString(Eval("SequenceId"),"0")!="0"&&SafeValue.SafeString(Eval("ExportInd"),"N")!="Y" %>'
                            ...
                            <td style="text-align: right; padding: 2px 2px 2px 2px">
                                <dxe:ASPxButton ID="btn_print" runat="server" Text="Print" Enabled='<%# SafeValue.SafeInt(Eval("SequenceId"),0)>0 %>'
                                    AutoPostBack="false" UseSubmitBehavior="false">
                                    <ClientSideEvents Click="function(s,e){
                               PrintInvoice(txt_DocNo.GetText(),'CN');
                            }" />
                                </dxe:ASPxButton>
                            </td>
                        </tr>
            ...
            onrowinserted="grid_InvDet_RowInserted" onrowupdated="grid_InvDet_RowUpdated" onrowdeleted="grid_InvDet_RowDeleted" Width="100%"
                                    ...
                                    <Columns>
                                        ...
                                        <dxwgv:GridViewDataTextColumn Caption="Ac Code" FieldName="AcCode" VisibleIndex="3"
                                            Width="120">
                                        <DataItemTemplate><%# R.Account(Eval("AcCode")) %>(<%# Eval("AcSource") %>)</DataItemTemplate>
                                        </dxwgv:GridViewDataTextColumn>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="60">
                                                        <dxe:ASPxSpinEdit Increment="0" Width="100%" ID="spin_det_GstP" ClientInstanceName="spin_det_GstP"
                                                             ReadOnly="true" BackColor="Control" runat="server" Value='<%# Bind("Gst") %>' DisplayFormatString="0.0000" >
                                                            <ClientSideEvents ValueChanged="function(s, e) {
                                                           PutAmt();
	                                                   }" />
                                                            <SpinButtons ShowIncrementButtons="false" />
                                ...
                                <ContentCollection>
                                    ...
                                    <Columns>
                                        <dxwgv:GridViewDataTextColumn Caption="Pay No" FieldName="RepNo" VisibleIndex="3"
                                            Width="40px">
                                        <DataItemTemplate>
                                        <a href="#" onclick='ShowReceipt("<%# Eval("RepNo")%>","<%# Eval("RepType")%>")'><%# Eval("RepNo")%></a>
                                         </DataItemTemplate>
                                        </dxwgv:GridViewDataTextColumn>
                                        <dxwgv:GridViewDataTextColumn Caption="Pay Type" FieldName="RepType" VisibleIndex="3"
                                            Width="40px">
                                        </dxwgv:GridViewDataTextColumn>
                                        <dxwgv:GridViewDataTextColumn Caption="Pay Date" FieldName="RepDate" VisibleIndex="3"
                                            Width="40px">
                                        </dxwgv:GridViewDataTextColumn>
                                        ...
                                        <dxwgv:GridViewDataTextColumn Caption="Post Ind" FieldName="PostInd" VisibleIndex="8"
                                            Width="40px">
                                        </dxwgv:GridViewDataTextColumn>
                                    </Columns>
                                    <Settings ShowFooter="true" />
