<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DeportOutEdit.aspx.cs" Inherits="PagesContainer_Job_DeportOutEdit" %>
    ...
    <script>
        function OnCallback(v) {
            if (v != null && v.length > 0)
                ...
                window.location = "DeportOutEdit.aspx"
            //parent.ClosePopup();
        }
        function OnCallback(v) {
            if (v != null && v.length > 0)
                    ...
                    <td colspan="4">
                        <dxwgv:ASPxGridView ID="grid_Transport" ClientInstanceName="detailGrid" runat="server"
                            ...
                            <Columns>
                                ...
                                <dxwgv:GridViewDataTextColumn Caption="ContNo" FieldName="ContainerNo" VisibleIndex="2">
                                </dxwgv:GridViewDataTextColumn>
                                <dxwgv:GridViewDataTextColumn Caption="ContType" FieldName="ContainerType" VisibleIndex="3">
                                </dxwgv:GridViewDataTextColumn>
                            </Columns>
                                ...
                                <DataRow>
                                    ...
                                    <table border="1" bordercolor="#b1cfef" style="border-collapse: collapse; font-family: Tahoma; font-size: 8pt;">
                                        <tr>
                                            ...
                                            <td width="230">
                                                <dxe:ASPxTextBox ID="txt_ContNo" runat="server" Text='<%# Eval("ContainerNo") %>' Width="220">
                                                </dxe:ASPxTextBox>
                                            ...
                                            <td width="280">
                                                <dxe:ASPxLabel ID="txt_ContType" runat="server" Text='<%# Eval("ContainerType") %>' Width="160">
                                                </dxe:ASPxLabel>
                                            </td>
                                        </tr>
                                    </table>
