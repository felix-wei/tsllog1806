    ...
    <script type="text/javascript">
        ...
        function PrintDN() {
            if (frm.GetText() == "") {
                ...
                if (cury.GetSelectedIndex() == 1 && rbt1.GetSelectedIndex() == 0) {
                    parent.PrintReport('/ReportAccount/Rptprintview.aspx?doc=6d&d1=' + frm.GetText() + '&d2=' + to.GetText() + '&cury=' + cury.GetSelectedIndex() + '&p=' + cmb_PartyTo.GetValue() + '&' + new Date())
                } else if (cury.GetSelectedIndex() == 1 && rbt1.GetSelectedIndex() == 1) {
                    parent.PrintReport('/ReportAccount/Rptprintview.aspx?doc=11&d1=' + frm.GetText() + '&d2=' + to.GetText() + '&cury=' + cury.GetSelectedIndex() + '&p=' + cmb_PartyTo.GetValue() + '&' + new Date())
                } else {
                    parent.PrintReport('/ReportAccount/Rptprintview.aspx?doc=2d&d1=' + frm.GetText() + '&d2=' + to.GetText() + '&cury=' + cury.GetSelectedIndex() + '&p=' + cmb_PartyTo.GetValue() + '&' + new Date())
                }
            }
        }
...
<body>
    ...
    <div>
        ...
        <table>
            ...
            <tr>
                <td>
                    <dxe:ASPxButton ID="ASPxButton3d" runat="server" Text="Print DN" Width="110" AutoPostBack="False"
                        UseSubmitBehavior="False">
                        <ClientSideEvents Click="function(s, e) {
                        PrintDN();
                                    }" />
