<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KPI_TEU.aspx.cs" Inherits="ReportAccount_OperationReport_KPI_TEU" %>
            ...
            <asp:Repeater ID="rp" runat="server" OnItemDataBound="rp_ItemDataBound" >
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td><%# Eval("o40") %></td>
                        <td><%# Eval("oe") %></td>
                        <td><%# SafeValue.SafeInt( Eval("i20"),0)+SafeValue.SafeInt( Eval("e20"),0)+SafeValue.SafeInt( Eval("o20"),0) %></td>
                        <td><%# SafeValue.SafeInt( Eval("i40"),0)+SafeValue.SafeInt( Eval("e40"),0)+SafeValue.SafeInt( Eval("o40"),0) %></td>
                        <td><%# Eval("oe") %></td>
                        <td><%# Eval("teu") %></td>
                        <td><%# Eval("fee") %></td>
                        <td><%# Eval("Trips") %></td>
                ...
                <FooterTemplate>
                    <tr class="tr_summary">
                        ...
                        <td><asp:Label ID="lb_t20" runat="server" ></asp:Label></td>
                        <td><asp:Label ID="lb_t40" runat="server" ></asp:Label></td>
                        <td><asp:Label ID="lb_te" runat="server" ></asp:Label></td>
                        <td><asp:Label ID="lb_teu" runat="server" ></asp:Label></td>
                        <td><asp:Label ID="lb_fee" runat="server" ></asp:Label></td>
