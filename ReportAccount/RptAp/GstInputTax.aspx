<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GstInputTax.aspx.cs" Inherits="ReportAccount_RptAp_GstInputTax" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>GST Input Tax</title>
</head>
<body>
                    ...
                    <dxe:ASPxButton ID="ASPxButton3" runat="server" Text="Print" Width="110" AutoPostBack="False"
                        ...
                        <ClientSideEvents Click="function(s, e) {
                                ...
                                alert('Please select the end date');
                                    ...
                                    parent.PrintReport('/ReportAccount/Rptprintview.aspx?doc=25&d1='+frm.GetText()+'&d2='+to.GetText())
                                    }" />
                    </dxe:ASPxButton>
                </td>
            </tr>
                    ...
                    <dxe:ASPxButton ID="ASPxButton1" runat="server" Text="Export To Excel" Width="110"
                        ...
                        <ClientSideEvents Click="function(s, e) {
                                ...
                                alert('Please select the end date');
                                    ...
                                    parent.PrintReport('/ReportAccount/Rptprintview.aspx?docType=1&doc=25&d1='+frm.GetText()+'&d2='+to.GetText())
                                    }" />
                    </dxe:ASPxButton>
                </td>
            </tr>
