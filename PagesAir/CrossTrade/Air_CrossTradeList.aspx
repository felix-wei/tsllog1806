<%@ Page Language="C#" EnableViewState="false" AutoEventWireup="true" CodeFile="Air_CrossTradeList.aspx.cs" Inherits="PagesAir_CrossTrade_Air_CrossTradeList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function ShowJob(masterId) {
            window.location = "Air_CrossTradeRefEdit.aspx?no=" + masterId;
        }
        function ShowHouse(masterNo, jobNo) {
            window.location = "Air_CrossTradeEdit.aspx?masterNo=" + masterNo + "&no=" + jobNo;
        }
    ...
    <form id="form1" runat="server">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <dxe:ASPxButtonEdit ID="txt_AgtId" ClientInstanceName="txt_AgtId" runat="server" Width="80" HorizontalAlign="Left" AutoPostBack="False">
                        <Buttons>
                ...
                <td colspan="4">
                    <dxe:ASPxTextBox ID="ASPxTextBox1" ClientInstanceName="txt_AgtName" ReadOnly="true" BackColor="Control" Width="325" runat="server">
                    </dxe:ASPxTextBox>
                </td>
                <td>
                ...
                <td colspan="3">
                    ...
                    PopupEditFormVerticalAlign="WindowCenter" />
                        ...
                        <Columns>
                            <dxwgv:GridViewDataTextColumn Caption="Ref No" FieldName="RefNo" VisibleIndex="0"
                                SortIndex="1" SortOrder="Ascending" Width="130">
                                <DataItemTemplate>
                                    <a onclick='ShowJob("<%# Eval("RefNo") %>");'><%# Eval("RefNo") %></a>
                                </DataItemTemplate>
                            </dxwgv:GridViewDataTextColumn>
                            <dxwgv:GridViewDataTextColumn Caption="CrossTrade No" FieldName="JobNo" VisibleIndex="0"
