            ...
            <tr>
                <td valign="top">
                    ...
                    <dxwgv:ASPxGridView ID="ASPxGridView1" ClientInstanceName="grid" runat="server" DataSourceID="dsRole"
                        ...
                        OnInit="ASPxGridView1_Init" OnRowDeleted="ASPxGridView1_Deleted" OnRowInserted="ASPxGridView1_Inserted" OnRowInserting="ASPxGridView1_RowInserting" OnRowUpdating="ASPxGridView1_RowUpdating" OnRowDeleting="ASPxGridView1_RowDeleting" >
