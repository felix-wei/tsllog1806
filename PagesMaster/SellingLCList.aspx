<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SellingLCList.aspx.cs" Inherits="PagesMaster_SellingLCList" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        function ShowHouse(masterId) {
            window.location = "SellingLCEdit.aspx?no=" + masterId;
        }
    </script>
</head>
<body>
        ...
        <div>
            ...
            <dxwgv:ASPxGridView ID="grid" ClientInstanceName="detailGrid" runat="server"
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="SoNo" FieldName="LcRef" VisibleIndex="4" Width="40">
                        <DataItemTemplate>
                            <a href='javascript: parent.navTab.openTab("<%# Eval("LcRef") %>","/WareHouse/Job/SoEdit.aspx?no=<%# Eval("LcRef") %>",{title:"<%# Eval("LcRef") %>", fresh:false, external:true});'><%# Eval("LcRef") %></a>
                        </DataItemTemplate>
                    </dxwgv:GridViewDataTextColumn>
