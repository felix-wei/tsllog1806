...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
		...
		parent.open_printer("Print Rate",'/PagesContTrucking/printrate.aspx?client=' + btn_ClientId.GetText());
...
<body>
    <form id="form1" runat="server">
        <div>
            <wilson:DataSource ID="ds1" runat="server" ObjectSpace="C2.Manager.ORManager" TypeName="C2.JobRate" KeyMember="Id" FilterExpression="1=0 and LineType='RATE'" />
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <dxe:ASPxButton ID="ASPxButton2p" Width="110" runat="server" Text="Print Rate" AutoPostBack="false" UseSubmitBehavior="false">
                            <ClientSideEvents Click="function(s,e){
                                if(btn_ClientId.GetText()!=''){
                                      PrintCharges();
                                }else{
                    ...
                    <td colspan="6">
                        <dxwgv:ASPxGridView ID="grid1" ClientInstanceName="grid1" runat="server"
                            ...
                            <Columns>
                                ...
                                <dxwgv:GridViewDataComboBoxColumn FieldName="ContSize" Caption="Cont Size" Width="50" VisibleIndex="1" Visible="true">
                                    <PropertiesComboBox>
                                        <Items>
