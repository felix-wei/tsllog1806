    ...
    public class XAArInvoiceDet
    {
        ...
        public string Display
        {
            get
            {
                ...
                if (this.docLineNo > 0)
                {
                    string sql = "select ExportInd from XAArinvoice where SequenceId='" + docId +"'";
        ...
        {
            get {
                string sql = "select CancelInd from XAArInvoice where SequenceId=" + docId;
