<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SalesProfitView.aspx.cs" Inherits="ReportFreigtSea_SalesProfitView" %>
...
<frameset runat="server" id="rptFrameset" cols="250,*" border="0" framespacing="2" bordercolor="#9B98B6">
	<frame name="schFrame" runat="server" id="schFrame" src="SalesProfit.aspx" />
