...
<script runat="server">
    ...
    void Page_Init(object o, EventArgs e)
    {
        ...
        master.report_name = "Import Shipment Performance Teus Analysis";
        ...
        master.query_sql = @"SELECT m.RefNo AS REF,c.JOBNO AS JOB, UPPER(m.CreateBy) AS STAFF, v.Code AS CARRIER, m.Pol AS PORT, p.Code AS AGENT, 
...
FROM SeaImportMkg AS c INNER JOIN
...
WHERE m.statuscode<>'CNL' and c.MkgType='Cont' and  (CONVERT(DATETIME, m.Eta, 111) BETWEEN '{0}' AND '{1}')";
        master.filename_template = "Import_Teus_{0:yyyy}_{1:MM}_{2:dd}.xls";
   }
