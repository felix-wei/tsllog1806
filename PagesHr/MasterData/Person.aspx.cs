...
public partial class PagesMaster_Person : System.Web.UI.Page
{
    protected void Page_Init(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (type.Length > 0)
            {
                ...
                this.dsSchPerson.FilterExpression = "Status='" + txt_Status.Text + "'";
            }
        }
    }
    ...
    protected void btn_Sch_Click(object sender, EventArgs e)
    {
        ...
        if (name.Length > 0)
        {
            where = string.Format("Id>0 and Status='{1}' and NAME LIKE '{0}%'", name.Replace("'", "''"),txt_Status.Text);
        }
        else
        {
