<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintPaySlip.aspx.cs" Inherits="PagesHr_Report_PrintPaySlip" %>
            ...
            <tr>
                 <td width="70%">
                   <p> <font size="6"> <%= System.Configuration.ConfigurationManager.AppSettings["CompanyName"] %></font></p>
                    ...
                    Tel: <%= System.Configuration.ConfigurationManager.AppSettings["CompanyTel"] %><br />
                    Fax: <%= System.Configuration.ConfigurationManager.AppSettings["CompanyFax"] %><br />
                    E-mail:<%= System.Configuration.ConfigurationManager.AppSettings["CompanyEmail"] %><br />
                       </font> </p>
                </td>
                <td width="20%"></td>
                <td width="10%">
                    <img width="200" height="127" src='<%= System.Configuration.ConfigurationManager.AppSettings["Logo"] %>' />
                </td>
            </tr>
        </table>
 <table class="table_A4" style="margin-top:15px;">
        ...
        <table class="table_A4" style="margin-top:10px">
            <tr style="vertical-align: top">
                ...
                <td width="120">:<%=Helper.Safe.Date3(tab.Rows[0]["BeginDate"]) %></td>
                <td width="120">
                    Month</td>
                <td width="120">:<%=Helper.Safe.Date2(tab.Rows[0]["FromDate"]) %></td>
            </tr>
            <tr>
                <td>Bank Name</td>
