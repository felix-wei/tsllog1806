<%@ Page Language="C#" AutoEventWireup="true" EnableViewState="false" CodeFile="Transhipment.aspx.cs" Inherits="PagesHr_Job_Transhipment" %>
                ...
                <tr>
                    ...
                    <td>
                        <dxe:ASPxComboBox runat="server" EnableIncrementalFiltering="true" ID="txtSchName" ClientInstanceName="txtSchName" TextFormatString="{1}"
                            ...
                            DataSourceID="dsPerson" ValueField="Id" TextField="Name" Width="150" ValueType="System.Int32">
                            <Buttons>
                    ...
                    <dxwgv:GridViewDataColumn Caption="#" Width="5%" VisibleIndex="0">
                        <DataItemTemplate>
                            <table>
                                <tr>
                                    <td>
                                        <dxe:ASPxButton ID="btn_Trans_edit" runat="server" Text="Edit" Width="40" AutoPostBack="false"
                                            ClientSideEvents-Click='<%# "function(s) { ASPxGridView1.StartEditRow("+Container.VisibleIndex+") }"  %>'>
                                        </dxe:ASPxButton>
                                    </td>
                                    <td>
                                        <dxe:ASPxButton ID="btn_Trans_del" runat="server"
                            ...
                            <tr>
                                ...
                                <td>
                                    <dxe:ASPxComboBox runat="server" EnableIncrementalFiltering="true" ID="cmb_Person" TextFormatString="{1}"
                                        EnableCallbackMode="true" IncrementalFilteringMode="StartsWith" DropDownStyle="DropDownList"
                                        DataSourceID="dsPerson" ValueField="Id" TextField="Name" Width="190" ValueType="System.Int32" Value='<%# Eval("Person")%>'>
                                    </dxe:ASPxComboBox>
                                </td>
                                <td>PIC
                                </td>
                                <td>
                                    <dxe:ASPxComboBox runat="server" EnableIncrementalFiltering="true" ID="txt_Trans_Pic" TextFormatString="{1}"
                                        EnableCallbackMode="true" IncrementalFilteringMode="StartsWith" DropDownStyle="DropDownList"
                                        DataSourceID="dsPIC" ValueField="Id" TextField="Name" Width="190" ValueType="System.Int32" Value='<%# Bind("Pic")%>'>
                                        <Buttons>
                                            <dxe:EditButton Text="Clear"></dxe:EditButton>
                                        </Buttons>
                                        <ClientSideEvents ButtonClick="function(s, e) {
