...
public partial class PagesContTrucking_Job_AssignDriverEdit : System.Web.UI.Page
{
    ...
    protected void btn_Search_Click(object sender, EventArgs e)
    {
        ...
        string sql = string.Format(@"select Id,JobNo,JobType,BkgDate,BkgTime,JobProgress,TptDate,TptTime,TptType,Driver,VehicleNo,TripCode,Wt,M3,Qty,PickFrm1,DeliveryTo1 from tpt_job where JobProgress='' and isnull(driver,'')='' and StatusCode<>'CNL' {0}", where);
