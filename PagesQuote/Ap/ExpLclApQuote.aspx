<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="ExpLclApQuote.aspx.cs"
    Inherits="PagesFreight_ExpLclApQuote" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function ShowQuo(invN) {
            window.location = 'ExpLclApQuoteEdit.aspx?no=' + invN;
        }
    </script>
