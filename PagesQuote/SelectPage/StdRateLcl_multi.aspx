<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="StdRateLcl_multi.aspx.cs"
    Inherits="PagesFreight_SelectPage_StdRateLcl_multi" %>
...
<body>
    ...
    <div>
        <wilson:DataSource ID="dsSeaQuoteDet" runat="server" ObjectSpace="C2.Manager.ORManager"
        ...
        <dxwgv:ASPxGridView ID="ASPxGridView1" runat="server" DataSourceID="dsSeaQuoteDet"
            ClientInstanceName="grid" Width="750" KeyFieldName="SequenceId" OnCustomDataCallback="ASPxGridView1_CustomDataCallback"
            >
            <SettingsPager Mode="ShowAllRecords">
            </SettingsPager>
            <SettingsCustomizationWindow Enabled="True" />
            <Columns>
                <dxwgv:GridViewDataTextColumn Caption="Description" VisibleIndex="2"
                    Width="200">
                </dxwgv:GridViewDataTextColumn>
                <dxwgv:GridViewDataTextColumn Caption="Currency" VisibleIndex="5"
                    Width="50">
                </dxwgv:GridViewDataTextColumn>
                <dxwgv:GridViewDataTextColumn Caption="Min Qty" VisibleIndex="5"
                    Width="80">
                </dxwgv:GridViewDataTextColumn>
