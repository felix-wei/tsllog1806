<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rate_Std.aspx.cs" Inherits="PagesQuote_Air_Rate_Std" %>
    ...
    <form id="form1" runat="server">
        <div>
            <wilson:DataSource ID="dsQuotationDet" runat="server" ObjectSpace="C2.Manager.ORManager"
                TypeName="C2.SeaQuoteDet1" KeyMember="SequenceId" FilterExpression="FclLclInd='Lcl' and QuoteId = '-1'" />
            <table>
                <tr>
                    <td>
