...
public partial class PagesQuote_FclRate_Std : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            Session["FclRate_" + typ] = "FclLclInd='Fcl' and ImpExpInd='" + typ + "' and QuoteId = '-1'";
        }
    ...
    {
        this.dsQuotationDet.FilterExpression = "FclLclInd='Fcl' and ImpExpInd='" + this.txt_type.Text + "' and QuoteId = '-1'";
    }
