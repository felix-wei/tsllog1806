<%@ Page Language="C#" EnableViewState="false" AutoEventWireup="true" CodeFile="LclQuoteEdit.aspx.cs" Inherits="PagesFreight_ExpLclQuoteEdit" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function ImportStdRate() {
            ...
            popubCtr.SetContentUrl('../SelectPage/StdRateLcl_multi.aspx?no=' + txt_Oid.GetText() + '&pol=' + txt_Pol.GetText() + '&pod=' + txt_Pod.GetText() + '&partyTo=' + txt_CustId.GetText());
            popubCtr.Show();
        }
        function ImportDet() {
            popubCtr.SetHeaderText('Export Standard List');
            popubCtr.SetContentUrl('../SelectPage/LclQuoteList.aspx?no=' + txt_Oid.GetText());
            popubCtr.Show();
        }
        function ImportArDet() {
            popubCtr.SetHeaderText('AR Invoice Item List');
            popubCtr.SetContentUrl('../SelectPage/ArList.aspx?no=' + txt_Oid.GetText());
            popubCtr.Show();
        }
        ...
        function PrintQuote(invN) {
            window.open('/ReportFreightSea/printview.aspx?document=Quote_LCL&house=0&master=' + invN);
        }
            ...
            <table>
                ...
                <td style="display: none">
                    ...
                    <td>
                     ...
                     window.location='LclQuoteEdit.aspx?no='+txtSchNo.GetText()+'&typ='+txt_type.GetText();
                        }" />
                                    </dxe:ASPxButton>
                                </td>
                                <td>
                                    <dxe:ASPxButton ID="ASPxButton1" Width="110" runat="server" Text="Add New" AutoPostBack="false">
                                        <ClientSideEvents Click="function(s, e) {
                     window.location='LclQuoteEdit.aspx?no=0&typ='+txt_type.GetText();
                        }" />
                                    </dxe:ASPxButton>
                                </td>
                            <td>
                                <dxe:ASPxButton ID="ASPxButton3" Width="110" runat="server" Text="Go Search" AutoPostBack="false">
                                    <ClientSideEvents Click="function(s, e) {
                     window.location='/PagesQuote/Sea/LclQuote.aspx?typ='+txt_type.GetText()
                        }" />
                                </dxe:ASPxButton>
                            </td>
                            </tr>
                        ...
                        <table border="0">
                            ...
                            <tr>
                               ...
                               ImportDet();
                                            ...
                                            <td>
                                                <dxe:ASPxButton ID="ASPxButton4" runat="server" Width="180" Text="Add Item From AR" Enabled='<%# SafeValue.SafeInt(Eval("SequenceId"),0)>0 %>'
                                                    AutoPostBack="false" UseSubmitBehavior="false">
                                                    <ClientSideEvents Click="function(s,e){
                               ImportArDet();
                            }" />
                                ...
                                <td>
                                    <dxwgv:ASPxGridView ID="grid_InvDet" ClientInstanceName="grid_det" runat="server"
                                        ...
                                        <Columns>
                                            ...
                                            <dxwgv:GridViewDataTextColumn Caption="Min Amt" FieldName="Amt" VisibleIndex="5"
                                                Width="80">
                                            </dxwgv:GridViewDataTextColumn>
                                        </Columns>
