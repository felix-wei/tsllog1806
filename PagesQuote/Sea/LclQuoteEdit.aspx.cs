...
public partial class PagesFreight_ExpLclQuoteEdit : BasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            Session["LclQuote_" + this.txt_type.Text] = null;
            if (Request.QueryString["no"] != null && Request.QueryString["no"].ToString() != "0")
            {
                this.txtSchNo.Text = Request.QueryString["no"].ToString();
                Session["LclQuote_" + typ] = string.Format("QuoteNo='{0}' and FclLclInd='Lcl' and ImpExpInd='{1}'", SafeValue.SafeString(Request.QueryString["no"], ""), typ);
        ...
        if (Session["LclQuote_" + this.txt_type.Text] != null)
        {
            this.dsQuotation.FilterExpression = Session["LclQuote_" + this.txt_type.Text].ToString();
    ...
    protected void ASPxGridView1_InitNewRow(object sender, DevExpress.Web.Data.ASPxDataInitNewRowEventArgs e)
    {
        ...
        e.NewValues["CreateUser"] = EzshipHelper.GetUserName();
    ...
    protected void ASPxGridView1_CustomCallback(object sender, DevExpress.Web.ASPxGridView.ASPxGridViewCustomCallbackEventArgs e)
    {
        ...
        {
            string runType = "SeaLcl-Quotation";
        ...
        Session["LclQuote_" + this.txt_type.Text] = "SequenceId=" + inv.SequenceId;
        this.dsQuotation.FilterExpression = Session["LclQuote_" + this.txt_type.Text].ToString();
        if (this.ASPxGridView1.GetRow(0) != null)
            this.ASPxGridView1.StartEdit(0);
    }
    ...
    {
        ASPxGridView grd = sender as ASPxGridView;
        this.dsQuotationDet.FilterExpression = "QuoteId='" + SafeValue.SafeInt(grd.GetMasterRowKeyValue(), -2) + "'";
    }
