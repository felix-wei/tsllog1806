<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChatChannel.aspx.cs" Inherits="Mobile_Chat_ChatChannel" %>
...
<head runat="server">
    ...
    <script src="script/js_ChatChannel.js"></script>
    <script type="text/javascript">
        $(function () {
            //alert(lb_user.GetText());
