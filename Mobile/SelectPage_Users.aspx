<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SelectPage_Users.aspx.cs" Inherits="Mobile_SelectPage_Users" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <dxwgv:ASPxGridView ID="ASPxGridView1" runat="server" Width="100%" AutoGenerateColumns="False">
