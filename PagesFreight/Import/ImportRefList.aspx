<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ImportRefList.aspx.cs" Inherits="Pages_ImportRefList" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Sea Import Ref</title>
    <link href="/Style/StyleSheet.css"  rel="stylesheet" type="text/css"/>
    <script type="text/javascript" src="/Script/pages.js"></script>
    <script type="text/javascript">
        function ShowJob(masterId) {
            window.location = "ImportRefEdit.aspx?no=" + masterId + "&refType=" + lab_RefType.GetText();
        }
        ...
        <div>
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <dxe:ASPxButtonEdit ID="txt_SchPod" ClientInstanceName="txt_SchPod" runat="server" MaxLength="5" Width="100" HorizontalAlign="Left" AutoPostBack="False">
                            <Buttons>
                    ...
                    <td colspan="3">
                        <dxe:ASPxTextBox ID="txt_Ves" Width="275" runat="server">
                        </dxe:ASPxTextBox>
                    </td>
                    <td>
                        Voyage
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <dxe:ASPxTextBox ID="ASPxTextBox1" ClientInstanceName="txt_AgtName" ReadOnly="true" BackColor="Control" Width="168" runat="server">
                        </dxe:ASPxTextBox>
                    </td>
                    <td>
                        ETA From
            ...
            <dxwgv:ASPxGridView ID="grid_ref" ClientInstanceName="grid_ref" runat="server" KeyFieldName="SequenceId"
                ...
                <Columns>
                    <dxwgv:GridViewDataTextColumn Caption="Ref No" VisibleIndex="1" Width="100"
                        SortIndex="1">
                        <DataItemTemplate>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Pol" FieldName="Pol" Width="100" VisibleIndex="7">
                    </dxwgv:GridViewDataTextColumn>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Weight" FieldName="Weight" Width="60" VisibleIndex="23">
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="Volume" FieldName="volume" Width="60" VisibleIndex="24">
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="Qty" FieldName="Qty" Width="80" VisibleIndex="25">
                    </dxwgv:GridViewDataTextColumn>
