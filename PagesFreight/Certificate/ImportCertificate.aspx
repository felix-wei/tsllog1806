                    ...
                    <EditForm>
                        <table border="0">
                            ...
                            <tr>
                                <td >Serial No</td>
                                <td Width="170">
                                    <dxe:ASPxTextBox ID="txt_SerialNo" runat="server" Text='<%# Eval("SerialNo")%>' Width="100%"></dxe:ASPxTextBox>
                                </td>
                                <td>Certificate Date
                                </td>
                                <td Width="170">
                            ...
                            <tr>
                                ...
                                <td>
                                    <dxe:ASPxSpinEdit Increment="0" ID="spin_GstPaidAmt" Width="100%" ClientInstanceName="spin_GstPaidAmt"
                                        DisplayFormatString="0.00" DecimalPlaces="2" runat="server" Value='<%# Eval("GstPaidAmt") %>'>
                            ...
                            <tr>
                                ...
                                <td>
                                    <dxe:ASPxButtonEdit ID="btn_RefCurrency" MaxLength="3" ClientInstanceName="btn_RefCurrency" runat="server"
                                        Width="100%" HorizontalAlign="Left" AutoPostBack="False" Text='<%# Eval("Currency")%>'>
                                        <Buttons>
                                ...
                                <td>
                                    <dxe:ASPxSpinEdit Increment="0" ID="txt_RefExRate" Width="100%" ClientInstanceName="txt_RefExRate"
                                            ...
                                            <EditForm>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                              <dxe:ASPxButtonEdit ID="btn_Currency" MaxLength="3" ClientInstanceName="btn_Currency" runat="server"
