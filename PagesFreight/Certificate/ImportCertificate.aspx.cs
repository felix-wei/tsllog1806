...
public partial class PagesFreight_Account_ImportCertificate : System.Web.UI.Page
{
    protected void page_Init(object sender, EventArgs e)
    {
        ...
        if (Session["ImportCertificate"] != null)
        {
            this.dsCertificate.FilterExpression = Session["ImportCertificate"].ToString();
    ...
    protected void ASPxGridView1_InitNewRow(object sender, DevExpress.Web.Data.ASPxDataInitNewRowEventArgs e)
    {
        ...
        if (Request.QueryString["JobType"] != null && Request.QueryString["RefN"] != null && Request.QueryString["JobN"] != null)
        {
            ...
            if (houseNo.Length > 1)
            {
                string sql = "SELECT AgentId FROM  SeaImportRef WHERE (RefNo= '" + houseNo + "')";
    ...
    private void SaveAndUpdate()
    {
        ...
        Session["ImportCertificate"] = "Id=" + cer.Id;
        this.dsCertificate.FilterExpression = Session["ImportCertificate"].ToString();
        if (this.ASPxGridView1.GetRow(0) != null)
            this.ASPxGridView1.StartEdit(0);
    }
