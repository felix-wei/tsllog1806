                    ...
                    <EditForm>
                        <table border="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <dxe:ASPxTextBox ID="txt_SpecialNote" ClientInstanceName="txt_SpecialNote" runat="server" Text='<%# Eval("SpecialNote") %>' Width="130">
                                    </dxe:ASPxTextBox>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>Job Type </td>
                                <td>
                                    <dxe:ASPxTextBox ID="txt_MastType" runat="server" BackColor="Control" ClientInstanceName="txt_MastType" ReadOnly="true" Text='<%# Eval("MastType")%>' Width="100">
                                    </dxe:ASPxTextBox>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td colspan="5">
                                    <dxe:ASPxMemo runat="server" ID="txt_Remarks1" Rows="3" Width="636" Text='<%# Eval("Description")%>'>
                                    </dxe:ASPxMemo>
                                </td>
                            </tr>
                            <tr>
                                ...
                                grid_det.AddNewRow();
                                        ...
                                        <td>
                                            <dxe:ASPxButton ID="btn_DetAdd_quote" runat="server" Text="Stand Rates" Enabled='<%# SafeValue.SafeString(Eval("SequenceId"),"0")!="0"&&SafeValue.SafeString(Eval("ExportIndStr"),"N")!="Y" %>'
                                ...
                                PrintInvoice(txt_DocNo.GetText(),'IV');
                                        ...
                                        <td>
                                            <dxe:ASPxButton ID="btn_EDI" runat="server" Width="60" AutoPostBack="false"
                                                Enabled='<%# SafeValue.SafeString(Eval("SequenceId"),"0")!="0" %>' UseSubmitBehavior="false"
                                                Text="EDI">
                                                <ClientSideEvents Click="function(s,e){
                            ...
                            <tr>
                                <td colspan="6">
                                    <dxwgv:ASPxGridView ID="grid_InvDet" ClientInstanceName="grid_det" runat="server"
                                        ...
                                        <Columns>
                                            <dxwgv:GridViewDataColumn Caption="#" Width="70">
                                                <DataItemTemplate>
                                            ...
                                            <dxwgv:GridViewDataTextColumn Caption="ChgCode" FieldName="ChgCode" VisibleIndex="3"
                                             ...
                                             <dxwgv:GridViewDataTextColumn Caption="LotNo" FieldName="JobRefNo" VisibleIndex="3"
                                                Width="80">
                                            </dxwgv:GridViewDataTextColumn>
                                             <dxwgv:GridViewDataTextColumn Caption="RefNo" FieldName="MastRefNo" VisibleIndex="3"
                                                Width="80">
                                            </dxwgv:GridViewDataTextColumn>
                                            ...
                                            <dxwgv:GridViewDataTextColumn Caption="Qty" FieldName="Qty" VisibleIndex="5" Width="80">
                                            </dxwgv:GridViewDataTextColumn>
                                            ...
                                            <dxwgv:GridViewDataTextColumn Caption="Gst" FieldName="Gst" VisibleIndex="5"
                                                Width="80">
                                            </dxwgv:GridViewDataTextColumn>
                                            ...
                                            <EditForm>
                                                <table style="border-bottom: solid 1px black;">
                                                    <tr>
                                                        ...
                                                        <td>ChgCode</td>
                                                        <td>
                                                            <dxe:ASPxButtonEdit ID="txt_det_ChgCode" ClientInstanceName="txt_det_ChgCode" runat="server"
                                                                Width="80" HorizontalAlign="Left" BackColor="Control" ReadOnly="true" AutoPostBack="False" Text='<%# Bind("ChgCode") %>'>
                                                                <Buttons>
                                                                    <dxe:EditButton Enabled="true" Text=".."></dxe:EditButton>
                                                                </Buttons>
                                                                <ClientSideEvents ButtonClick="function(s, e) {
                                                        PopupChgCode_Ar(txt_det_ChgCode,txt_det_Des1,txt_det_Unit,txt_det_GstType,spin_det_GstP,txt_det_AcCode,txt_DetMastType.GetText());
                                                            }" />
                                                            </dxe:ASPxButtonEdit>
                                                        <td>Des</td>
                                                        <td width="230">
                                                        ...
                                                        <td>Currency</td>
                                                        <td>
                                                            <dxe:ASPxButtonEdit ID="txt_det_Currency" ClientInstanceName="txt_det_Currency" runat="server" MaxLength="3"
                                                                Width="70" HorizontalAlign="Left" AutoPostBack="False" Text='<%# Bind("Currency") %>'>
                                                                <Buttons>
                                                                    <dxe:EditButton Enabled="true" Text=".."></dxe:EditButton>
                                                                </Buttons>
                                                                <ClientSideEvents ButtonClick="function(s, e) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>ExRate</td>
                                                        <td>
                                                            <dxe:ASPxSpinEdit Increment="0" Width="70" ID="spin_det_ExRate" ClientInstanceName="spin_det_ExRate"
                                                        ...
                                                        <td>Type</td>
                                                        <td>
                                                            <dxe:ASPxComboBox runat="server" ID="txt_det_GstType" ClientInstanceName="txt_det_GstType" Width="100%" Text='<%# Bind("GstType")%>'>
                                                                <Items>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td></td>
                                                        <td>
                                                             <dxe:ASPxTextBox Width="100%" ID="ASPxTextBox3" ClientInstanceName="txt_det_Des3"
                                                                runat="server" Text='<%# Bind("ChgDes3") %>'>
                                                            </dxe:ASPxTextBox>
                                                        </td>
                                                        <td>Unit</td>
                                                        <td>
                                                        ...
                                                        <td>LotNo</td>
                                                        <td> <dxe:ASPxTextBox Width="100%" ID="txt_det_LotNo" ClientInstanceName="txt_det_LotNo"
                                                                runat="server" Text='<%# Bind("JobRefNo") %>'>
                                                            </dxe:ASPxTextBox></td>
                                                        <td colspan="2"></td>
                                                        <td>Loc Amt</td>
                                                        <td>
                                                    ...
                                                    <tr >
                                                        <td colspan="10">
                                                            ...
                                                            <table border="0" cellspacing="0">
                                                                ...
                                                                <td colspan="2">
                                                                    <dxe:ASPxTextBox ID="txt_MastRefNo" runat="server" BackColor="Control" ClientInstanceName="btn_MastRefNo" ReadOnly="true" Text='<%# Bind("MastRefNo")%>' Width="100%">
                                                                    </dxe:ASPxTextBox>
                                                                    <dxe:ASPxButtonEdit ID="btn_MastRefNo" ReadOnly="true" Visible="false" BackColor="Control" ClientInstanceName="btn_MastRefNo" runat="server" Text='<%# Bind("MastRefNo") %>' Width="170">
                                                                        <Buttons>
                                                                ...
                                                                <td style="display:none">
                                                                    <td width="55"  style="display:none">Job No </td>
                                                                    <td>
                                                                      <%--  <dxe:ASPxButtonEdit ID="btn_JobRefNo" ReadOnly="true" BackColor="Control" ClientInstanceName="btn_JobRefNo" runat="server" Text='<%# Bind("JobRefNo") %>' Width="190">
                                                                            <Buttons>
                                                                                <dxe:EditButton Text="..."></dxe:EditButton>
                                                                            </Buttons>
                                                                            <ClientSideEvents ButtonClick="function(s,e){
                                                                ...
                                                                <td width="65"  style="display:none">Split Type
                                                                </td>
                                                                <td  style="display:none">
                                                                    <dxe:ASPxComboBox ID="cbo_SplitType" runat="server" Text='<%# Bind("SplitType")%>' Width="70">
                                                                        <Items>
                                                                ...
                                                                <td width="55"  style="display:none">Job Type </td>
                                                                <td  style="display:none">
                                                                    <dxe:ASPxTextBox ID="txt_DetMastType" runat="server" BackColor="Control" ClientInstanceName="txt_DetMastType" ReadOnly="true" Text='<%# Bind("MastType")%>' Width="100%">
                                                                    </dxe:ASPxTextBox>
                                                                </td>
                                                            </table>
                                                        </td>
                                                        <td width="65"  style="display:none">Other Amt</td>
                                                        <td  style="display:none">
                                                    ...
                                                    <tr>
                                                        <td colspan="12" style="text-align: right; padding: 2px 2px 2px 2px">
