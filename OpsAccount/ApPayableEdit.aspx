<%@ Page Language="C#" EnableViewState="false" AutoEventWireup="true" CodeFile="ApPayableEdit.aspx.cs" Inherits="Account_ApPayableEdit" %>
            ...
            <table>
                <tr>
                    ...
                    <td>
                     ...
                     window.location='ApPayableEdit.aspx?no='+txtSchNo.GetText()
                        }" />
                                    </dxe:ASPxButton>
                                </td>
                                <td>
                                    <dxe:ASPxButton ID="ASPxButton3" Width="100" runat="server" Text="Go Search" AutoPostBack="false"
                                        ...
                                        <ClientSideEvents Click="function(s,e) {
                                           window.location='ApPayableList.aspx';
                        }" />
                                    </dxe:ASPxButton>
                                </td>
                            </tr>
            ...
            <dxwgv:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" runat="server"
                ...
                <Templates>
                    <EditForm>
                            ...
                            <tr>
                                ...
                                <td width="160">
                                    <dxe:ASPxComboBox runat="server" ID="cbo_DocType" ClientInstanceName="cbo_DocType"
                                        Width="155" Text='<%# Eval("DocType")%>' Enabled='<%# SafeValue.SafeString(Eval("SequenceId"),"0")=="0"%>'>
                                        <Items>
                                ...
                                <td width="160">
                                    <dxe:ASPxDateEdit ID="txt_DocDt" runat="server" Width="100" Value='<%# Eval("DocDate")%>'
                                        EditFormat="Custom" EditFormatString="dd/MM/yyyy" ReadOnly="true" BackColor="Control">
                                    </dxe:ASPxDateEdit>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <dxe:ASPxTextBox ID="txt_SupplierBillNo" ClientInstanceName="txt_SupplierBillNo"
                                        Width="130" runat="server" Text='<%# Eval("SupplierBillNo") %>'>
                                    </dxe:ASPxTextBox>
                                </td>
                                <td>Supplier Bill Date
                                </td>
                                <td>
                                    <dxe:ASPxDateEdit ID="txt_SupplierBillDate" runat="server" Width="155" Value='<%# Eval("SupplierBillDate")%>'
                            ...
                            <tr>
                                ...
                                <td>
                                    <dxe:ASPxTextBox runat="server" ID="txt_AcSource" ClientInstanceName="txt_AcSource"
                                        Width="155" ReadOnly="true" BackColor="Control" Text='<%# Eval("AcSource")%>'>
                                    </dxe:ASPxTextBox>
                                </td>
                                <td>A/C Period
                                </td>
                        ...
                        <td>
                            <dxe:ASPxButton ID="btn_Post" runat="server" Width="100" AutoPostBack="false" UseSubmitBehavior="false"
                                Enabled='<%# SafeValue.SafeInt(Eval("SequenceId"),0)>0&&SafeValue.SafeString(Eval("ExportInd"),"N")!="Y"&& SafeValue.SafeString(Eval("CancelInd"),"N")!="Y" %>'
                                Text="Post">
                                <ClientSideEvents Click="function(s,e) {
