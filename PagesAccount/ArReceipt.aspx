<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ArReceipt.aspx.cs" Inherits="Account_ArReceipt" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ShowArReceipt(invN) {
            window.location = 'EditPage/ArReceiptEdit.aspx?no=' + invN;
        }
    </script>
...
<body width="800">
    ...
    ShowArReceipt('0');}" />
        ...
        <dxwgv:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" runat="server"
            DataSourceID="dsArReceipt" Width="100%" KeyFieldName="SequenceId" AutoGenerateColumns="False">
            ...
            <Columns>
                ...
                <dxwgv:GridViewDataTextColumn Caption="Remark" FieldName="Remark" VisibleIndex="99">
                </dxwgv:GridViewDataTextColumn>
