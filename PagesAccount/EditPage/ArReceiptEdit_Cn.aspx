<%@ Page Language="C#" AutoEventWireup="true" EnableViewState="false"  CodeFile="ArReceiptEdit_Cn.aspx.cs" Inherits="Account_ArReceiptEdit_Cn" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function AddDet() {
            ...
            if (docAmt > 0) {
                popubCtr.SetHeaderText('Credit Note List');
                popubCtr.SetContentUrl('../SelectPage/ArInvoiceList_Cn_multi.aspx?partyTo=' + cmb_PartyTo.GetValue() + "&no=" + txt_Oid.GetText());
                popubCtr.Show();
            } else {
        ...
        function PrintBill() {
            ...
            window.open("/ReportAccount/printview.aspx?doc=5&docId=" + invN);
        }
...
<body>
    ...
    <div>
            ...
            <tr>
                ...
                <td>
                    <table>
                     ...
                     window.location='ArReceiptEdit_Cn.aspx?no='+txtSchNo.GetText()
                        }" />
                                </dxe:ASPxButton>
                            </td>
                            <td>
                                <dxe:ASPxButton ID="ASPxButton9" Width="110" runat="server" Text="Add New" AutoPostBack="False">
                                    <ClientSideEvents Click="function(s, e) {
                     window.location='ArReceiptEdit_Cn.aspx?no=0'
                        }" />
                                </dxe:ASPxButton>
                            </td>
                            <td>
                                <dxe:ASPxButton ID="btn_back" Width="110" runat="server" Text="Go Search" AutoPostBack="False">
                                    <ClientSideEvents Click="function(s, e) {
                     window.location='../ArReceipt_Cn.aspx';
                        }" />
                                </dxe:ASPxButton>
                            </td>
                        </tr>
       ...
       <dxwgv:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" runat="server"
            DataSourceID="dsArReceipt" KeyFieldName="SequenceId" OnInit="ASPxGridView1_Init" Width="800"
                ...
                <EditForm>
                    ...
                    <tr><td colspan="6" style="display:none">
                     ...
                     <dxe:ASPxComboBox ID="cmb_PartyTo" ClientInstanceName="cmb_PartyTo" runat="server" Value='<%# Eval("PartyTo") %>'
                        Width="350" DropDownWidth="380" DropDownStyle="DropDownList" DataSourceID="dsCustomerMast"
                        ...
                        <tr>
                            ...
                            <td>
                                <dxe:ASPxSpinEdit Increment="0" ID="txt_DocExRate" Width="100" ClientInstanceName="txt_DocExRate" DisplayFormatString="0.000000" DecimalPlaces="6"
                                    runat="server" Value='<%# Eval("DocExRate") %>'>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <dxe:ASPxTextBox runat="server" ID="txt_BankName" Width="350" Text='<%# Eval("BankName")%>'>
                                </dxe:ASPxTextBox>
                            </td>
                        <tr>
                            <td>Doc Amt</td>
                       ...
                       <td colspan="6"><table><tr>
                            ...
                            <td>&nbsp;</td>
                            <td>
                                <dxe:ASPxButton ID="btn_DetAdd1" runat="server" Text="Add Det" Enabled='<%# SafeValue.SafeString(Eval("SequenceId"),"0")!="0"&&SafeValue.SafeString(Eval("ExportInd"),"N")!="Y" %>'
                            ...
                            <td>&nbsp;</td>
                            <td>
                                <dxe:ASPxButton ID="btn_DetAdd" runat="server" Text="Add AR Det" Enabled='<%# SafeValue.SafeString(Eval("SequenceId"),"0")!="0"&&SafeValue.SafeString(Eval("ExportInd"),"N")!="Y" %>'
                                    AutoPostBack="false" UseSubmitBehavior="false">
                                    <ClientSideEvents Click="function(s,e){
                               AddDet();
                            }" />
                            ...
                            <td>&nbsp;</td>
                            <td>
                                <dxe:ASPxButton ID="ASPxButton5" runat="server" Width="80" AutoPostBack="false" UseSubmitBehavior="false" Enabled='<%# SafeValue.SafeString(Eval("SequenceId"),"0")!="0"&&SafeValue.SafeString(Eval("ExportInd"),"N")!="Y" %>'
                                    Text="Gain&Loss">
                                                <ClientSideEvents Click="function(s,e) {
                            ...
                            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                            <td>
                                <dxe:ASPxButton ID="ASPxButton6" runat="server" Width="90" AutoPostBack="false" UseSubmitBehavior="false" Enabled='<%# SafeValue.SafeString(Eval("SequenceId"),"0")!="0"&&SafeValue.SafeString(Eval("ExportInd"),"N")!="Y" %>'
                                    Text="Delete Detail">
                                    <ClientSideEvents Click="function(s,e) {
                            ...
                            <td colspan="6">
                                <dxwgv:ASPxGridView ID="grid_InvDet" ClientInstanceName="grid_det" runat="server"
                                    ...
                                    <Columns>
                                        ...
                                        <dxwgv:GridViewDataTextColumn Caption="DocId" FieldName="DocId" Visible="false"
                                            Width="80px">
                                        </dxwgv:GridViewDataTextColumn>
