    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["partyTo"] != null && Request.QueryString["no"] != null)
            {
                ...
                string sql = string.Format(@"SELECT TOP (200) SequenceId, DocType, DocNo, DocDate,MastType,SupplierBillNo,SupplierBillDate, CurrencyId, ExRate, DocAmt, LocAmt, BalanceAmt
