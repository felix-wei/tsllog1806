...
<body>
    ...
    <div>
		<div style="background:#cccccc; border-bottom:solid 3px #888888;height:32px; width:100%; padding:2px;position:fixed;left:0px;top:0px;">		
         <table>
            <tr>
            <td>Bill No
            </td>
            ...
            <td>
                ...
                <td>
                    <dxe:ASPxButton ID="ASPxButton1" runat="server" Text="Add To Receipt"  AutoPostBack="false" UseSubmitBehavior="false">
                        <ClientSideEvents Click="function(s,e) {
...
<div style="height:48px;width:900px;"></div>		
        <dxwgv:ASPxGridView ID="ASPxGridView1" runat="server" 
            ClientInstanceName="grid" Width="900" KeyFieldName="SequenceId" oncustomdatacallback="ASPxGridView1_CustomDataCallback" oncustomcallback="ASPxGridView1_CustomCallback">
            ...
            <Columns>
                ...
                <dxwgv:GridViewDataTextColumn Caption="Payment Amt" VisibleIndex="10" Width="120">
                </dxwgv:GridViewDataTextColumn>
