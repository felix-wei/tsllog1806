<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="ChartOfAccount.aspx.cs" Inherits="SelectPage_ChartOfAccount" %>
        ...
        <dxwgv:ASPxGridView ID="ASPxGridView1" runat="server" ClientInstanceName="grid" DataSourceID="dsGlAccChart"
            ...
            <Columns>
                <dxwgv:GridViewDataTextColumn Caption="#" VisibleIndex="0" Width="5%">
                    <DataItemTemplate>
                        <a onclick='parent.PutValue("<%# Eval("Code") %>","<%# Eval("AcDesc") %>","<%# Eval("AcDorc") %>");'>Select</a>
                    </DataItemTemplate>
                    <EditItemTemplate>
                    </EditItemTemplate>
