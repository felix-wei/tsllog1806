<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VolumeByAgtView.aspx.cs" Inherits="ReportAir_Report_VolumeByAgtView" %>
...
<frameset runat="server" id="rptFrameset" cols="250,*" border="0" framespacing="2" bordercolor="#9B98B6">
	<frame name="schFrame" runat="server" id="schFrame" src="VolumeByAgt.aspx" />
