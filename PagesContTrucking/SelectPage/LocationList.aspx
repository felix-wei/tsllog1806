<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LocationList.aspx.cs" Inherits="PagesContTrucking_SelectPage_LocationList" %>
            ...
            <dxwgv:ASPxGridView ID="ASPxGridView1" runat="server" Width="100%"
                ...
                <Columns>
                    <dxwgv:GridViewDataTextColumn Caption="#" VisibleIndex="0" Width="5%">
                        <DataItemTemplate>
                            <a onclick='parent.CTM_PutValue2("<%# Eval("Code") %>","<%# Eval("Name") %>");'>Select</a>
                        </DataItemTemplate>
                        <EditItemTemplate>
                        </EditItemTemplate>
