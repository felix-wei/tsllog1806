<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewJobListBill.aspx.cs" Inherits="PagesContTrucking_Job_NewJobListBill" %>
   ...
   <script src="../script/firebase.js"></script>
    ...
    <script type="text/javascript">
        ...
        function create_inv_inline_callback(res){
            ...
            popubCtr1.SetContentUrl('../SelectPage/SelectJobCost.aspx?no=' + jobNo + '&type=' + type + '&client=' + client+"&quoteNo="+quoteNo);
            popubCtr1.Show();
    ...
    <form id="form1" runat="server">
        <div>
                    ...
                    <td>
                        <dxe:ASPxComboBox ID="cbb_BillingStatusCode" runat="server" Width="100">
                            <Items>
                                ...
                                <dxe:ListEditItem Value="UnClosed" Text="UnClosed" />
            ...
            <dxwgv:ASPxGridView ID="grid_Transport" ClientInstanceName="detailGrid" runat="server" OnHtmlDataCellPrepared="grid_Transport_HtmlDataCellPrepared" OnPageSizeChanged="grid_Transport_PageSizeChanged"
                ...
                <Settings HorizontalScrollBarMode="Visible" VerticalScrollableHeight="430"/>
                            ...
                            <table style="width: 100%">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div class='<%# SafeValue.SafeString(Eval("DocNo"))==""?"hide":"show" %>' style="min-width: 120px;">
