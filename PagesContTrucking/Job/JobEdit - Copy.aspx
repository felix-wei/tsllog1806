...
<body>
        ...
        <div>
            <table>
                <tr>
                    ...
                    <td>
                        <dxe:ASPxButton ID="btn_AddNew" runat="server" Text="Add Goods Receipt" AutoPostBack="false">
                            <ClientSideEvents Click="function(s,e){
                        grid_job.GetValuesOnCustomCallback('AddGR',onGRCallBack);
                    }" />
                        </dxe:ASPxButton>
                    </td>
                    <td>
                        <dxe:ASPxButton ID="ASPxButton3" runat="server" Text="Add Delivery Order" AutoPostBack="false">
                            <ClientSideEvents Click="function(s,e){
                        grid_job.GetValuesOnCustomCallback('AddDO',onDOCallBack);
                    }" />
                        </dxe:ASPxButton>
                    </td>
                                ...
                                <td>
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                <dxe:ASPxButton ID="btn_PrintJobSheet" runat="server" Text="Print JobSheet" AutoPostBack="false" Width="100"></dxe:ASPxButton>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                        ...
                        <div style="padding: 10px; background-color: #FFFFFF; border: 1px solid #A8A8A8; white-space: nowrap">
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <dxe:ASPxComboBox ID="cbb_JobType" runat="server" Value='<%# Eval("JobType") %>' Width="80">
                                            <Items>
                                                ...
                                                <%--<tr>
                                                    ...
                                                    <td colspan="3">
                                                        <table>
                                                            <tr>
                                                                <td>
                                                                    <dxe:ASPxButtonEdit ID="btn_HaulierId" ClientInstanceName="btn_HaulierId" runat="server" Text='<%# Eval("HaulierId") %>' Width="100" AutoPostBack="False" ReadOnly="true">
                                                                        <Buttons>
                                                                            <dxe:EditButton Enabled="true" Text=".."></dxe:EditButton>
                                                                        </Buttons>
                                                                        <ClientSideEvents ButtonClick="function(s, e) {
                                                                ...
                                                                <td>
                                                                    <dxe:ASPxTextBox ID="txt_HaulierName" ClientInstanceName="txt_HaulierName" runat="server" Width="300" ReadOnly="true" BackColor="Control"></dxe:ASPxTextBox>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <dxe:ASPxComboBox ID="cbb_warehouse_status" runat="server" Text='<%# Bind("WarehouseStatus") %>' Width="165">
                                                                            <Items>
                                                                                ...
                                                                                <dxe:ListEditItem Value="Loaded" Text="Loaded" />
                                                                            </Items>
                                                                        </dxe:ASPxComboBox>
                                                                    </td>
                                                                    <td>B/R</td>
                                                            ...
                                                            <table style="width: 100%;">
                                                                ...
                                                                <tr>
                                                                    <td colspan="3" style="padding: 4px; text-align: center; background: lightgreen">
                                                                        <b style="float: left;" onclick="$('.fee_showhide').toggle(1000);">+</b>
                                                                        <%--<div style="">--%>
                                                                        <b>COMMON CHARGES</b>
                                                                    </td>
	...
	<tr class="fee_showhide">
		...
		<td>
			<dxe:ASPxTextBox ID="txt_feeNote1" runat="server" Text='<%# Bind("FeeNote1") %>' Width="100" />
		</td>		
		<td>WEIGNING</td>
		<td>
		...
		<td>
			<dxe:ASPxTextBox ID="txt_feeNote11" runat="server" Text='<%# Bind("FeeNote11") %>' Width="100" />
		</td>		
		<td>PSA STORAGE</td>
		<td>
		...
		<td>
			<dxe:ASPxTextBox ID="txt_feeNote21" runat="server" Text='<%# Bind("FeeNote21") %>' Width="100" />
		</td>		
		<td>PSA FLEXIBOOK</td>
		<td>
		...
		<td>
			<dxe:ASPxTextBox ID="txt_feeNote31" runat="server" Text='<%# Bind("FeeNote31") %>' Width="100" />
		</td>		
	</tr>
	<tr class="fee_showhide">
		<td>FUEL</td>
		...
		<td>
			<dxe:ASPxTextBox ID="txt_feeNote2" runat="server" Text='<%# Bind("FeeNote2") %>' Width="100" />
		</td>		
		<td>WASHING</td>
		<td>
		...
		<td>
			<dxe:ASPxTextBox ID="txt_feeNote12" runat="server" Text='<%# Bind("FeeNote12") %>' Width="100" />
		</td>		
		<td>EX ONE-WAY</td>
		<td>
		...
		<td>
			<dxe:ASPxTextBox ID="txt_feeNote22" runat="server" Text='<%# Bind("FeeNote22") %>' Width="100" />
		</td>		
		<td>PSA NO SHOW</td>
		<td>
		...
		<td>
			<dxe:ASPxTextBox ID="txt_feeNote32" runat="server" Text='<%# Bind("FeeNote32") %>' Width="100" />
		</td>		
	</tr>
	<tr class="fee_showhide">
		<td>DHC</td>
		...
		<td>
			<dxe:ASPxTextBox ID="txt_feeNote3" runat="server" Text='<%# Bind("FeeNote3") %>' Width="100" />
		</td>		
		<td>REPAIR</td>
		<td>
		...
		<td>
			<dxe:ASPxTextBox ID="txt_feeNote13" runat="server" Text='<%# Bind("FeeNote13") %>' Width="100" />
		</td>		
		<td>WRONG WEIGHT</td>
		<td>
		...
		<td>
			<dxe:ASPxTextBox ID="txt_feeNote23" runat="server" Text='<%# Bind("FeeNote23") %>' Width="100" />
		</td>		
		...
		<td>
			<dxe:ASPxTextBox ID="txt_feeNote33" runat="server" Text='<%# Bind("FeeNote33") %>' Width="100" />
		</td>		
	</tr>
	<tr class="fee_showhide">
		<td>PORTNET</td>
		...
		<td>
			<dxe:ASPxTextBox ID="txt_feeNote4" runat="server" Text='<%# Bind("FeeNote4") %>' Width="100" />
		</td>		
		<td>DETENTION</td>
		<td>
		...
		<td>
			<dxe:ASPxTextBox ID="txt_feeNote14" runat="server" Text='<%# Bind("FeeNote14") %>' Width="100" />
		</td>		
		<td>ELECTRICITY</td>
		<td>
		...
		<td>
			<dxe:ASPxTextBox ID="txt_feeNote24" runat="server" Text='<%# Bind("FeeNote24") %>' Width="100" />
		</td>		
		<td>PARKING</td>
		<td>
		...
		<td>
			<dxe:ASPxTextBox ID="txt_feeNote34" runat="server" Text='<%# Bind("FeeNote34") %>' Width="100" />
		</td>		
	</tr>
	<tr class="fee_showhide">
		<td>CMS</td>
		...
		<td>
			<dxe:ASPxTextBox ID="txt_feeNote5" runat="server" Text='<%# Bind("FeeNote5") %>' Width="100" />
		</td>		
		<td>DEMURRAGE</td>
		<td>
		...
		<td>
			<dxe:ASPxTextBox ID="txt_feeNote15" runat="server" Text='<%# Bind("FeeNote15") %>' Width="100" />
		</td>		
		<td>PERMIT</td>
		<td>
		...
		<td>
			<dxe:ASPxTextBox ID="txt_feeNote25" runat="server" Text='<%# Bind("FeeNote25") %>' Width="100" />
		</td>		
		<td>SHIFTING</td>
		<td>
		...
		<td>
			<dxe:ASPxTextBox ID="txt_feeNote35" runat="server" Text='<%# Bind("FeeNote35") %>' Width="100" />
		</td>		
	</tr>
	<tr class="fee_showhide">
		<td>PSA LOLO</td>
		...
		<td>
			<dxe:ASPxTextBox ID="txt_feeNote6" runat="server" Text='<%# Bind("FeeNote6") %>' Width="100" />
		</td>		
		<td>C/S LOLO</td>
		<td>
		...
		<td>
			<dxe:ASPxTextBox ID="txt_feeNote16" runat="server" Text='<%# Bind("FeeNote16") %>' Width="100" />
		</td>		
		<td>EXCHANGE DO</td>
		<td>
		...
		<td>
			<dxe:ASPxTextBox ID="txt_feeNote26" runat="server" Text='<%# Bind("FeeNote26") %>' Width="100" />
		</td>		
		<td>STAND-BY</td>
		<td>
		...
		<td>
			<dxe:ASPxTextBox ID="txt_feeNote36" runat="server" Text='<%# Bind("FeeNote36") %>' Width="100" />
		</td>		
	</tr>
	<tr class="fee_showhide">
		<td></td>
		...
		<td>
			<dxe:ASPxTextBox ID="txt_feeNote17" runat="server" Text='<%# Bind("FeeNote17") %>' Width="100" />
		</td>		
		<td>SEAL</td>
		<td>
		...
		<td>
			<dxe:ASPxTextBox ID="txt_feeNote27" runat="server" Text='<%# Bind("FeeNote27") %>' Width="100" />
		</td>		
		<td></td>
		<td>
		</td>
	...
	<tr class="fee_showhide">
		...
		<td>
			<dxe:ASPxTextBox ID="txt_feeNote18" runat="server" Text='<%# Bind("FeeNote18") %>' Width="100" />
		</td>		
		<td>DOCUMENTATION</td>
		<td>
		...
		<td>
			<dxe:ASPxTextBox ID="txt_feeNote28" runat="server" Text='<%# Bind("FeeNote28") %>' Width="100" />
		</td>		
		<td>MISC 1</td>
		<td>
		...
		<td>
			<dxe:ASPxTextBox ID="txt_feeNote37" runat="server" Text='<%# Bind("FeeNote37") %>' Width="100" />
		</td>		
	</tr>
	<tr class="fee_showhide">
		<td> </td>
		...
		<td>
			<dxe:ASPxTextBox ID="txt_feeNote19" runat="server" Text='<%# Bind("FeeNote19") %>' Width="100" />
		</td>		
		<td>ERP CHARGES</td>
		<td>
		...
		<td>
			<dxe:ASPxTextBox ID="txt_feeNote29" runat="server" Text='<%# Bind("FeeNote29") %>' Width="100" />
		</td>		
		<td>MISC 2</td>
		<td>
		...
		<td>
			<dxe:ASPxTextBox ID="txt_feeNote38" runat="server" Text='<%# Bind("FeeNote38") %>' Width="100" />
		</td>		
	</tr>
	<tr class="fee_showhide">
		<td> </td>
		...
		<td>
			<dxe:ASPxTextBox ID="txt_feeNote30" runat="server" Text='<%# Bind("FeeNote30") %>' Width="100" />
		</td>		
		<td>MISC 3</td>
		<td>
		...
		<td>
			<dxe:ASPxTextBox ID="txt_feeNote39" runat="server" Text='<%# Bind("FeeNote39") %>' Width="100" />
		</td>		
	</tr>
                                                ...
                                                <dxwgv:ASPxGridView ID="grid_Trip" ClientInstanceName="grid_Trip" runat="server" Width="950px" DataSourceID="dsTrip" KeyFieldName="Id" OnInit="grid_Trip_Init" AutoGenerateColumns="False" OnBeforePerformDataSelect="grid_Trip_BeforePerformDataSelect" OnHtmlEditFormCreated="grid_Trip_HtmlEditFormCreated" OnRowInserting="grid_Trip_RowInserting" OnInitNewRow="grid_Trip_InitNewRow" OnRowDeleting="grid_Trip_RowDeleting" OnRowUpdating="grid_Trip_RowUpdating" OnRowDeleted="grid_Trip_RowDeleted" OnRowInserted="grid_Trip_RowInserted" OnRowUpdated="grid_Trip_RowUpdated" OnCustomDataCallback="grid_Trip_CustomDataCallback">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dxwgv:GridViewDataColumn VisibleIndex="10" FieldName="Charge1" Caption="Total Surcharge">
                                                            <DataItemTemplate><%# SafeValue.SafeDecimal(Eval("Charge1"))+SafeValue.SafeDecimal(Eval("Charge2"))+SafeValue.SafeDecimal(Eval("Charge3"))+SafeValue.SafeDecimal(Eval("Charge4"))+SafeValue.SafeDecimal(Eval("Charge5"))+SafeValue.SafeDecimal(Eval("Charge6"))+SafeValue.SafeDecimal(Eval("Charge7"))+SafeValue.SafeDecimal(Eval("Charge8"))+SafeValue.SafeDecimal(Eval("Charge9")) %></DataItemTemplate>
                                                        </dxwgv:GridViewDataColumn>
                                                    </Columns>
                                                    <Templates>
                                                        <EditForm>
                                                    ...
                                                    <td colspan="3">
                                                        <dxwgv:ASPxGridView ID="ASPxGridView1" runat="server" Width="100%" DataSourceID="dsLogEvent"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <dxwgv:GridViewDataTextColumn Caption="Ag.Rate" FieldName="Value2" VisibleIndex="2">
                                                                    <PropertiesTextEdit DisplayFormatString="#,##0.00"></PropertiesTextEdit>
                                                                </dxwgv:GridViewDataTextColumn>
                                                                <dxwgv:GridViewDataTextColumn Caption="DN" FieldName="Value3" VisibleIndex="2">
                                                                    <PropertiesTextEdit DisplayFormatString="#,##0.00"></PropertiesTextEdit>
                                                                </dxwgv:GridViewDataTextColumn>
                                                                <dxwgv:GridViewDataTextColumn Caption="Fr.Collect" FieldName="Value4" VisibleIndex="2">
                                                                    <PropertiesTextEdit DisplayFormatString="#,##0.00"></PropertiesTextEdit>
                                                                </dxwgv:GridViewDataTextColumn>
                                                                <dxwgv:GridViewDataTextColumn Caption="Payment VO" FieldName="Value5" VisibleIndex="2">
                                                                    <PropertiesTextEdit DisplayFormatString="#,##0.00"></PropertiesTextEdit>
                                                                </dxwgv:GridViewDataTextColumn>
                                                                <dxwgv:GridViewDataTextColumn Caption="CN" FieldName="Value6" VisibleIndex="2">
                                                                    <PropertiesTextEdit DisplayFormatString="#,##0.00"></PropertiesTextEdit>
                                                                </dxwgv:GridViewDataTextColumn>
                                                                <dxwgv:GridViewDataTextColumn Caption="Imp.Rate" FieldName="Value7" VisibleIndex="2">
                                                                    <PropertiesTextEdit DisplayFormatString="#,##0.00"></PropertiesTextEdit>
                                                                </dxwgv:GridViewDataTextColumn>
                                                                <dxwgv:GridViewDataTextColumn Caption="Other" FieldName="Value8" VisibleIndex="2">
                                                                    <PropertiesTextEdit DisplayFormatString="#,##0.00"></PropertiesTextEdit>
                                                                </dxwgv:GridViewDataTextColumn>
                                                                <dxwgv:GridViewDataTextColumn Caption="P&L" FieldName="Value8" VisibleIndex="2" Width="100">
