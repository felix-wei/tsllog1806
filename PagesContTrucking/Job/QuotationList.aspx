    ...
    <form id="form1" runat="server">
        <div>
                        ...
                        <div style="padding: 2px 2px 2px 2px; width: 360px">
                            <table style="text-align: left; padding: 2px 2px 2px 2px; width: 350px">
                                <tr>
                                    <td>Creation&nbsp;Date</td>
                                    <td>
                                        <dxe:ASPxDateEdit ID="txt_new_JobDate" ClientInstanceName="txt_new_JobDate" runat="server" Width="180px" DisplayFormatString="dd/MM/yyyy" EditFormatString="dd/MM/yyyy"></dxe:ASPxDateEdit>
                                    </td>
                                ...
                                <tr>
                                    <td>Job&nbsp;Type</td>
                                    <td>
                                        <dxe:ASPxComboBox ID="cbb_new_jobtype" ClientInstanceName="cbb_new_jobtype" runat="server" Width="180px" DropDownStyle="DropDown" IncrementalFilteringMode="StartsWith">
                                            <Items>
            ...
            <dxwgv:ASPxGridView ID="grid_Transport" ClientInstanceName="detailGrid" runat="server"
                ...
                <Settings HorizontalScrollBarMode="Visible" VerticalScrollBarStyle="Virtual" VerticalScrollableHeight="450"/>
                <SettingsCustomizationWindow Enabled="True" />
                <SettingsEditing Mode="EditForm" />
                <SettingsPager Mode="ShowAllRecords"></SettingsPager>
                <Columns>
                    <dxwgv:GridViewDataTextColumn Caption="Quotation No" FieldName="JobNo" FixedStyle="Left">
                        <DataItemTemplate>
                            <%--<a onclick="go_page('<%# Eval("JobNo") %>')"><%# Eval("JobNo") %></a>--%>
                            <div class='<%# SafeValue.SafeString(string.Format("{0}",Eval("StatusCode")))=="New"?"link":"none" %>' style="min-width: 70px;">
                                <a href='javascript:open_job("<%# Eval("QuoteNo") %>","<%# Eval("JobType") %>")'><%# Eval("QuoteNo") %></a>
                            </div>
                        </DataItemTemplate>
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataColumn FieldName="QuoteStatus" Caption="Quote Status" FixedStyle="Left"></dxwgv:GridViewDataColumn>
                    <dxwgv:GridViewDataColumn FieldName="JobNo" Caption="Job No" Width="120px" FixedStyle="Left">
                        <DataItemTemplate>
