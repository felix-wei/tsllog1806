<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdatePlannerTPT.aspx.cs" Inherits="PagesContTrucking_Daily_UpdatePlannerTPT" %>
        ...
        app.factory('SV_Job', function ($http, SV_Common) {
            ...
            var vm = {
                init: function () {
                    ...
                    data.search = {
                        From: new Date(moment().add(1, 'days')),
                ...
                <table class="bx_table_grid">
                    ...
                    <tr ng-repeat="row in vm.leftList">
                        ...
                        <td>Job:{{row.JobRemark}}<br />
                            Cont:{{row.ContRemark}}</td>
                        <td>
                            <div class="col_boxset col_boxset_p">
                                <div class="col_box_small col_box_small_p {{row.JobType=='IMP'?'col_box_small_p_grey':(row.JobType=='EXP'?'col_box_small_p_red':'')}}" ng-class="{'P':'col_box_orange','S':'col_box_green','C':'col_box_blue','X':'col_box_gray'}[row.Statuscode]" ng-click="action.viewRow(row);">
                                    &nbsp;{{row.TripCode}}
                                </div>
                            </div>
                        </td>
            ...
            <div class="part2" ng-class="{'M1':'part2M1','M2':'part2M2','M3':'part2M3','M4':'part2M4'}[vm.search.viewMode]">
                <table class="bx_table_grid">
                    ...
                    <tr ng-repeat="row in vm.rightList">
                        <td ng-show="row.isTitle" style="background-color: #aaaaaa; padding: 6px;" colspan="10">
                        ...
                        <td ng-hide="row.isTitle">
                            <div ng-hide="planner.data.chooseLeftList.length>0" style="min-width: 120px">
                                <input type="button" class="button" value="<" ng-click="planner.replan(row);" />
                                <input type="button" class="button" value=">" ng-click="planner.assign(row);" />
