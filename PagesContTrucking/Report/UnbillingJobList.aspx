<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UnbillingJobList.aspx.cs" Inherits="PagesContTrucking_Report_UnbillingJobList" %>
        ...
        <div>
            ...
            <dxwgv:ASPxGridView ID="grid_Transport" ClientInstanceName="detailGrid" runat="server" Width="850" KeyFieldName="Id" AutoGenerateColumns="False">
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataColumn FieldName="ClientName" Caption="ClientName"></dxwgv:GridViewDataColumn>
                    ...
                    <dxwgv:GridViewDataColumn FieldName="ClientRefNo" Caption="ClientRefNo"></dxwgv:GridViewDataColumn>
