...
public partial class PagesContTrucking_DriverReporting_Fuel_Log : System.Web.UI.Page
{
    ...
    protected void grid_Transport_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
    {
        ...
        e.NewValues["Amount"] = SafeValue.SafeDecimal(e.NewValues["Amount"]);
    }
    ...
    protected void grid_Transport_Init(object sender, EventArgs e)
    {
        ...
        if (grid != null)
        {
            grid.ForceDataRowType(typeof(C2.VehicleFuelLog));
        }
    }
}