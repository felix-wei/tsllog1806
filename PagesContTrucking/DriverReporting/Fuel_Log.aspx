<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Fuel_Log.aspx.cs" Inherits="PagesContTrucking_DriverReporting_Fuel_Log" %>
...
<body>
    <form id="form1" runat="server">
        <wilson:DataSource ID="dsTransport" runat="server" ObjectSpace="C2.Manager.ORManager"
            TypeName="C2.VehicleFuelLog" KeyMember="Id" FilterExpression="1=0" />
        <table>
            <tr>
                <td>Driver</td>
                <td>
        ...
        <dxwgv:ASPxGridView ID="grid_Transport" ClientInstanceName="detailGrid" runat="server" DataSourceID="dsTransport" KeyFieldName="Id" OnRowInserting="grid_Transport_RowInserting" OnRowDeleting="grid_Transport_RowDeleting" OnRowUpdating="grid_Transport_RowUpdating" OnInitNewRow="grid_Transport_InitNewRow" OnInit="grid_Transport_Init">
            ...
            <Columns>
                ...
                <dx:GridViewDataSpinEditColumn FieldName="Volume" Caption="Litre" Width="100" PropertiesSpinEdit-SpinButtons-ShowIncrementButtons="false" PropertiesSpinEdit-Increment="0" PropertiesSpinEdit-DecimalPlaces="2" PropertiesSpinEdit-DisplayFormatString="0.00"></dx:GridViewDataSpinEditColumn>
                <dx:GridViewDataSpinEditColumn FieldName="Amount" Caption="Mileage" Width="100" PropertiesSpinEdit-SpinButtons-ShowIncrementButtons="false" PropertiesSpinEdit-Increment="0" PropertiesSpinEdit-DecimalPlaces="2" PropertiesSpinEdit-DisplayFormatString="0.00"></dx:GridViewDataSpinEditColumn>
