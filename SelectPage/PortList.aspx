<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PortList.aspx.cs" Inherits="SelectPage_PortList" %>
     ...
     <table>
        ...
        <dxwgv:ASPxGridView ID="ASPxGridView1" runat="server" Width="100%"
            ...
            <Columns>
                ...
                <dxwgv:GridViewDataTextColumn Caption="Port Code" FieldName="Code" VisibleIndex="1" SortIndex="0" Width="150" SortOrder="Ascending">
                </dxwgv:GridViewDataTextColumn>
