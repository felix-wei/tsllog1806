<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StdRateList.aspx.cs" Inherits="PagesSelectpge_StdRateList" %>
...
<body>
    ...
    <div>
        ...
        <dxwgv:ASPxGridView ID="ASPxGridView1" ClientInstanceName="grid_Sch" runat="server" 
            KeyFieldName="SequenceId" Width="650"
              ...
              <templates>
                <DataRow>
                    <div style="padding: 5px">
                        <table width="650" style="border-bottom: solid 1px black;">
                            <tr style="font-weight: bold; font-size: 11px">
                                <td style="width: 100px">
                                    <%# Eval("ChgCode")%>
                                </td>
                                <td style="width: 250px">
                                    <%# D.Text("select ChgCodeDes from XxChgCode where ChgCodeId='" + Eval("ChgCode","{0}") + "'") %>
                                </td>
                                <td style="width: 100px">
                                    
                                <dxe:ASPxSpinEdit SpinButtons-ShowIncrementButtons="false" Width="70" ID="spin_Qty"
                                ...
                                <td style="width: 100px">
                                <dxe:ASPxSpinEdit SpinButtons-ShowIncrementButtons="false" Width="70" ID="spin_Price"
                                ...
                                <dxe:ASPxSpinEdit SpinButtons-ShowIncrementButtons="false" Width="60" ID="spin_ExRate"
                                    runat="server" DisplayFormatString="0.00" DecimalPlaces="6"
