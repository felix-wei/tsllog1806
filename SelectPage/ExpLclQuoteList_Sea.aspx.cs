...
public partial class PagesFreight_Account_ExpLclQuoteList_Sea : System.Web.UI.Page
{
    ...
    protected void btn_Sch_Click(object sender, EventArgs e)
    {
        ...
        if (invNo.Length > 0)
        {
            string sql = string.Format("select sequenceid from SeaQuote1 where  FclLclInd='LCL' and QuoteNo='{0}'", invNo);
