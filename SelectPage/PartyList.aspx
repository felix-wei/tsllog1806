<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PartyList.aspx.cs" Inherits="PagesFreight_SelectPage_PartyList" %>
    ...
    <form id="form1" runat="server">
        <table>
            <tr>
                ...
                <td>
                    <dxe:ASPxTextBox ID="txt_Code" Width="160" runat="server">
                    </dxe:ASPxTextBox>
                </td>
                ...
                <td  style="display:none">
                    <dxe:ASPxTextBox ID="txt_Name" Width="140" runat="server">
                    </dxe:ASPxTextBox>
                </td>
                <td style="display:none">
                    <dxe:ASPxLabel ID="ASPxLabel1" runat="server" Text="ClientType" /></td>
                <td  style="display:none">
                    <dxe:ASPxComboBox ID="search_ClientType" runat="server" DropDownStyle="DropDown" Width="80">
                        <Items>
                ...
                <td>
                    <dxe:ASPxButton ID="ASPxButton1" runat="server" Text="Clear" AutoPostBack="false">
                        <ClientSideEvents Click="function(s,e){parent.PutValue('','');}" />
                    </dxe:ASPxButton>
                </td>
                 <td>
        ...
        <wilson:DataSource ID="dsPartyGroup" runat="server" ObjectSpace="C2.Manager.ORManager"
            TypeName="C2.XXPartyGroup" KeyMember="Code" FilterExpression="1=1" />
        ...
        <dxwgv:ASPxGridView ID="grid" ClientInstanceName="grid" runat="server" Width="100%" DataSourceID="dsXXParty"
            KeyFieldName="SequenceId" AutoGenerateColumns="False"
              OnInit="grid_Init" OnInitNewRow="grid_InitNewRow" OnRowDeleting="grid_RowDeleting" OnCustomDataCallback="grid_CustomDataCallback" OnCustomCallback="grid_CustomCallback" OnHtmlEditFormCreated="grid_HtmlEditFormCreated">
            <SettingsPager Mode="ShowAllRecords">
            </SettingsPager>
            <Columns>
                <dxwgv:GridViewDataTextColumn Caption="#" VisibleIndex="0" Width="5%">
                    <DataItemTemplate>
                        <a onclick='parent.PutValue("<%# Eval("PartyId") %>","<%# Eval("Name").ToString().Replace("'"," ") %>","<%# Eval("Contact1") %>","<%# Eval("Email1") %>");'>Select</a>
                    </DataItemTemplate>
                    <EditItemTemplate>
                    </EditItemTemplate>
            ...
            <dxwgv:ASPxGridViewExporter ID="ASPxGridViewExporter1" runat="server" GridViewID="grid">
            </dxwgv:ASPxGridViewExporter>
