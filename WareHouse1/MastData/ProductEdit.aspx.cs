...
public partial class WareHouse_MastData_ProductEdit : System.Web.UI.Page
{
    protected void Page_Init(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            {
                Session["SkuWhere"] = "Code='" + Request.QueryString["no"].ToString() + "' ";
                this.txt_Code.Text = Request.QueryString["no"].ToString();
            }
    ...
    protected void grid_InitNewRow(object sender, DevExpress.Web.Data.ASPxDataInitNewRowEventArgs e)
    {
        ...
        e.NewValues["ProductClass"] = "LIQUOR";
