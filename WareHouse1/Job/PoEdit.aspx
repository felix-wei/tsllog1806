...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function PrintDo(doNo, doType) {
            ...
            window.open('/ReportWarehouse/PrintView.aspx?document=wh_Po&master=' + doNo + "&house=0");
        }
                                                    ...
                                                    <dxwgv:ASPxGridView ID="grid_DoDet" ClientInstanceName="grid_DoDet"
                                                        ...
                                                        <Columns>
                                                           ...
                                                           <%-- <dxwgv:GridViewDataSpinEditColumn Caption="Whole Qty" FieldName="Qty2" VisibleIndex="11" Width="60">
                                                            ...
                                                            <dxwgv:GridViewDataComboBoxColumn Caption="ACL%" FieldName="Att2" VisibleIndex="7" Width="60">
                                                                 <EditItemTemplate>
                                                            ...
                                                            <dxwgv:GridViewDataComboBoxColumn Caption="CO" FieldName="Att3" VisibleIndex="7" Width="60">
                                                               <EditItemTemplate>
                                                            ...
                                                            <dxwgv:GridViewDataComboBoxColumn Caption="NRF/REF" FieldName="Att4" VisibleIndex="7" Width="60">
                                                                 <EditItemTemplate>
                                                            ...
                                                            <dxwgv:GridViewDataComboBoxColumn Caption="GBX" FieldName="Att5" VisibleIndex="7" Width="60">
                                                                 <EditItemTemplate>
                                                            ...
                                                            <dxwgv:GridViewDataComboBoxColumn Caption="DECODED" FieldName="Att6" VisibleIndex="7" Width="60">
                                                                 <EditItemTemplate>
                                                ...
                                                <dxwgv:ASPxGridView ID="grid_DoIn" ClientInstanceName="grid_DoIn"
                                                    ...
                                                    <Columns>
                                                        <dxwgv:GridViewDataTextColumn Caption="GRN No" FieldName="DoNo" VisibleIndex="1" Width="100">
                                                             <DataItemTemplate>
                                                                <a href='javascript: parent.navTab.openTab("<%# Eval("DoNo") %>","/WareHouse/Job/DoInEdit.aspx?no=<%# Eval("DoNo") %>",{title:"<%# Eval("DoNo") %>", fresh:false, external:true});'><%# Eval("DoNo") %></a>
                                                            </DataItemTemplate>
                                                        </dxwgv:GridViewDataTextColumn>
                                                 ...
                                                 <dxwgv:ASPxGridView ID="grid_Payment" ClientInstanceName="grid_Payment" runat="server"
                                                    ...
                                                    <Columns>
                                                        <dxwgv:GridViewDataTextColumn Caption="DocNo" FieldName="DocNo" VisibleIndex="1"
                                                            Width="8%">
                                                            <DataItemTemplate>
                                                                <a href='javascript: parent.navTab.openTab("<%# Eval("DocNo") %>","/PagesAccount/EditPage/ApPaymentEdit.aspx?no=<%# Eval("DocNo") %>",{title:"<%# Eval("DocNo") %>", fresh:false, external:true});'><%# Eval("DocNo") %></a>
                                                            </DataItemTemplate>
                                                        </dxwgv:GridViewDataTextColumn>
