<%@ Page Language="C#" EnableViewState="false" AutoEventWireup="true" CodeFile="OutboundTemp.aspx.cs" Inherits="WareHouse_Job_OutboundTemp" %>
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                                ...
                                                <td colspan="2" rowspan="5">
                                                    <dxe:ASPxMemo ID="memo_Description" Rows="5" Width="150" ClientInstanceName="memo_Description" Height="100%" Text='<%# Eval("ItemDes") %>'
                                                        runat="server">
                                                    </dxe:ASPxMemo>
                                                </td>
                                                <td>Pack Date</td>
                                            ...
                                            <dxw:ContentControl ID="ContentControl10" runat="server">
                                               <table style="width:960px;">
                                                    ...
                                                    <tr>
                                                        <td>
                                                             <dxe:ASPxHtmlEditor ID="txt_Attention1" ToolbarMode="None" runat="server" SettingsHtmlEditing-AllowScripts="false" Settings-AllowContextMenu="False"  Height="180" Width="100%" Html='<%# Eval("Attention1") %>'>
                                                               <Settings  AllowDesignView="true" AllowContextMenu="False" AllowHtmlView="true" AllowPreview="false" AllowInsertDirectImageUrls="false"/>       
                                                 ...
                                                 <tr>
                                                    ...
                                                    <tr>
                                                        <td>
                                                             <dxe:ASPxHtmlEditor ID="txt_Attention7" ToolbarMode="None" runat="server" SettingsHtmlEditing-AllowScripts="false" Settings-AllowContextMenu="False"  Height="320" Width="100%" Html='<%# Eval("Attention7") %>'>
                                                               <Settings  AllowDesignView="true" AllowContextMenu="False" AllowHtmlView="true" AllowPreview="false" AllowInsertDirectImageUrls="false"/>       
                                                 ...
                                                 <tr>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <dxe:ASPxHtmlEditor ID="txt_Attention3" ToolbarMode="None" runat="server" SettingsHtmlEditing-AllowScripts="false" Settings-AllowContextMenu="False"  Height="180" Width="100%" Html='<%# Eval("Attention3") %>'>
                                                               <Settings  AllowDesignView="true" AllowContextMenu="False" AllowHtmlView="true" AllowPreview="true" AllowInsertDirectImageUrls="false"/>       
                                                    ...
                                                    <tr>
                                                        <td style="background-color: Gray; color: White;">
                                                            <b>PAYMENT TERMS REMARKS:</b>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <dxe:ASPxHtmlEditor ID="txt_Attention5" ToolbarMode="None" runat="server" SettingsHtmlEditing-AllowScripts="false" Settings-AllowContextMenu="False"  Height="180" Width="100%" Html='<%# Eval("Attention5") %>'>
                                                               <Settings  AllowDesignView="true" AllowContextMenu="False" AllowHtmlView="true" AllowPreview="true" AllowInsertDirectImageUrls="false"/>       
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <dxe:ASPxHtmlEditor ID="txt_Attention6" ToolbarMode="None" runat="server" SettingsHtmlEditing-AllowScripts="false" Settings-AllowContextMenu="False"  Height="180" Width="100%" Html='<%# Eval("Attention6") %>'>
                                                               <Settings  AllowDesignView="true" AllowContextMenu="False" AllowHtmlView="true" AllowPreview="true" AllowInsertDirectImageUrls="false"/>       
