...
public partial class WareHouse_Job_OfficeMoveTemp : System.Web.UI.Page
{
    protected void Page_Init()
    {
        if (!IsPostBack)
        {
            ...
            {
                string sql = string.Format(@"select count(*) from JobInfo where JobType='OMTemp'");
                ...
                {
                    Session["SoWhere"] = "JobType='OMTemp'";
