<%@ Page Language="C#" EnableViewState="false" AutoEventWireup="true" CodeFile="AirTemp.aspx.cs" Inherits="WareHouse_Job_AirTemp" %>
...
<%-- <dxe:ASPxMemo runat="server" Rows="10" Width="100%" ID="txt_Attention1" MaxLength="500" Text='<%# Eval("Attention1")%>'>
                                                    ...
                                                    <tr>
                                                        <td>
                                                             <dxe:ASPxHtmlEditor ID="txt_Attention2" ToolbarMode="None" runat="server" SettingsHtmlEditing-AllowScripts="false" Settings-AllowContextMenu="False"  Height="180" Width="100%" Html='<%# Eval("Attention2") %>'>
                                                               <Settings  AllowDesignView="true" AllowContextMenu="False" AllowHtmlView="false" AllowPreview="false" AllowInsertDirectImageUrls="false"/>       
