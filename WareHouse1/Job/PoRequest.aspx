            ...
            <dxwgv:ASPxGridView ID="grid" ClientInstanceName="grid"
                ...
                <Columns>
                   ...
                   <%-- <dxwgv:GridViewDataSpinEditColumn Caption="W.Qty" FieldName="Qty2" VisibleIndex="4" Width="60">
                    ...
                    <dxwgv:GridViewDataComboBoxColumn Caption="ML" FieldName="Att1" VisibleIndex="51" Width="60">
                        <EditItemTemplate>
                    ...
                    <dxwgv:GridViewDataComboBoxColumn Caption="ACL%" FieldName="Att2" VisibleIndex="52" Width="60">
                        <EditItemTemplate>
                    ...
                    <dxwgv:GridViewDataComboBoxColumn Caption="CO" FieldName="Att3" VisibleIndex="53" Width="60">
                        <EditItemTemplate>
                    ...
                    <dxwgv:GridViewDataComboBoxColumn Caption="NRF/REF" FieldName="Att4" VisibleIndex="54" Width="60">
                        <EditItemTemplate>
                    ...
                    <dxwgv:GridViewDataComboBoxColumn Caption="GBX" FieldName="Att5" VisibleIndex="55" Width="60">
                        <EditItemTemplate>
                    ...
                    <dxwgv:GridViewDataComboBoxColumn Caption="DECODED" FieldName="Att6" VisibleIndex="56" Width="60">
                        <EditItemTemplate>
