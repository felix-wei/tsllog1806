...
public partial class WareHouse_Job_MatRet : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            this.dsJobSchedule.FilterExpression = where + "and JobType='IN3' and CustomerName='CM'";
        }
    }
    protected void btn_search_Click(object sender, EventArgs e)
    {
        ...
        if (where.Length > 0)
        {
            where += " and JobType='IN3' and CustomerName='CM' ";
        }
    ...
    protected void grid_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
    {
        ...
        C2Setup.SetNextNo("", "Materials-IN3", refNo, DateTime.Now);
        e.NewValues["WorkStatus"] = "Cancel";
    }
    protected void grid_InitNewRow(object sender, DevExpress.Web.Data.ASPxDataInitNewRowEventArgs e)
    {
        DateTime dt = DateTime.Now;
        string refNo = C2Setup.GetNextSchNo("", "Materials-IN3", dt);
        e.NewValues["RefNo"] = refNo;
        e.NewValues["JobType"] = "IN3";
