<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mo_spj.aspx.cs" Inherits="WareHouse_Job_Mo_SPJ" %>
          ...
          <td>
             ...
             <dxwgv:ASPxGridView ID="grid" ClientInstanceName="grid" runat="server" DataSourceID="dsStock" 
                ...
                <Columns>
                 ...
                 <dxwgv:GridViewDataComboBoxColumn Caption="Term" Width="80" FieldName="BillTerm" VisibleIndex="2" >
                 ...
                 <dxwgv:GridViewDataComboBoxColumn Caption="Item Code" Width="80" FieldName="Code" VisibleIndex="2" >
                    ...
                    <dxwgv:GridViewDataTextColumn ReadOnly="true" Caption="Amount" FieldName="Price" VisibleIndex="2" Width="80">
					</dxwgv:GridViewDataTextColumn>
					<dxwgv:GridViewDataComboBoxColumn Caption="GST" FieldName="GstType" VisibleIndex="2" Width="100">
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="GstAmt" FieldName="GstAmt" Readonly="true" VisibleIndex="2" Width="80">
					</dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="Total" FieldName="DocAmt" Readonly="true" VisibleIndex="2" Width="80">
					</dxwgv:GridViewDataTextColumn>
					<dxwgv:GridViewDataComboBoxColumn Caption="Customer" Width="80" FieldName="PartyTo" VisibleIndex="2" >
                                    <PropertiesComboBox DataSourceID="dsParty" ValueField="PartyId" TextField="Name" 
									DropDownStyle="DropDownList" ValueType="System.String" IncrementalFilteringMode="StartsWith">
                                    </PropertiesComboBox>
                    </dxwgv:GridViewDataComboBoxColumn>			
                    <dxwgv:GridViewDataTextColumn Caption="Description" FieldName="Description" VisibleIndex="2" Width="80">
					</dxwgv:GridViewDataTextColumn>
