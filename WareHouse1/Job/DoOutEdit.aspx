...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function PrintDo(doNo, doType) {
            if (doType == "DoOut")
                window.open('/ReportWarehouse/PrintView.aspx?document=wh_DoOut&master=' + doNo + "&house=0");
            else if (doType == "Picking")
                window.open('/ReportWarehouse/PrintView.aspx?document=wh_Picking&master=' + doNo + "&house=0");
        }
        ...
        function MultipleAdd() {
            ...
            popubCtr.SetContentUrl('../SelectPage/ProductList_so.aspx?typ=so&Sn=' + txt_DoNo.GetText() + '&so=' + txt_PONo.GetText());
            popubCtr.Show();
        }
                                                 ...
                                                 Enabled='<%# SafeValue.SafeString(Eval("Id"),"0")!="0"&&SafeValue.SafeString(Eval("StatusCode"),"USE")=="USE" %>'>
                                                    <ClientSideEvents Click="function(s,e) {
                                                       grid_SKULine.AddNewRow();
                                                            ...
                                                            <td>
                                                                <dxe:ASPxButton ID="btn_AddSKULine1" Width="150" runat="server" Text="Pick From SO" AutoPostBack="false" UseSubmitBehavior="false"
                                                                    Enabled='<%# SafeValue.SafeString(Eval("Id"),"0")!="0"&&SafeValue.SafeString(Eval("StatusCode"),"USE")=="USE" %>'>
                                                                    <ClientSideEvents Click="function(s,e) {
                                                       MultipleAdd();
                                                        }" />
