<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mo_SPJ_WHS.aspx.cs" Inherits="WareHouse_Job_Mo_SPJ_WHS" %>
            ...
            <table class="noprint">
             ...
             <dxwgv:ASPxGridView ID="grid" ClientInstanceName="grid" runat="server" DataSourceID="dsStock" 
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataTextColumn Visible="False" Caption="Bill No" FieldName="BillNo" VisibleIndex="2" Width="80">
						<DataItemTemplate>
							<b><%# Eval("BillNo")%></b>
							<div style='display:<%# Eval("DoType","{0}") == "OUT3" ? "" : "none" %>'>
                 ...
                 <dxwgv:GridViewDataComboBoxColumn Caption="Item Code" Width="80" FieldName="Code" VisibleIndex="2" >
                    ...
                    <dxwgv:GridViewDataTextColumn ReadOnly="true" Visible="False" Caption="Price" FieldName="Price" VisibleIndex="2" Width="80">
					</dxwgv:GridViewDataTextColumn>
