<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductList_so.aspx.cs" Inherits="WareHouse_SelectPage_ProductList_so" %>
<!DOCTYPE html>
        ...
        <div>
            ...
            <dxwgv:ASPxGridView ID="ASPxGridView1" ClientInstanceName="grid" runat="server" Width="100%"
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Description" FieldName="Des1" VisibleIndex="2">
                    </dxwgv:GridViewDataTextColumn>
...
<%--                    <dxwgv:GridViewDataTextColumn Caption="Whole Qty" FieldName="Qty2" VisibleIndex="2" Width="80">
                        <DataItemTemplate>
                            <dxe:ASPxSpinEdit id="spin_Qty2" runat="server" Value='<%# Eval("Qty2") %>' Width="80" Increment="0" NumberType="Integer" SpinButtons-ShowIncrementButtons="false"></dxe:ASPxSpinEdit>
                        </DataItemTemplate>
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="Loose Qty" FieldName="Qty3" VisibleIndex="2" Width="80">
                        <DataItemTemplate>
                            <dxe:ASPxSpinEdit id="spin_Qty3" runat="server" Value='<%# Eval("Qty3") %>' Width="80" Increment="0" NumberType="Integer" SpinButtons-ShowIncrementButtons="false"></dxe:ASPxSpinEdit>
                        </DataItemTemplate>
                    </dxwgv:GridViewDataTextColumn>--%>
