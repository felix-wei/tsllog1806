<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SelectProductToContract.aspx.cs" Inherits="WareHouse_SelectPage_SelectProductToContract" %>
            ...
            <dxwgv:ASPxGridView ID="ASPxGridView1" runat="server" Width="100%"
                ...
                <Columns>
                    <dxwgv:GridViewDataTextColumn Caption="#" VisibleIndex="0" Width="5%">
                        <DataItemTemplate>
                            <a onclick='parent.PutValue("<%# Eval("Code") %>","<%# Eval("ProductClass") %>");'>Select</a>
                        </DataItemTemplate>
                        <EditItemTemplate>
                        </EditItemTemplate>
