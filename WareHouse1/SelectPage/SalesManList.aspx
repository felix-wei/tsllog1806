<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SalesManList.aspx.cs" Inherits="WareHouse_SelectPage_SalesManList" %>
     ...
     <table>
            ...
            <dxwgv:ASPxGridView ID="ASPxGridView1" runat="server" Width="100%"
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Tel" FieldName="Tel" VisibleIndex="3">
                    </dxwgv:GridViewDataTextColumn>
                </Columns>
            </dxwgv:ASPxGridView>
    </div>
