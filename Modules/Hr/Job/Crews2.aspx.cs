...
public partial class Modules_Hr_Job_Crews2 : System.Web.UI.Page
{
    protected void Page_Init(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            this.txt_date.Date = new DateTime(2014,1,1);
    ...
    private void Bind()
    {
        string where = "Name='XXX'";
        if (txt_from.Value != null)
        {
            where = "Name='" + btn_Name.Text + "' and Status='Pay' group by Name,JobTime,PayDate";
        }
    ...
    protected void btn_search_Click(object sender, EventArgs e)
    {
        ...
        if (btn_Name.Text!="")
        {
            ...
            where = "Name='" + btn_Name.Text + "' and Status='Pay'  ";
