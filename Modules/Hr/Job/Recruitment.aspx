<%@ Page Language="C#" AutoEventWireup="true" EnableViewState="false" CodeFile="Recruitment.aspx.cs" Inherits="Modules_Hr_Job_Recruitment" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <dxwgv:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" runat="server" OnRowInserting="ASPxGridView1_RowInserting"
                DataSourceID="dsRecruitment" Width="800px" KeyFieldName="Id" OnInit="ASPxGridView1_Init" OnRowUpdating="ASPxGridView1_RowUpdating"
                    ...
                    <EditForm>
                        ...
                        <table border="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    <dxe:ASPxTextBox ID="txt_RecruitPic" ClientInstanceName="txt_RecruitPic" Width="240" runat="server"
                                        Text='<%# Bind("Pic")%>'>
                                    </dxe:ASPxTextBox>
                                </td>
                                <td>Status
                        ...
                        <table>
                            <tr>
                                <td>
                                    <dxe:ASPxButton ID="btn_Recruitment_update" runat="server" Text="Update" Width="40" AutoPostBack="false"
