<%@ WebHandler Language="C#" Class="JsonResponse2" %>
...
public class JsonResponse2 : IHttpHandler, IRequiresSessionState 
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        foreach (CalendarEvent cevent in EventHrDAO2.getEvents(start, end))
        {
    ...
    private String convertCalendarEventIntoString(CalendarEvent cevent)
    {
        ...
        return    "{" +
                  "id: '" + cevent.id + "'," +
                  "title: '" + cevent.title.Substring(3).Replace("\r","").Replace("\n","") + "'," +
