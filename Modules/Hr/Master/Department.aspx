<%@ Page Title="Port" Language="C#"  AutoEventWireup="true" CodeFile="Department.aspx.cs" Inherits="Modules_Hr_Master_Department" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <dxwgv:ASPxGridView ID="grid" ClientInstanceName="grid" runat="server" DataSourceID="dsDepartment"
            ...
            <Columns>
                ...
                <dxwgv:GridViewDataSpinEditColumn Caption="Work Days" FieldName="WorkDays" VisibleIndex="3" Width="140">
                    <PropertiesSpinEdit NumberType="Float" Increment="0" DecimalPlaces="1" SpinButtons-ShowIncrementButtons="false"></PropertiesSpinEdit>
