<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintApplicationForLeave.aspx.cs" Inherits="Modules_Hr_Report_PrintApplicationForLeave" %>
    ...
    <form id="form1" runat="server">
        ...
        <table class="table_A4" style="margin-top: 50px;">
            <tr style="text-align: center">
                <td>
                    <font size="6">MAXWILL FOODLINK PTE LTD</font>
                </td>
