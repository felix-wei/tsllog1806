<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="ArReceipt_ArInvoice_multi.aspx.cs"
    Inherits="PagesAccount_SelectPage_ArReceipt_ArInvoice_multi" %>
...
<body>
    ...
    <div>
        <wilson:DataSource ID="dsArInvoice" runat="server" ObjectSpace="C2.Manager.ORManager"
			...
			<div style="width:100%;position:fixed;top:0px;left:0px;height:28px;background:#EEEEEE;">
			<table>
            <tr>
            <td>Bill No
            </td>
        ...
        <dxwgv:ASPxGridView ID="ASPxGridView1" runat="server" 
            ClientInstanceName="grid" Width="820" KeyFieldName="SequenceId" oncustomdatacallback="ASPxGridView1_CustomDataCallback" oncustomcallback="ASPxGridView1_CustomCallback">
            ...
            <Columns>
                ...
                <dxwgv:GridViewDataTextColumn Caption="Curr" FieldName="CurrencyId" VisibleIndex="5"
                    Width="40">
                </dxwgv:GridViewDataTextColumn>
                <dxwgv:GridViewDataTextColumn Caption="ExRate" FieldName="ExRate" VisibleIndex="6"
                    Width="60">
                </dxwgv:GridViewDataTextColumn>
                <dxwgv:GridViewDataTextColumn Caption="DocAmt" FieldName="DocAmt1" VisibleIndex="7"
                    Width="80">
                </dxwgv:GridViewDataTextColumn>
                ...
                <dxwgv:GridViewDataTextColumn Caption="Amt Adj." VisibleIndex="10" Width="70">
                </dxwgv:GridViewDataTextColumn>
                <dxwgv:GridViewDataTextColumn Caption="Amt Utilised" VisibleIndex="10" Width="80">
                </dxwgv:GridViewDataTextColumn>
                <dxwgv:GridViewDataTextColumn Caption=" " VisibleIndex="11" Width="60">
                    <DataItemTemplate>
                    </DataItemTemplate>
                </dxwgv:GridViewDataTextColumn>
            </Columns>
            ...
            <Templates>
                <DataRow>
                    <table border="0" style="border-bottom: solid 1px BLACK; width: 100%">
                        ...
                        <td width="70">
                            <dxe:ASPxSpinEdit Width="100%" ID="spin_Amt" OnInit="bal_amt_init" DisplayFormatString="0.00" Value='<%# Eval("BalanceAmt")%>'
                                runat="server">
                                <SpinButtons ShowIncrementButtons="false" />
                            </dxe:ASPxSpinEdit>
                        </td>
