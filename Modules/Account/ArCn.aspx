<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="ArCn.aspx.cs" Inherits="Account_ArCn" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ShowArInvoice(invN) {
            window.location='EditPage/ArInvoiceEdit.aspx?type=CN&no=' + invN;
        }
    </script>
...
<body width="800">
    ...
    <div>
        <wilson:DataSource ID="dsArInvoice" runat="server" ObjectSpace="C2.Manager.ORManager"
            TypeName="C2.XAArInvoice" KeyMember="SequenceId" />
    ...
    ShowArInvoice('0');}" />
        ...
        <dxwgv:ASPxGridView ID="ASPxGridView1" runat="server" DataSourceID="dsArInvoice"
            ClientInstanceName="grid" Width="880" KeyFieldName="SequenceId">
            ...
            <Columns>
                ...
                <dxwgv:GridViewDataTextColumn Caption="Job No" FieldName="MastRefNo" VisibleIndex="1"
                    Width="8%">
                </dxwgv:GridViewDataTextColumn>
                ...
                <dxwgv:GridViewDataTextColumn Caption="Posted" FieldName="ExportInd" VisibleIndex="9"
                    Width="5%">
                    <DataItemTemplate>
