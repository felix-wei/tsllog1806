...
public partial class Modules_RptPrintView : BasePage
{
        ...
        if (!IsPostBack && Request.Params["doc"] != null)
        {
           ...
           // string printCury = SafeValue.SafeString(Request.Params["prtCury"], "0");
            ...
            try
            {
                ...
                else if (reportName == "41a")//Trial Balance
                {
                    ms = PrintGlTrialBalanceNz(date1, date2, userId);
                    fileName = "TrialBalance";
                }
                ...
                else if (reportName == "42a")//Balance sheet
                {
                    ms = PrintGlBalanceSheetNz(date1, date2, userId);
                    fileName = "BalanceSheet";
                }
                ...
                else if (reportName == "43a")//Balance sheet
                {
                    if (date2 == "13")
                    {
                        ms = PrintGlPlStatement_year(date1, userId);
                    ...
                    {
                        ms = PrintGlPlStatementNz(date1, date2, userId);
                        fileName = "PlStatement";
                    }
                }
                ...
                else if (reportName == "45")//audit trail by chart of account
                {
                    ...
                    fileName = "GeneralLedgerByAcCode";
                }
                else if (reportName == "45b")//audit trail by chart of account
                {
                    ms = PrintGlAuditTrial_AccCode_Mix(date1, date2, date3, partyTo, userId);
                    fileName = "GeneralLedgerByAcCode";
                }
                else if (reportName == "45a")//audit trail by chart of account
                {
                    ms = PrintGlAuditTrial_AccCode_Full(date1, date2, date3, partyTo, userId);
                    fileName = "GeneralLedgerByAcCode";
                }
    ...
    private MemoryStream PrintGlTrialBalanceNz(string date1, string date2, string userId)
    {
        XtraReport rpt = new XtraReport();
        rpt.LoadLayout(Server.MapPath(@"~\ReportAccount\Repx\GlTrialBalance.repx"));
        rpt.DataSource = AccountPrint.DsGlTrialBalanceNz(date1, date2, userId);
    ...
    private MemoryStream PrintGlBalanceSheetNz(string date1, string date2, string userId)
    {
        XtraReport rpt = new XtraReport();
        rpt.LoadLayout(Server.MapPath(@"~\ReportAccount\Repx\GlBalanceSheet.repx"));
        rpt.DataSource = AccountPrint.DsGlBalanceSheetNz(date1, date2, userId);
    ...
    private MemoryStream PrintGlPlStatement(string date1, string date2, string userId)
    {
	    ...
	    private MemoryStream PrintGlPlStatementNz(string date1, string date2, string userId)
    {
        XtraReport rpt = new XtraReport();
        rpt.LoadLayout(Server.MapPath(@"~\ReportAccount\Repx\GlPlStatement_0.repx"));

        DataSet set = AccountPrint.DsGlPlStatement_1Nz(date1, date2, userId);
        DataTable tab_mast = set.Tables[0];
        DataTable tab_Pl = set.Tables[1];
        DataTable tab_Other = set.Tables[2];
        DataTable tab_Revenue = set.Tables[3];
    ...
    private MemoryStream PrintGlAuditTrial_AccCode_Mix(string date1, string date2, string date3, string accCode, string userId)
    {
        XtraReport rpt = new XtraReport();
        if (accCode == "" || accCode == "null")
        {
            ...
            {
                XtraReport subRpt = new XtraReport();
                subRpt.LoadLayout(Server.MapPath(@"~\ReportAccount\Repx\GlAuditTrial_AccCode_Mix.repx"));
                subRpt.DataSource = AccountPrint.DsGlAuditTrial_AccCode(date1, date2, date3, tab.Rows[i][0].ToString(), userId);
                subRpt.CreateDocument();
                rpt.Pages.AddRange(subRpt.Pages);
            }
    ...
    private MemoryStream PrintGlAuditTrial_AccCode_Full(string date1, string date2, string date3, string accCode, string userId)
    {
        XtraReport rpt = new XtraReport();
        if (accCode == "" || accCode == "null")
        {
            ...
            {
                XtraReport subRpt = new XtraReport();
                subRpt.LoadLayout(Server.MapPath(@"~\ReportAccount\Repx\GlAuditTrial_AccCode_Full.repx"));
                subRpt.DataSource = AccountPrint.DsGlAuditTrial_AccCode(date1, date2, date3, tab.Rows[i][0].ToString(), userId);
                subRpt.CreateDocument();
                rpt.Pages.AddRange(subRpt.Pages);
            }
        ...
        {
            rpt.LoadLayout(Server.MapPath(@"~\ReportAccount\Repx\GlAuditTrial_AccCode_Full.repx"));
            rpt.DataSource = AccountPrint.DsGlAuditTrial_AccCode(date1, date2, date3, accCode, userId);
        }
        System.IO.MemoryStream str = new MemoryStream();
        if (docType == "1")
    ...
    private MemoryStream PrintArDocListing_Sum(string date1, string date2, string partyTo,string docType, string userId)
    {
		...
		if(docType=="RE")
			...
			rpt.LoadLayout(Server.MapPath(@"~\ReportAccount\Repx\ArDocListing_Sum2.repx"));
