...
<body>
    ...
    <div>
        <table>
            ...
            <Items>
            <dxe:ListEditItem Text="Supplier Invoice" Value="PIN" />
            <dxe:ListEditItem Text="Supplier Credit Note" Value="PCN" />
            <dxe:ListEditItem Text="Supplier Debit Note" Value="PDN" />
            <dxe:ListEditItem Text="Payment PVS" Value="PVS" />
            <dxe:ListEditItem Text="Payment PVG" Value="PVG" />
            <dxe:ListEditItem Text="Payment PCF" Value="PCF" />
            <dxe:ListEditItem Text="Payment IBT" Value="IBT" />
            </Items>
            </dxe:ASPxComboBox>
            </td>
            </tr>
