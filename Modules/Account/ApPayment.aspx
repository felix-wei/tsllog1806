...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function ShowArInvoice(invN, typ) {
			if(typ=="PVS")
				window.location = 'EditPage/ApPaymentEdit.aspx?no=' + invN + '&type=' + typ;
			if(typ=="PVG")
				window.location = 'EditPage/ApPaymentEditGl.aspx?no=' + invN + '&type=' + typ;
			if(typ=="PCF")
				window.location = 'EditPage/ApPaymentEditGl.aspx?no=' + invN + '&type=' + typ;
			if(typ=="IBT")
				window.location = 'EditPage/ApPaymentEditBt.aspx?no=' + invN + '&type=' + typ;
...
<body>
    ...
    ShowArInvoice('0',txt_doctype.GetText());}" />
        ...
        <dxwgv:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" runat="server"
            DataSourceID="dsApPayment" Width="880" KeyFieldName="SequenceId" AutoGenerateColumns="False">
            ...
            <Columns>
                ...
                <dxwgv:GridViewDataTextColumn Caption="#" VisibleIndex="0" Width="5%">
                    <DataItemTemplate>
                        <a onclick='ShowArInvoice("<%# Eval("DocNo") %>",txt_doctype.GetText());'>Edit</a>
                    </DataItemTemplate>
                </dxwgv:GridViewDataTextColumn>
                <dxwgv:GridViewDataTextColumn Caption="DocNo" FieldName="DocNo" VisibleIndex="3"
                    Width="8%">
                </dxwgv:GridViewDataTextColumn>
                 <dxwgv:GridViewDataTextColumn Caption="Type" FieldName="DocType" VisibleIndex="3"
                    Width="5%">
                </dxwgv:GridViewDataTextColumn>
                ...
                <dxwgv:GridViewDataTextColumn Caption="Cancel" FieldName="CancelInd" VisibleIndex="99"
                    Width="8%">
                    <DataItemTemplate>
