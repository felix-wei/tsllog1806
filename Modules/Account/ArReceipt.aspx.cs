...
public partial class Account_ArReceipt : BasePage
{
    ...
    protected void btn_search_Click(object sender, EventArgs e)
    {
        ...
        {
            string sql = "select  repId from XAARReceiptDet where DocType='SIN' and docno='" + this.txt_InvNo.Text.Trim() + "'";
    ...
    protected void btn_Export_Click(object sender, EventArgs e)
    {
        ...
        gridExport.WriteXlsToResponse("ARRV", true);
    }
}
