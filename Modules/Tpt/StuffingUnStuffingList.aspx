<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StuffingUnStuffingList.aspx.cs" Inherits="Modules_Tpt_WarehouseList" %>
        ...
        <div>
            <table>
                <tr>
                    ...
                    <td>
                        <dxe:ASPxLabel ID="ASPxLabel2" runat="server" Text="Schedule/Start Date From"></dxe:ASPxLabel>
                    </td>
                    <td>
            ...
            <dxwgv:ASPxGridView ID="grid_Transport" ClientInstanceName="detailGrid" runat="server" KeyFieldName="Id" Width="100%" AutoGenerateColumns="False" OnCustomDataCallback="grid_Transport_CustomDataCallback">
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataColumn Caption="WH Schedule/Start Date" FieldName="ScheduleStartDate"></dxwgv:GridViewDataColumn>
                    <dxwgv:GridViewDataColumn Caption="Time" FieldName="ScheduleStartTime"></dxwgv:GridViewDataColumn>
                    <dxwgv:GridViewDataColumn Caption="Completion Date" FieldName="CompletionDate"></dxwgv:GridViewDataColumn>
                    <dxwgv:GridViewDataColumn FieldName="client" Caption="Client"></dxwgv:GridViewDataColumn>
                    <dxwgv:GridViewDataColumn Caption="IMP Date" FieldName="IMPDate"></dxwgv:GridViewDataColumn>
                    <dxwgv:GridViewDataColumn Caption="COL Date" FieldName="COLDate"></dxwgv:GridViewDataColumn>
                    <dxwgv:GridViewDataColumn Caption="EXP Date" FieldName="EXPDate"></dxwgv:GridViewDataColumn>
                    ...
                    <dxwgv:GridViewDataColumn FieldName="ContainerNo" Caption="Cont.No"></dxwgv:GridViewDataColumn>
                    <dxwgv:GridViewDataColumn Caption="SealNo" FieldName="SealNo"></dxwgv:GridViewDataColumn>
                    <dxwgv:GridViewDataColumn FieldName="CfsStatus" Caption="WH.Status"></dxwgv:GridViewDataColumn>
                    <dxwgv:GridViewDataDateColumn FieldName="DateIn" Caption="Date In" PropertiesDateEdit-DisplayFormatString="dd/MM/yyyy"></dxwgv:GridViewDataDateColumn>
                    <dxwgv:GridViewDataDateColumn FieldName="DateOut" Caption="Date Out" PropertiesDateEdit-DisplayFormatString="dd/MM/yyyy"></dxwgv:GridViewDataDateColumn>
                    ...
                    <dxwgv:GridViewDataColumn Caption="#">
                        <DataItemTemplate>
                            ...
                            <dxe:ASPxButton ID="btn_contStart" Width="60" Text="Start" runat="server" Visible='<%# (!Eval("CfsStatus").Equals("Completed")&&!Eval("CfsStatus").Equals("Started")) %>' AutoPostBack="false" >
