<%@ Page Language="C#" AutoEventWireup="true" EnableViewState="false" CodeFile="TripListForJobList.aspx.cs" Inherits="Modules_Tpt_SelectPage_TripListForJobList" %>
    ...
    <script type="text/javascript">
        ...
        function Cont_callback(v) {
            ...
            if (v == "Completed") {
                ...
                alert('Opened Job');
                btn_ContClose.SetText("Close Job");
            }
        ...
        function goJob() {
            ...
            parent.parent.navTab.openTab(jobno, "/PagesContTrucking/Job/JobEdit.aspx?jobNo=" + jobno, { title: jobno, fresh: false, external: true });
        }
        function $(s) {
        ...
        <div>
            <table style="width: 100%">
                    ...
                    <td colspan="8">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <dxe:ASPxButton ID="btn_ContClose" ClientInstanceName="btn_ContClose" Width="120" runat="server" Text="Completed Job" AutoPostBack="false">
                ...
                <tr>
                    <td>Trailer No:</td>
                    <td>
                        <dxe:ASPxButtonEdit ID="txt_ContNo" ClientInstanceName="txt_ContNo" runat="server"  AutoPostBack="False" Width="120">
                                            <Buttons>
                                                <dxe:EditButton Enabled="true" Text=".."></dxe:EditButton>
                                            </Buttons>
                                            <ClientSideEvents ButtonClick="function(s, e) {
                                                PopupCTM_MasterData(txt_ContNo,null,'Chessis');
                                                                        }" />
                                        </dxe:ASPxButtonEdit>
                    </td>
                    <td colspan="1"></td>
            ...
            <dxwgv:ASPxGridView ID="grid_Trip" ClientInstanceName="grid_Trip" runat="server" Width="930"
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataColumn VisibleIndex="4" FieldName="ToParkingLot" Caption="Driver/ParkingLot/Instr">
                        <DataItemTemplate>
                            <table>
                                <tr>
                                    <td>
                    ...
                    <EditForm>
                        ...
                        <table>
                            ...
                            <tr style="display:none">
                                <td style="display:none">Container
                                </td>
                                <td style="display:none">
