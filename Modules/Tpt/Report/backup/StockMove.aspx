    ...
    <form runat="server" id="form1">
        ...
        <table cellspacing="0" cellpadding="0" style="border-bottom: solid #000000 1px; width: 3000px; height: auto">
            <tr style="background-color: #999999; font-size: 18px; font-weight: bold; text-align: center; line-height: 35px">
                <td colspan="33">Stock Movement Report</td>
            </tr>
            ...
            <%
                ...
                DataTable tab = GetData(this.txt_CustId.Text, dateFrom, dateTo, txt_HblNo.Text, txt_LotNo.Text, txt_SKULine_Product.Text, cmb_WareHouse.Text, txt_Location.Text, txt_ContNo.Text);
                int n = 0;
                ...
                for (int i = 0; i < tab.Rows.Count; i++)
                {
                    ...
                    if (refNo == lastRefNo && skuCode == lastSkuCode && bookingNo == lastBookingNo && hblNo == lastHblNo&&lineId==lastLineId)
                    {
