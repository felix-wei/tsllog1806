<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TransferList.aspx.cs" Inherits="Modules_Tpt_TransferList" %>
                ...
                <tr>
                    ...
                    <td>
                        <dxe:ASPxComboBox ID="search_JobType" runat="server" Width="100" DropDownStyle="DropDownList">
                            <Items>
                                <dxe:ListEditItem Text="FRT" Value="FRT" Selected />
                            </Items>
                        </dxe:ASPxComboBox>
                    </td>
            ...
            <dxpc:ASPxPopupControl ID="ASPxPopupControl1" ClientInstanceName="ASPxPopupClientControl" SkinID="None" Width="240px"
                ...
                <HeaderTemplate>
                    <table style="width: 100%;">
                        <tr>
                            <td style="width: 100%;">
                                <dxe:ASPxLabel ID="lbl_Header" Text="New Job" runat="server" ClientInstanceName="lbl_Header"></dxe:ASPxLabel>
                            </td>
                            <td>
...
<%--                                                <dxe:ListEditItem Text="WDO" Value="WDO" />
            ...
            <dxwgv:ASPxGridView ID="grid_Transport" ClientInstanceName="detailGrid" runat="server" OnHtmlDataCellPrepared="grid_Transport_HtmlDataCellPrepared"
                ...
                <Columns>
                    <dxwgv:GridViewDataTextColumn Caption="Job No" FieldName="JobNo" Width="120px" FixedStyle="Left">
                        <DataItemTemplate>
                    ...
                    <dxwgv:GridViewDataColumn Caption="Hbl No" FieldName="HblNo" Width="80"></dxwgv:GridViewDataColumn>
                    <dxwgv:GridViewDataColumn Caption="OP" FieldName="OperatorCode" Width="80"></dxwgv:GridViewDataColumn>
