<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AssignExportContainerList.aspx.cs" Inherits="Modules_Freight_Job_AssignExportContainerList" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <wilson:DataSource ID="dsParty" runat="server" ObjectSpace="C2.Manager.ORManager"
            TypeName="C2.XXParty" KeyMember="id" FilterExpression="" />
        ...
        <div>
            ...
            <dxwgv:ASPxGridView ID="grid" ClientInstanceName="grid" runat="server" 
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Trucking Date" FieldName="ScheduleDate" VisibleIndex="3" Width="120">
                        <DataItemTemplate>
                            <%--<%# SafeValue.SafeDateStr(Eval("TptDate")) %>--%>
