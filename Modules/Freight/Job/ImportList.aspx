<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ImportList.aspx.cs" Inherits="Modules_Freight_Job_ImportList" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        function PopupTripsList(jobno, contId, canGO, isWarehouse) {
            ...
            popubCtr1.SetContentUrl('/PagesContTrucking/SelectPage/TripListForJobList.aspx?JobNo=' + jobno + "&contId=" + contId + "&isWarehouse=" + isWarehouse);
            popubCtr1.Show();
        }
        ...
        <div>
                ...
                <tr>
                    ...
                    <td>
                        <dxe:ASPxComboBox ID="search_JobType" runat="server" Width="100" DropDownStyle="DropDownList">
                            <Items>
                                <dxe:ListEditItem Text="IMP" Value="IMP" Selected="true" />
            ...
            <dxwgv:ASPxGridView ID="grid_Transport" ClientInstanceName="detailGrid" runat="server" OnHtmlDataCellPrepared="grid_Transport_HtmlDataCellPrepared"
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataColumn FieldName="ClientContact" Caption="Contractor"></dxwgv:GridViewDataColumn>
