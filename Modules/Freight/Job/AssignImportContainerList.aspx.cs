...
public partial class Modules_Freight_Job_AssignImportContainerList : System.Web.UI.Page
{
...
where JobNo=@JobNo and ContainerNo=@ContNo");
    ...
    internal class Record
    {
        ...
        public Record(int _id, string _jobNo, string _contNo, DateTime _schedule, string _sealNo, string _contType, string _customsClearStatus, DateTime _customsClearDate,
            string _customsVerifyInd, DateTime _customsVerifyDate, string _customsRemark, string _contIndex,DateTime _valiDate,DateTime _scheduleStartDate,DateTime _billingDate,DateTime _dispatchDate,DateTime _etaDate)
        {
            id = _id;
            jobNo = _jobNo;
            contNo = _contNo;
