...
public partial class PagesContTrucking_Job_NewJobListBill : System.Web.UI.Page
{
	...
	{
		string where = "";
        string sql = string.Format(@"select * from(select job.Id,job.JobNo,job.StatusCode as JobStatus,job.JobDate,job.YardRef as Depot,job.ClientRefNo,job.ClientId,
