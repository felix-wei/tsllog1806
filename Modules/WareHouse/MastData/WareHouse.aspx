                                            ...
                                            <div style="padding: 4px 4px 3px 4px;">
                                                <table width="80%">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <dxe:ASPxTextBox ID="txt_Code" ClientInstanceName="txt_Code" runat="server" Width="150" Value='<%# Bind("Code") %>'>
                                                            </dxe:ASPxTextBox>
                                                        </td>
                                                        <td width="150">StockType</td>
                                                        <td>
                                                            <dxe:ASPxComboBox EnableIncrementalFiltering="True" Width="150px" ID="cmb_StockType"
                                                        ...
                                                        <td width="180">WH Type</td>
                                                        <td>
                                                            <dxe:ASPxComboBox EnableIncrementalFiltering="True" Width="180px" ID="cmb_Type"
                                                                runat="server" Text='<%# Bind("IsBonded") %>'>
                                                                <Items>
                                                                    <dxe:ListEditItem Text="Normal" Value="Normal" />
                                                                    <dxe:ListEditItem Text="ZeroGST" Value="ZeroGST" />
                                                                    <dxe:ListEditItem Text="Bonded" Value="Bonded" />
                                                                     <dxe:ListEditItem Text="Licensed" Value="Licensed" />
                                                                </Items>
                                                            </dxe:ASPxComboBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td colspan="2">
                                                            <dxe:ASPxTextBox ID="txt_LotCode" Width="100%" runat="server" Text='<%# Eval("LotCode") %>'></dxe:ASPxTextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td rowspan="3">Address： </td>
                                                        <td colspan="3" rowspan="3">
                                                            <dxe:ASPxMemo ID="txtAddress" runat="server" Rows="4" Value='<%# Bind("Address") %>' Width="100%">
                                                            </dxe:ASPxMemo>
                                                        </td>
                                                        <td>Contact： </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>License No</td>
                                                        <td>
                                                            <dxe:ASPxTextBox ID="txt_LicenseNo" Width="100%" runat="server" Text='<%# Eval("LicenseNo") %>'></dxe:ASPxTextBox>
                                                        </td>
                                                        <td>License Expiry
                                                        </td>
                                                        <td>
                                                            <dxe:ASPxDateEdit ID="date_LicenseExpiry" runat="server" Value='<%# Eval("LicenseExpiry") %>' Width="100%" EditFormat="Custom" EditFormatString="dd/MM/yyyy">
                                                            </dxe:ASPxDateEdit>
                                                        </td>
                                                        <td>License Remark
                                                        </td>
                                                        <td colspan="3">
                                                            <dxe:ASPxMemo ID="memo_LicenseRemark" ClientInstanceName="memo_LicenseRemark" Rows="2" runat="server" Width="100%" Text='<%# Eval("LicenseRemark") %>'></dxe:ASPxMemo>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>Remarks： </td>
                                                                                        ...
                                                                                        <td colspan="4">
                                                                                            <div style="text-align: right; padding: 2px 2px 2px 2px">
                                                                                                <%--<dxwgv:ASPxGridViewTemplateReplacement ID="UpdateButton" ReplacementType="EditFormUpdateButton"
                                                                                                    ...
                                                                                                    <ClientSideEvents Click="function(s,e) {
                                                                                                       grid_Location.PerformCallback('Save');grid_Location.CancelEdit();
                                                                                                }" />
                                                                                                </dxe:ASPxHyperLink>
                                                                                                <dxwgv:ASPxGridViewTemplateReplacement ID="CancelButton" ReplacementType="EditFormCancelButton"
                                                                                                    runat="server"></dxwgv:ASPxGridViewTemplateReplacement>
