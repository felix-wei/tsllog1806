<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PurchasePrice.aspx.cs" Inherits="WareHouse_MastData_PurchasePrice" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        function ShowHouse(masterId) {
            window.location = "PurchasePriceEdit.aspx?no=" + masterId;
        }
    </script>
</head>
<body>
                    ...
                    <td>
                        <dxe:ASPxButtonEdit ID="txt_Supplier" ClientInstanceName="txt_Supplier" runat="server" Width="80" HorizontalAlign="Left" AutoPostBack="False">
                                ...
                                <ClientSideEvents ButtonClick="function(s, e) {
                                                               PopupParty(txt_Supplier,txt_SupplierName,null,null,null,null,null,null,'V');
                                                                    }" />
                            </dxe:ASPxButtonEdit>
                    </td>
                    <td>
                     ...
                     <td>
                        ...
                        window.location='PurchasePrice.aspx?name='+txt_SupplierName.GetText();
                    }" />
                        </dxe:ASPxButton>
                    </td>
                    <td>
                  ...
                  <Columns>
                     <dxwgv:GridViewDataTextColumn Caption="#" VisibleIndex="0" Width="20">
                      ...
                      <dxwgv:GridViewDataTextColumn Caption="No" FieldName="DoNo" VisibleIndex="1">
                        ...
                        <dxwgv:GridViewDataTextColumn Caption="Supplier" FieldName="PartyName" VisibleIndex="2" Width="80">
                        </dxwgv:GridViewDataTextColumn>
