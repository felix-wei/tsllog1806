<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProductClass.aspx.cs" Inherits="WareHouse_MastData_ProductClass" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <div>
                <dxwgv:ASPxGridView ID="grid" runat="server" ClientInstanceName="grid" DataSourceID="dsProductClass"
