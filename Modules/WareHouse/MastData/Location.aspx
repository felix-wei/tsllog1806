<%@ Page Language="C#" AutoEventWireup="true" EnableViewState="false" CodeFile="Location.aspx.cs" Inherits="WareHouse_MastData_Location" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        function PopupPageLocation() {

            popubCtr.SetContentUrl('AddLocation.aspx');
            popubCtr.SetHeaderText('Multiple Add Loction');
            popubCtr.Show();
        }
    </script>
</head>
            ...
            <table width="600">
                <tr>
                    ...
                    <td>
                     ...
                     <td>
                        <dxe:ASPxButton ID="btn_Add" Width="160" runat="server" Text="Multiple Add Loction"  UseSubmitBehavior="false" AutoPostBack="false">
                            <ClientSideEvents Click="function(s,e){
                       PopupPageLocation();
                    }" />
                        </dxe:ASPxButton>
