...
public partial class PagesFreight_Account_ExpFclQuoteList_Air : System.Web.UI.Page
{
    ...
    protected void btn_Sch_Click(object sender, EventArgs e)
    {
        ...
        if (invNo.Length > 0)
        {
            string sql = string.Format("select sequenceid from AirQuote1 where  FclLclInd='FCL' and QuoteNo='{0}'", invNo);
