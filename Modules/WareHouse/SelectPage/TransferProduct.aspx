<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TransferProduct.aspx.cs" Inherits="Modules_WareHouse_SelectPage_TransferProduct" %>
        ...
        <div>
            ...
            <dxwgv:ASPxGridView ID="ASPxGridView1" ClientInstanceName="grid" runat="server"
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="W/H" FieldName="FromWh" VisibleIndex="2" Width="120">
                        <DataItemTemplate>
                            <dxe:ASPxLabel runat="server" ID="lbl_FromWh" Text='<%# Eval("FromWh") %>'></dxe:ASPxLabel>
                        </DataItemTemplate>
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="From" FieldName="FromLoc" VisibleIndex="2" Width="120">
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="To W/H" FieldName="ToWh" VisibleIndex="2" Width="120">
                        <DataItemTemplate>
<%--                            <dxe:ASPxTextBox ID="txt_ToWh" ClientInstanceName="txt_ToWh" runat="server"
                                    Text='<%# Eval("ToWh") %>' Width="100">
                                </dxe:ASPxTextBox>--%>
                             <dxe:ASPxComboBox ID="txt_ToWh" ClientInstanceName="txt_ToWh" runat="server" Value='<%# Eval("ToWh") %>'
                        Width="100px" DropDownWidth="120" DropDownStyle="DropDownList" DataSourceID="dsRefWarehouse"
