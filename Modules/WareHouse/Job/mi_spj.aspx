<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mi_spj.aspx.cs" Inherits="WareHouse_Job_Mi_SPJ" %>
             ...
             <dxwgv:ASPxGridView ID="grid" ClientInstanceName="grid" runat="server" DataSourceID="dsStock" 
                ...
                <Columns>
                 ...
                 <dxwgv:GridViewDataComboBoxColumn Caption="Item Code" Width="80" FieldName="Code" VisibleIndex="2" >
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Amount" Visible="False" FieldName="Price" VisibleIndex="2" Width="80">
					</dxwgv:GridViewDataTextColumn>
