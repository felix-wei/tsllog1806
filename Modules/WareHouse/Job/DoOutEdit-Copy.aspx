                    ...
                    <EditForm>
                        <div style="padding: 2px 2px 2px 2px">
                            ...
                            <table>
                                ...
                                <td>Other Permit</td>
                                <td>
                                   <dxe:ASPxMemo ID="txt_OtherPermit" Rows="2" runat="server" Width="100%" Text='<%# Eval("OtherPermit") %>'></dxe:ASPxMemo>                             
                                                            ...
                                                            <dxwgv:GridViewDataTextColumn Caption="SKU" FieldName="ProductCode" VisibleIndex="2" Width="80">
                                                                <EditItemTemplate>
                                                                    <dxe:ASPxButtonEdit ID="txt_SKULine_Product" ReadOnly="true" BackColor="Control" ClientInstanceName="txt_SKULine_Product" runat="server" Value='<%# Bind("ProductCode") %>' Width="80">
                                                                        ...
                                                                        <ClientSideEvents ButtonClick="function(s, e) {
                                                                              PopupProductFromDoIn(txt_SKULine_Product,txt_Det1_LotNo,txt_Description,null,null,txt_Uom1,null,null,cb_Att1,cb_Att2,cb_Att3,cb_Att4,cb_Att5,cb_Att6,txt_WareHouseId.GetText());
                                                                           }" />
                                                                    </dxe:ASPxButtonEdit>
                                                                </EditItemTemplate>
                                                            </dxwgv:GridViewDataTextColumn>
...
<%--                                                            <dxwgv:GridViewDataSpinEditColumn Caption="UNIT" FieldName="QtyWholeLoose" VisibleIndex="5" Width="40">
                                                    ...
                                                    <dxwgv:ASPxGridView ID="Grid_Cont" ClientInstanceName="grid_Cont" runat="server"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <dxwgv:GridViewDataDateColumn Caption="Job Start" FieldName="JobStart" VisibleIndex="7" Width="80">
                                                                <EditItemTemplate>
                                                                    <dxe:ASPxDateEdit ID="txt_ExpiredDate" runat="server" Value='<%# Bind("JobStart") %>' Width="100" EditFormat="Custom" EditFormatString="dd/MM/yyyy">
                                                                    </dxe:ASPxDateEdit>
                                                                </EditItemTemplate>
                                                            </dxwgv:GridViewDataDateColumn>
                                                         <dxwgv:GridViewDataDateColumn Caption="Job End" FieldName="JobEnd" VisibleIndex="7" Width="80">
                                                                <EditItemTemplate>
                                                                    <dxe:ASPxDateEdit ID="txt_ExpiredDate" runat="server" Value='<%# Bind("JobEnd") %>' Width="100" EditFormat="Custom" EditFormatString="dd/MM/yyyy">
                                                                    </dxe:ASPxDateEdit>
                                                                </EditItemTemplate>
                                                            </dxwgv:GridViewDataDateColumn>
                                                        </Columns>
                                                   ...
                                                   <tr>
                                                        ...
                                                        <td colspan="7">
                                                            <dxe:ASPxButtonEdit ID="txt_Transport" ClientInstanceName="txt_Transport" runat="server"
                                                                ...
                                                                <ClientSideEvents ButtonClick="function(s, e) {
                                                                             PopupNewParty(null,txt_Transport,'Transporter')
                                                                    }" />
                                                            </dxe:ASPxButtonEdit>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <dxe:ASPxDateEdit ID="date_TransportStart" runat="server" Value='<%# Eval("TransportStart") %>' Width="150px" EditFormat="Custom" EditFormatString="dd/MM/yyyy">
                                                            </dxe:ASPxDateEdit>

                                                        </td>
                                                        <td>Transport End</td>
                                                        <td>
                                                            <dxe:ASPxDateEdit ID="date_TransportEnd" runat="server" Value='<%# Eval("TransportEnd") %>' Width="150px" EditFormat="Custom" EditFormatString="dd/MM/yyyy">
                                                            </dxe:ASPxDateEdit>
                                                        </td>
                                                    </tr>
                                                   <tr>
                                    ...
                                    <dxtc:TabPage Text="Freight" Visible="true">
                                        <ContentCollection>
