...
public partial class WareHouse_Job_Mi_SPJ : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            this.dsStock.FilterExpression = where + " and DocOwner='SPJ' and DoType='IN3'";
        }
    }
    protected void btn_search_Click(object sender, EventArgs e)
    {
        ...
        if (where.Length > 0)
        {
            where += " and DocOwner='SPJ' and DoType='IN3' ";
        }
    ...
    protected void btn_export_Click(object sender, EventArgs e)
    {
        ...
        if (dateFrom.Length > 0)
        {
            where = GetWhere(where, " DocOwner='SPJ' and DoType='IN3' and DocDate>= '" + dateFrom + "' and DocDate<= '" + dateTo + "'");
        }
        if (where.Length > 0)
        {
       //     where += " Order by JobNo";
        ...
        dsStock.FilterExpression = where;
        //btn_search_Click(null, null);
        gridExport.WriteXlsToResponse("Material-In", true);
    }	
