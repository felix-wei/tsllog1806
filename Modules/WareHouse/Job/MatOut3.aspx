<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MatOut3.aspx.cs" Inherits="WareHouse_Job_MatOut3" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        ...
        function PopubMaterials(jobNo, company) {
            ...
            popubCtr.SetContentUrl('/Modules/WareHouse/SelectPage/SelectMaterialsFromIN.aspx?no=' + jobNo + '&type=OUT3&company=' + company);
            popubCtr.Show();
        }
        ...
        <div>
            <table class="noprint">
             ...
             <dxwgv:ASPxGridView ID="grid" ClientInstanceName="grid" runat="server" DataSourceID="dsJobSchedule" OnRowUpdating="grid_RowUpdating" OnRowInserting="grid_RowInserting" OnInitNewRow="grid_InitNewRow"
                KeyFieldName="Id" Width="100%" AutoGenerateColumns="False" OnHtmlDataCellPrepared="grid_HtmlDataCellPrepared" OnRowDeleting="grid_RowDeleting" OnCustomDataCallback="grid_CustomDataCallback" OnInit="grid_Init">
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Client" FieldName="OriginAdd" VisibleIndex="2" Width="120">
                          <DataItemTemplate>
                            <%# Eval("OriginAdd") %>
                        </DataItemTemplate>
                        <EditItemTemplate>
                    ...
                    <dxwgv:GridViewDataComboBoxColumn Caption="Status" FieldName="Value1" VisibleIndex="2" Width="100">
                        <PropertiesComboBox Width="100">
                            <Items>
                                ...
                                <dxe:ListEditItem Text="Billed" Value="Billed" />
