...
public partial class WareHouse_Job_JobScheduleEdit : System.Web.UI.Page
{
    protected void Page_Init()
    {
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["JobType"] != null && Request.QueryString["JobType"] != "0")
            {
                this.txt_JobType.Text = SafeValue.SafeString(Request.QueryString["JobType"]);
            }
    ...
    protected void grid_Issue_InitNewRow(object sender, DevExpress.Web.Data.ASPxDataInitNewRowEventArgs e)
    {
        ...
        e.NewValues["JobType"] =SafeValue.SafeString(Request.QueryString["JobType"]);
    ...
    protected string SaveJob()
    {
        try
        {
            ...
            job.JobType = this.txt_JobType.Text;
            //Main Info
