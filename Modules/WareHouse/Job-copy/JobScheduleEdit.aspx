<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JobScheduleEdit.aspx.cs" Inherits="WareHouse_Job_JobScheduleEdit" %>
    ...
    <script type="text/javascript">
        ...
        function OnSaveCallBack(v) {
            if (v != null && v.indexOf("Fail") > -1) {
                ...
                window.location = 'JobScheduleEdit.aspx?no=' + v;
            ...
            <table>
                <tr>
                    ...
                    <td>
                        ...
                        window.location='JobScheduleEdit.aspx?no='+txt_SchRefNo.GetText();
                    }" />
                        </dxe:ASPxButton>
                    </td>
                    <td>
                        <dxe:ASPxButton ID="btn_Add" Width="100" runat="server" Text="Add New" AutoPostBack="false">
                            <ClientSideEvents Click="function(s,e){
                        window.location='JobScheduleEdit.aspx?no=0';
                                                        }" />
                        </dxe:ASPxButton>
                    </td>
                    <td>
                        <dxe:ASPxButton ID="ASPxButton3" Width="100" runat="server" Text="Go Search" AutoPostBack="false"
                            ...
                            <ClientSideEvents Click="function(s,e) {
                                           window.location='JobSchedule.aspx';
                        }" />
                        </dxe:ASPxButton>
                    </td>
                </tr>
                    ...
                    <EditForm>
                     ...
                     <td>WorkStatus</td>
                            ...
                            PopupCurrency(cmb_CostCostCurrency,null);
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <dxe:ASPxButtonEdit ID="txt_AgentCode" ClientInstanceName="txt_AgentCode" runat="server"
                                                                            ...
                                                                            <ClientSideEvents ButtonClick="function(s, e) {
                                                                            PopupPersonInfo(txt_AgentCode,null,txt_AgentName,txt_AgentContact,txt_AgentTelexFax,txt_AgentCountry,txt_AgentCity,txt_AgentPostalCode,memo_AgentAddress,'D');
                                                                        }" />
                                                                        </dxe:ASPxButtonEdit>
                                                                    </td>
                                                                    <td>
                                                                        <dxe:ASPxTextBox runat="server" Width="260" ID="txt_AgentName" Text='<%# Eval("AgentName") %>' ClientInstanceName="txt_AgentName">
                                                                        </dxe:ASPxTextBox>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="2">
                                                            ...
                                                            <dxe:ASPxButtonEdit ID="txt_NotifyCode" ClientInstanceName="txt_NotifyCode" runat="server"
                                                                Width="150" HorizontalAlign="Left" AutoPostBack="False" Text='<%# Eval("NotifyId") %>'>
                                                                <Buttons>
                                                                    <dxe:EditButton Enabled="true" Text=".."></dxe:EditButton>
                                                                </Buttons>
                                                                <ClientSideEvents ButtonClick="function(s, e) {
                                                                            PopupPersonInfo(null,txt_NotifyCode,txt_NotifyName,txt_NotifyContact,txt_NotifyTelexFax,txt_NotifyCountry,txt_NotifyCity,txt_NotifyPostalCode,memo_NotifyAddress,'P');
                                                                    }" />
                                                            </dxe:ASPxButtonEdit>
                                                        </td>
                                                        ...
                                                        <td>Name</td>
                                                        <td>
                                                            <dxe:ASPxTextBox runat="server" Width="155" ID="txt_NotifyName" Text='<%# Eval("NotifyName") %>' ClientInstanceName="txt_NotifyName">
                                                            </dxe:ASPxTextBox>
                                                        </td>
                                    ...
                                    <dxtc:TabPage Text="Attachment" Visible="false">
                                        <ContentCollection>
