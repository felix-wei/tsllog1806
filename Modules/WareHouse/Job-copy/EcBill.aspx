<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="EcBill.aspx.cs"
    Inherits="WareHouse_Job_EcBill" %>
    ...
    <div>
       ...
       <table border="0">
            ...
            <tr>
                ...
                <td>
                    <dxe:ASPxDateEdit ID="txt_from" Width="120" runat="server"  EditFormat="Custom" EditFormatString="dd/MM/yyyy" DisplayFormatString="dd/MM/yyyy">
                    </dxe:ASPxDateEdit>
                </td>
                <td>
                    To
                ...
                <td>
                    <dxe:ASPxDateEdit ID="txt_end" Width="120" runat="server" EditFormat="Custom" EditFormatString="dd/MM/yyyy" DisplayFormatString="dd/MM/yyyy">
                    </dxe:ASPxDateEdit>
                </td>
                <td>
                    <table>
        ...
        <dxwgv:ASPxGridView ID="ASPxGridView1" runat="server" DataSourceID="dsArInvoice"
            ClientInstanceName="grid" Width="980" KeyFieldName="SequenceId">
            ...
            <Columns>
                ...
                <dxwgv:GridViewDataTextColumn Caption="PartyTo" FieldName="PartyName" VisibleIndex="4" Width="20%">
                </dxwgv:GridViewDataTextColumn>
