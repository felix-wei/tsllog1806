<%@ Page Language="C#" EnableViewState="false" AutoEventWireup="true" CodeFile="JobOrderEdit.aspx.cs" Inherits="WareHouse_Job_JobOrderEdit" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <wilson:DataSource ID="dsIssue" runat="server" ObjectSpace="C2.Manager.ORManager" TypeName="C2.WhTrans"
                KeyMember="Id" FilterExpression="1=0" />
            <wilson:DataSource ID="dsSubSo" runat="server" ObjectSpace="C2.Manager.ORManager" TypeName="C2.WhTrans"
                KeyMember="Id" />
            ...
            <table>
                <tr>
                    ...
                    <td>
                        ...
                        window.location='JobOrderEdit.aspx?no='+txt_SchRefNo.GetText();
                    }" />
                        </dxe:ASPxButton>
                    </td>
                    <td>
                        <dxe:ASPxButton ID="btn_Add" Width="100" runat="server" Text="Add New" AutoPostBack="false">
                            <ClientSideEvents Click="function(s,e){
                        window.location='JobOrderEdit.aspx?no=0';
                                                        }" />
                        </dxe:ASPxButton>
                    </td>
                    <td>
                        <dxe:ASPxButton ID="ASPxButton3" Width="100" runat="server" Text="Go Search" AutoPostBack="false"
                            ...
                            <ClientSideEvents Click="function(s,e) {
                                           window.location='JobOrderList.aspx';
                        }" />
                        </dxe:ASPxButton>
                    </td>
                </tr>
                                ...
                                <tr>
                                    <td width="90%">
                                        <table style="border: solid 1px black; padding: 2px 2px 2px 2px; width: 100%">
                                            <tr>
                                                <td>Print Document:&nbsp;&nbsp;
                                        <a href="#" onclick='PrintDo("<%# Eval("DoNo") %>","SO")'>Job Order</a>
                                                    &nbsp;&nbsp;
                                    ...
                                    <td>
                                        <dxe:ASPxButton ID="btn_AutoPurchase" Width="120" runat="server" Text="Auto Purchase" AutoPostBack="False"
...
<%--                                                            <dxwgv:GridViewDataComboBoxColumn Caption="Att7" FieldName="Att7" VisibleIndex="51" Width="60">
                                                ...
                                                <div>
                                                    <dxwgv:ASPxGridView ID="grid_SubSO" ClientInstanceName="grid_SubSO" runat="server" OnRowInserting="grid_SubSO_RowInserting"
                                                        OnRowDeleting="grid_SubSO_RowDeleting" OnRowUpdating="grid_SubSO_RowUpdating" OnBeforePerformDataSelect="grid_SubSO_BeforePerformDataSelect"
                                                        KeyFieldName="Id" Width="1000" AutoGenerateColumns="False" Styles-Cell-Paddings-Padding="2" DataSourceID="dsSubSo" OnInit="grid_SubSO_Init" OnInitNewRow="grid_SubSO_InitNewRow">
                                                        <SettingsCustomizationWindow Enabled="True" />
                                                        <SettingsEditing Mode="Inline" />
                                                        <SettingsPager Mode="ShowAllRecords"></SettingsPager>
                                                        <Columns>
                                                            <dxwgv:GridViewDataColumn Caption="DoNo" VisibleIndex="0" Width="40">
                                                                <DataItemTemplate>
                                                                    <a href='javascript: parent.navTab.openTab("<%# Eval("DoNo") %>","/Modules/WareHouse/Job/PoEdit.aspx?no=<%# Eval("DoNo") %>",{title:"<%# Eval("DoNo") %>", fresh:false, external:true});'><%# Eval("DoNo") %></a>
                                                                </DataItemTemplate>
                                                            </dxwgv:GridViewDataColumn>
