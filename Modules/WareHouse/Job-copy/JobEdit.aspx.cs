...
public partial class WareHouse_Job_JobEdit : System.Web.UI.Page
{
	protected void Page_Init()
	{
		if (!IsPostBack)
		{
			...
			{
				 Console.Write("JobNo:==============="+Request.QueryString["no"]);
        ...
        {
            this.dsIssue.FilterExpression =SafeValue.SafeString(Session["SoWhere"]);
    ...
    protected string SaveJob()
    {
        try
        {
            ...
            job.Volumne=SafeValue.SafeDecimal(txt_Volumne.Text);
