<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BlanketPOList.aspx.cs" Inherits="WareHouse_Job_BlanketPOList" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        function ShowHouse(masterId, type) {
            window.location = "BlanketPOEdit.aspx?no=" + masterId;
        }
    </script>
</head>
<body>
                ...
                <tr>
                    ...
                    <td>
                        <dxe:ASPxButtonEdit ID="txt_CustId" ClientInstanceName="txt_CustId" runat="server" Width="120px" HorizontalAlign="Left" AutoPostBack="False">
                            ...
                            PopupParty(txt_CustId,txt_CustName,null,null,null,null,null,null,'V');
                                }" />
                        </dxe:ASPxButtonEdit>
                    </td>
                    <td colspan="4">
            ...
            <dxwgv:ASPxGridView ID="grid" ClientInstanceName="detailGrid" runat="server"
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Total Amt" FieldName="TotalAmt" VisibleIndex="4" Width="40">
                     ...
                     <dxwgv:GridViewDataSpinEditColumn Caption="OutstandingQty" FieldName="OutstandingQty" VisibleIndex="4" Width="40">
