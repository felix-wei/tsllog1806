                                                    ...
                                                    <tr>
                                                        <td>
                                                            <dxe:ASPxButton ID="btn_AddDoIn" ClientInstanceName="btn_AddDoIn" runat="server" Width="180" Text="Create Storing Order" AutoPostBack="False"
                                                                UseSubmitBehavior="false" Enabled='<%# SafeValue.SafeInt(Eval("Id"),0)>0&&SafeValue.SafeString(Eval("JobStatus"),"")!="Closed"&&SafeValue.SafeString(Eval("ViaWh"),"No")!="No" %>'>
                                                                <ClientSideEvents Click="function(s, e) {
                                            ...
                                            <dxw:ContentControl ID="ContentControl200" runat="server">
                                                ...
                                                <dxwgv:ASPxGridView ID="grid_Inventory" ClientInstanceName="grid_Inventory" runat="server"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dxwgv:GridViewDataTextColumn Caption="Balance Qty" FieldName="Qty" VisibleIndex="2" Width="60" ReadOnly="true">
                                                            <DataItemTemplate>
                                                                <%# GetBalQty(SafeValue.SafeString(Eval("ItemNo"))) %>
                                                            </DataItemTemplate>
                                                        </dxwgv:GridViewDataTextColumn>
                                                        ...
                                                        <dxwgv:GridViewDataTextColumn Caption="Type" FieldName="DoType" VisibleIndex="2"
                                                            Width="60">
                                                        </dxwgv:GridViewDataTextColumn>
                                                        ...
                                                        <dxwgv:GridViewDataDateColumn Caption="Stock Date" FieldName="DoDate" VisibleIndex="10" Width="120">
                                                ...
                                                <table>
                                                    <tr>
                                                        <td>
                                                            <dxe:ASPxButton ID="ASPxButton9" runat="server" Text="Add New Released" AutoPostBack="false"
                                                                UseSubmitBehavior="false" Enabled='<%# SafeValue.SafeString(Eval("JobStatus"),"")!="Closed" %>'>
                                                                <ClientSideEvents Click="function(s,e) {
                                                                   grid_Released.AddNewRow();
                                                                 }" />
                                                            </dxe:ASPxButton>
                                                        </td>
                                                    </tr>
                                                ...
                                                <dxwgv:ASPxGridView ID="grid_Released" ClientInstanceName="grid_Released" runat="server" OnRowInserted="grid_Released_RowInserted"
                                                    ...
                                                    OnBeforePerformDataSelect="grid_Released_BeforePerformDataSelect" OnInit="grid_Released_Init" OnInitNewRow="grid_Released_InitNewRow"
                                                      OnRowInserting="grid_Released_RowInserting" OnRowDeleting="grid_Released_RowDeleting" OnRowUpdating="grid_Released_RowUpdating" >
                                                    <SettingsPager Mode="ShowAllRecords"></SettingsPager>
                                                    <SettingsEditing  Mode="Inline"/>
                                                    <Columns>
                                                        <dxwgv:GridViewDataColumn Caption="#" VisibleIndex="0" Width="40">
