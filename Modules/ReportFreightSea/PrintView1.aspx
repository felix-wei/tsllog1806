<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintView1.aspx.cs" Inherits="ReportFreightSea_PrintView1" %>
				...
				LoadReport(txt_no.GetText());
                    ...
                    <tr>
                        ...
                        <td style="display:none">
                            <dxe:ASPxButton ID="btn_send" runat="server" ClientInstanceName="btn_send" OnClick="btn_send_Click" Text="Send Email">
                                <ClientSideEvents Click="function(s,e){
