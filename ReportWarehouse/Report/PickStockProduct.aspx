       ...
       <table>
            ...
            <dxwgv:ASPxGridView ID="ASPxGridView1" ClientInstanceName="grid" runat="server"
                ...
                <Columns>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="Product" FieldName="ProductCode" Width="120" VisibleIndex="1" >
                         <DataItemTemplate>
                            <dxe:ASPxTextBox ID="txt_Product" BackColor="Control" ReadOnly="true" runat="server"
                                    Text='<%# Eval("ProductCode") %>' Width="120">
                                </dxe:ASPxTextBox>
                        </DataItemTemplate>
                    </dxwgv:GridViewDataTextColumn>
                    <dxwgv:GridViewDataTextColumn Caption="Lot No" FieldName="LotNo" VisibleIndex="2" Width="100">
                        <DataItemTemplate>
                            <%# Eval("LotNo") %>
                            <div style="display: none">
                                <dxe:ASPxTextBox ID="txt_LotNo" Width="100" Border-BorderWidth="0" ReadOnly="true" runat="server"
                                    Text='<%# Eval("LotNo") %>'>
                                </dxe:ASPxTextBox>
                            </div>
                        </DataItemTemplate>
                    ...
                    <dxwgv:GridViewDataTextColumn Caption="AvaibleQty" FieldName="AvaibleQty" VisibleIndex="2" Width="40">
                    </dxwgv:GridViewDataTextColumn>
                     <dxwgv:GridViewDataTextColumn Caption="Picked" FieldName="Qty5" VisibleIndex="2" Width="40">
                    </dxwgv:GridViewDataTextColumn>
                    ...
                    <dxwgv:GridViewDataComboBoxColumn Caption="Length" FieldName="Att1" ReadOnly="true" VisibleIndex="6" Width="60">
                    </dxwgv:GridViewDataComboBoxColumn>
                    <dxwgv:GridViewDataComboBoxColumn Caption="Diameter" FieldName="Att2" ReadOnly="true" VisibleIndex="6" Width="60">
                    </dxwgv:GridViewDataComboBoxColumn>
                    <dxwgv:GridViewDataComboBoxColumn Caption="Att1" FieldName="Att3" ReadOnly="true" VisibleIndex="6" Width="60" Visible="false">
                    </dxwgv:GridViewDataComboBoxColumn>
                    <dxwgv:GridViewDataComboBoxColumn Caption="Att2" FieldName="Att4" ReadOnly="true" VisibleIndex="6" Width="60" Visible="false">
                    </dxwgv:GridViewDataComboBoxColumn>
                    <dxwgv:GridViewDataComboBoxColumn Caption="Att3" FieldName="Att5" ReadOnly="true" VisibleIndex="6" Width="60" Visible="false">
                    </dxwgv:GridViewDataComboBoxColumn>
