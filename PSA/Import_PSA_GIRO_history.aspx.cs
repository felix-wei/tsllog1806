...
public partial class PSA_Import_PSA_GIRO_history : System.Web.UI.Page
{
...
where JobType='GIRO' and datediff(d,CreateDateTime,'{0}')<=0 and datediff(d,CreateDatetime,'{1}')>=0 
